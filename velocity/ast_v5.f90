...
MODULE mo_loopindices
  ...
  SUBROUTINE get_indices_v(global_data_var_22, p_patch_var_41, i_blk_var_42, i_startblk_var_43, i_endblk_var_44, i_startidx_var_47, i_endidx_var_48, irl_start_var_45, opt_rl_end_var_46)
    ...
    irl_end_var_49 = opt_rl_end_var_46
    IF (i_blk_var_42 == i_startblk_var_43) THEN
      i_startidx_var_47 = p_patch_var_41 % verts % start_index(irl_start_var_45)
      i_endidx_var_48 = 48
      IF (i_blk_var_42 == i_endblk_var_44) i_endidx_var_48 = p_patch_var_41 % verts % end_index(irl_end_var_49)
    ELSE IF (i_blk_var_42 == i_endblk_var_44) THEN
      i_startidx_var_47 = 1
      i_endidx_var_48 = p_patch_var_41 % verts % end_index(irl_end_var_49)
    ELSE
      i_startidx_var_47 = 1
      i_endidx_var_48 = 48
    END IF
...
MODULE mo_math_divrot
  ...
  SUBROUTINE rot_vertex_ri(global_data_var_23, vec_e, ptr_patch_var_50, ptr_int, rot_vec, opt_slev_var_51, opt_elev_var_52, opt_rlend_var_53, opt_acc_async_var_54)
    ...
    DO jb_var_59 = i_startblk_var_62, i_endblk_var_63
      CALL get_indices_v(global_data_var_23, ptr_patch_var_50, jb_var_59, i_startblk_var_62, i_endblk_var_63, i_startidx_var_64, i_endidx_var_65, rl_start_var_60, rl_end_var_61)
...
MODULE mo_icon_interpolation_scalar
  ...
  SUBROUTINE cells2verts_scalar_ri(global_data_var_26, p_cell_in, ptr_patch_var_68, c_int, p_vert_out, opt_slev_var_69, opt_elev_var_70, opt_rlstart, opt_rlend_var_71, opt_acc_async_var_72)
    ...
    DO jb_var_77 = i_startblk_var_80, i_endblk_var_81
      CALL get_indices_v(global_data_var_26, ptr_patch_var_68, jb_var_77, i_startblk_var_80, i_endblk_var_81, i_startidx_var_82, i_endidx_var_83, rl_start_var_78, rl_end_var_79)
  ...
  SUBROUTINE velocity_tendencies(global_data, p_prog, p_patch, p_int, p_metrics, p_diag, z_w_concorr_me, z_kin_hor_e, z_vt_ie, ntnd, istep, lvn_only, dtime, dt_linintp_ubc, ldeepatmo)
    ...
    IF (istep == 1) THEN
      ...
      DO jb_var_84 = i_startblk_var_86, i_endblk_var_87
        CALL get_indices_e(global_data, p_patch, jb_var_84, i_startblk_var_86, i_endblk_var_87, i_startidx_var_88, i_endidx_var_89, rl_start_var_90, rl_end_var_91)
    ...
    DO jb_var_84 = i_startblk_var_86, i_endblk_var_87
      CALL get_indices_c(global_data, p_patch, jb_var_84, i_startblk_var_86, i_endblk_var_87, i_startidx_var_88, i_endidx_var_89, rl_start_var_90, rl_end_var_91)
      DO jk_var_85 = 1, nlev_var_92
      ...
      CALL get_indices_c(global_data, p_patch, jb_var_84, i_startblk_2, i_endblk_2, i_startidx_2, i_endidx_2, rl_start_2, rl_end_2)
      DO jk_var_85 = 2, nlev_var_92
