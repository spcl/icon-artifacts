...
MODULE mo_intp_data_strc
  IMPLICIT NONE
  TYPE :: t_int_state
    REAL(KIND = 8) :: c_lin_e(1 : 32, 1 : 2, 1 : 960)
    REAL(KIND = 8) :: e_bln_c_s(1 : 32, 1 : 3, 1 : 640)
    REAL(KIND = 8) :: cells_aw_verts(1 : 32, 1 : 6, 1 : 321)
    REAL(KIND = 8) :: rbf_vec_coeff_e(1 : 4, 1 : 32, 1 : 960)
    REAL(KIND = 8) :: geofac_grdiv(1 : 32, 1 : 5, 1 : 960)
...
MODULE mo_model_domain
  ...
  IMPLICIT NONE
  TYPE :: t_grid_cells
    INTEGER(KIND = 4) :: neighbor_idx(1 : 32, 1 : 640, 1 : 3)
    INTEGER(KIND = 4) :: neighbor_blk(1 : 32, 1 : 640, 1 : 3)
    INTEGER(KIND = 4) :: edge_idx(1 : 32, 1 : 640, 1 : 3)
    INTEGER(KIND = 4) :: edge_blk(1 : 32, 1 : 640, 1 : 3)
    REAL(KIND = 8), POINTER :: area(:, :)
    INTEGER(KIND = 4) :: start_index(- 8 : 5)
    INTEGER(KIND = 4) :: end_index(- 8 : 5)
    INTEGER(KIND = 4) :: start_block(- 8 : 5)
    INTEGER(KIND = 4) :: end_block(- 8 : 5)
    TYPE(t_grid_domain_decomp_info) :: decomp_info
  END TYPE t_grid_cells
  TYPE :: t_grid_edges
    INTEGER(KIND = 4) :: cell_idx(1 : 32, 1 : 960, 1 : 2)
    INTEGER(KIND = 4) :: cell_blk(1 : 32, 1 : 960, 1 : 2)
    INTEGER(KIND = 4) :: vertex_idx(1 : 32, 1 : 960, 1 : 4)
    INTEGER(KIND = 4) :: vertex_blk(1 : 32, 1 : 960, 1 : 4)
    REAL(KIND = 8) :: tangent_orientation(1 : 32, 1 : 960)
    INTEGER(KIND = 4) :: quad_idx(1 : 32, 1 : 960, 1 : 4)
    INTEGER(KIND = 4) :: quad_blk(1 : 32, 1 : 960, 1 : 4)
    REAL(KIND = 8) :: inv_primal_edge_length(1 : 32, 1 : 960)
    REAL(KIND = 8) :: inv_dual_edge_length(1 : 32, 1 : 960)
    REAL(KIND = 8) :: area_edge(1 : 32, 1 : 960)
    REAL(KIND = 8) :: f_e(1 : 32, 1 : 960)
    REAL(KIND = 8) :: fn_e(1 : 32, 1 : 960)
    REAL(KIND = 8) :: ft_e(1 : 32, 1 : 960)
    INTEGER(KIND = 4) :: start_index(- 13 : 10)
    INTEGER(KIND = 4) :: end_index(- 13 : 10)
    INTEGER(KIND = 4) :: start_block(- 13 : 10)
    INTEGER(KIND = 4) :: end_block(- 13 : 10)
  END TYPE t_grid_edges
  TYPE :: t_grid_vertices
    INTEGER(KIND = 4) :: cell_idx(1 : 32, 1 : 321, 1 : 6)
    INTEGER(KIND = 4) :: cell_blk(1 : 32, 1 : 321, 1 : 6)
    INTEGER(KIND = 4) :: edge_idx(1 : 32, 1 : 321, 1 : 6)
    INTEGER(KIND = 4) :: edge_blk(1 : 32, 1 : 321, 1 : 6)
    INTEGER(KIND = 4) :: start_index(- 7 : 5)
    INTEGER(KIND = 4) :: end_index(- 7 : 5)
    INTEGER(KIND = 4) :: start_blk(- 7 : 5, 1 : 1)
    INTEGER(KIND = 4) :: start_block(- 7 : 5)
    INTEGER(KIND = 4) :: end_blk(- 7 : 5, 1 : 1)
    INTEGER(KIND = 4) :: end_block(- 7 : 5)
...
MODULE mo_math_divrot
  ...
  SUBROUTINE rot_vertex_ri(global_data_var_23, vec_e, ptr_patch_var_50, ptr_int, rot_vec, opt_slev_var_51, opt_elev_var_52, opt_rlend_var_53, opt_acc_async_var_54)
    ...
    DO jb_var_59 = i_startblk_var_62, i_endblk_var_63
      CALL get_indices_v(global_data_var_23, ptr_patch_var_50, jb_var_59, i_startblk_var_62, i_endblk_var_63, i_startidx_var_64, i_endidx_var_65, 2, -5)
...
MODULE mo_icon_interpolation_scalar
  ...
  SUBROUTINE cells2verts_scalar_ri(global_data_var_26, p_cell_in, ptr_patch_var_68, c_int, p_vert_out, opt_slev_var_69, opt_elev_var_70, opt_rlstart, opt_rlend_var_71, opt_acc_async_var_72)
    ...
    IF (global_data_var_26 % timers_level > 10) CALL timer_start(global_data_var_26, global_data_var_26 % timer_intp)
    DO jb_var_77 = i_startblk_var_80, i_endblk_var_81
      CALL get_indices_v(global_data_var_26, ptr_patch_var_68, jb_var_77, i_startblk_var_80, i_endblk_var_81, i_startidx_var_82, i_endidx_var_83, 2, -5)
      ...
      END DO
    END DO
    IF (global_data_var_26 % timers_level > 10) CALL timer_stop(global_data_var_26, global_data_var_26 % timer_intp)
...
MODULE mo_velocity_advection
  ...
  SUBROUTINE velocity_tendencies(global_data, p_prog, p_patch, p_int, p_metrics, p_diag, z_w_concorr_me, z_kin_hor_e, z_vt_ie, ntnd, istep, lvn_only, dtime, dt_linintp_ubc, ldeepatmo)
    ...
    INTEGER :: jg
    REAL(KIND = 8) :: cfl_w_limit, vcfl, maxvcfl, vcflmax(640)
    ...
    END IF
    IF (.NOT. lvn_only) CALL cells2verts_scalar_ri(global_data, p_prog % w, p_patch, p_int % cells_aw_verts, z_w_v, opt_rlend_var_71 = - 5, opt_acc_async_var_72 = .TRUE.)
    CALL rot_vertex_ri(global_data, p_prog % vn, p_patch, p_int, zeta, opt_rlend_var_53 = - 5, opt_acc_async_var_54 = .TRUE.)
    IF (istep == 1) THEN
      rl_start_var_90 = 5
      rl_end_var_91 = -10
      ...
      DO jb_var_84 = i_startblk_var_86, i_endblk_var_87
        CALL get_indices_e(global_data, p_patch, jb_var_84, i_startblk_var_86, i_endblk_var_87, i_startidx_var_88, i_endidx_var_89, 5, -10)
        ...
        DO je = i_startidx_var_88, i_endidx_var_89
          ...
          p_diag % vn_ie(je, nlevp1_var_93, jb_var_84) = p_metrics % wgtfacq_e(je, 1, jb_var_84) * p_prog % vn(je, 90, jb_var_84) + p_metrics % wgtfacq_e(je, 2, jb_var_84) * p_prog % vn(je, 89, jb_var_84) + p_metrics % wgtfacq_e(je, 3, jb_var_84) * p_prog % vn(je, 88, jb_var_84)
        END DO
      END DO
    END IF
    rl_start_var_90 = 7
    ...
    IF (.NOT. lvn_only) THEN
      DO jb_var_84 = i_startblk_var_86, i_endblk_var_87
        CALL get_indices_e(global_data, p_patch, jb_var_84, i_startblk_var_86, i_endblk_var_87, i_startidx_var_88, i_endidx_var_89, 7, -9)
        DO jk_var_85 = 1, nlev_var_92
          DO je = i_startidx_var_88, i_endidx_var_89
    ...
    DO jb_var_84 = i_startblk_var_86, i_endblk_var_87
      CALL get_indices_c(global_data, p_patch, jb_var_84, i_startblk_var_86, i_endblk_var_87, i_startidx_var_88, i_endidx_var_89, 4, -5)
      DO jk_var_85 = 1, nlev_var_92
      ...
      CALL get_indices_c(global_data, p_patch, jb_var_84, i_startblk_2, i_endblk_2, i_startidx_2, i_endidx_2, 5, -4)
      DO jk_var_85 = 2, nlev_var_92
    ...
    DO jb_var_84 = i_startblk_var_86, i_endblk_var_87
      CALL get_indices_e(global_data, p_patch, jb_var_84, i_startblk_var_86, i_endblk_var_87, i_startidx_var_88, i_endidx_var_89, 10, -8)
    ...
    max_vcfl_dyn_var_94 = MAX(0.0D0, MAXVAL(vcflmax(i_startblk_var_86 : i_endblk_var_87)))
