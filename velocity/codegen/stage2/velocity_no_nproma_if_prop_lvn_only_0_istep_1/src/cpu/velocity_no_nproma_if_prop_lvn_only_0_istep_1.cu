...
inline void loop_body_32_0_4(velocity_no_nproma_if_prop_lvn_only_0_istep_1_state_t *__state, double* __restrict__ __CG_p_metrics__m_ddqz_z_half, int* __restrict__ cfl_clipping, const double&  dtime, double* __restrict__ maxvcfl_arr, double* __restrict__ z_w_con_c, int _for_it_22, int64_t _for_it_35, int64_t _for_it_37, int tmp_struct_symbol_1, int tmp_struct_symbol_14) {
    int _if_cond_18;
    double vcfl;
    ...
    if ((! ((out_val_0[0] == 0) == 1))) {
        {
...

            {
                for (auto _for_it_37 = i_startidx_var_148; _for_it_37 < (i_endidx_var_149 + 1); _for_it_37 += 1) {
                    loop_body_32_0_4(__state, &__CG_p_metrics__m_ddqz_z_half[0], &cfl_clipping[0], dtime, &maxvcfl_arr[0], &z_w_con_c[0], _for_it_22, _for_it_35, _for_it_37, tmp_struct_symbol_1, tmp_struct_symbol_14);
                }
            }
            {
                int size;
        ...
        }
        {
            for (auto _for_it_25 = nflatlev_jg; _for_it_25 < 91; _for_it_25 += 1) {
                for (auto _for_it_26 = i_startidx_var_148; _for_it_26 < (i_endidx_var_149 + 1); _for_it_26 += 1) {
                    loop_body_29_5_8(__state, &__CG_p_int__m_e_bln_c_s[0], &__CG_p_patch__CG_cells__m_edge_blk[0], &__CG_p_patch__CG_cells__m_edge_idx[0], &z_w_concorr_me[0], &z_w_concorr_mc[0], __f2dace_A_z_w_concorr_me_d_0_s_360, __f2dace_A_z_w_concorr_me_d_1_s_361, __f2dace_OA_z_w_concorr_me_d_0_s_360, __f2dace_OA_z_w_concorr_me_d_1_s_361, __f2dace_OA_z_w_concorr_me_d_2_s_362, _for_it_22, _for_it_25, _for_it_26, tmp_struct_symbol_0);
                }
            }
        }
        {
...

    {
        ...
        }
        {
            for (auto _for_it_35 = Max(3, (nrdmax_jg - 2)); _for_it_35 < 88; _for_it_35 += 1) {
                loop_body_29_1_2(__state, &__CG_p_metrics__m_ddqz_z_half[0], cfl_w_limit, dtime, &cfl_clipping[0], &levmask[0], &maxvcfl_arr[0], &z_w_con_c[0], _for_it_22, _for_it_35, i_endidx_var_149, i_startidx_var_148, tmp_struct_symbol_1, tmp_struct_symbol_13, tmp_struct_symbol_14);
            }
        }
