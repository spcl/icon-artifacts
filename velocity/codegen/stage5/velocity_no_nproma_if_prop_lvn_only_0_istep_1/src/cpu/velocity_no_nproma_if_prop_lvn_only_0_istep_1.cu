        ...
        }
        {
            for (auto _for_it_9 = 2; _for_it_9 < 91; _for_it_9 += 1) {
                for (auto _for_it_10 = i_startidx_var_148; _for_it_10 < (i_endidx_var_149 + 1); _for_it_10 += 1) {
                    ...
                    {
                        double p_diag_0_in_vt_0 = __CG_p_diag__m_vt[((((__f2dace_SA_vt_d_0_s_p_diag_9 * ((- __f2dace_SOA_vt_d_1_s_p_diag_9) + _for_it_9)) + ((90 * __f2dace_SA_vt_d_0_s_p_diag_9) * ((- __f2dace_SOA_vt_d_2_s_p_diag_9) + _for_it_6))) - __f2dace_SOA_vt_d_0_s_p_diag_9) + _for_it_10)];
                        double p_diag_1_in_vt_0 = __CG_p_diag__m_vt[(((((90 * __f2dace_SA_vt_d_0_s_p_diag_9) * ((- __f2dace_SOA_vt_d_2_s_p_diag_9) + _for_it_6)) + (__f2dace_SA_vt_d_0_s_p_diag_9 * (((- __f2dace_SOA_vt_d_1_s_p_diag_9) + _for_it_9) - 1))) - __f2dace_SOA_vt_d_0_s_p_diag_9) + _for_it_10)];
...

        {
            for (auto _for_it_23 = 1; _for_it_23 < 91; _for_it_23 += 1) {
                for (auto _for_it_24 = i_startidx_var_148; _for_it_24 < (i_endidx_var_149 + 1); _for_it_24 += 1) {
                    ...
                    {
                        double p_prog_0_in_w_0 = __CG_p_prog__m_w[((((__f2dace_SA_w_d_0_s_p_prog_7 * ((- __f2dace_SOA_w_d_1_s_p_prog_7) + _for_it_23)) + ((91 * __f2dace_SA_w_d_0_s_p_prog_7) * ((- __f2dace_SOA_w_d_2_s_p_prog_7) + _for_it_22))) - __f2dace_SOA_w_d_0_s_p_prog_7) + _for_it_24)];
                        double z_w_con_c_out_0;
