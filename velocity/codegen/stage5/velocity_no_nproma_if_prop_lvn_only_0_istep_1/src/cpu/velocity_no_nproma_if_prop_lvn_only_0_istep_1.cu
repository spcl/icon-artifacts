...
inline void loop_body_27_0_4(velocity_no_nproma_if_prop_lvn_only_0_istep_1_state_t *__state, double* __restrict__ __CG_p_metrics__m_ddqz_z_half, uint8_t* __restrict__ cfl_clipping, const double&  dtime, double* __restrict__ maxvcfl_arr, double* __restrict__ z_w_con_c, int _for_it_22, int _for_it_35, int _for_it_37, int tmp_struct_symbol_1, int tmp_struct_symbol_14, int tmp_struct_symbol_4) {
    uint8_t _if_cond_18;
    double vcfl;
...
inline void loop_body_24_1_2(velocity_no_nproma_if_prop_lvn_only_0_istep_1_state_t *__state, double* __restrict__ __CG_p_metrics__m_ddqz_z_half, const double&  cfl_w_limit, const double&  dtime, uint8_t* __restrict__ cfl_clipping, uint8_t* __restrict__ levmask, double* __restrict__ maxvcfl_arr, double* __restrict__ z_w_con_c, int _for_it_22, int _for_it_35, int i_endidx_var_149, int i_startidx_var_148, int tmp_struct_symbol_1, int tmp_struct_symbol_13, int tmp_struct_symbol_14, int tmp_struct_symbol_4) {
...

    {
        ...
        {
            uint8_t* in_arr = &cfl_clipping[((i_startidx_var_148 + (tmp_struct_symbol_14 * (_for_it_35 - 1))) - 1)];
    ...
    if ((! ((out_val_0[0] == 0) == 1))) {
        {
            ...
            {
                uint8_t in_arr = cfl_clipping[((_for_it_22 + (tmp_struct_symbol_14 * (_for_it_35 - 1))) - 1)];
...
inline void loop_body_35_2_10(velocity_no_nproma_if_prop_lvn_only_0_istep_1_state_t *__state, double* __restrict__ __CG_p_int__m_e_bln_c_s, int* __restrict__ __CG_p_patch__CG_cells__m_edge_blk, int* __restrict__ __CG_p_patch__CG_cells__m_edge_idx, double* __restrict__ z_v_grad_w, double* __restrict__ __CG_p_diag__m_ddt_w_adv_pc, int _for_it_22, int _for_it_42, int _for_it_43, int ntnd, int tmp_struct_symbol_4) {
    int tmp_index_581;
    int tmp_index_583;
    int tmp_index_593;
    int tmp_index_595;
...
inline void loop_body_35_2_16(velocity_no_nproma_if_prop_lvn_only_0_istep_1_state_t *__state, double* __restrict__ __CG_p_int__m_geofac_n2s, double* __restrict__ __CG_p_metrics__m_ddqz_z_half, int* __restrict__ __CG_p_patch__CG_cells__CG_decomp_info__m_owner_mask, double* __restrict__ __CG_p_patch__CG_cells__m_area, int* __restrict__ __CG_p_patch__CG_cells__m_neighbor_blk, int* __restrict__ __CG_p_patch__CG_cells__m_neighbor_idx, double* __restrict__ __CG_p_prog__m_w, uint8_t* __restrict__ cfl_clipping, const double&  cfl_w_limit, const double&  dtime, uint8_t* __restrict__ levmask, const double&  scalfac_exdiff, double* __restrict__ z_w_con_c, double* __restrict__ __CG_p_diag__m_ddt_w_adv_pc, int _for_it_22, int _for_it_44, int i_endidx_2, int i_startidx_2, int ntnd, int tmp_struct_symbol_1, int tmp_struct_symbol_13, int tmp_struct_symbol_14) {
    uint8_t _if_cond_24;
            ...
            for (auto _for_it_23 = 1; _for_it_23 < 91; _for_it_23 += 1) {
                for (auto _for_it_24 = i_startidx_var_148; _for_it_24 < (i_endidx_var_149 + 1); _for_it_24 += 1) {
                    loop_body_24_5_5(__state, &__CG_p_int__m_e_bln_c_s[0], &__CG_p_patch__CG_cells__m_edge_blk[0], &__CG_p_patch__CG_cells__m_edge_idx[0], &z_kin_hor_e[0], &z_ekinh[0], __f2dace_A_z_kin_hor_e_d_0_s_363, __f2dace_A_z_kin_hor_e_d_1_s_364, __f2dace_OA_z_kin_hor_e_d_0_s_363, __f2dace_OA_z_kin_hor_e_d_1_s_364, __f2dace_OA_z_kin_hor_e_d_2_s_365, _for_it_22, _for_it_23, _for_it_24, tmp_struct_symbol_10);
                    {
                        ...
                        z_w_con_c[(((_for_it_24 + ((91 * tmp_struct_symbol_1) * (_for_it_22 - 1))) + (tmp_struct_symbol_1 * (_for_it_23 - 1))) - 1)] = z_w_con_c_out_0;
                    }
                }
            }
        }
...
void __program_velocity_no_nproma_if_prop_lvn_only_0_istep_1_internal(velocity_no_nproma_if_prop_lvn_only_0_istep_1_state_t*__state, global_data_type* global_data, t_nh_diag* p_diag, t_int_state* p_int, t_nh_metrics* p_metrics, t_patch* p_patch, t_nh_prog* p_prog, double * __restrict__ z_kin_hor_e, double * __restrict__ z_vt_ie, double * __restrict__ z_w_concorr_me, int __f2dace_A_z_kin_hor_e_d_0_s_363, int __f2dace_A_z_kin_hor_e_d_1_s_364, int __f2dace_A_z_vt_ie_d_0_s_366, int __f2dace_A_z_vt_ie_d_1_s_367, int __f2dace_A_z_w_concorr_me_d_0_s_360, int __f2dace_A_z_w_concorr_me_d_1_s_361, int __f2dace_OA_z_kin_hor_e_d_0_s_363, int __f2dace_OA_z_kin_hor_e_d_1_s_364, int __f2dace_OA_z_kin_hor_e_d_2_s_365, int __f2dace_OA_z_vt_ie_d_0_s_366, int __f2dace_OA_z_vt_ie_d_1_s_367, int __f2dace_OA_z_vt_ie_d_2_s_368, int __f2dace_OA_z_w_concorr_me_d_0_s_360, int __f2dace_OA_z_w_concorr_me_d_1_s_361, int __f2dace_OA_z_w_concorr_me_d_2_s_362, double dt_linintp_ubc, double dtime, int istep, int ldeepatmo, int lvn_only, int ntnd)
{
    ...
    uint8_t *levelmask;
    levelmask = new uint8_t DACE_ALIGN(64)[90];
   ...
   // cudaEvent_t start1, stop1;
    ...
    {
        uint8_t *levmask;
        levmask = new uint8_t DACE_ALIGN(64)[(90 * tmp_struct_symbol_13)];
        uint8_t *cfl_clipping;
        cfl_clipping = new uint8_t DACE_ALIGN(64)[(91 * tmp_struct_symbol_14)];
        ...
        }
        {
            ...
            for (auto _for_it_46 = Max(3, (nrdmax_jg - 2)); _for_it_46 < 88; _for_it_46 += 1) {
                ...
                }
                {
                    ...
                    uint8_t* in_arr = &levmask[((i_startblk_var_146 + (tmp_struct_symbol_13 * (_for_it_46 - 1))) - 1)];
                    uint8_t out;
...

    {
        ...
        {
            double __in_tmp_call_18 = out_val;
