...
void __program_velocity_no_nproma_if_prop_lvn_only_1_istep_1_internal(velocity_no_nproma_if_prop_lvn_only_1_istep_1_state_t*__state, global_data_type* global_data, t_nh_diag* p_diag, t_int_state* p_int, t_nh_metrics* p_metrics, t_patch* p_patch, t_nh_prog* p_prog, double * __restrict__ z_kin_hor_e, double * __restrict__ z_vt_ie, double * __restrict__ z_w_concorr_me, int __f2dace_A_z_kin_hor_e_d_0_s, int __f2dace_A_z_kin_hor_e_d_1_s, int __f2dace_A_z_kin_hor_e_d_2_s, int __f2dace_A_z_vt_ie_d_0_s, int __f2dace_A_z_vt_ie_d_1_s, int __f2dace_A_z_vt_ie_d_2_s, int __f2dace_A_z_w_concorr_me_d_0_s, int __f2dace_A_z_w_concorr_me_d_1_s, int __f2dace_A_z_w_concorr_me_d_2_s, int __f2dace_OA_z_kin_hor_e_d_0_s, int __f2dace_OA_z_kin_hor_e_d_1_s, int __f2dace_OA_z_kin_hor_e_d_2_s, int __f2dace_OA_z_vt_ie_d_0_s, int __f2dace_OA_z_vt_ie_d_1_s, int __f2dace_OA_z_vt_ie_d_2_s, int __f2dace_OA_z_w_concorr_me_d_0_s, int __f2dace_OA_z_w_concorr_me_d_1_s, int __f2dace_OA_z_w_concorr_me_d_2_s, double dt_linintp_ubc, double dtime, int istep, int ldeepatmo, int lvn_only, int ntnd)
{
...

    {
        ...
        DACE_GPU_CHECK(cudaMemcpyAsync(gpu___CG_p_int__m_rbf_vec_coeff_e, __CG_p_int__m_rbf_vec_coeff_e, ((__f2dace_SA_rbf_vec_coeff_e_d_0_s_p_int_6 * __f2dace_SA_rbf_vec_coeff_e_d_1_s_p_int_6) * __f2dace_SA_rbf_vec_coeff_e_d_2_s_p_int_6) * sizeof(double), cudaMemcpyHostToDevice, nullptr));
        ...
        DACE_GPU_CHECK(cudaMemcpyAsync(gpu___CG_p_metrics__m_ddxn_z_full, __CG_p_metrics__m_ddxn_z_full, ((90 * __f2dace_SA_ddxn_z_full_d_0_s_p_metrics_8) * __f2dace_SA_ddxn_z_full_d_2_s_p_metrics_8) * sizeof(double), cudaMemcpyHostToDevice, nullptr));
        DACE_GPU_CHECK(cudaMemcpyAsync(gpu___CG_p_metrics__m_ddxt_z_full, __CG_p_metrics__m_ddxt_z_full, ((90 * __f2dace_SA_ddxt_z_full_d_0_s_p_metrics_8) * __f2dace_SA_ddxt_z_full_d_2_s_p_metrics_8) * sizeof(double), cudaMemcpyHostToDevice, nullptr));
        DACE_GPU_CHECK(cudaMemcpyAsync(gpu___CG_p_metrics__m_wgtfac_c, __CG_p_metrics__m_wgtfac_c, ((91 * __f2dace_SA_wgtfac_c_d_0_s_p_metrics_8) * __f2dace_SA_wgtfac_c_d_2_s_p_metrics_8) * sizeof(double), cudaMemcpyHostToDevice, nullptr));
        DACE_GPU_CHECK(cudaMemcpyAsync(gpu___CG_p_metrics__m_wgtfac_e, __CG_p_metrics__m_wgtfac_e, ((91 * __f2dace_SA_wgtfac_e_d_0_s_p_metrics_8) * __f2dace_SA_wgtfac_e_d_2_s_p_metrics_8) * sizeof(double), cudaMemcpyHostToDevice, nullptr));
        DACE_GPU_CHECK(cudaMemcpyAsync(gpu___CG_p_metrics__m_wgtfacq_e, __CG_p_metrics__m_wgtfacq_e, ((__f2dace_SA_wgtfacq_e_d_0_s_p_metrics_8 * __f2dace_SA_wgtfacq_e_d_1_s_p_metrics_8) * __f2dace_SA_wgtfacq_e_d_2_s_p_metrics_8) * sizeof(double), cudaMemcpyHostToDevice, nullptr));
...
//        DACE_GPU_CHECK(cudaStreamSynchronize(nullptr));
...

    {

        {
            ...
            ///////////////////
            dace_measure_time("velocity_no_nproma_if_prop_lvn_only_1_istep_1");
            ///////////////////
...
//            cudaEventRecord(__state->gpu_context->events[4], nullptr);
//            cudaStreamWaitEvent(nullptr, __state->gpu_context->events[4], 0);
            {
...
//            DACE_GPU_CHECK(cudaStreamSynchronize(nullptr));
...

    {
        ...
        DACE_GPU_CHECK(cudaMemcpyAsync(__CG_p_int__m_rbf_vec_coeff_e, gpu___CG_p_int__m_rbf_vec_coeff_e, ((__f2dace_SA_rbf_vec_coeff_e_d_0_s_p_int_6 * __f2dace_SA_rbf_vec_coeff_e_d_1_s_p_int_6) * __f2dace_SA_rbf_vec_coeff_e_d_2_s_p_int_6) * sizeof(double), cudaMemcpyDeviceToHost, nullptr));
        ...
        DACE_GPU_CHECK(cudaMemcpyAsync(__CG_p_metrics__m_ddxn_z_full, gpu___CG_p_metrics__m_ddxn_z_full, ((90 * __f2dace_SA_ddxn_z_full_d_0_s_p_metrics_8) * __f2dace_SA_ddxn_z_full_d_2_s_p_metrics_8) * sizeof(double), cudaMemcpyDeviceToHost, nullptr));
        DACE_GPU_CHECK(cudaMemcpyAsync(__CG_p_metrics__m_ddxt_z_full, gpu___CG_p_metrics__m_ddxt_z_full, ((90 * __f2dace_SA_ddxt_z_full_d_0_s_p_metrics_8) * __f2dace_SA_ddxt_z_full_d_2_s_p_metrics_8) * sizeof(double), cudaMemcpyDeviceToHost, nullptr));
        DACE_GPU_CHECK(cudaMemcpyAsync(__CG_p_metrics__m_wgtfac_c, gpu___CG_p_metrics__m_wgtfac_c, ((91 * __f2dace_SA_wgtfac_c_d_0_s_p_metrics_8) * __f2dace_SA_wgtfac_c_d_2_s_p_metrics_8) * sizeof(double), cudaMemcpyDeviceToHost, nullptr));
        DACE_GPU_CHECK(cudaMemcpyAsync(__CG_p_metrics__m_wgtfac_e, gpu___CG_p_metrics__m_wgtfac_e, ((91 * __f2dace_SA_wgtfac_e_d_0_s_p_metrics_8) * __f2dace_SA_wgtfac_e_d_2_s_p_metrics_8) * sizeof(double), cudaMemcpyDeviceToHost, nullptr));
        DACE_GPU_CHECK(cudaMemcpyAsync(__CG_p_metrics__m_wgtfacq_e, gpu___CG_p_metrics__m_wgtfacq_e, ((__f2dace_SA_wgtfacq_e_d_0_s_p_metrics_8 * __f2dace_SA_wgtfacq_e_d_1_s_p_metrics_8) * __f2dace_SA_wgtfacq_e_d_2_s_p_metrics_8) * sizeof(double), cudaMemcpyDeviceToHost, nullptr));
