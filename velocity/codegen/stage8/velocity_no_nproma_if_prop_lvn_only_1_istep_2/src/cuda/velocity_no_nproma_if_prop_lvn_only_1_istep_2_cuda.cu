...
void __dace_runkernel_single_state_body_0_map_3_3_0_0_36(velocity_no_nproma_if_prop_lvn_only_1_istep_2_state_t *__state, uint8_t * __restrict__ gpu_levelmask, const uint8_t * __restrict__ gpu_levmask, int nrdmax_jg, int replaced_var_0, int replaced_var_1, int tmp_struct_symbol_13)
{
    ...
    gpuError_t __err = cudaLaunchKernel((void*)single_state_body_0_map_3_3_0_0_36, dim3(int_ceil(int_ceil((88 - Max(3, (nrdmax_jg - 2))), 1), 256), 1, 1), dim3(256, 1, 1), single_state_body_0_map_3_3_0_0_36_args, 0, open_acc_stream);
