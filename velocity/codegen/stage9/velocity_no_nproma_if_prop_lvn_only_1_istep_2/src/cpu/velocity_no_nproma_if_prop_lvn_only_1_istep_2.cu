...
inline void loop_body_7_0_16(velocity_no_nproma_if_prop_lvn_only_1_istep_2_state_t *__state, const int&  __CG_global_data__m_nproma, int* __restrict__ __CG_p_patch__CG_cells__m_end_index, int* __restrict__ __CG_p_patch__CG_cells__m_start_index, const double&  cfl_w_limit, const double&  dtime, double * __restrict__ gpu___CG_p_diag__m_w_concorr_c, double * __restrict__ gpu___CG_p_int__m_e_bln_c_s, double * __restrict__ gpu___CG_p_metrics__m_ddqz_z_half, uint8_t * __restrict__ gpu___CG_p_patch__CG_cells__m_edge_blk_uint8, uint16_t * __restrict__ gpu___CG_p_patch__CG_cells__m_edge_idx_uint16, double * __restrict__ gpu___CG_p_prog__m_w, double* __restrict__ z_kin_hor_e, uint8_t * __restrict__ gpu_cfl_clipping, uint8_t * __restrict__ gpu_levmask, double * __restrict__ gpu_maxvcfl_arr, double * __restrict__ gpu_vcflmax, double * __restrict__ gpu_z_ekinh, double * __restrict__ gpu_z_w_con_c, double * __restrict__ gpu_z_w_con_c_full, int __f2dace_A_z_kin_hor_e_d_0_s, int __f2dace_A_z_kin_hor_e_d_1_s, int __f2dace_OA_z_kin_hor_e_d_0_s, int __f2dace_OA_z_kin_hor_e_d_1_s, int __f2dace_OA_z_kin_hor_e_d_2_s, int _for_it_22, int i_endblk_var_147, int i_startblk_var_146, int nflatlev_jg, int nrdmax_jg, int tmp_struct_symbol_1, int tmp_struct_symbol_10, int tmp_struct_symbol_13, int tmp_struct_symbol_14, int tmp_struct_symbol_2, int tmp_struct_symbol_4) {
...

    {
        ...
        __dace_runkernel_single_state_body_2_map_3_3_16_3_11(__state, gpu___CG_p_diag__m_w_concorr_c, gpu_z_w_con_c, __f2dace_SA_w_concorr_c_d_0_s_p_diag_9, __f2dace_SOA_w_concorr_c_d_0_s_p_diag_9, __f2dace_SOA_w_concorr_c_d_1_s_p_diag_9, __f2dace_SOA_w_concorr_c_d_2_s_p_diag_9, _for_it_22, i_endidx_var_149, i_startidx_var_148, nflatlev_jg, tmp_struct_symbol_1);
...
inline void loop_body_43_0_16(velocity_no_nproma_if_prop_lvn_only_1_istep_2_state_t *__state, const int&  __CG_global_data__m_nproma, int* __restrict__ __CG_p_patch__CG_cells__m_end_index, int* __restrict__ __CG_p_patch__CG_cells__m_start_index, const double&  cfl_w_limit, const double&  dtime, double * __restrict__ gpu___CG_p_diag__m_w_concorr_c, double * __restrict__ gpu___CG_p_int__m_e_bln_c_s, double * __restrict__ gpu___CG_p_metrics__m_ddqz_z_half, uint8_t * __restrict__ gpu___CG_p_patch__CG_cells__m_edge_blk_uint8, int * __restrict__ gpu___CG_p_patch__CG_cells__m_edge_idx, double * __restrict__ gpu___CG_p_prog__m_w, double* __restrict__ z_kin_hor_e, uint8_t * __restrict__ gpu_cfl_clipping, uint8_t * __restrict__ gpu_levmask, double * __restrict__ gpu_maxvcfl_arr, double * __restrict__ gpu_vcflmax, double * __restrict__ gpu_z_ekinh, double * __restrict__ gpu_z_w_con_c, double * __restrict__ gpu_z_w_con_c_full, int __f2dace_A_z_kin_hor_e_d_0_s, int __f2dace_A_z_kin_hor_e_d_1_s, int __f2dace_OA_z_kin_hor_e_d_0_s, int __f2dace_OA_z_kin_hor_e_d_1_s, int __f2dace_OA_z_kin_hor_e_d_2_s, int _for_it_22, int i_endblk_var_147, int i_startblk_var_146, int nflatlev_jg, int nrdmax_jg, int tmp_struct_symbol_1, int tmp_struct_symbol_10, int tmp_struct_symbol_13, int tmp_struct_symbol_14, int tmp_struct_symbol_2, int tmp_struct_symbol_4) {
...

    {
        ...
        __dace_runkernel_single_state_body_2_map_3_3_52_3_11(__state, gpu___CG_p_diag__m_w_concorr_c, gpu_z_w_con_c, __f2dace_SA_w_concorr_c_d_0_s_p_diag_9, __f2dace_SOA_w_concorr_c_d_0_s_p_diag_9, __f2dace_SOA_w_concorr_c_d_1_s_p_diag_9, __f2dace_SOA_w_concorr_c_d_2_s_p_diag_9, _for_it_22, i_endidx_var_149, i_startidx_var_148, nflatlev_jg, tmp_struct_symbol_1);
        __dace_runkernel_single_state_body_4_map_3_3_52_3_19(__state, gpu___CG_p_metrics__m_ddqz_z_half, gpu_cfl_clipping, gpu_z_w_con_c, __f2dace_SA_ddqz_z_half_d_0_s_p_metrics_8, __f2dace_SOA_ddqz_z_half_d_0_s_p_metrics_8, __f2dace_SOA_ddqz_z_half_d_1_s_p_metrics_8, __f2dace_SOA_ddqz_z_half_d_2_s_p_metrics_8, _for_it_22, cfl_w_limit, i_endidx_var_149, i_startidx_var_148, nrdmax_jg, tmp_struct_symbol_1, tmp_struct_symbol_14);
        ...
        if ((bitwidth_sym == 16)) {
            {
                ...
                __dace_runkernel_copy_map_gpu___CG_p_patch__CG_edges__m_quad_idx_to_gpu___CG_p_patch__CG_edges__m_quad_idx_uint16_3_3_4_0_15(__state, gpu___CG_p_patch__CG_edges__m_quad_idx, __state->__0_gpu___CG_p_patch__CG_edges__m_quad_idx_uint16, __f2dace_SA_quad_idx_d_0_s_edges_p_patch_4, __f2dace_SA_quad_idx_d_1_s_edges_p_patch_4, __f2dace_SA_quad_idx_d_2_s_edges_p_patch_4);
                __dace_runkernel_copy_map_gpu___CG_p_patch__CG_verts__m_start_index_to_gpu___CG_p_patch__CG_verts__m_start_index_uint16_3_3_4_0_20(__state, gpu___CG_p_patch__CG_verts__m_start_index, __state->__0_gpu___CG_p_patch__CG_verts__m_start_index_uint16, __f2dace_SA_start_index_d_0_s_verts_p_patch_5);
                __dace_runkernel_copy_map_gpu___CG_p_patch__CG_edges__m_end_index_to_gpu___CG_p_patch__CG_edges__m_end_index_uint16_3_3_4_0_25(__state, gpu___CG_p_patch__CG_edges__m_end_index, __state->__0_gpu___CG_p_patch__CG_edges__m_end_index_uint16, __f2dace_SA_end_index_d_0_s_edges_p_patch_4);
                __dace_runkernel_copy_map_gpu___CG_p_patch__CG_verts__m_end_index_to_gpu___CG_p_patch__CG_verts__m_end_index_uint16_3_3_4_0_30(__state, gpu___CG_p_patch__CG_verts__m_end_index, __state->__0_gpu___CG_p_patch__CG_verts__m_end_index_uint16, __f2dace_SA_end_index_d_0_s_verts_p_patch_5);
                __dace_runkernel_copy_map_gpu___CG_p_patch__CG_edges__m_cell_idx_to_gpu___CG_p_patch__CG_edges__m_cell_idx_uint16_3_3_4_0_35(__state, gpu___CG_p_patch__CG_edges__m_cell_idx, __state->__0_gpu___CG_p_patch__CG_edges__m_cell_idx_uint16, __f2dace_SA_cell_idx_d_0_s_edges_p_patch_4, __f2dace_SA_cell_idx_d_1_s_edges_p_patch_4, __f2dace_SA_cell_idx_d_2_s_edges_p_patch_4);
                __dace_runkernel_copy_map_gpu___CG_p_patch__CG_cells__m_end_index_to_gpu___CG_p_patch__CG_cells__m_end_index_uint16_3_3_4_0_40(__state, gpu___CG_p_patch__CG_cells__m_end_index, __state->__0_gpu___CG_p_patch__CG_cells__m_end_index_uint16, __f2dace_SA_end_index_d_0_s_cells_p_patch_2);
                __dace_runkernel_copy_map_gpu___CG_p_patch__CG_cells__m_start_index_to_gpu___CG_p_patch__CG_cells__m_start_index_uint16_3_3_4_0_45(__state, gpu___CG_p_patch__CG_cells__m_start_index, __state->__0_gpu___CG_p_patch__CG_cells__m_start_index_uint16, __f2dace_SA_start_index_d_0_s_cells_p_patch_2);
                __dace_runkernel_copy_map_gpu___CG_p_patch__CG_edges__m_start_index_to_gpu___CG_p_patch__CG_edges__m_start_index_uint16_3_3_4_0_50(__state, gpu___CG_p_patch__CG_edges__m_start_index, __state->__0_gpu___CG_p_patch__CG_edges__m_start_index_uint16, __f2dace_SA_start_index_d_0_s_edges_p_patch_4);
//                DACE_GPU_CHECK(cudaStreamSynchronize(__state->gpu_context->streams[0]));
...
//            DACE_GPU_CHECK(cudaStreamSynchronize(__state->gpu_context->streams[0]));
    ...
    } else if (((bitwidth_sym == 32) || (bitwidth_sym == 64))) {
        {
            ...
            __dace_runkernel_single_state_body_0_map_3_3_43_0_36(__state, __state->__0_gpu_levelmask, __state->__0_gpu_levmask, loop_body_reduce_scan_size, nrdmax_jg, replaced_var_0, replaced_var_1, tmp_struct_symbol_13);
            DACE_GPU_CHECK(cudaMemcpyAsync(__state->__0_vcflmax, __state->__0_gpu_vcflmax, tmp_struct_symbol_12 * sizeof(double), cudaMemcpyDeviceToHost, __state->gpu_context->streams[0]));
            {
                for (auto _for_it_47 = replaced_var_3; _for_it_47 < (replaced_var_2 + 1); _for_it_47 += 1) {
