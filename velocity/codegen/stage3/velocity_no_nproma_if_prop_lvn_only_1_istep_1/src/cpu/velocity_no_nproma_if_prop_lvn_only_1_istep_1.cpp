...
inline void loop_body_0_0_5(velocity_no_nproma_if_prop_lvn_only_1_istep_1_state_t *__state, double* __restrict__ __CG_p_int__m_geofac_rot, int* __restrict__ __CG_p_patch__CG_verts__m_edge_blk, int* __restrict__ __CG_p_patch__CG_verts__m_edge_idx, int* __restrict__ __CG_p_patch__CG_verts__m_end_index, int* __restrict__ __CG_p_patch__CG_verts__m_start_index, double* __restrict__ __CG_p_prog__m_vn, double* __restrict__ zeta, int _for_it_3_0, int i_endblk_var_119_0, int i_startblk_var_118_0, int tmp_struct_symbol_8) {
...

        {
            for (auto _for_it_7 = 1; _for_it_7 < 91; _for_it_7 += 1) {
                for (auto _for_it_8 = i_startidx_var_148; _for_it_8 < (i_endidx_var_149 + 1); _for_it_8 += 1) {
                    loop_body_7_2_3(__state, &__CG_p_int__m_rbf_vec_coeff_e[0], &__CG_p_patch__CG_edges__m_quad_blk[0], &__CG_p_patch__CG_edges__m_quad_idx[0], &__CG_p_prog__m_vn[0], &__CG_p_diag__m_vt[0], _for_it_6, _for_it_7, _for_it_8);
                }
            }
        }
        {
...
inline void loop_body_17_2_14(velocity_no_nproma_if_prop_lvn_only_1_istep_1_state_t *__state, double* __restrict__ __CG_p_int__m_e_bln_c_s, int* __restrict__ __CG_p_patch__CG_cells__m_edge_blk, int* __restrict__ __CG_p_patch__CG_cells__m_edge_idx, double* __restrict__ z_v_grad_w, double* __restrict__ __CG_p_diag__m_ddt_w_adv_pc, int _for_it_22, int _for_it_42, int64_t _for_it_43, int64_t ntnd, int tmp_struct_symbol_4) {
...
inline void loop_body_17_2_28(velocity_no_nproma_if_prop_lvn_only_1_istep_1_state_t *__state, double* __restrict__ __CG_p_int__m_geofac_n2s, double* __restrict__ __CG_p_metrics__m_ddqz_z_half, int* __restrict__ __CG_p_patch__CG_cells__CG_decomp_info__m_owner_mask, double* __restrict__ __CG_p_patch__CG_cells__m_area, int* __restrict__ __CG_p_patch__CG_cells__m_neighbor_blk, int* __restrict__ __CG_p_patch__CG_cells__m_neighbor_idx, double* __restrict__ __CG_p_prog__m_w, int* __restrict__ cfl_clipping, const double&  cfl_w_limit, const double&  dtime, int* __restrict__ levmask, const double&  scalfac_exdiff, double* __restrict__ z_w_con_c, double* __restrict__ __CG_p_diag__m_ddt_w_adv_pc, double&  difcoef, int _for_it_22, int _for_it_44, int i_endidx_in_var_80_0, int i_startidx_2, int64_t ntnd, int tmp_struct_symbol_1, int tmp_struct_symbol_13, int tmp_struct_symbol_14) {
    int _if_cond_24;
...
void __program_velocity_no_nproma_if_prop_lvn_only_1_istep_1_internal(velocity_no_nproma_if_prop_lvn_only_1_istep_1_state_t*__state, global_data_type* global_data, t_nh_diag* p_diag, t_int_state* p_int, t_nh_metrics* p_metrics, t_patch* p_patch, t_nh_prog* p_prog, double * __restrict__ z_kin_hor_e, double * __restrict__ z_vt_ie, double * __restrict__ z_w_concorr_me, int __f2dace_A_z_kin_hor_e_d_0_s_363, int __f2dace_A_z_kin_hor_e_d_1_s_364, int __f2dace_A_z_vt_ie_d_0_s_366, int __f2dace_A_z_vt_ie_d_1_s_367, int __f2dace_A_z_w_concorr_me_d_0_s_360, int __f2dace_A_z_w_concorr_me_d_1_s_361, int __f2dace_OA_z_kin_hor_e_d_0_s_363, int __f2dace_OA_z_kin_hor_e_d_1_s_364, int __f2dace_OA_z_kin_hor_e_d_2_s_365, int __f2dace_OA_z_vt_ie_d_0_s_366, int __f2dace_OA_z_vt_ie_d_1_s_367, int __f2dace_OA_z_vt_ie_d_2_s_368, int __f2dace_OA_z_w_concorr_me_d_0_s_360, int __f2dace_OA_z_w_concorr_me_d_1_s_361, int __f2dace_OA_z_w_concorr_me_d_2_s_362, double dt_linintp_ubc, double dtime, int istep, int ldeepatmo, int lvn_only, int ntnd)
{
    ...
    double out_val;
    double *maxvcfl_arr;
    maxvcfl_arr = new double DACE_ALIGN(64)[(87 * tmp_struct_symbol_4)];
    int nrdmax_jg;
    int nflatlev_jg;
   ...
   measure_time("Run"); 
    ...
    for (_for_it_22 = i_startblk_var_146; (_for_it_22 <= i_endblk_var_147); _for_it_22 = (_for_it_22 + 1)) {
        ...
        }
        {
            ...
            }
            {
                ...
                for (auto _for_it_35 = Max(3, (nrdmax_jg - 2)); _for_it_35 < 88; _for_it_35 += 1) {
                    loop_body_14_0_2(__state, &__CG_p_metrics__m_ddqz_z_half[0], cfl_w_limit, dtime, &cfl_clipping[0], &levmask[0], &maxvcfl_arr[0], &z_w_con_c[0], _for_it_22, _for_it_35, i_endidx_in_var_80_1, i_startidx_var_148, tmp_struct_symbol_1, tmp_struct_symbol_14);
                }
            }
        ...
        }
        {
            ...
            {
                double* in_arr = &maxvcfl_arr[((87 * i_startidx_var_148) - 87)];
                ...
                }
                {
                    ...
                    for (auto _for_it_42 = 2; _for_it_42 < 91; _for_it_42 += 1) {
                        for (auto _for_it_43 = i_startidx_2; _for_it_43 < (i_endidx_in_var_80_0 + 1); _for_it_43 += 1) {
                            loop_body_17_2_14(__state, &__CG_p_int__m_e_bln_c_s[0], &__CG_p_patch__CG_cells__m_edge_blk[0], &__CG_p_patch__CG_cells__m_edge_idx[0], &z_v_grad_w[0], &__CG_p_diag__m_ddt_w_adv_pc[0], _for_it_22, _for_it_42, _for_it_43, ntnd, tmp_struct_symbol_4);
                        }
                    }
                }
                {
