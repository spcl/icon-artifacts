...
//        DACE_GPU_CHECK(cudaStreamSynchronize(__state->gpu_context->streams[0]));
  ...
  measure_time("Run");
...

    {
        ...
        {
            double* in_arr = &__state->__0_vcflmax[(i_startblk_var_146 - 1)];
