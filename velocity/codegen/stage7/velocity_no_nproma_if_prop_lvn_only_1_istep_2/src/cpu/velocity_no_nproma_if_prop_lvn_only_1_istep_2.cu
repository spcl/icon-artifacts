...
//        cudaEventRecord(__state->gpu_context->events[8], __state->gpu_context->streams[0]);
//        cudaStreamWaitEvent(__state->gpu_context->streams[0], __state->gpu_context->events[8], 0);
        {
