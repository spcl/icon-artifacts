...
DACE_EXPORTED void __dace_runkernel_GPU_DeviceMap_3_3_0_0_66(velocity_no_nproma_if_prop_lvn_only_1_istep_2_state_t *__state, int * __restrict__ gpu_levelmask, const int * __restrict__ gpu_levmask, int i_endblk_var_147, int i_startblk_var_146, int nrdmax_jg, int tmp_struct_symbol_13);
...
//        DACE_GPU_CHECK(cudaStreamSynchronize(__state->gpu_context->streams[0]));
   ...
   cudaDeviceSynchronize();
...

    {
        ...
        __dace_runkernel_GPU_DeviceMap_3_3_0_0_66(__state, __state->__0_gpu_levelmask, __state->__0_gpu_levmask, i_endblk_var_147, i_startblk_var_146, nrdmax_jg, tmp_struct_symbol_13);
        {
