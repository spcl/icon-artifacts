...
//        DACE_GPU_CHECK(cudaStreamSynchronize(__state->gpu_context->streams[0]));
 ...
 measure_time("Run");
...

    {
        ...
        __dace_runkernel_single_state_body_0_map_2_2_0_0_53(__state, __state->__0_gpu_levelmask, __state->__0_gpu_levmask, nrdmax_jg, replaced_var_1, replaced_var_3, tmp_struct_symbol_13);
