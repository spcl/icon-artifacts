...
//        DACE_GPU_CHECK(cudaStreamSynchronize(__state->gpu_context->streams[0]));
...

    {
        ...
        __dace_runkernel_GPU_DeviceMap_2_2_16_4_20(__state, gpu_cfl_clipping, gpu_levmask, _for_it_22, nrdmax_jg, tmp_struct_symbol_13, tmp_struct_symbol_14);
...
//        DACE_GPU_CHECK(cudaStreamSynchronize(__state->gpu_context->streams[0]));
   ...
   // cudaEvent_t start1, stop1;
...

    {
        ...
        __dace_runkernel_GPU_DeviceMap_2_2_0_0_81(__state, __state->__0_gpu_levelmask, __state->__0_gpu_levmask, nrdmax_jg, replaced_var_2, replaced_var_3, tmp_struct_symbol_13);
//        cudaEventRecord(__state->gpu_context->events[13], __state->gpu_context->streams[0]);
//        cudaStreamWaitEvent(__state->gpu_context->streams[0], __state->gpu_context->events[13], 0);
        {
