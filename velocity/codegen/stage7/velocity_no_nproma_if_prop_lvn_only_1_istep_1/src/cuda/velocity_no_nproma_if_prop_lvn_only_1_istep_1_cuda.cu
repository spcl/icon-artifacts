...
void __dace_runkernel_single_state_body_0_map_2_2_0_0_56(velocity_no_nproma_if_prop_lvn_only_1_istep_1_state_t *__state, uint8_t * __restrict__ gpu_levelmask, const uint8_t * __restrict__ gpu_levmask, int nrdmax_jg, int replaced_var_2, int replaced_var_3, int tmp_struct_symbol_13)
{
    ...
    gpuError_t __err = cudaLaunchKernel((void*)single_state_body_0_map_2_2_0_0_56, dim3(int_ceil(int_ceil((88 - Max(3, (nrdmax_jg - 2))), 1), 256), 1, 1), dim3(256, 1, 1), single_state_body_0_map_2_2_0_0_56_args, 0, __state->gpu_context->streams[0]);
