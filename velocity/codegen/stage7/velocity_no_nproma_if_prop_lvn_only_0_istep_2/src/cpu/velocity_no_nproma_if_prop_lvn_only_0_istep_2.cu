...
DACE_EXPORTED void __dace_runkernel_GPU_DeviceMap_1_1_24_5_20(velocity_no_nproma_if_prop_lvn_only_0_istep_2_state_t *__state, const double * __restrict__ gpu___CG_p_metrics__m_ddqz_z_half, const int * __restrict__ gpu_cfl_clipping, int * __restrict__ gpu_levmask, const double * __restrict__ gpu_z_w_con_c, int __f2dace_SA_ddqz_z_half_d_0_s_317_p_metrics_8, int _for_it_22, const double dtime, int nrdmax_jg, int tmp_struct_symbol_1, int tmp_struct_symbol_13, int tmp_struct_symbol_14);
...
//        DACE_GPU_CHECK(cudaStreamSynchronize(__state->gpu_context->streams[0]));
...

    {
        ...
        __dace_runkernel_GPU_DeviceMap_1_1_24_5_20(__state, gpu___CG_p_metrics__m_ddqz_z_half, gpu_cfl_clipping, gpu_levmask, gpu_z_w_con_c, __f2dace_SA_ddqz_z_half_d_0_s_317_p_metrics_8, _for_it_22, dtime, nrdmax_jg, tmp_struct_symbol_1, tmp_struct_symbol_13, tmp_struct_symbol_14);
...
//        cudaEventRecord(__state->gpu_context->events[14], __state->gpu_context->streams[0]);
//        cudaStreamWaitEvent(__state->gpu_context->streams[0], __state->gpu_context->events[14], 0);
        {
