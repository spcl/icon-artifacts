...
__global__ void __launch_bounds__(256) single_state_body_0_map_1_1_0_0_68(uint8_t * __restrict__ gpu_levelmask, const uint8_t * __restrict__ gpu_levmask, int nrdmax_jg, int replaced_var_0, int replaced_var_1, int tmp_struct_symbol_13) {
    {
...
void __dace_runkernel_single_state_body_0_map_1_1_0_0_68(velocity_no_nproma_if_prop_lvn_only_0_istep_2_state_t *__state, uint8_t * __restrict__ gpu_levelmask, const uint8_t * __restrict__ gpu_levmask, int nrdmax_jg, int replaced_var_0, int replaced_var_1, int tmp_struct_symbol_13)
{
    ...
    void  *single_state_body_0_map_1_1_0_0_68_args[] = { (void *)&gpu_levelmask, (void *)&gpu_levmask, (void *)&nrdmax_jg, (void *)&replaced_var_0, (void *)&replaced_var_1, (void *)&tmp_struct_symbol_13 };
    gpuError_t __err = cudaLaunchKernel((void*)single_state_body_0_map_1_1_0_0_68, dim3(int_ceil(int_ceil((88 - Max(3, (nrdmax_jg - 2))), 1), 256), 1, 1), dim3(256, 1, 1), single_state_body_0_map_1_1_0_0_68_args, 0, __state->gpu_context->streams[0]);
    DACE_KERNEL_LAUNCH_CHECK(__err, "single_state_body_0_map_1_1_0_0_68", int_ceil(int_ceil((88 - Max(3, (nrdmax_jg - 2))), 1), 256), 1, 1, 256, 1, 1);
}
