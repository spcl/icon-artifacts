...
//        DACE_GPU_CHECK(cudaStreamSynchronize(__state->gpu_context->streams[0]));
   ...
   // cudaEvent_t start1, stop1;
...

    {
        ...
        __dace_runkernel_single_state_body_0_map_2_2_0_5_26(__state, gpu_levelmask, gpu_levmask, i_endblk_var_147, i_startblk_var_146, nrdmax_jg, tmp_struct_symbol_13);
