...
DACE_EXPORTED void __dace_runkernel_single_state_body_0_map_1_1_0_4_37(velocity_no_nproma_if_prop_lvn_only_0_istep_2_state_t *__state, int * __restrict__ gpu_levelmask, const int * __restrict__ gpu_levmask, int i_endblk_var_147, int i_startblk_var_146, int nrdmax_jg, int tmp_struct_symbol_13);
...
//        DACE_GPU_CHECK(cudaStreamSynchronize(__state->gpu_context->streams[1]));
...

    {
        ...
        __dace_runkernel_single_state_body_0_map_1_1_0_4_37(__state, gpu_levelmask, gpu_levmask, i_endblk_var_147, i_startblk_var_146, nrdmax_jg, tmp_struct_symbol_13);
//        DACE_GPU_CHECK(cudaStreamSynchronize(__state->gpu_context->streams[0]));
//        DACE_GPU_CHECK(cudaStreamSynchronize(__state->gpu_context->streams[1]));
//        DACE_GPU_CHECK(cudaStreamSynchronize(__state->gpu_context->streams[2]));
//        DACE_GPU_CHECK(cudaStreamSynchronize(__state->gpu_context->streams[3]));
