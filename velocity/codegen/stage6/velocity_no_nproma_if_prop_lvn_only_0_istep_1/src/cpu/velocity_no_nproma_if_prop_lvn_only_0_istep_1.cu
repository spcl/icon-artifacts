...
inline void loop_body_0_0_24(velocity_no_nproma_if_prop_lvn_only_0_istep_1_state_t *__state, const int&  __CG_global_data__m_nproma, double * __restrict__ gpu___CG_p_int__m_rbf_vec_coeff_e, double * __restrict__ gpu___CG_p_metrics__m_ddxn_z_full, double * __restrict__ gpu___CG_p_metrics__m_ddxt_z_full, double * __restrict__ gpu___CG_p_metrics__m_wgtfac_e, double * __restrict__ gpu___CG_p_metrics__m_wgtfacq_e, int* __restrict__ gpu___CG_p_patch__CG_edges__m_end_index, int * __restrict__ gpu___CG_p_patch__CG_edges__m_quad_blk, int * __restrict__ gpu___CG_p_patch__CG_edges__m_quad_idx, int* __restrict__ gpu___CG_p_patch__CG_edges__m_start_index, double * __restrict__ gpu___CG_p_prog__m_vn, double * __restrict__ gpu___CG_p_diag__m_vn_ie, double * __restrict__ gpu___CG_p_diag__m_vt, double * __restrict__ gpu_z_kin_hor_e, double * __restrict__ gpu_z_vt_ie, double * __restrict__ gpu_z_w_concorr_me, int __f2dace_A_z_kin_hor_e_d_0_s, int __f2dace_A_z_kin_hor_e_d_1_s, int __f2dace_A_z_vt_ie_d_0_s, int __f2dace_A_z_vt_ie_d_1_s, int __f2dace_A_z_w_concorr_me_d_0_s, int __f2dace_A_z_w_concorr_me_d_1_s, int __f2dace_OA_z_kin_hor_e_d_0_s, int __f2dace_OA_z_kin_hor_e_d_1_s, int __f2dace_OA_z_kin_hor_e_d_2_s, int __f2dace_OA_z_vt_ie_d_0_s, int __f2dace_OA_z_vt_ie_d_1_s, int __f2dace_OA_z_vt_ie_d_2_s, int __f2dace_OA_z_w_concorr_me_d_0_s, int __f2dace_OA_z_w_concorr_me_d_1_s, int __f2dace_OA_z_w_concorr_me_d_2_s, int _for_it_6, int i_endblk_var_147, int i_startblk_var_146, int nflatlev_jg) {
    ...
    i_startidx_in_var_91_3 = gpu___CG_p_patch__CG_edges__m_start_index[(5 - __f2dace_SOA_start_index_d_0_s_edges_p_patch_4)];
    i_endidx_in_var_92_3 = gpu___CG_p_patch__CG_edges__m_end_index[((- __f2dace_SOA_end_index_d_0_s_edges_p_patch_4) - 10)];
...
inline void loop_body_0_5_0(velocity_no_nproma_if_prop_lvn_only_0_istep_1_state_t *__state, const int&  __CG_global_data__m_nproma, double * __restrict__ gpu___CG_p_diag__m_vn_ie, int * __restrict__ gpu___CG_p_patch__CG_edges__m_cell_blk, int * __restrict__ gpu___CG_p_patch__CG_edges__m_cell_idx, int* __restrict__ gpu___CG_p_patch__CG_edges__m_end_index, double * __restrict__ gpu___CG_p_patch__CG_edges__m_inv_dual_edge_length, double * __restrict__ gpu___CG_p_patch__CG_edges__m_inv_primal_edge_length, int* __restrict__ gpu___CG_p_patch__CG_edges__m_start_index, double * __restrict__ gpu___CG_p_patch__CG_edges__m_tangent_orientation, int * __restrict__ gpu___CG_p_patch__CG_edges__m_vertex_blk, int * __restrict__ gpu___CG_p_patch__CG_edges__m_vertex_idx, double * __restrict__ gpu___CG_p_prog__m_w, double * __restrict__ gpu_z_vt_ie, double * __restrict__ gpu_z_w_v, double * __restrict__ gpu_z_v_grad_w, int __f2dace_A_z_vt_ie_d_0_s, int __f2dace_A_z_vt_ie_d_1_s, int __f2dace_OA_z_vt_ie_d_0_s, int __f2dace_OA_z_vt_ie_d_1_s, int __f2dace_OA_z_vt_ie_d_2_s, int _for_it_16, int i_endblk_var_147, int i_startblk_var_146, int tmp_struct_symbol_4, int tmp_struct_symbol_6) {
    ...
    i_startidx_in_var_91_2 = gpu___CG_p_patch__CG_edges__m_start_index[(7 - __f2dace_SOA_start_index_d_0_s_edges_p_patch_4)];
    i_endidx_in_var_92_2 = gpu___CG_p_patch__CG_edges__m_end_index[((- __f2dace_SOA_end_index_d_0_s_edges_p_patch_4) - 9)];
...
//        DACE_GPU_CHECK(cudaStreamSynchronize(__state->gpu_context->streams[0]));
    ...
    if ((! (((_for_it_22 < i_startblk_2) || (_for_it_22 > i_endblk_2)) == 1))) {
        ...
        i_startidx_in_var_79_0 = gpu___CG_p_patch__CG_cells__m_start_index[(5 - __f2dace_SOA_start_index_d_0_s_cells_p_patch_2)];
        i_endidx_in_var_80_0 = gpu___CG_p_patch__CG_cells__m_end_index[((- __f2dace_SOA_end_index_d_0_s_cells_p_patch_2) - 4)];
...
void __program_velocity_no_nproma_if_prop_lvn_only_0_istep_1_internal(velocity_no_nproma_if_prop_lvn_only_0_istep_1_state_t*__state, global_data_type* global_data, t_nh_diag* p_diag, t_int_state* p_int, t_nh_metrics* p_metrics, t_patch* p_patch, t_nh_prog* p_prog, double * __restrict__ z_kin_hor_e, double * __restrict__ z_vt_ie, double * __restrict__ z_w_concorr_me, int __f2dace_A_z_kin_hor_e_d_0_s, int __f2dace_A_z_kin_hor_e_d_1_s, int __f2dace_A_z_kin_hor_e_d_2_s, int __f2dace_A_z_vt_ie_d_0_s, int __f2dace_A_z_vt_ie_d_1_s, int __f2dace_A_z_vt_ie_d_2_s, int __f2dace_A_z_w_concorr_me_d_0_s, int __f2dace_A_z_w_concorr_me_d_1_s, int __f2dace_A_z_w_concorr_me_d_2_s, int __f2dace_OA_z_kin_hor_e_d_0_s, int __f2dace_OA_z_kin_hor_e_d_1_s, int __f2dace_OA_z_kin_hor_e_d_2_s, int __f2dace_OA_z_vt_ie_d_0_s, int __f2dace_OA_z_vt_ie_d_1_s, int __f2dace_OA_z_vt_ie_d_2_s, int __f2dace_OA_z_w_concorr_me_d_0_s, int __f2dace_OA_z_w_concorr_me_d_1_s, int __f2dace_OA_z_w_concorr_me_d_2_s, double dt_linintp_ubc, double dtime, int istep, int ldeepatmo, int lvn_only, int ntnd)
{
    ...
    __CG_p_int__m_rbf_vec_coeff_e = new double DACE_ALIGN(64)[((((__f2dace_SA_rbf_vec_coeff_e_d_0_s_p_int_6 * __f2dace_SA_rbf_vec_coeff_e_d_1_s_p_int_6) * (__f2dace_SA_rbf_vec_coeff_e_d_2_s_p_int_6 - 1)) + (__f2dace_SA_rbf_vec_coeff_e_d_0_s_p_int_6 * (__f2dace_SA_rbf_vec_coeff_e_d_1_s_p_int_6 - 1))) + __f2dace_SA_rbf_vec_coeff_e_d_0_s_p_int_6)];
    ...
    __CG_p_metrics__m_ddxn_z_full = new double DACE_ALIGN(64)[(((90 * __f2dace_SA_ddxn_z_full_d_0_s_p_metrics_8) * (__f2dace_SA_ddxn_z_full_d_2_s_p_metrics_8 - 1)) + (90 * __f2dace_SA_ddxn_z_full_d_0_s_p_metrics_8))];
    double *__CG_p_metrics__m_ddxt_z_full;
    __CG_p_metrics__m_ddxt_z_full = new double DACE_ALIGN(64)[(((90 * __f2dace_SA_ddxt_z_full_d_0_s_p_metrics_8) * (__f2dace_SA_ddxt_z_full_d_2_s_p_metrics_8 - 1)) + (90 * __f2dace_SA_ddxt_z_full_d_0_s_p_metrics_8))];
    ...
    __CG_p_metrics__m_wgtfac_c = new double DACE_ALIGN(64)[(((91 * __f2dace_SA_wgtfac_c_d_0_s_p_metrics_8) * (__f2dace_SA_wgtfac_c_d_2_s_p_metrics_8 - 1)) + (91 * __f2dace_SA_wgtfac_c_d_0_s_p_metrics_8))];
    double *__CG_p_metrics__m_wgtfac_e;
    __CG_p_metrics__m_wgtfac_e = new double DACE_ALIGN(64)[(((91 * __f2dace_SA_wgtfac_e_d_0_s_p_metrics_8) * (__f2dace_SA_wgtfac_e_d_2_s_p_metrics_8 - 1)) + (91 * __f2dace_SA_wgtfac_e_d_0_s_p_metrics_8))];
    double *__CG_p_metrics__m_wgtfacq_e;
    __CG_p_metrics__m_wgtfacq_e = new double DACE_ALIGN(64)[((((__f2dace_SA_wgtfacq_e_d_0_s_p_metrics_8 * __f2dace_SA_wgtfacq_e_d_1_s_p_metrics_8) * (__f2dace_SA_wgtfacq_e_d_2_s_p_metrics_8 - 1)) + (__f2dace_SA_wgtfacq_e_d_0_s_p_metrics_8 * (__f2dace_SA_wgtfacq_e_d_1_s_p_metrics_8 - 1))) + __f2dace_SA_wgtfacq_e_d_0_s_p_metrics_8)];
    ...
    DACE_GPU_CHECK(cudaMalloc((void**)&gpu___CG_p_int__m_rbf_vec_coeff_e, ((((__f2dace_SA_rbf_vec_coeff_e_d_0_s_p_int_6 * __f2dace_SA_rbf_vec_coeff_e_d_1_s_p_int_6) * (__f2dace_SA_rbf_vec_coeff_e_d_2_s_p_int_6 - 1)) + (__f2dace_SA_rbf_vec_coeff_e_d_0_s_p_int_6 * (__f2dace_SA_rbf_vec_coeff_e_d_1_s_p_int_6 - 1))) + __f2dace_SA_rbf_vec_coeff_e_d_0_s_p_int_6) * sizeof(double)));
    ...
    DACE_GPU_CHECK(cudaMalloc((void**)&gpu___CG_p_metrics__m_ddxn_z_full, (((90 * __f2dace_SA_ddxn_z_full_d_0_s_p_metrics_8) * (__f2dace_SA_ddxn_z_full_d_2_s_p_metrics_8 - 1)) + (90 * __f2dace_SA_ddxn_z_full_d_0_s_p_metrics_8)) * sizeof(double)));
    double * gpu___CG_p_metrics__m_ddxt_z_full;
    DACE_GPU_CHECK(cudaMalloc((void**)&gpu___CG_p_metrics__m_ddxt_z_full, (((90 * __f2dace_SA_ddxt_z_full_d_0_s_p_metrics_8) * (__f2dace_SA_ddxt_z_full_d_2_s_p_metrics_8 - 1)) + (90 * __f2dace_SA_ddxt_z_full_d_0_s_p_metrics_8)) * sizeof(double)));
    double * gpu___CG_p_metrics__m_wgtfac_c;
    DACE_GPU_CHECK(cudaMalloc((void**)&gpu___CG_p_metrics__m_wgtfac_c, (((91 * __f2dace_SA_wgtfac_c_d_0_s_p_metrics_8) * (__f2dace_SA_wgtfac_c_d_2_s_p_metrics_8 - 1)) + (91 * __f2dace_SA_wgtfac_c_d_0_s_p_metrics_8)) * sizeof(double)));
    double * gpu___CG_p_metrics__m_wgtfac_e;
    DACE_GPU_CHECK(cudaMalloc((void**)&gpu___CG_p_metrics__m_wgtfac_e, (((91 * __f2dace_SA_wgtfac_e_d_0_s_p_metrics_8) * (__f2dace_SA_wgtfac_e_d_2_s_p_metrics_8 - 1)) + (91 * __f2dace_SA_wgtfac_e_d_0_s_p_metrics_8)) * sizeof(double)));
    double * gpu___CG_p_metrics__m_wgtfacq_e;
    DACE_GPU_CHECK(cudaMalloc((void**)&gpu___CG_p_metrics__m_wgtfacq_e, ((((__f2dace_SA_wgtfacq_e_d_0_s_p_metrics_8 * __f2dace_SA_wgtfacq_e_d_1_s_p_metrics_8) * (__f2dace_SA_wgtfacq_e_d_2_s_p_metrics_8 - 1)) + (__f2dace_SA_wgtfacq_e_d_0_s_p_metrics_8 * (__f2dace_SA_wgtfacq_e_d_1_s_p_metrics_8 - 1))) + __f2dace_SA_wgtfacq_e_d_0_s_p_metrics_8) * sizeof(double)));
...

    {
                ...
                {
                    {
                        ...
                        #pragma omp parallel for
                        for (auto k = 0; k < __f2dace_SA_rbf_vec_coeff_e_d_2_s_p_int_6; k++){
                            for (auto j = 0; j < __f2dace_SA_rbf_vec_coeff_e_d_1_s_p_int_6; j++){
                                #pragma omp simd
                                for (auto i = 0; i < __f2dace_SA_rbf_vec_coeff_e_d_0_s_p_int_6; i++){
                                    __cg_p_int__m_rbf_vec_coeff_e[(i * (1)) + (j * (__f2dace_SA_rbf_vec_coeff_e_d_0_s_p_int_6)) + (k * ((__f2dace_SA_rbf_vec_coeff_e_d_0_s_p_int_6 * __f2dace_SA_rbf_vec_coeff_e_d_1_s_p_int_6)))] = p_int->rbf_vec_coeff_e[(i * (1)) + (j * (__f2dace_SA_rbf_vec_coeff_e_d_0_s_p_int_6)) + (k * ((__f2dace_SA_rbf_vec_coeff_e_d_0_s_p_int_6 * __f2dace_SA_rbf_vec_coeff_e_d_1_s_p_int_6)))];
                                }
                            }
                        }
                        ...
                        #pragma omp parallel for
                        for (auto k = 0; k < __f2dace_SA_ddxn_z_full_d_2_s_p_metrics_8; k++){
                            for (auto j = 0; j < 90; j++){
                                #pragma omp simd
                                for (auto i = 0; i < __f2dace_SA_ddxn_z_full_d_0_s_p_metrics_8; i++){
                                    __cg_p_metrics__m_ddxn_z_full[(i * (1)) + (j * (__f2dace_SA_ddxn_z_full_d_0_s_p_metrics_8)) + (k * ((90 * __f2dace_SA_ddxn_z_full_d_0_s_p_metrics_8)))] = p_metrics->ddxn_z_full[(i * (1)) + (j * (__f2dace_SA_ddxn_z_full_d_0_s_p_metrics_8)) + (k * ((90 * __f2dace_SA_ddxn_z_full_d_0_s_p_metrics_8)))];
                                }
                            }
                        }

                        #pragma omp parallel for
                        for (auto k = 0; k < __f2dace_SA_ddxt_z_full_d_2_s_p_metrics_8; k++){
                            for (auto j = 0; j < 90; j++){
                                #pragma omp simd
                                for (auto i = 0; i < __f2dace_SA_ddxt_z_full_d_0_s_p_metrics_8; i++){
                                    __cg_p_metrics__m_ddxt_z_full[(i * (1)) + (j * (__f2dace_SA_ddxt_z_full_d_0_s_p_metrics_8)) + (k * ((90 * __f2dace_SA_ddxt_z_full_d_0_s_p_metrics_8)))] = p_metrics->ddxt_z_full[(i * (1)) + (j * (__f2dace_SA_ddxt_z_full_d_0_s_p_metrics_8)) + (k * ((90 * __f2dace_SA_ddxt_z_full_d_0_s_p_metrics_8)))];
                                }
                            }
                        }
                        ...
                        #pragma omp parallel for
                        for (auto k = 0; k < __f2dace_SA_wgtfac_c_d_2_s_p_metrics_8; k++){
                            for (auto j = 0; j < 91; j++){
                                #pragma omp simd
                                for (auto i = 0; i < __f2dace_SA_wgtfac_c_d_0_s_p_metrics_8; i++){
                                    __cg_p_metrics__m_wgtfac_c[(i * (1)) + (j * (__f2dace_SA_wgtfac_c_d_0_s_p_metrics_8)) + (k * ((91 * __f2dace_SA_wgtfac_c_d_0_s_p_metrics_8)))] = p_metrics->wgtfac_c[(i * (1)) + (j * (__f2dace_SA_wgtfac_c_d_0_s_p_metrics_8)) + (k * ((91 * __f2dace_SA_wgtfac_c_d_0_s_p_metrics_8)))];
                                }
                            }
                        }

                        #pragma omp parallel for
                        for (auto k = 0; k < __f2dace_SA_wgtfac_e_d_2_s_p_metrics_8; k++){
                            for (auto j = 0; j < 91; j++){
                                #pragma omp simd
                                for (auto i = 0; i < __f2dace_SA_wgtfac_e_d_0_s_p_metrics_8; i++){
                                    __cg_p_metrics__m_wgtfac_e[(i * (1)) + (j * (__f2dace_SA_wgtfac_e_d_0_s_p_metrics_8)) + (k * ((91 * __f2dace_SA_wgtfac_e_d_0_s_p_metrics_8)))] = p_metrics->wgtfac_e[(i * (1)) + (j * (__f2dace_SA_wgtfac_e_d_0_s_p_metrics_8)) + (k * ((91 * __f2dace_SA_wgtfac_e_d_0_s_p_metrics_8)))];
                                }
                            }
                        }

                        #pragma omp parallel for
                        for (auto k = 0; k < __f2dace_SA_wgtfacq_e_d_2_s_p_metrics_8; k++){
                            for (auto j = 0; j < __f2dace_SA_wgtfacq_e_d_1_s_p_metrics_8; j++){
                                #pragma omp simd
                                for (auto i = 0; i < __f2dace_SA_wgtfacq_e_d_0_s_p_metrics_8; i++){
                                    __cg_p_metrics__m_wgtfacq_e[(i * (1)) + (j * (__f2dace_SA_wgtfacq_e_d_0_s_p_metrics_8)) + (k * ((__f2dace_SA_wgtfacq_e_d_0_s_p_metrics_8 * __f2dace_SA_wgtfacq_e_d_1_s_p_metrics_8)))] = p_metrics->wgtfacq_e[(i * (1)) + (j * (__f2dace_SA_wgtfacq_e_d_0_s_p_metrics_8)) + (k * ((__f2dace_SA_wgtfacq_e_d_0_s_p_metrics_8 * __f2dace_SA_wgtfacq_e_d_1_s_p_metrics_8)))];
                                }
                            }
                        }
        ...
        DACE_GPU_CHECK(cudaMemcpyAsync(gpu___CG_p_diag__m_ddt_w_adv_pc, __CG_p_diag__m_ddt_w_adv_pc, (((91 * __f2dace_SA_ddt_w_adv_pc_d_0_s_p_diag_9) * __f2dace_SA_ddt_w_adv_pc_d_2_s_p_diag_9) * __f2dace_SA_ddt_w_adv_pc_d_3_s_p_diag_9) * sizeof(double), cudaMemcpyHostToDevice, __state->gpu_context->streams[0]));
        ...
        DACE_GPU_CHECK(cudaMemcpyAsync(gpu___CG_p_int__m_cells_aw_verts, __CG_p_int__m_cells_aw_verts, ((__f2dace_SA_cells_aw_verts_d_0_s_p_int_6 * __f2dace_SA_cells_aw_verts_d_1_s_p_int_6) * __f2dace_SA_cells_aw_verts_d_2_s_p_int_6) * sizeof(double), cudaMemcpyHostToDevice, __state->gpu_context->streams[0]));
        ...
        DACE_GPU_CHECK(cudaMemcpyAsync(gpu___CG_p_int__m_geofac_n2s, __CG_p_int__m_geofac_n2s, ((__f2dace_SA_geofac_n2s_d_0_s_p_int_6 * __f2dace_SA_geofac_n2s_d_1_s_p_int_6) * __f2dace_SA_geofac_n2s_d_2_s_p_int_6) * sizeof(double), cudaMemcpyHostToDevice, __state->gpu_context->streams[0]));
        ...
        DACE_GPU_CHECK(cudaMemcpyAsync(gpu___CG_p_int__m_rbf_vec_coeff_e, __CG_p_int__m_rbf_vec_coeff_e, ((__f2dace_SA_rbf_vec_coeff_e_d_0_s_p_int_6 * __f2dace_SA_rbf_vec_coeff_e_d_1_s_p_int_6) * __f2dace_SA_rbf_vec_coeff_e_d_2_s_p_int_6) * sizeof(double), cudaMemcpyHostToDevice, __state->gpu_context->streams[0]));
        DACE_GPU_CHECK(cudaMemcpyAsync(gpu___CG_p_metrics__m_coeff1_dwdz, __CG_p_metrics__m_coeff1_dwdz, ((90 * __f2dace_SA_coeff1_dwdz_d_0_s_p_metrics_8) * __f2dace_SA_coeff1_dwdz_d_2_s_p_metrics_8) * sizeof(double), cudaMemcpyHostToDevice, __state->gpu_context->streams[0]));
        DACE_GPU_CHECK(cudaMemcpyAsync(gpu___CG_p_metrics__m_coeff2_dwdz, __CG_p_metrics__m_coeff2_dwdz, ((90 * __f2dace_SA_coeff2_dwdz_d_0_s_p_metrics_8) * __f2dace_SA_coeff2_dwdz_d_2_s_p_metrics_8) * sizeof(double), cudaMemcpyHostToDevice, __state->gpu_context->streams[0]));
        ...
        DACE_GPU_CHECK(cudaMemcpyAsync(gpu___CG_p_metrics__m_ddxn_z_full, __CG_p_metrics__m_ddxn_z_full, ((90 * __f2dace_SA_ddxn_z_full_d_0_s_p_metrics_8) * __f2dace_SA_ddxn_z_full_d_2_s_p_metrics_8) * sizeof(double), cudaMemcpyHostToDevice, __state->gpu_context->streams[0]));
        DACE_GPU_CHECK(cudaMemcpyAsync(gpu___CG_p_metrics__m_ddxt_z_full, __CG_p_metrics__m_ddxt_z_full, ((90 * __f2dace_SA_ddxt_z_full_d_0_s_p_metrics_8) * __f2dace_SA_ddxt_z_full_d_2_s_p_metrics_8) * sizeof(double), cudaMemcpyHostToDevice, __state->gpu_context->streams[0]));
        DACE_GPU_CHECK(cudaMemcpyAsync(gpu___CG_p_metrics__m_wgtfac_c, __CG_p_metrics__m_wgtfac_c, ((91 * __f2dace_SA_wgtfac_c_d_0_s_p_metrics_8) * __f2dace_SA_wgtfac_c_d_2_s_p_metrics_8) * sizeof(double), cudaMemcpyHostToDevice, __state->gpu_context->streams[0]));
        DACE_GPU_CHECK(cudaMemcpyAsync(gpu___CG_p_metrics__m_wgtfac_e, __CG_p_metrics__m_wgtfac_e, ((91 * __f2dace_SA_wgtfac_e_d_0_s_p_metrics_8) * __f2dace_SA_wgtfac_e_d_2_s_p_metrics_8) * sizeof(double), cudaMemcpyHostToDevice, __state->gpu_context->streams[0]));
        DACE_GPU_CHECK(cudaMemcpyAsync(gpu___CG_p_metrics__m_wgtfacq_e, __CG_p_metrics__m_wgtfacq_e, ((__f2dace_SA_wgtfacq_e_d_0_s_p_metrics_8 * __f2dace_SA_wgtfacq_e_d_1_s_p_metrics_8) * __f2dace_SA_wgtfacq_e_d_2_s_p_metrics_8) * sizeof(double), cudaMemcpyHostToDevice, __state->gpu_context->streams[0]));
        DACE_GPU_CHECK(cudaMemcpyAsync(gpu___CG_p_patch__CG_cells__CG_decomp_info__m_owner_mask, __CG_p_patch__CG_cells__CG_decomp_info__m_owner_mask, (__f2dace_SA_owner_mask_d_0_s_decomp_info_cells_p_patch_3 * __f2dace_SA_owner_mask_d_1_s_decomp_info_cells_p_patch_3) * sizeof(int), cudaMemcpyHostToDevice, __state->gpu_context->streams[0]));
        DACE_GPU_CHECK(cudaMemcpyAsync(gpu___CG_p_patch__CG_cells__m_area, __CG_p_patch__CG_cells__m_area, (__f2dace_SA_area_d_0_s_cells_p_patch_2 * __f2dace_SA_area_d_1_s_cells_p_patch_2) * sizeof(double), cudaMemcpyHostToDevice, __state->gpu_context->streams[0]));
        ...
        DACE_GPU_CHECK(cudaMemcpyAsync(gpu___CG_p_patch__CG_cells__m_neighbor_blk, __CG_p_patch__CG_cells__m_neighbor_blk, ((__f2dace_SA_neighbor_blk_d_0_s_cells_p_patch_2 * __f2dace_SA_neighbor_blk_d_1_s_cells_p_patch_2) * __f2dace_SA_neighbor_blk_d_2_s_cells_p_patch_2) * sizeof(int), cudaMemcpyHostToDevice, __state->gpu_context->streams[0]));
        DACE_GPU_CHECK(cudaMemcpyAsync(gpu___CG_p_patch__CG_cells__m_neighbor_idx, __CG_p_patch__CG_cells__m_neighbor_idx, ((__f2dace_SA_neighbor_idx_d_0_s_cells_p_patch_2 * __f2dace_SA_neighbor_idx_d_1_s_cells_p_patch_2) * __f2dace_SA_neighbor_idx_d_2_s_cells_p_patch_2) * sizeof(int), cudaMemcpyHostToDevice, __state->gpu_context->streams[0]));
        ...
        DACE_GPU_CHECK(cudaMemcpyAsync(gpu___CG_p_patch__CG_edges__m_inv_dual_edge_length, __CG_p_patch__CG_edges__m_inv_dual_edge_length, (__f2dace_SA_inv_dual_edge_length_d_0_s_edges_p_patch_4 * __f2dace_SA_inv_dual_edge_length_d_1_s_edges_p_patch_4) * sizeof(double), cudaMemcpyHostToDevice, __state->gpu_context->streams[0]));
        ...
        DACE_GPU_CHECK(cudaMemcpyAsync(gpu___CG_p_patch__CG_verts__m_cell_blk, __CG_p_patch__CG_verts__m_cell_blk, ((__f2dace_SA_cell_blk_d_0_s_verts_p_patch_5 * __f2dace_SA_cell_blk_d_1_s_verts_p_patch_5) * __f2dace_SA_cell_blk_d_2_s_verts_p_patch_5) * sizeof(int), cudaMemcpyHostToDevice, __state->gpu_context->streams[0]));
        DACE_GPU_CHECK(cudaMemcpyAsync(gpu___CG_p_patch__CG_verts__m_cell_idx, __CG_p_patch__CG_verts__m_cell_idx, ((__f2dace_SA_cell_idx_d_0_s_verts_p_patch_5 * __f2dace_SA_cell_idx_d_1_s_verts_p_patch_5) * __f2dace_SA_cell_idx_d_2_s_verts_p_patch_5) * sizeof(int), cudaMemcpyHostToDevice, __state->gpu_context->streams[0]));
...
//    //cudaStreamSynchronize(__state->gpu_context->streams[0]); 
  //std::cout << "CUDA Events Based Total time: " << milliseconds1*1000.0 << " us" << std::endl;
        ...
        DACE_GPU_CHECK(cudaMemcpyAsync(__CG_p_diag__m_ddt_w_adv_pc, gpu___CG_p_diag__m_ddt_w_adv_pc, (((91 * __f2dace_SA_ddt_w_adv_pc_d_0_s_p_diag_9) * __f2dace_SA_ddt_w_adv_pc_d_2_s_p_diag_9) * __f2dace_SA_ddt_w_adv_pc_d_3_s_p_diag_9) * sizeof(double), cudaMemcpyDeviceToHost, __state->gpu_context->streams[0]));
        ...
        DACE_GPU_CHECK(cudaMemcpyAsync(__CG_p_int__m_cells_aw_verts, gpu___CG_p_int__m_cells_aw_verts, ((__f2dace_SA_cells_aw_verts_d_0_s_p_int_6 * __f2dace_SA_cells_aw_verts_d_1_s_p_int_6) * __f2dace_SA_cells_aw_verts_d_2_s_p_int_6) * sizeof(double), cudaMemcpyDeviceToHost, __state->gpu_context->streams[0]));
        ...
        DACE_GPU_CHECK(cudaMemcpyAsync(__CG_p_int__m_geofac_n2s, gpu___CG_p_int__m_geofac_n2s, ((__f2dace_SA_geofac_n2s_d_0_s_p_int_6 * __f2dace_SA_geofac_n2s_d_1_s_p_int_6) * __f2dace_SA_geofac_n2s_d_2_s_p_int_6) * sizeof(double), cudaMemcpyDeviceToHost, __state->gpu_context->streams[0]));
        ...
        DACE_GPU_CHECK(cudaMemcpyAsync(__CG_p_int__m_rbf_vec_coeff_e, gpu___CG_p_int__m_rbf_vec_coeff_e, ((__f2dace_SA_rbf_vec_coeff_e_d_0_s_p_int_6 * __f2dace_SA_rbf_vec_coeff_e_d_1_s_p_int_6) * __f2dace_SA_rbf_vec_coeff_e_d_2_s_p_int_6) * sizeof(double), cudaMemcpyDeviceToHost, __state->gpu_context->streams[0]));
        DACE_GPU_CHECK(cudaMemcpyAsync(__CG_p_metrics__m_coeff1_dwdz, gpu___CG_p_metrics__m_coeff1_dwdz, ((90 * __f2dace_SA_coeff1_dwdz_d_0_s_p_metrics_8) * __f2dace_SA_coeff1_dwdz_d_2_s_p_metrics_8) * sizeof(double), cudaMemcpyDeviceToHost, __state->gpu_context->streams[0]));
        DACE_GPU_CHECK(cudaMemcpyAsync(__CG_p_metrics__m_coeff2_dwdz, gpu___CG_p_metrics__m_coeff2_dwdz, ((90 * __f2dace_SA_coeff2_dwdz_d_0_s_p_metrics_8) * __f2dace_SA_coeff2_dwdz_d_2_s_p_metrics_8) * sizeof(double), cudaMemcpyDeviceToHost, __state->gpu_context->streams[0]));
        ...
        DACE_GPU_CHECK(cudaMemcpyAsync(__CG_p_metrics__m_ddxn_z_full, gpu___CG_p_metrics__m_ddxn_z_full, ((90 * __f2dace_SA_ddxn_z_full_d_0_s_p_metrics_8) * __f2dace_SA_ddxn_z_full_d_2_s_p_metrics_8) * sizeof(double), cudaMemcpyDeviceToHost, __state->gpu_context->streams[0]));
        DACE_GPU_CHECK(cudaMemcpyAsync(__CG_p_metrics__m_ddxt_z_full, gpu___CG_p_metrics__m_ddxt_z_full, ((90 * __f2dace_SA_ddxt_z_full_d_0_s_p_metrics_8) * __f2dace_SA_ddxt_z_full_d_2_s_p_metrics_8) * sizeof(double), cudaMemcpyDeviceToHost, __state->gpu_context->streams[0]));
        DACE_GPU_CHECK(cudaMemcpyAsync(__CG_p_metrics__m_wgtfac_c, gpu___CG_p_metrics__m_wgtfac_c, ((91 * __f2dace_SA_wgtfac_c_d_0_s_p_metrics_8) * __f2dace_SA_wgtfac_c_d_2_s_p_metrics_8) * sizeof(double), cudaMemcpyDeviceToHost, __state->gpu_context->streams[0]));
        DACE_GPU_CHECK(cudaMemcpyAsync(__CG_p_metrics__m_wgtfac_e, gpu___CG_p_metrics__m_wgtfac_e, ((91 * __f2dace_SA_wgtfac_e_d_0_s_p_metrics_8) * __f2dace_SA_wgtfac_e_d_2_s_p_metrics_8) * sizeof(double), cudaMemcpyDeviceToHost, __state->gpu_context->streams[0]));
        DACE_GPU_CHECK(cudaMemcpyAsync(__CG_p_metrics__m_wgtfacq_e, gpu___CG_p_metrics__m_wgtfacq_e, ((__f2dace_SA_wgtfacq_e_d_0_s_p_metrics_8 * __f2dace_SA_wgtfacq_e_d_1_s_p_metrics_8) * __f2dace_SA_wgtfacq_e_d_2_s_p_metrics_8) * sizeof(double), cudaMemcpyDeviceToHost, __state->gpu_context->streams[0]));
        DACE_GPU_CHECK(cudaMemcpyAsync(__CG_p_patch__CG_cells__CG_decomp_info__m_owner_mask, gpu___CG_p_patch__CG_cells__CG_decomp_info__m_owner_mask, (__f2dace_SA_owner_mask_d_0_s_decomp_info_cells_p_patch_3 * __f2dace_SA_owner_mask_d_1_s_decomp_info_cells_p_patch_3) * sizeof(int), cudaMemcpyDeviceToHost, __state->gpu_context->streams[0]));
        DACE_GPU_CHECK(cudaMemcpyAsync(__CG_p_patch__CG_cells__m_area, gpu___CG_p_patch__CG_cells__m_area, (__f2dace_SA_area_d_0_s_cells_p_patch_2 * __f2dace_SA_area_d_1_s_cells_p_patch_2) * sizeof(double), cudaMemcpyDeviceToHost, __state->gpu_context->streams[0]));
        ...
        DACE_GPU_CHECK(cudaMemcpyAsync(__CG_p_patch__CG_cells__m_neighbor_blk, gpu___CG_p_patch__CG_cells__m_neighbor_blk, ((__f2dace_SA_neighbor_blk_d_0_s_cells_p_patch_2 * __f2dace_SA_neighbor_blk_d_1_s_cells_p_patch_2) * __f2dace_SA_neighbor_blk_d_2_s_cells_p_patch_2) * sizeof(int), cudaMemcpyDeviceToHost, __state->gpu_context->streams[0]));
        DACE_GPU_CHECK(cudaMemcpyAsync(__CG_p_patch__CG_cells__m_neighbor_idx, gpu___CG_p_patch__CG_cells__m_neighbor_idx, ((__f2dace_SA_neighbor_idx_d_0_s_cells_p_patch_2 * __f2dace_SA_neighbor_idx_d_1_s_cells_p_patch_2) * __f2dace_SA_neighbor_idx_d_2_s_cells_p_patch_2) * sizeof(int), cudaMemcpyDeviceToHost, __state->gpu_context->streams[0]));
        ...
        DACE_GPU_CHECK(cudaMemcpyAsync(__CG_p_patch__CG_edges__m_inv_dual_edge_length, gpu___CG_p_patch__CG_edges__m_inv_dual_edge_length, (__f2dace_SA_inv_dual_edge_length_d_0_s_edges_p_patch_4 * __f2dace_SA_inv_dual_edge_length_d_1_s_edges_p_patch_4) * sizeof(double), cudaMemcpyDeviceToHost, __state->gpu_context->streams[0]));
        ...
        DACE_GPU_CHECK(cudaMemcpyAsync(__CG_p_patch__CG_verts__m_cell_blk, gpu___CG_p_patch__CG_verts__m_cell_blk, ((__f2dace_SA_cell_blk_d_0_s_verts_p_patch_5 * __f2dace_SA_cell_blk_d_1_s_verts_p_patch_5) * __f2dace_SA_cell_blk_d_2_s_verts_p_patch_5) * sizeof(int), cudaMemcpyDeviceToHost, __state->gpu_context->streams[0]));
        DACE_GPU_CHECK(cudaMemcpyAsync(__CG_p_patch__CG_verts__m_cell_idx, gpu___CG_p_patch__CG_verts__m_cell_idx, ((__f2dace_SA_cell_idx_d_0_s_verts_p_patch_5 * __f2dace_SA_cell_idx_d_1_s_verts_p_patch_5) * __f2dace_SA_cell_idx_d_2_s_verts_p_patch_5) * sizeof(int), cudaMemcpyDeviceToHost, __state->gpu_context->streams[0]));
                ...
                {
                    {
                        ...
                        for (auto k = 0; k < __f2dace_SA_rbf_vec_coeff_e_d_2_s_p_int_6; k++){
                            for (auto j = 0; j < __f2dace_SA_rbf_vec_coeff_e_d_1_s_p_int_6; j++){
                                #pragma omp simd
                                for (auto i = 0; i < __f2dace_SA_rbf_vec_coeff_e_d_0_s_p_int_6; i++){
                                    p_int->rbf_vec_coeff_e[(i * (1)) + (j * (__f2dace_SA_rbf_vec_coeff_e_d_0_s_p_int_6)) + (k * ((__f2dace_SA_rbf_vec_coeff_e_d_0_s_p_int_6 * __f2dace_SA_rbf_vec_coeff_e_d_1_s_p_int_6)))] = __cg_p_int__m_rbf_vec_coeff_e[(i * (1)) + (j * (__f2dace_SA_rbf_vec_coeff_e_d_0_s_p_int_6)) + (k * ((__f2dace_SA_rbf_vec_coeff_e_d_0_s_p_int_6 * __f2dace_SA_rbf_vec_coeff_e_d_1_s_p_int_6)))];
                                }
                            }
                        }
                        ...
                        for (auto k = 0; k < __f2dace_SA_ddxn_z_full_d_2_s_p_metrics_8; k++){
                            for (auto j = 0; j < 90; j++){
                                #pragma omp simd
                                for (auto i = 0; i < __f2dace_SA_ddxn_z_full_d_0_s_p_metrics_8; i++){
                                    p_metrics->ddxn_z_full[(i * (1)) + (j * (__f2dace_SA_ddxn_z_full_d_0_s_p_metrics_8)) + (k * ((90 * __f2dace_SA_ddxn_z_full_d_0_s_p_metrics_8)))] = __cg_p_metrics__m_ddxn_z_full[(i * (1)) + (j * (__f2dace_SA_ddxn_z_full_d_0_s_p_metrics_8)) + (k * ((90 * __f2dace_SA_ddxn_z_full_d_0_s_p_metrics_8)))];
                                }
                            }
                        }
                        ...
                        for (auto k = 0; k < __f2dace_SA_ddxt_z_full_d_2_s_p_metrics_8; k++){
                            for (auto j = 0; j < 90; j++){
                                #pragma omp simd
                                for (auto i = 0; i < __f2dace_SA_ddxt_z_full_d_0_s_p_metrics_8; i++){
                                    p_metrics->ddxt_z_full[(i * (1)) + (j * (__f2dace_SA_ddxt_z_full_d_0_s_p_metrics_8)) + (k * ((90 * __f2dace_SA_ddxt_z_full_d_0_s_p_metrics_8)))] = __cg_p_metrics__m_ddxt_z_full[(i * (1)) + (j * (__f2dace_SA_ddxt_z_full_d_0_s_p_metrics_8)) + (k * ((90 * __f2dace_SA_ddxt_z_full_d_0_s_p_metrics_8)))];
                                }
                            }
                        }
                        ...
                        for (auto k = 0; k < __f2dace_SA_wgtfac_c_d_2_s_p_metrics_8; k++){
                            for (auto j = 0; j < 91; j++){
                                #pragma omp simd
                                for (auto i = 0; i < __f2dace_SA_wgtfac_c_d_0_s_p_metrics_8; i++){
                                    p_metrics->wgtfac_c[(i * (1)) + (j * (__f2dace_SA_wgtfac_c_d_0_s_p_metrics_8)) + (k * ((91 * __f2dace_SA_wgtfac_c_d_0_s_p_metrics_8)))] = __cg_p_metrics__m_wgtfac_c[(i * (1)) + (j * (__f2dace_SA_wgtfac_c_d_0_s_p_metrics_8)) + (k * ((91 * __f2dace_SA_wgtfac_c_d_0_s_p_metrics_8)))];
                                }
                            }
                        }
                        ...
                        for (auto k = 0; k < __f2dace_SA_wgtfac_e_d_2_s_p_metrics_8; k++){
                            for (auto j = 0; j < 91; j++){
                                #pragma omp simd
                                for (auto i = 0; i < __f2dace_SA_wgtfac_e_d_0_s_p_metrics_8; i++){
                                    p_metrics->wgtfac_e[(i * (1)) + (j * (__f2dace_SA_wgtfac_e_d_0_s_p_metrics_8)) + (k * ((91 * __f2dace_SA_wgtfac_e_d_0_s_p_metrics_8)))] = __cg_p_metrics__m_wgtfac_e[(i * (1)) + (j * (__f2dace_SA_wgtfac_e_d_0_s_p_metrics_8)) + (k * ((91 * __f2dace_SA_wgtfac_e_d_0_s_p_metrics_8)))];
                                }
                            }
                        }
                        ...
                        for (auto k = 0; k < __f2dace_SA_wgtfacq_e_d_2_s_p_metrics_8; k++){
                            for (auto j = 0; j < __f2dace_SA_wgtfacq_e_d_1_s_p_metrics_8; j++){
                                #pragma omp simd
                                for (auto i = 0; i < __f2dace_SA_wgtfacq_e_d_0_s_p_metrics_8; i++){
                                    p_metrics->wgtfacq_e[(i * (1)) + (j * (__f2dace_SA_wgtfacq_e_d_0_s_p_metrics_8)) + (k * ((__f2dace_SA_wgtfacq_e_d_0_s_p_metrics_8 * __f2dace_SA_wgtfacq_e_d_1_s_p_metrics_8)))] = __cg_p_metrics__m_wgtfacq_e[(i * (1)) + (j * (__f2dace_SA_wgtfacq_e_d_0_s_p_metrics_8)) + (k * ((__f2dace_SA_wgtfacq_e_d_0_s_p_metrics_8 * __f2dace_SA_wgtfacq_e_d_1_s_p_metrics_8)))];
                                }
                            }
                        }
