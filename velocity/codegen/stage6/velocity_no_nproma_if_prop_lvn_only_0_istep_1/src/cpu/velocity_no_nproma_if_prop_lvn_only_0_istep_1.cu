...
//        DACE_GPU_CHECK(cudaStreamSynchronize(__state->gpu_context->streams[0]));
   ...
   cudaDeviceSynchronize();
...

    {
        ...
        __dace_runkernel_single_state_body_0_map_0_0_0_3_38(__state, gpu_levelmask, gpu_levmask, i_endblk_var_147, i_startblk_var_146, nrdmax_jg, tmp_struct_symbol_13);
