...
__global__ void __launch_bounds__(256) single_state_body_0_map_3_3_0_4_22(int * __restrict__ gpu_levelmask, const int * __restrict__ gpu_levmask, int i_endblk_var_147, int i_startblk_var_146, int nrdmax_jg, int tmp_struct_symbol_13) {
    {
...
void __dace_runkernel_single_state_body_0_map_3_3_0_4_22(velocity_no_nproma_if_prop_lvn_only_1_istep_2_state_t *__state, int * __restrict__ gpu_levelmask, const int * __restrict__ gpu_levmask, int i_endblk_var_147, int i_startblk_var_146, int nrdmax_jg, int tmp_struct_symbol_13)
{
    ...
    void  *single_state_body_0_map_3_3_0_4_22_args[] = { (void *)&gpu_levelmask, (void *)&gpu_levmask, (void *)&i_endblk_var_147, (void *)&i_startblk_var_146, (void *)&nrdmax_jg, (void *)&tmp_struct_symbol_13 };
    gpuError_t __err = cudaLaunchKernel((void*)single_state_body_0_map_3_3_0_4_22, dim3(int_ceil(int_ceil((88 - Max(3, (nrdmax_jg - 2))), 1), 256), 1, 1), dim3(256, 1, 1), single_state_body_0_map_3_3_0_4_22_args, 0, __state->gpu_context->streams[1]);
    DACE_KERNEL_LAUNCH_CHECK(__err, "single_state_body_0_map_3_3_0_4_22", int_ceil(int_ceil((88 - Max(3, (nrdmax_jg - 2))), 1), 256), 1, 1, 256, 1, 1);
}
