...
void __program_velocity_no_nproma_if_prop_lvn_only_0_istep_1_internal(velocity_no_nproma_if_prop_lvn_only_0_istep_1_state_t*__state, global_data_type* global_data, t_nh_diag* p_diag, t_int_state* p_int, t_nh_metrics* p_metrics, t_patch* p_patch, t_nh_prog* p_prog, double * __restrict__ z_kin_hor_e, double * __restrict__ z_vt_ie, double * __restrict__ z_w_concorr_me, int __f2dace_A_z_kin_hor_e_d_0_s_363, int __f2dace_A_z_kin_hor_e_d_1_s_364, int __f2dace_A_z_vt_ie_d_0_s_366, int __f2dace_A_z_vt_ie_d_1_s_367, int __f2dace_A_z_w_concorr_me_d_0_s_360, int __f2dace_A_z_w_concorr_me_d_1_s_361, int __f2dace_OA_z_kin_hor_e_d_0_s_363, int __f2dace_OA_z_kin_hor_e_d_1_s_364, int __f2dace_OA_z_kin_hor_e_d_2_s_365, int __f2dace_OA_z_vt_ie_d_0_s_366, int __f2dace_OA_z_vt_ie_d_1_s_367, int __f2dace_OA_z_vt_ie_d_2_s_368, int __f2dace_OA_z_w_concorr_me_d_0_s_360, int __f2dace_OA_z_w_concorr_me_d_1_s_361, int __f2dace_OA_z_w_concorr_me_d_2_s_362, double dt_linintp_ubc, double dtime, int istep, int ldeepatmo, int lvn_only, int ntnd)
{
    ...
    memset(z_w_concorr_mc, 0, sizeof(double)*(90 * tmp_struct_symbol_0));
    double *z_w_con_c;
    z_w_con_c = new double DACE_ALIGN(64)[(91 * tmp_struct_symbol_1)];
    memset(z_w_con_c, 0, sizeof(double)*(91 * tmp_struct_symbol_1));
    ...
    memset(z_w_con_c_full, 0, sizeof(double)*(((90 * tmp_struct_symbol_2) * (tmp_struct_symbol_3 - 1)) + (90 * tmp_struct_symbol_2)));
    double *z_v_grad_w;
    z_v_grad_w = new double DACE_ALIGN(64)[(((90 * tmp_struct_symbol_4) * (tmp_struct_symbol_5 - 1)) + (90 * tmp_struct_symbol_4))];
    memset(z_v_grad_w, 0, sizeof(double)*(((90 * tmp_struct_symbol_4) * (tmp_struct_symbol_5 - 1)) + (90 * tmp_struct_symbol_4)));
    double *z_w_v;
    z_w_v = new double DACE_ALIGN(64)[(((91 * tmp_struct_symbol_6) * (tmp_struct_symbol_7 - 1)) + (91 * tmp_struct_symbol_6))];
    memset(z_w_v, 0, sizeof(double)*(((91 * tmp_struct_symbol_6) * (tmp_struct_symbol_7 - 1)) + (91 * tmp_struct_symbol_6)));
    double *zeta;
    zeta = new double DACE_ALIGN(64)[(((90 * tmp_struct_symbol_8) * (tmp_struct_symbol_9 - 1)) + (90 * tmp_struct_symbol_8))];
    memset(zeta, 0, sizeof(double)*(((90 * tmp_struct_symbol_8) * (tmp_struct_symbol_9 - 1)) + (90 * tmp_struct_symbol_8)));
    double *z_ekinh;
    z_ekinh = new double DACE_ALIGN(64)[(((90 * tmp_struct_symbol_10) * (tmp_struct_symbol_11 - 1)) + (90 * tmp_struct_symbol_10))];
    memset(z_ekinh, 0, sizeof(double)*(((90 * tmp_struct_symbol_10) * (tmp_struct_symbol_11 - 1)) + (90 * tmp_struct_symbol_10)));
    double cfl_w_limit = 0;
    double maxvcfl = 0;
    double *vcflmax;
    vcflmax = new double DACE_ALIGN(64)[tmp_struct_symbol_12];
    memset(vcflmax, 0, sizeof(double)*tmp_struct_symbol_12);
    double w_con_e = 0;
    double scalfac_exdiff = 0;
    double difcoef = 0;
    int *levmask;
    levmask = new int DACE_ALIGN(64)[(90 * tmp_struct_symbol_13)];
    memset(levmask, 0, sizeof(int)*(90 * tmp_struct_symbol_13));
    int *levelmask;
    levelmask = new int DACE_ALIGN(64)[90];
    memset(levelmask, 0, sizeof(int)*90);
    int *cfl_clipping;
    cfl_clipping = new int DACE_ALIGN(64)[(91 * tmp_struct_symbol_14)];
    memset(cfl_clipping, 0, sizeof(int)*(91 * tmp_struct_symbol_14));
    ...
    memset(out_val_0, 0, sizeof(int)*1);
    double *maxvcfl_arr;
    maxvcfl_arr = new double DACE_ALIGN(64)[(88 * tmp_struct_symbol_4)];
    memset(maxvcfl_arr, 0, sizeof(double)*(88 * tmp_struct_symbol_4));
    int64_t il_size;
    int nrdmax_jg;
    int nflatlev_jg;
 ...
 cudaEvent_t start1, stop1;
  ...
  measure_time("Run");
...

    {
        ...
        DACE_GPU_CHECK(cudaMemcpyAsync(__CG_p_metrics__m_ddqz_z_half, gpu___CG_p_metrics__m_ddqz_z_half, ((91 * __f2dace_SA_ddqz_z_half_d_0_s_317_p_metrics_8) * __f2dace_SA_ddqz_z_half_d_2_s_319_p_metrics_8) * sizeof(double), cudaMemcpyDeviceToHost, __state->gpu_context->streams[1]));
        ...
        DACE_GPU_CHECK(cudaMemcpyAsync(__CG_p_prog__m_w, gpu___CG_p_prog__m_w, ((91 * __f2dace_SA_w_d_0_s_285_p_prog_7) * __f2dace_SA_w_d_2_s_287_p_prog_7) * sizeof(double), cudaMemcpyDeviceToHost, __state->gpu_context->streams[2]));
        ...
        DACE_GPU_CHECK(cudaMemcpyAsync(__CG_p_diag__m_ddt_w_adv_pc, gpu___CG_p_diag__m_ddt_w_adv_pc, (((91 * __f2dace_SA_ddt_w_adv_pc_d_0_s_304_p_diag_9) * __f2dace_SA_ddt_w_adv_pc_d_2_s_306_p_diag_9) * __f2dace_SA_ddt_w_adv_pc_d_3_s_307_p_diag_9) * sizeof(double), cudaMemcpyDeviceToHost, __state->gpu_context->streams[3]));
        ...
        DACE_GPU_CHECK(cudaMemcpyAsync(__CG_p_patch__CG_cells__m_end_index, gpu___CG_p_patch__CG_cells__m_end_index, __f2dace_SA_end_index_d_0_s_161_cells_p_patch_2 * sizeof(int), cudaMemcpyDeviceToHost, __state->gpu_context->streams[1]));
        DACE_GPU_CHECK(cudaMemcpyAsync(__CG_p_patch__CG_verts__m_start_block, gpu___CG_p_patch__CG_verts__m_start_block, __f2dace_SA_start_block_d_0_s_214_verts_p_patch_5 * sizeof(int), cudaMemcpyDeviceToHost, __state->gpu_context->streams[2]));
        ...
        DACE_GPU_CHECK(cudaMemcpyAsync(__CG_p_metrics__m_coeff1_dwdz, gpu___CG_p_metrics__m_coeff1_dwdz, ((90 * __f2dace_SA_coeff1_dwdz_d_0_s_332_p_metrics_8) * __f2dace_SA_coeff1_dwdz_d_2_s_334_p_metrics_8) * sizeof(double), cudaMemcpyDeviceToHost, __state->gpu_context->streams[2]));
        DACE_GPU_CHECK(cudaMemcpyAsync(__CG_p_patch__CG_verts__m_end_block, gpu___CG_p_patch__CG_verts__m_end_block, __f2dace_SA_end_block_d_0_s_215_verts_p_patch_5 * sizeof(int), cudaMemcpyDeviceToHost, __state->gpu_context->streams[3]));
        ...
        DACE_GPU_CHECK(cudaMemcpyAsync(__CG_p_int__m_rbf_vec_coeff_e, gpu___CG_p_int__m_rbf_vec_coeff_e, ((__f2dace_SA_rbf_vec_coeff_e_d_0_s_34_p_int_6 * __f2dace_SA_rbf_vec_coeff_e_d_1_s_35_p_int_6) * __f2dace_SA_rbf_vec_coeff_e_d_2_s_36_p_int_6) * sizeof(double), cudaMemcpyDeviceToHost, __state->gpu_context->streams[1]));
        ...
        DACE_GPU_CHECK(cudaMemcpyAsync(__CG_p_diag__m_ddt_vn_apc_pc, gpu___CG_p_diag__m_ddt_vn_apc_pc, (((90 * __f2dace_SA_ddt_vn_apc_pc_d_0_s_300_p_diag_9) * __f2dace_SA_ddt_vn_apc_pc_d_2_s_302_p_diag_9) * __f2dace_SA_ddt_vn_apc_pc_d_3_s_303_p_diag_9) * sizeof(double), cudaMemcpyDeviceToHost, __state->gpu_context->streams[2]));
        ...
        DACE_GPU_CHECK(cudaMemcpyAsync(__CG_p_patch__CG_edges__m_end_block, gpu___CG_p_patch__CG_edges__m_end_block, __f2dace_SA_end_block_d_0_s_199_edges_p_patch_4 * sizeof(int), cudaMemcpyDeviceToHost, __state->gpu_context->streams[3]));
        ...
        DACE_GPU_CHECK(cudaMemcpyAsync(__CG_p_int__m_geofac_n2s, gpu___CG_p_int__m_geofac_n2s, ((__f2dace_SA_geofac_n2s_d_0_s_43_p_int_6 * __f2dace_SA_geofac_n2s_d_1_s_44_p_int_6) * __f2dace_SA_geofac_n2s_d_2_s_45_p_int_6) * sizeof(double), cudaMemcpyDeviceToHost, __state->gpu_context->streams[2]));
        ...
        DACE_GPU_CHECK(cudaMemcpyAsync(__CG_p_patch__CG_cells__m_area, gpu___CG_p_patch__CG_cells__m_area, (__f2dace_SA_area_d_0_s_158_cells_p_patch_2 * __f2dace_SA_area_d_1_s_159_cells_p_patch_2) * sizeof(double), cudaMemcpyDeviceToHost, __state->gpu_context->streams[1]));
        ...
        DACE_GPU_CHECK(cudaMemcpyAsync(__CG_p_diag__m_vn_ie, gpu___CG_p_diag__m_vn_ie, ((91 * __f2dace_SA_vn_ie_d_0_s_294_p_diag_9) * __f2dace_SA_vn_ie_d_2_s_296_p_diag_9) * sizeof(double), cudaMemcpyDeviceToHost, __state->gpu_context->streams[2]));
        DACE_GPU_CHECK(cudaMemcpyAsync(__CG_p_patch__CG_cells__m_end_block, gpu___CG_p_patch__CG_cells__m_end_block, __f2dace_SA_end_block_d_0_s_163_cells_p_patch_2 * sizeof(int), cudaMemcpyDeviceToHost, __state->gpu_context->streams[3]));
//        DACE_GPU_CHECK(cudaStreamSynchronize(__state->gpu_context->streams[0]));
