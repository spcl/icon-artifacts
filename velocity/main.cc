...
int main () {
    ...
    const std::array<int, 13> ns = { 1, 2, 7, 9, 43, 93, 463, 519, 1140, 1814, 2593, 5701, 6519 };
    ...
    for (int n : ns) {
        ...
        std::cout << "Step " << n << " variables, extra_diffu: " << global_data.lextra_diffu
                  << ", istep: ";
        std::cout << istep << ", lvn_only: " << lvn_only
                  << ", ldeepatmo: " << ldeepatmo << std::endl;
        auto* h = __dace_init_velocity_tendencies (&global_data, &p_diag, &p_int,
        &p_metrics, &p_patch, &p_prog, z_kin_hor_e, z_vt_ie, z_w_concorr_me,
        ...
        __program_velocity_tendencies (h, &global_data, &p_diag, &p_int,
        &p_metrics, &p_patch, &p_prog, z_kin_hor_e, z_vt_ie, z_w_concorr_me,
        /*__f2dace_A_z_kin_hor_e_d_0_s_157=*/
        serde::ARRAY_META_DICT ()->at (z_kin_hor_e).size.at (0),
        /*__f2dace_A_z_kin_hor_e_d_1_s_158=*/
