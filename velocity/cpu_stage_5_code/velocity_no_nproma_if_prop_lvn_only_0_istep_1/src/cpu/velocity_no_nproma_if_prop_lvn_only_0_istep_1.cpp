...
inline void loop_body_7_2_5(velocity_no_nproma_if_prop_lvn_only_0_istep_1_state_t *__state, double* __restrict__ __CG_p_int__m_geofac_rot, int* __restrict__ __CG_p_patch__CG_verts__m_edge_blk, int* __restrict__ __CG_p_patch__CG_verts__m_edge_idx, double* __restrict__ __CG_p_prog__m_vn, double* __restrict__ zeta, int _for_it_3_0, int64_t _for_it_4_0, int64_t _for_it_5_0, int tmp_struct_symbol_8) {
    int tmp_index_92_0;
    int tmp_index_94_0;
    int tmp_index_104_0;
    int tmp_index_106_0;
...

        {
            for (auto _for_it_4_0 = 1; _for_it_4_0 < 91; _for_it_4_0 += 1) {
                for (auto _for_it_5_0 = i_startidx_var_120_0; _for_it_5_0 < (i_endidx_in_var_104_0_0 + 1); _for_it_5_0 += 1) {
                    loop_body_7_2_5(__state, &__CG_p_int__m_geofac_rot[0], &__CG_p_patch__CG_verts__m_edge_blk[0], &__CG_p_patch__CG_verts__m_edge_idx[0], &__CG_p_prog__m_vn[0], &zeta[0], _for_it_3_0, _for_it_4_0, _for_it_5_0, tmp_struct_symbol_8);
                }
            }
        }
...

        {
            for (auto _for_it_7 = 1; _for_it_7 < 91; _for_it_7 += 1) {
                for (auto _for_it_8 = i_startidx_var_148; _for_it_8 < (i_endidx_var_149 + 1); _for_it_8 += 1) {
                    loop_body_13_2_5(__state, &__CG_p_int__m_rbf_vec_coeff_e[0], &__CG_p_patch__CG_edges__m_quad_blk[0], &__CG_p_patch__CG_edges__m_quad_idx[0], &__CG_p_prog__m_vn[0], &__CG_p_diag__m_vt[0], _for_it_6, _for_it_7, _for_it_8);
                }
            }
        }
        {
            for (auto _for_it_9 = 2; _for_it_9 < 91; _for_it_9 += 1) {
                for (auto _for_it_10 = i_startidx_var_148; _for_it_10 < (i_endidx_var_149 + 1); _for_it_10 += 1) {
                    ...
                    }
                    {
                        ...
                        double p_diag_1_in_vt_0 = __CG_p_diag__m_vt[(((((90 * __f2dace_SA_vt_d_0_s_291_p_diag_9) * ((- __f2dace_SOA_vt_d_2_s_293_p_diag_9) + _for_it_6)) + (__f2dace_SA_vt_d_0_s_291_p_diag_9 * (((- __f2dace_SOA_vt_d_1_s_292_p_diag_9) + _for_it_9) - 1))) - __f2dace_SOA_vt_d_0_s_291_p_diag_9) + _for_it_10)];
                        ...
                        z_vt_ie[(((((__f2dace_A_z_vt_ie_d_0_s_366 * __f2dace_A_z_vt_ie_d_1_s_367) * ((- __f2dace_OA_z_vt_ie_d_2_s_368) + _for_it_6)) + (__f2dace_A_z_vt_ie_d_0_s_366 * ((- __f2dace_OA_z_vt_ie_d_1_s_367) + _for_it_9))) - __f2dace_OA_z_vt_ie_d_0_s_366) + _for_it_10)] = z_vt_ie_out_0;
                    }
                    {
                        double p_diag_0_in_vt_0 = __CG_p_diag__m_vt[((((__f2dace_SA_vt_d_0_s_291_p_diag_9 * ((- __f2dace_SOA_vt_d_1_s_292_p_diag_9) + _for_it_9)) + ((90 * __f2dace_SA_vt_d_0_s_291_p_diag_9) * ((- __f2dace_SOA_vt_d_2_s_293_p_diag_9) + _for_it_6))) - __f2dace_SOA_vt_d_0_s_291_p_diag_9) + _for_it_10)];
...
inline void loop_body_62_2_12(velocity_no_nproma_if_prop_lvn_only_0_istep_1_state_t *__state, double* __restrict__ __CG_p_diag__m_vn_ie, int* __restrict__ __CG_p_patch__CG_edges__m_cell_blk, int* __restrict__ __CG_p_patch__CG_edges__m_cell_idx, double* __restrict__ __CG_p_patch__CG_edges__m_inv_dual_edge_length, double* __restrict__ __CG_p_patch__CG_edges__m_inv_primal_edge_length, double* __restrict__ __CG_p_patch__CG_edges__m_tangent_orientation, int* __restrict__ __CG_p_patch__CG_edges__m_vertex_blk, int* __restrict__ __CG_p_patch__CG_edges__m_vertex_idx, double* __restrict__ __CG_p_prog__m_w, double* __restrict__ z_vt_ie, double* __restrict__ z_w_v, double* __restrict__ z_v_grad_w, int __f2dace_A_z_vt_ie_d_0_s_366, int __f2dace_A_z_vt_ie_d_1_s_367, int __f2dace_OA_z_vt_ie_d_0_s_366, int __f2dace_OA_z_vt_ie_d_1_s_367, int __f2dace_OA_z_vt_ie_d_2_s_368, int _for_it_16, int64_t _for_it_17, int64_t _for_it_18, int tmp_struct_symbol_4, int tmp_struct_symbol_6) {
    int tmp_index_329;
    int tmp_index_331;
    int tmp_index_338;
    int tmp_index_340;
...
inline void loop_body_23_0_4(velocity_no_nproma_if_prop_lvn_only_0_istep_1_state_t *__state, double* __restrict__ __CG_p_metrics__m_ddqz_z_half, int* __restrict__ cfl_clipping, const double&  dtime, double* __restrict__ maxvcfl_arr, double* __restrict__ z_w_con_c, int _for_it_22, int64_t _for_it_35, int64_t _for_it_37, int tmp_struct_symbol_1, int tmp_struct_symbol_14) {
    int _if_cond_18;
    double vcfl;
    ...
    if ((_if_cond_18 == 1)) {
        ...
        vcfl = ((z_w_con_c[((_for_it_37 + (tmp_struct_symbol_1 * (_for_it_35 - 1))) - 1)] * dtime) / __CG_p_metrics__m_ddqz_z_half[((((__f2dace_SA_ddqz_z_half_d_0_s_317_p_metrics_8 * ((- __f2dace_SOA_ddqz_z_half_d_1_s_318_p_metrics_8) + _for_it_35)) + ((91 * __f2dace_SA_ddqz_z_half_d_0_s_317_p_metrics_8) * ((- __f2dace_SOA_ddqz_z_half_d_2_s_319_p_metrics_8) + _for_it_22))) - __f2dace_SOA_ddqz_z_half_d_0_s_317_p_metrics_8) + _for_it_37)]);
        {
            ...
            }
            {
                ...
                maxvcfl_arr[((_for_it_35 + (87 * _for_it_37)) - 88)] = maxvcfl_out;
            }
...
inline void loop_body_20_1_2(velocity_no_nproma_if_prop_lvn_only_0_istep_1_state_t *__state, double* __restrict__ __CG_p_metrics__m_ddqz_z_half, const double&  cfl_w_limit, const double&  dtime, int* __restrict__ cfl_clipping, int* __restrict__ levmask, double* __restrict__ maxvcfl_arr, double* __restrict__ z_w_con_c, int _for_it_22, int64_t _for_it_35, int clip_count, int i_endidx_in_var_80_1, int64_t i_startidx_var_148, int tmp_struct_symbol_1, int tmp_struct_symbol_13, int tmp_struct_symbol_14) {
    ...
    if ((! ((clip_count == 0) == 1))) {
        {
            ...
            {
                for (auto _for_it_37 = i_startidx_var_148; _for_it_37 < (i_endidx_in_var_80_1 + 1); _for_it_37 += 1) {
                    loop_body_23_0_4(__state, &__CG_p_metrics__m_ddqz_z_half[0], &cfl_clipping[0], dtime, &maxvcfl_arr[0], &z_w_con_c[0], _for_it_22, _for_it_35, _for_it_37, tmp_struct_symbol_1, tmp_struct_symbol_14);
                }
            }
            {
                int size;
...
inline void loop_body_0_4_0(velocity_no_nproma_if_prop_lvn_only_0_istep_1_state_t *__state, int* __restrict__ __CG_global_data__m_nproma, double* __restrict__ __CG_p_int__m_e_bln_c_s, double* __restrict__ __CG_p_int__m_geofac_n2s, double* __restrict__ __CG_p_metrics__m_coeff1_dwdz, double* __restrict__ __CG_p_metrics__m_coeff2_dwdz, double* __restrict__ __CG_p_metrics__m_ddqz_z_half, double* __restrict__ __CG_p_metrics__m_wgtfac_c, int* __restrict__ __CG_p_patch__CG_cells__CG_decomp_info__m_owner_mask, double* __restrict__ __CG_p_patch__CG_cells__m_area, int* __restrict__ __CG_p_patch__CG_cells__m_edge_blk, int* __restrict__ __CG_p_patch__CG_cells__m_edge_idx, int* __restrict__ __CG_p_patch__CG_cells__m_end_index, int* __restrict__ __CG_p_patch__CG_cells__m_neighbor_blk, int* __restrict__ __CG_p_patch__CG_cells__m_neighbor_idx, int* __restrict__ __CG_p_patch__CG_cells__m_start_index, double* __restrict__ __CG_p_prog__m_w, const double&  cfl_w_limit, const double&  dtime, const double&  scalfac_exdiff, double* __restrict__ z_kin_hor_e, double* __restrict__ z_v_grad_w, double* __restrict__ z_w_concorr_me, double* __restrict__ __CG_p_diag__m_ddt_w_adv_pc, double* __restrict__ __CG_p_diag__m_w_concorr_c, int* __restrict__ cfl_clipping, int* __restrict__ levmask, double* __restrict__ maxvcfl_arr, double* __restrict__ vcflmax, double* __restrict__ z_ekinh, double* __restrict__ z_w_con_c, double* __restrict__ z_w_con_c_full, double* __restrict__ z_w_concorr_mc, int __f2dace_A_z_kin_hor_e_d_0_s_363, int __f2dace_A_z_kin_hor_e_d_1_s_364, int __f2dace_A_z_w_concorr_me_d_0_s_360, int __f2dace_A_z_w_concorr_me_d_1_s_361, int __f2dace_OA_z_kin_hor_e_d_0_s_363, int __f2dace_OA_z_kin_hor_e_d_1_s_364, int __f2dace_OA_z_kin_hor_e_d_2_s_365, int __f2dace_OA_z_w_concorr_me_d_0_s_360, int __f2dace_OA_z_w_concorr_me_d_1_s_361, int __f2dace_OA_z_w_concorr_me_d_2_s_362, int _for_it_22, int clip_count, int i_endblk_2, int i_endblk_var_147, int i_startblk_2, int i_startblk_var_146, int nflatlev_jg, int nrdmax_jg, int64_t ntnd, int tmp_struct_symbol_0, int tmp_struct_symbol_1, int tmp_struct_symbol_10, int tmp_struct_symbol_13, int tmp_struct_symbol_14, int tmp_struct_symbol_2, int tmp_struct_symbol_4) {
...

        {
            for (auto _for_it_23 = 1; _for_it_23 < 91; _for_it_23 += 1) {
                for (auto _for_it_24 = i_startidx_var_148; _for_it_24 < (i_endidx_in_var_80_1 + 1); _for_it_24 += 1) {
                    ...
                    {
                        double p_prog_0_in_w_0 = __CG_p_prog__m_w[((((__f2dace_SA_w_d_0_s_285_p_prog_7 * ((- __f2dace_SOA_w_d_1_s_286_p_prog_7) + _for_it_23)) + ((91 * __f2dace_SA_w_d_0_s_285_p_prog_7) * ((- __f2dace_SOA_w_d_2_s_287_p_prog_7) + _for_it_22))) - __f2dace_SOA_w_d_0_s_285_p_prog_7) + _for_it_24)];
                        double z_w_con_c_out_0;
...

    {
        ...
        }
        {
            for (auto _for_it_35 = Max(3, (nrdmax_jg - 2)); _for_it_35 < 88; _for_it_35 += 1) {
                loop_body_20_1_2(__state, &__CG_p_metrics__m_ddqz_z_half[0], cfl_w_limit, dtime, &cfl_clipping[0], &levmask[0], &maxvcfl_arr[((87 * tmp_struct_symbol_4) * (_for_it_22 - 1))], &z_w_con_c[0], _for_it_22, _for_it_35, clip_count, i_endidx_in_var_80_1, i_startidx_var_148, tmp_struct_symbol_1, tmp_struct_symbol_13, tmp_struct_symbol_14);
            }
        }
...

    {
        ...
        {
            double* in_arr = &maxvcfl_arr[(((87 * i_startidx_var_148) + ((87 * tmp_struct_symbol_4) * (_for_it_22 - 1))) - 87)];
            ...
            }
            {
                for (auto _for_it_42 = 2; _for_it_42 < 91; _for_it_42 += 1) {
                    for (auto _for_it_43 = i_startidx_2; _for_it_43 < (i_endidx_in_var_80_0 + 1); _for_it_43 += 1) {
                        loop_body_31_2_11(__state, &__CG_p_int__m_e_bln_c_s[0], &__CG_p_patch__CG_cells__m_edge_blk[0], &__CG_p_patch__CG_cells__m_edge_idx[0], &z_v_grad_w[0], &__CG_p_diag__m_ddt_w_adv_pc[0], _for_it_22, _for_it_42, _for_it_43, ntnd, tmp_struct_symbol_4);
                    }
                }
            }
            {
                for (auto _for_it_44 = Max(3, (nrdmax_jg - 2)); _for_it_44 < 88; _for_it_44 += 1) {
                    loop_body_31_2_17(__state, &__CG_p_int__m_geofac_n2s[0], &__CG_p_metrics__m_ddqz_z_half[0], &__CG_p_patch__CG_cells__CG_decomp_info__m_owner_mask[0], &__CG_p_patch__CG_cells__m_area[0], &__CG_p_patch__CG_cells__m_neighbor_blk[0], &__CG_p_patch__CG_cells__m_neighbor_idx[0], &__CG_p_prog__m_w[0], &cfl_clipping[0], cfl_w_limit, dtime, &levmask[0], scalfac_exdiff, &z_w_con_c[0], &__CG_p_diag__m_ddt_w_adv_pc[0], _for_it_22, _for_it_44, i_endidx_in_var_80_0, i_startidx_2, ntnd, tmp_struct_symbol_1, tmp_struct_symbol_13, tmp_struct_symbol_14);
                }
            }
...
void __program_velocity_no_nproma_if_prop_lvn_only_0_istep_1_internal(velocity_no_nproma_if_prop_lvn_only_0_istep_1_state_t*__state, global_data_type* global_data, t_nh_diag* p_diag, t_int_state* p_int, t_nh_metrics* p_metrics, t_patch* p_patch, t_nh_prog* p_prog, double * __restrict__ z_kin_hor_e, double * __restrict__ z_vt_ie, double * __restrict__ z_w_concorr_me, int __f2dace_A_z_kin_hor_e_d_0_s_363, int __f2dace_A_z_kin_hor_e_d_1_s_364, int __f2dace_A_z_vt_ie_d_0_s_366, int __f2dace_A_z_vt_ie_d_1_s_367, int __f2dace_A_z_w_concorr_me_d_0_s_360, int __f2dace_A_z_w_concorr_me_d_1_s_361, int __f2dace_OA_z_kin_hor_e_d_0_s_363, int __f2dace_OA_z_kin_hor_e_d_1_s_364, int __f2dace_OA_z_kin_hor_e_d_2_s_365, int __f2dace_OA_z_vt_ie_d_0_s_366, int __f2dace_OA_z_vt_ie_d_1_s_367, int __f2dace_OA_z_vt_ie_d_2_s_368, int __f2dace_OA_z_w_concorr_me_d_0_s_360, int __f2dace_OA_z_w_concorr_me_d_1_s_361, int __f2dace_OA_z_w_concorr_me_d_2_s_362, int clip_count, double dt_linintp_ubc, double dtime, int istep, int ldeepatmo, int lvn_only, int ntnd)
{
    ...
    double out_val;
    double *maxvcfl_arr;
    maxvcfl_arr = new double DACE_ALIGN(64)[(((87 * tmp_struct_symbol_4) * (tmp_struct_symbol_11 - 1)) + (87 * tmp_struct_symbol_4))];
    memset(maxvcfl_arr, 0, sizeof(double)*(((87 * tmp_struct_symbol_4) * (tmp_struct_symbol_11 - 1)) + (87 * tmp_struct_symbol_4)));
    int nrdmax_jg;
    int nflatlev_jg;
