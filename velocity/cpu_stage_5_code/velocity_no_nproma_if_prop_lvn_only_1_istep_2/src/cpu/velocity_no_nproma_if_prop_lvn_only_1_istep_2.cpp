...
inline void loop_body_7_1_2(velocity_no_nproma_if_prop_lvn_only_1_istep_2_state_t *__state, double* __restrict__ __CG_p_metrics__m_ddqz_z_half, const double&  cfl_w_limit, const double&  dtime, int* __restrict__ cfl_clipping, int* __restrict__ levmask, double* __restrict__ maxvcfl_arr, double* __restrict__ z_w_con_c, int _for_it_22, int64_t _for_it_35, int clip_count, int i_endidx_in_var_80_1, int64_t i_startidx_var_148, int tmp_struct_symbol_1, int tmp_struct_symbol_13, int tmp_struct_symbol_14) {
    ...
    if ((! ((clip_count == 0) == 1))) {
        {
...

            {
                for (auto _for_it_37 = i_startidx_var_148; _for_it_37 < (i_endidx_in_var_80_1 + 1); _for_it_37 += 1) {
                    loop_body_10_0_4(__state, &__CG_p_metrics__m_ddqz_z_half[0], &cfl_clipping[0], dtime, &maxvcfl_arr[0], &z_w_con_c[0], _for_it_22, _for_it_35, _for_it_37, tmp_struct_symbol_1, tmp_struct_symbol_14);
                }
            }
            {
                int size;
...

    {
        ...
        }
        {
            for (auto _for_it_35 = Max(3, (nrdmax_jg - 2)); _for_it_35 < 88; _for_it_35 += 1) {
                loop_body_7_1_2(__state, &__CG_p_metrics__m_ddqz_z_half[0], cfl_w_limit, dtime, &cfl_clipping[0], &levmask[0], &maxvcfl_arr[((87 * tmp_struct_symbol_4) * (_for_it_22 - 1))], &z_w_con_c[0], _for_it_22, _for_it_35, clip_count, i_endidx_in_var_80_1, i_startidx_var_148, tmp_struct_symbol_1, tmp_struct_symbol_13, tmp_struct_symbol_14);
            }
        }
