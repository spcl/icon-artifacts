...
PERMUTE_CONFIGS["nlev_first"] = _make_config({
    ...
    "__CG_p_patch__CG_verts__m_cell_blk":       [2, 0, 1],
    "__CG_p_patch__CG_edges__m_cell_idx":       [2, 0, 1],
    "__CG_p_patch__CG_edges__m_cell_blk":       [2, 0, 1],
    "__CG_p_patch__CG_cells__m_edge_idx":       [2, 0, 1],
    "__CG_p_patch__CG_cells__m_edge_blk":       [2, 0, 1],
    "__CG_p_patch__CG_edges__m_vertex_idx":     [2, 0, 1],
    "__CG_p_patch__CG_edges__m_vertex_blk":     [2, 0, 1],
    "__CG_p_patch__CG_edges__m_quad_idx":       [2, 0, 1],
    "__CG_p_patch__CG_edges__m_quad_blk":       [2, 0, 1],
    "__CG_p_patch__CG_cells__m_neighbor_idx":   [2, 0, 1],
    "__CG_p_patch__CG_cells__m_neighbor_blk":   [2, 0, 1],
})
