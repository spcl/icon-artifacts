...
__dace_init_velocity_no_nproma_if_prop_lvn_only_0_istep_1(
    ...
    t_patch* p_patch,
    t_nh_prog* p_prog,
    double *__restrict__ z_kin_hor_e,
    double *__restrict__ z_vt_ie,
    double *__restrict__ z_w_concorr_me,
