...
__device__ __inline__ void reduce_maxZ_to_address_device(const double *d_in, double* d_out, int size)
{
...
__device__ __inline__ void reduce_sum_to_address_device(const int *d_in, int* d_out, int size)
{
