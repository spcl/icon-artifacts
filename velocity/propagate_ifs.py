...
sdfg1.save("if_prop_lvn_only_0_istep_1.sdfgz", compress=True)
...
sdfg2.save("if_prop_lvn_only_1_istep_1.sdfgz", compress=True)

prop_dict = {"lextra_diffu": "1", "ldeepatmo": "0", "lvn_only": "1", "istep": "0"}
print(f"Propagate for: {prop_dict}")
sdfg3 = copy.deepcopy(sdfg)
sdfg3.name = sdfg_name + "_if_prop_lvn_only_1_istep_0"
propagate_if_cond(sdfg3, sdfg3, prop_dict, verbose=True)
sdfg3.save("if_prop_lvn_only_1_istep_0.sdfgz", compress=True)

prop_dict = {"lextra_diffu": "1", "ldeepatmo": "0", "lvn_only": "0", "istep": "0"}
print(f"Propagate for: {prop_dict}")
sdfg4 = copy.deepcopy(sdfg)
sdfg4.name = sdfg_name + "_if_prop_lvn_only_0_istep_0"
propagate_if_cond(sdfg4, sdfg4, prop_dict, verbose=True)
sdfg4.save("if_prop_lvn_only_0_istep_0.sdfgz", compress=True)
