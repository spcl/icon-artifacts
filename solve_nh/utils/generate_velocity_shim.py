...
static void velocity_tendencies{gpu_suffix}(
...
static void exit_velocity_tendencies{gpu_suffix}() {{
    if (state_lvn_only_1_istep_1 != nullptr) {{
...
def _generate_velocity_shim_gpu(velocity_header: str, velocity_shim_output: str,
                            sdfgs: List[dace.SDFG], typed_inputs):
    results = parse_function_arguments(velocity_header)
    velocity_tendencies_args = list()
    velocity_lvn_only_1_istep_1_args = list()
...
if __name__ == "__main__":
    header_path = 'include/velocity_gpu.h'
    header_shim_path = 'include/velocity_shim_gpu.h'
    ...
    sdfg_paths = [
        "codegen/gpu_solve_nh_corrector_post_stage3.sdfgz",
        "codegen/gpu_solve_nh_corrector_pre_stage3.sdfgz",
        "codegen/gpu_solve_nh_predictor_pre_stage3.sdfgz",
        "codegen/gpu_solve_nh_predictor_post_stage3.sdfgz",
    ]
