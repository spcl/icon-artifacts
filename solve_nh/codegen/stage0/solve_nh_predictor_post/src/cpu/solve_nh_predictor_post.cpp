...
void __program_solve_nh_predictor_post_internal(solve_nh_predictor_post_state_t*__state, double * __restrict__ bdy_divdamp, double * __restrict__ enh_divdamp_fac, global_data_type* global_data, t_int_state* p_int, t_nh_state* p_nh, t_nh_prog* p_nh_prog_nnew, t_nh_prog* p_nh_prog_nnow, t_patch* p_patch, t_prepare_adv* prep_adv, double * __restrict__ scal_divdamp, double * __restrict__ z_alpha, double * __restrict__ z_beta, double * __restrict__ z_contr_w_fl_l, double * __restrict__ z_dexner_dz_c, double * __restrict__ z_dwdz_dd, double * __restrict__ z_exner_ex_pr, double * __restrict__ z_exner_expl, double * __restrict__ z_exner_ic, double * __restrict__ z_flxdiv_mass, double * __restrict__ z_flxdiv_theta, double * __restrict__ z_grad_rth, double * __restrict__ z_graddiv2_vn, double * __restrict__ z_graddiv_vn, double * __restrict__ z_gradh_exner, double * __restrict__ z_hydro_corr, double * __restrict__ z_kin_hor_e, double * __restrict__ z_mflx_top, double * __restrict__ z_q, double * __restrict__ z_raylfac, double * __restrict__ z_rho_e, double * __restrict__ z_rho_expl, double * __restrict__ z_rho_v, double * __restrict__ z_rth_pr, double * __restrict__ z_th_ddz_exner_c, double * __restrict__ z_theta_v_e, double * __restrict__ z_theta_v_fl_e, double * __restrict__ z_theta_v_pr_ic, double * __restrict__ z_theta_v_v, double * __restrict__ z_vn_avg, double * __restrict__ z_vt_ie, double * __restrict__ z_w_concorr_mc, double * __restrict__ z_w_concorr_me, double * __restrict__ z_w_expl, int __f2dace_OPTIONAL_lacc, double alin, double aqdr, double bqdr, double df32, double df42, double distv_bary_1, double distv_bary_2, double dt_linintp_ubc, double dt_linintp_ubc_nnew, double dt_linintp_ubc_nnow, double dt_shift, double dthalf, double dtime, double dz32, double dz42, double dzlin, double dzqdr, int i_endblk, int i_endidx, int i_startblk, int i_startidx, int idyn_timestep, int ishift, int istep, int jb, int jc, int je, int jg, int jk, int jk_start, int jks, int jstep, int l_child_vertnest, int l_init, int l_recompute, int l_vert_nested, int lacc, int lclean_mflx, int lprep_adv, int lsave_mflx, int lvn_only, int lvn_pos, int nblks_gradp, int nlen_gradp, int nlev, int nlevp1, int nnew, int nnow, int nproma_gradp, int npromz_gradp, int nshift, int nshift_total, int ntl1, int ntl2, int nvar, double r_dtimensubsteps, double r_nsubsteps, int rl_end, int rl_start, double scal_divdamp_o2, double wgt_nnew_rth, double wgt_nnew_vel, double wgt_nnow_rth, double wgt_nnow_vel, double z_a, double z_b, double z_c, double z_d_vn_dmp, double z_d_vn_iau, double z_ddt_vn_apc, double z_ddt_vn_cor, double z_ddt_vn_dyn, double z_ddt_vn_pgr, double z_ddt_vn_ray, double z_g, double z_gamma, double z_ntdistv_bary_1, double z_ntdistv_bary_2, double z_rho_tavg, double z_rho_tavg_m1, double z_theta1, double z_theta2, double z_theta_tavg, double z_theta_tavg_m1, double z_theta_v_pr_mc, double z_theta_v_pr_mc_m1, double z_w_backtraj, double zf)
{
    ...
    for (_for_it_0 = i_startblk; (_for_it_0 <= i_endblk); _for_it_0 = (_for_it_0 + 1)) {
        ...
        i_startidx_in_var_69_0 = v_v_p_patch_var_60_edges_start_index[(5 - __f2dace_SOA_start_index_d_0_s_222_edges_p_patch_10)];
        {


        }
        tmp_arg_0_0_0 = (_for_it_0 != i_startblk);
        i_endidx_in_var_70_0 = v_v_p_patch_var_60_edges_end_index[((- __f2dace_SOA_end_index_d_0_s_223_edges_p_patch_10) - 10)];
        if (tmp_arg_0_0_0) {
            {
        ...
        for (_for_it_1 = 1; (_for_it_1 <= nlev); _for_it_1 = (_for_it_1 + 1)) {
            for (_for_it_2 = i_startidx; (_for_it_2 <= i_endidx); _for_it_2 = (_for_it_2 + 1)) {
                ...
                tmp_index_83 = (v_v_p_patch_edges_quad_idx[(((((__f2dace_SA_quad_idx_d_0_s_196_edges_p_patch_10 * __f2dace_SA_quad_idx_d_1_s_197_edges_p_patch_10) * (1 - __f2dace_SOA_quad_idx_d_2_s_198_edges_p_patch_10)) + (__f2dace_SA_quad_idx_d_0_s_196_edges_p_patch_10 * ((- __f2dace_SOA_quad_idx_d_1_s_197_edges_p_patch_10) + _for_it_0))) - __f2dace_SOA_quad_idx_d_0_s_196_edges_p_patch_10) + _for_it_2)] - __f2dace_SOA_vn_d_0_s_499_p_nh_prog_nnew_16);
                {
                ...
                tmp_index_85 = (v_v_p_patch_edges_quad_blk[(((((__f2dace_SA_quad_blk_d_0_s_199_edges_p_patch_10 * __f2dace_SA_quad_blk_d_1_s_200_edges_p_patch_10) * (1 - __f2dace_SOA_quad_blk_d_2_s_201_edges_p_patch_10)) + (__f2dace_SA_quad_blk_d_0_s_199_edges_p_patch_10 * ((- __f2dace_SOA_quad_blk_d_1_s_200_edges_p_patch_10) + _for_it_0))) - __f2dace_SOA_quad_blk_d_0_s_199_edges_p_patch_10) + _for_it_2)] - __f2dace_SOA_vn_d_2_s_501_p_nh_prog_nnew_16);
                {
                ...
                tmp_index_97 = (v_v_p_patch_edges_quad_blk[(((((__f2dace_SA_quad_blk_d_0_s_199_edges_p_patch_10 * __f2dace_SA_quad_blk_d_1_s_200_edges_p_patch_10) * (2 - __f2dace_SOA_quad_blk_d_2_s_201_edges_p_patch_10)) + (__f2dace_SA_quad_blk_d_0_s_199_edges_p_patch_10 * ((- __f2dace_SOA_quad_blk_d_1_s_200_edges_p_patch_10) + _for_it_0))) - __f2dace_SOA_quad_blk_d_0_s_199_edges_p_patch_10) + _for_it_2)] - __f2dace_SOA_vn_d_2_s_501_p_nh_prog_nnew_16);
                {


                }
                tmp_index_107 = (v_v_p_patch_edges_quad_idx[(((((__f2dace_SA_quad_idx_d_0_s_196_edges_p_patch_10 * __f2dace_SA_quad_idx_d_1_s_197_edges_p_patch_10) * (3 - __f2dace_SOA_quad_idx_d_2_s_198_edges_p_patch_10)) + (__f2dace_SA_quad_idx_d_0_s_196_edges_p_patch_10 * ((- __f2dace_SOA_quad_idx_d_1_s_197_edges_p_patch_10) + _for_it_0))) - __f2dace_SOA_quad_idx_d_0_s_196_edges_p_patch_10) + _for_it_2)] - __f2dace_SOA_vn_d_0_s_499_p_nh_prog_nnew_16);
                {


                }
                tmp_index_109 = (v_v_p_patch_edges_quad_blk[(((((__f2dace_SA_quad_blk_d_0_s_199_edges_p_patch_10 * __f2dace_SA_quad_blk_d_1_s_200_edges_p_patch_10) * (3 - __f2dace_SOA_quad_blk_d_2_s_201_edges_p_patch_10)) + (__f2dace_SA_quad_blk_d_0_s_199_edges_p_patch_10 * ((- __f2dace_SOA_quad_blk_d_1_s_200_edges_p_patch_10) + _for_it_0))) - __f2dace_SOA_quad_blk_d_0_s_199_edges_p_patch_10) + _for_it_2)] - __f2dace_SOA_vn_d_2_s_501_p_nh_prog_nnew_16);
                {


                }
                tmp_index_119 = (v_v_p_patch_edges_quad_idx[(((((__f2dace_SA_quad_idx_d_0_s_196_edges_p_patch_10 * __f2dace_SA_quad_idx_d_1_s_197_edges_p_patch_10) * (4 - __f2dace_SOA_quad_idx_d_2_s_198_edges_p_patch_10)) + (__f2dace_SA_quad_idx_d_0_s_196_edges_p_patch_10 * ((- __f2dace_SOA_quad_idx_d_1_s_197_edges_p_patch_10) + _for_it_0))) - __f2dace_SOA_quad_idx_d_0_s_196_edges_p_patch_10) + _for_it_2)] - __f2dace_SOA_vn_d_0_s_499_p_nh_prog_nnew_16);
                {


                }
                tmp_index_121 = (v_v_p_patch_edges_quad_blk[(((((__f2dace_SA_quad_blk_d_0_s_199_edges_p_patch_10 * __f2dace_SA_quad_blk_d_1_s_200_edges_p_patch_10) * (4 - __f2dace_SOA_quad_blk_d_2_s_201_edges_p_patch_10)) + (__f2dace_SA_quad_blk_d_0_s_199_edges_p_patch_10 * ((- __f2dace_SOA_quad_blk_d_1_s_200_edges_p_patch_10) + _for_it_0))) - __f2dace_SOA_quad_blk_d_0_s_199_edges_p_patch_10) + _for_it_2)] - __f2dace_SOA_vn_d_2_s_501_p_nh_prog_nnew_16);
                {


                }
                tmp_index_134 = (v_v_p_patch_edges_quad_idx[(((((__f2dace_SA_quad_idx_d_0_s_196_edges_p_patch_10 * __f2dace_SA_quad_idx_d_1_s_197_edges_p_patch_10) * (1 - __f2dace_SOA_quad_idx_d_2_s_198_edges_p_patch_10)) + (__f2dace_SA_quad_idx_d_0_s_196_edges_p_patch_10 * ((- __f2dace_SOA_quad_idx_d_1_s_197_edges_p_patch_10) + _for_it_0))) - __f2dace_SOA_quad_idx_d_0_s_196_edges_p_patch_10) + _for_it_2)] - __f2dace_SOA_vn_d_0_s_499_p_nh_prog_nnew_16);
                {
                    double* v_p_int_geofac_grdiv;
                    v_p_int_geofac_grdiv = (double*)(&(p_int->geofac_grdiv)[0]);

                    {
                        double p_int_0_in_geofac_grdiv_0 = v_p_int_geofac_grdiv[(((((__f2dace_SA_geofac_grdiv_d_0_s_59_p_int_6 * __f2dace_SA_geofac_grdiv_d_1_s_60_p_int_6) * ((- __f2dace_SOA_geofac_grdiv_d_2_s_61_p_int_6) + _for_it_0)) + (__f2dace_SA_geofac_grdiv_d_0_s_59_p_int_6 * (1 - __f2dace_SOA_geofac_grdiv_d_1_s_60_p_int_6))) - __f2dace_SOA_geofac_grdiv_d_0_s_59_p_int_6) + _for_it_2)];
                        double p_int_1_in_geofac_grdiv_0 = v_p_int_geofac_grdiv[(((((__f2dace_SA_geofac_grdiv_d_0_s_59_p_int_6 * __f2dace_SA_geofac_grdiv_d_1_s_60_p_int_6) * ((- __f2dace_SOA_geofac_grdiv_d_2_s_61_p_int_6) + _for_it_0)) + (__f2dace_SA_geofac_grdiv_d_0_s_59_p_int_6 * (2 - __f2dace_SOA_geofac_grdiv_d_1_s_60_p_int_6))) - __f2dace_SOA_geofac_grdiv_d_0_s_59_p_int_6) + _for_it_2)];
                        double p_int_2_in_geofac_grdiv_0 = v_p_int_geofac_grdiv[(((((__f2dace_SA_geofac_grdiv_d_0_s_59_p_int_6 * __f2dace_SA_geofac_grdiv_d_1_s_60_p_int_6) * ((- __f2dace_SOA_geofac_grdiv_d_2_s_61_p_int_6) + _for_it_0)) + (__f2dace_SA_geofac_grdiv_d_0_s_59_p_int_6 * (3 - __f2dace_SOA_geofac_grdiv_d_1_s_60_p_int_6))) - __f2dace_SOA_geofac_grdiv_d_0_s_59_p_int_6) + _for_it_2)];
                        ...
                        double p_nh_prog_nnew_0_in_vn_0 = v_p_nh_prog_nnew_vn[(((((__f2dace_SA_vn_d_0_s_499_p_nh_prog_nnew_16 * __f2dace_SA_vn_d_1_s_500_p_nh_prog_nnew_16) * ((- __f2dace_SOA_vn_d_2_s_501_p_nh_prog_nnew_16) + _for_it_0)) + (__f2dace_SA_vn_d_0_s_499_p_nh_prog_nnew_16 * ((- __f2dace_SOA_vn_d_1_s_500_p_nh_prog_nnew_16) + _for_it_1))) - __f2dace_SOA_vn_d_0_s_499_p_nh_prog_nnew_16) + _for_it_2)];
                        double p_nh_prog_nnew_1_in_vn_0 = v_p_nh_prog_nnew_vn[((((__f2dace_SA_vn_d_0_s_499_p_nh_prog_nnew_16 * __f2dace_SA_vn_d_1_s_500_p_nh_prog_nnew_16) * tmp_index_85) + (__f2dace_SA_vn_d_0_s_499_p_nh_prog_nnew_16 * ((- __f2dace_SOA_vn_d_1_s_500_p_nh_prog_nnew_16) + _for_it_1))) + tmp_index_83)];
                        double p_nh_prog_nnew_2_in_vn_0 = v_p_nh_prog_nnew_vn[((((__f2dace_SA_vn_d_0_s_499_p_nh_prog_nnew_16 * __f2dace_SA_vn_d_1_s_500_p_nh_prog_nnew_16) * tmp_index_97) + (__f2dace_SA_vn_d_0_s_499_p_nh_prog_nnew_16 * ((- __f2dace_SOA_vn_d_1_s_500_p_nh_prog_nnew_16) + _for_it_1))) + tmp_index_95)];
                        double p_nh_prog_nnew_3_in_vn_0 = v_p_nh_prog_nnew_vn[((((__f2dace_SA_vn_d_0_s_499_p_nh_prog_nnew_16 * __f2dace_SA_vn_d_1_s_500_p_nh_prog_nnew_16) * tmp_index_109) + (__f2dace_SA_vn_d_0_s_499_p_nh_prog_nnew_16 * ((- __f2dace_SOA_vn_d_1_s_500_p_nh_prog_nnew_16) + _for_it_1))) + tmp_index_107)];
                        double p_nh_prog_nnew_4_in_vn_0 = v_p_nh_prog_nnew_vn[((((__f2dace_SA_vn_d_0_s_499_p_nh_prog_nnew_16 * __f2dace_SA_vn_d_1_s_500_p_nh_prog_nnew_16) * tmp_index_121) + (__f2dace_SA_vn_d_0_s_499_p_nh_prog_nnew_16 * ((- __f2dace_SOA_vn_d_1_s_500_p_nh_prog_nnew_16) + _for_it_1))) + tmp_index_119)];
                ...
                tmp_index_136 = (v_v_p_patch_edges_quad_blk[(((((__f2dace_SA_quad_blk_d_0_s_199_edges_p_patch_10 * __f2dace_SA_quad_blk_d_1_s_200_edges_p_patch_10) * (1 - __f2dace_SOA_quad_blk_d_2_s_201_edges_p_patch_10)) + (__f2dace_SA_quad_blk_d_0_s_199_edges_p_patch_10 * ((- __f2dace_SOA_quad_blk_d_1_s_200_edges_p_patch_10) + _for_it_0))) - __f2dace_SOA_quad_blk_d_0_s_199_edges_p_patch_10) + _for_it_2)] - __f2dace_SOA_vn_d_2_s_501_p_nh_prog_nnew_16);
                {
                ...
                tmp_index_148 = (v_v_p_patch_edges_quad_blk[(((((__f2dace_SA_quad_blk_d_0_s_199_edges_p_patch_10 * __f2dace_SA_quad_blk_d_1_s_200_edges_p_patch_10) * (2 - __f2dace_SOA_quad_blk_d_2_s_201_edges_p_patch_10)) + (__f2dace_SA_quad_blk_d_0_s_199_edges_p_patch_10 * ((- __f2dace_SOA_quad_blk_d_1_s_200_edges_p_patch_10) + _for_it_0))) - __f2dace_SOA_quad_blk_d_0_s_199_edges_p_patch_10) + _for_it_2)] - __f2dace_SOA_vn_d_2_s_501_p_nh_prog_nnew_16);
                {
                ...
                tmp_index_160 = (v_v_p_patch_edges_quad_blk[(((((__f2dace_SA_quad_blk_d_0_s_199_edges_p_patch_10 * __f2dace_SA_quad_blk_d_1_s_200_edges_p_patch_10) * (3 - __f2dace_SOA_quad_blk_d_2_s_201_edges_p_patch_10)) + (__f2dace_SA_quad_blk_d_0_s_199_edges_p_patch_10 * ((- __f2dace_SOA_quad_blk_d_1_s_200_edges_p_patch_10) + _for_it_0))) - __f2dace_SOA_quad_blk_d_0_s_199_edges_p_patch_10) + _for_it_2)] - __f2dace_SOA_vn_d_2_s_501_p_nh_prog_nnew_16);
                {


                }
                tmp_index_170 = (v_v_p_patch_edges_quad_idx[(((((__f2dace_SA_quad_idx_d_0_s_196_edges_p_patch_10 * __f2dace_SA_quad_idx_d_1_s_197_edges_p_patch_10) * (4 - __f2dace_SOA_quad_idx_d_2_s_198_edges_p_patch_10)) + (__f2dace_SA_quad_idx_d_0_s_196_edges_p_patch_10 * ((- __f2dace_SOA_quad_idx_d_1_s_197_edges_p_patch_10) + _for_it_0))) - __f2dace_SOA_quad_idx_d_0_s_196_edges_p_patch_10) + _for_it_2)] - __f2dace_SOA_vn_d_0_s_499_p_nh_prog_nnew_16);
                {
                ...
                tmp_index_172 = (v_v_p_patch_edges_quad_blk[(((((__f2dace_SA_quad_blk_d_0_s_199_edges_p_patch_10 * __f2dace_SA_quad_blk_d_1_s_200_edges_p_patch_10) * (4 - __f2dace_SOA_quad_blk_d_2_s_201_edges_p_patch_10)) + (__f2dace_SA_quad_blk_d_0_s_199_edges_p_patch_10 * ((- __f2dace_SOA_quad_blk_d_1_s_200_edges_p_patch_10) + _for_it_0))) - __f2dace_SOA_quad_blk_d_0_s_199_edges_p_patch_10) + _for_it_2)] - __f2dace_SOA_vn_d_2_s_501_p_nh_prog_nnew_16);
                {
...

                    {
                        ...
                        double p_nh_prog_nnew_0_in_vn_0 = v_p_nh_prog_nnew_vn[((((__f2dace_SA_vn_d_0_s_499_p_nh_prog_nnew_16 * __f2dace_SA_vn_d_1_s_500_p_nh_prog_nnew_16) * tmp_index_136) + (__f2dace_SA_vn_d_0_s_499_p_nh_prog_nnew_16 * ((- __f2dace_SOA_vn_d_1_s_500_p_nh_prog_nnew_16) + _for_it_1))) + tmp_index_134)];
                        double p_nh_prog_nnew_1_in_vn_0 = v_p_nh_prog_nnew_vn[((((__f2dace_SA_vn_d_0_s_499_p_nh_prog_nnew_16 * __f2dace_SA_vn_d_1_s_500_p_nh_prog_nnew_16) * tmp_index_148) + (__f2dace_SA_vn_d_0_s_499_p_nh_prog_nnew_16 * ((- __f2dace_SOA_vn_d_1_s_500_p_nh_prog_nnew_16) + _for_it_1))) + tmp_index_146)];
                        double p_nh_prog_nnew_2_in_vn_0 = v_p_nh_prog_nnew_vn[((((__f2dace_SA_vn_d_0_s_499_p_nh_prog_nnew_16 * __f2dace_SA_vn_d_1_s_500_p_nh_prog_nnew_16) * tmp_index_160) + (__f2dace_SA_vn_d_0_s_499_p_nh_prog_nnew_16 * ((- __f2dace_SOA_vn_d_1_s_500_p_nh_prog_nnew_16) + _for_it_1))) + tmp_index_158)];
                        double p_nh_prog_nnew_3_in_vn_0 = v_p_nh_prog_nnew_vn[((((__f2dace_SA_vn_d_0_s_499_p_nh_prog_nnew_16 * __f2dace_SA_vn_d_1_s_500_p_nh_prog_nnew_16) * tmp_index_172) + (__f2dace_SA_vn_d_0_s_499_p_nh_prog_nnew_16 * ((- __f2dace_SOA_vn_d_1_s_500_p_nh_prog_nnew_16) + _for_it_1))) + tmp_index_170)];
            ...
            for (_for_it_6 = i_startidx; (_for_it_6 <= i_endidx); _for_it_6 = (_for_it_6 + 1)) {
                {
...

                    {
                        ...
                        double p_nh_1_in_diag_vt_0 = v_v_p_nh_diag_vt[(((((__f2dace_SA_vt_d_0_s_580_diag_p_nh_3 * __f2dace_SA_vt_d_1_s_581_diag_p_nh_3) * ((- __f2dace_SOA_vt_d_2_s_582_diag_p_nh_3) + _for_it_0)) + (__f2dace_SA_vt_d_0_s_580_diag_p_nh_3 * ((- __f2dace_SOA_vt_d_1_s_581_diag_p_nh_3) + _for_it_5))) - __f2dace_SOA_vt_d_0_s_580_diag_p_nh_3) + _for_it_6)];
            ...
            for (_for_it_8 = i_startidx; (_for_it_8 <= i_endidx); _for_it_8 = (_for_it_8 + 1)) {
                {
                    ...
                    {
                        double p_nh_0_in_metrics_wgtfac_e_0 = v_v_p_nh_metrics_wgtfac_e[(((((__f2dace_SA_wgtfac_e_d_0_s_673_metrics_p_nh_5 * __f2dace_SA_wgtfac_e_d_1_s_674_metrics_p_nh_5) * ((- __f2dace_SOA_wgtfac_e_d_2_s_675_metrics_p_nh_5) + _for_it_0)) + (__f2dace_SA_wgtfac_e_d_0_s_673_metrics_p_nh_5 * ((- __f2dace_SOA_wgtfac_e_d_1_s_674_metrics_p_nh_5) + _for_it_7))) - __f2dace_SOA_wgtfac_e_d_0_s_673_metrics_p_nh_5) + _for_it_8)];
                        double p_nh_1_in_metrics_wgtfac_e_0 = v_v_p_nh_metrics_wgtfac_e[(((((__f2dace_SA_wgtfac_e_d_0_s_673_metrics_p_nh_5 * __f2dace_SA_wgtfac_e_d_1_s_674_metrics_p_nh_5) * ((- __f2dace_SOA_wgtfac_e_d_2_s_675_metrics_p_nh_5) + _for_it_0)) + (__f2dace_SA_wgtfac_e_d_0_s_673_metrics_p_nh_5 * ((- __f2dace_SOA_wgtfac_e_d_1_s_674_metrics_p_nh_5) + _for_it_7))) - __f2dace_SOA_wgtfac_e_d_0_s_673_metrics_p_nh_5) + _for_it_8)];
                        double p_nh_prog_nnew_0_in_vn_0 = v_p_nh_prog_nnew_vn[(((((__f2dace_SA_vn_d_0_s_499_p_nh_prog_nnew_16 * __f2dace_SA_vn_d_1_s_500_p_nh_prog_nnew_16) * ((- __f2dace_SOA_vn_d_2_s_501_p_nh_prog_nnew_16) + _for_it_0)) + (__f2dace_SA_vn_d_0_s_499_p_nh_prog_nnew_16 * ((- __f2dace_SOA_vn_d_1_s_500_p_nh_prog_nnew_16) + _for_it_7))) - __f2dace_SOA_vn_d_0_s_499_p_nh_prog_nnew_16) + _for_it_8)];
                        double p_nh_prog_nnew_1_in_vn_0 = v_p_nh_prog_nnew_vn[(((((__f2dace_SA_vn_d_0_s_499_p_nh_prog_nnew_16 * __f2dace_SA_vn_d_1_s_500_p_nh_prog_nnew_16) * ((- __f2dace_SOA_vn_d_2_s_501_p_nh_prog_nnew_16) + _for_it_0)) + (__f2dace_SA_vn_d_0_s_499_p_nh_prog_nnew_16 * (((- __f2dace_SOA_vn_d_1_s_500_p_nh_prog_nnew_16) + _for_it_7) - 1))) - __f2dace_SOA_vn_d_0_s_499_p_nh_prog_nnew_16) + _for_it_8)];
                        ...
                        v_v_p_nh_diag_vn_ie[(((((__f2dace_SA_vn_ie_d_0_s_592_diag_p_nh_3 * __f2dace_SA_vn_ie_d_1_s_593_diag_p_nh_3) * ((- __f2dace_SOA_vn_ie_d_2_s_594_diag_p_nh_3) + _for_it_0)) + (__f2dace_SA_vn_ie_d_0_s_592_diag_p_nh_3 * ((- __f2dace_SOA_vn_ie_d_1_s_593_diag_p_nh_3) + _for_it_7))) - __f2dace_SOA_vn_ie_d_0_s_592_diag_p_nh_3) + _for_it_8)] = p_nh_out_diag_vn_ie_0;
                    }
                    {
                        double p_nh_0_in_metrics_wgtfac_e_0 = v_v_p_nh_metrics_wgtfac_e[(((((__f2dace_SA_wgtfac_e_d_0_s_673_metrics_p_nh_5 * __f2dace_SA_wgtfac_e_d_1_s_674_metrics_p_nh_5) * ((- __f2dace_SOA_wgtfac_e_d_2_s_675_metrics_p_nh_5) + _for_it_0)) + (__f2dace_SA_wgtfac_e_d_0_s_673_metrics_p_nh_5 * ((- __f2dace_SOA_wgtfac_e_d_1_s_674_metrics_p_nh_5) + _for_it_7))) - __f2dace_SOA_wgtfac_e_d_0_s_673_metrics_p_nh_5) + _for_it_8)];
                        double p_nh_1_in_diag_vt_0 = v_v_p_nh_diag_vt[(((((__f2dace_SA_vt_d_0_s_580_diag_p_nh_3 * __f2dace_SA_vt_d_1_s_581_diag_p_nh_3) * ((- __f2dace_SOA_vt_d_2_s_582_diag_p_nh_3) + _for_it_0)) + (__f2dace_SA_vt_d_0_s_580_diag_p_nh_3 * ((- __f2dace_SOA_vt_d_1_s_581_diag_p_nh_3) + _for_it_7))) - __f2dace_SOA_vt_d_0_s_580_diag_p_nh_3) + _for_it_8)];
                        double p_nh_2_in_metrics_wgtfac_e_0 = v_v_p_nh_metrics_wgtfac_e[(((((__f2dace_SA_wgtfac_e_d_0_s_673_metrics_p_nh_5 * __f2dace_SA_wgtfac_e_d_1_s_674_metrics_p_nh_5) * ((- __f2dace_SOA_wgtfac_e_d_2_s_675_metrics_p_nh_5) + _for_it_0)) + (__f2dace_SA_wgtfac_e_d_0_s_673_metrics_p_nh_5 * ((- __f2dace_SOA_wgtfac_e_d_1_s_674_metrics_p_nh_5) + _for_it_7))) - __f2dace_SOA_wgtfac_e_d_0_s_673_metrics_p_nh_5) + _for_it_8)];
                        double p_nh_3_in_diag_vt_0 = v_v_p_nh_diag_vt[(((((__f2dace_SA_vt_d_0_s_580_diag_p_nh_3 * __f2dace_SA_vt_d_1_s_581_diag_p_nh_3) * ((- __f2dace_SOA_vt_d_2_s_582_diag_p_nh_3) + _for_it_0)) + (__f2dace_SA_vt_d_0_s_580_diag_p_nh_3 * (((- __f2dace_SOA_vt_d_1_s_581_diag_p_nh_3) + _for_it_7) - 1))) - __f2dace_SOA_vt_d_0_s_580_diag_p_nh_3) + _for_it_8)];
                ...
                }
                {
                    ...
                    {
                        double p_nh_0_in_diag_vt_0 = v_v_p_nh_diag_vt[(((((__f2dace_SA_vt_d_0_s_580_diag_p_nh_3 * __f2dace_SA_vt_d_1_s_581_diag_p_nh_3) * ((- __f2dace_SOA_vt_d_2_s_582_diag_p_nh_3) + _for_it_0)) + (__f2dace_SA_vt_d_0_s_580_diag_p_nh_3 * ((- __f2dace_SOA_vt_d_1_s_581_diag_p_nh_3) + _for_it_7))) - __f2dace_SOA_vt_d_0_s_580_diag_p_nh_3) + _for_it_8)];
            ...
            for (_for_it_9 = i_startidx; (_for_it_9 <= i_endidx); _for_it_9 = (_for_it_9 + 1)) {
                {
                    ...
                    {
                        double p_nh_0_in_diag_vt_0 = v_v_p_nh_diag_vt[(((((__f2dace_SA_vt_d_0_s_580_diag_p_nh_3 * __f2dace_SA_vt_d_1_s_581_diag_p_nh_3) * ((- __f2dace_SOA_vt_d_2_s_582_diag_p_nh_3) + _for_it_0)) + (__f2dace_SA_vt_d_0_s_580_diag_p_nh_3 * (1 - __f2dace_SOA_vt_d_1_s_581_diag_p_nh_3))) - __f2dace_SOA_vt_d_0_s_580_diag_p_nh_3) + _for_it_9)];
                        double z_vt_ie_out_0;
                ...
                tmp_index_270 = (nlevp1 - __f2dace_SOA_vn_ie_d_1_s_593_diag_p_nh_3);
                tmp_index_276 = (nlev - __f2dace_SOA_vn_d_1_s_500_p_nh_prog_nnew_16);
                tmp_index_282 = ((nlev - 1) - __f2dace_SOA_vn_d_1_s_500_p_nh_prog_nnew_16);
                tmp_index_288 = ((nlev - 2) - __f2dace_SOA_vn_d_1_s_500_p_nh_prog_nnew_16);
                {
                    double tmp_call_4;
                    double tmp_call_3;
                ...
                }
                {

                    {
                        ...
                        double p_nh_prog_nnew_0_in_vn_0 = v_p_nh_prog_nnew_vn[(((((__f2dace_SA_vn_d_0_s_499_p_nh_prog_nnew_16 * __f2dace_SA_vn_d_1_s_500_p_nh_prog_nnew_16) * ((- __f2dace_SOA_vn_d_2_s_501_p_nh_prog_nnew_16) + _for_it_0)) + (__f2dace_SA_vn_d_0_s_499_p_nh_prog_nnew_16 * tmp_index_276)) - __f2dace_SOA_vn_d_0_s_499_p_nh_prog_nnew_16) + _for_it_9)];
                        double p_nh_prog_nnew_1_in_vn_0 = v_p_nh_prog_nnew_vn[(((((__f2dace_SA_vn_d_0_s_499_p_nh_prog_nnew_16 * __f2dace_SA_vn_d_1_s_500_p_nh_prog_nnew_16) * ((- __f2dace_SOA_vn_d_2_s_501_p_nh_prog_nnew_16) + _for_it_0)) + (__f2dace_SA_vn_d_0_s_499_p_nh_prog_nnew_16 * tmp_index_282)) - __f2dace_SOA_vn_d_0_s_499_p_nh_prog_nnew_16) + _for_it_9)];
                        double p_nh_prog_nnew_2_in_vn_0 = v_p_nh_prog_nnew_vn[(((((__f2dace_SA_vn_d_0_s_499_p_nh_prog_nnew_16 * __f2dace_SA_vn_d_1_s_500_p_nh_prog_nnew_16) * ((- __f2dace_SOA_vn_d_2_s_501_p_nh_prog_nnew_16) + _for_it_0)) + (__f2dace_SA_vn_d_0_s_499_p_nh_prog_nnew_16 * tmp_index_288)) - __f2dace_SOA_vn_d_0_s_499_p_nh_prog_nnew_16) + _for_it_9)];
                        double p_nh_out_diag_vn_ie_0;
                        ...
                        v_v_p_nh_diag_vn_ie[(((((__f2dace_SA_vn_ie_d_0_s_592_diag_p_nh_3 * __f2dace_SA_vn_ie_d_1_s_593_diag_p_nh_3) * ((- __f2dace_SOA_vn_ie_d_2_s_594_diag_p_nh_3) + _for_it_0)) + (__f2dace_SA_vn_ie_d_0_s_592_diag_p_nh_3 * tmp_index_270)) - __f2dace_SOA_vn_ie_d_0_s_592_diag_p_nh_3) + _for_it_9)] = p_nh_out_diag_vn_ie_0;
                    }
            ...
            for (_for_it_10 = i_startidx; (_for_it_10 <= i_endidx); _for_it_10 = (_for_it_10 + 1)) {
                {
                    ...
                    {
                        double p_nh_0_in_diag_vt_0 = v_v_p_nh_diag_vt[(((((__f2dace_SA_vt_d_0_s_580_diag_p_nh_3 * __f2dace_SA_vt_d_1_s_581_diag_p_nh_3) * ((- __f2dace_SOA_vt_d_2_s_582_diag_p_nh_3) + _for_it_0)) + (__f2dace_SA_vt_d_0_s_580_diag_p_nh_3 * (1 - __f2dace_SOA_vt_d_1_s_581_diag_p_nh_3))) - __f2dace_SOA_vt_d_0_s_580_diag_p_nh_3) + _for_it_10)];
                        double z_vt_ie_out_0;
                ...
                tmp_index_315 = (nlevp1 - __f2dace_SOA_vn_ie_d_1_s_593_diag_p_nh_3);
                tmp_index_321 = (nlev - __f2dace_SOA_vn_d_1_s_500_p_nh_prog_nnew_16);
                tmp_index_327 = ((nlev - 1) - __f2dace_SOA_vn_d_1_s_500_p_nh_prog_nnew_16);
                tmp_index_333 = ((nlev - 2) - __f2dace_SOA_vn_d_1_s_500_p_nh_prog_nnew_16);
                {
                    double tmp_call_6;
                    double tmp_call_5;
                ...
                }
                {

                    {
                        ...
                        double p_nh_prog_nnew_0_in_vn_0 = v_p_nh_prog_nnew_vn[(((((__f2dace_SA_vn_d_0_s_499_p_nh_prog_nnew_16 * __f2dace_SA_vn_d_1_s_500_p_nh_prog_nnew_16) * ((- __f2dace_SOA_vn_d_2_s_501_p_nh_prog_nnew_16) + _for_it_0)) + (__f2dace_SA_vn_d_0_s_499_p_nh_prog_nnew_16 * tmp_index_321)) - __f2dace_SOA_vn_d_0_s_499_p_nh_prog_nnew_16) + _for_it_10)];
                        double p_nh_prog_nnew_1_in_vn_0 = v_p_nh_prog_nnew_vn[(((((__f2dace_SA_vn_d_0_s_499_p_nh_prog_nnew_16 * __f2dace_SA_vn_d_1_s_500_p_nh_prog_nnew_16) * ((- __f2dace_SOA_vn_d_2_s_501_p_nh_prog_nnew_16) + _for_it_0)) + (__f2dace_SA_vn_d_0_s_499_p_nh_prog_nnew_16 * tmp_index_327)) - __f2dace_SOA_vn_d_0_s_499_p_nh_prog_nnew_16) + _for_it_10)];
                        double p_nh_prog_nnew_2_in_vn_0 = v_p_nh_prog_nnew_vn[(((((__f2dace_SA_vn_d_0_s_499_p_nh_prog_nnew_16 * __f2dace_SA_vn_d_1_s_500_p_nh_prog_nnew_16) * ((- __f2dace_SOA_vn_d_2_s_501_p_nh_prog_nnew_16) + _for_it_0)) + (__f2dace_SA_vn_d_0_s_499_p_nh_prog_nnew_16 * tmp_index_333)) - __f2dace_SOA_vn_d_0_s_499_p_nh_prog_nnew_16) + _for_it_10)];
                        double p_nh_out_diag_vn_ie_0;
                        ...
                        v_v_p_nh_diag_vn_ie[(((((__f2dace_SA_vn_ie_d_0_s_592_diag_p_nh_3 * __f2dace_SA_vn_ie_d_1_s_593_diag_p_nh_3) * ((- __f2dace_SOA_vn_ie_d_2_s_594_diag_p_nh_3) + _for_it_0)) + (__f2dace_SA_vn_ie_d_0_s_592_diag_p_nh_3 * tmp_index_315)) - __f2dace_SOA_vn_ie_d_0_s_592_diag_p_nh_3) + _for_it_10)] = p_nh_out_diag_vn_ie_0;
                    }
        ...
        for (_for_it_11 = 1; (_for_it_11 <= *v_v_p_nh_metrics_bdy_mflx_e_dim); _for_it_11 = (_for_it_11 + 1)) {
            {
                ...
                {
                    int p_nh_0_in_metrics_bdy_mflx_e_idx_0 = v_v_p_nh_metrics_bdy_mflx_e_idx[((- __f2dace_SOA_bdy_mflx_e_idx_d_0_s_740_metrics_p_nh_5) + _for_it_11)];
                    int je_out;
            ...
            }
            {
                ...
                {
                    int p_nh_0_in_metrics_bdy_mflx_e_blk_0 = v_v_p_nh_metrics_bdy_mflx_e_blk[((- __f2dace_SOA_bdy_mflx_e_blk_d_0_s_741_metrics_p_nh_5) + _for_it_11)];
                    int jb_out;
            ...
            for (_for_it_12 = 1; (_for_it_12 <= nlev); _for_it_12 = (_for_it_12 + 1)) {
                ...
                tmp_index_337 = (je - __f2dace_SOA_mass_fl_e_d_0_s_514_diag_p_nh_3);
                tmp_index_339 = (jb - __f2dace_SOA_mass_fl_e_d_2_s_516_diag_p_nh_3);
                tmp_index_346 = (je - 1);
                tmp_index_348 = (jb - 1);
                tmp_index_349 = (je - __f2dace_SOA_mass_fl_e_d_0_s_514_diag_p_nh_3);
                tmp_index_351 = (jb - __f2dace_SOA_mass_fl_e_d_2_s_516_diag_p_nh_3);
                tmp_index_352 = (je - 1);
                tmp_index_354 = (jb - 1);
                {
...

                    {
                        ...
                        v_v_p_nh_diag_mass_fl_e[((((__f2dace_SA_mass_fl_e_d_0_s_514_diag_p_nh_3 * __f2dace_SA_mass_fl_e_d_1_s_515_diag_p_nh_3) * tmp_index_339) + (__f2dace_SA_mass_fl_e_d_0_s_514_diag_p_nh_3 * ((- __f2dace_SOA_mass_fl_e_d_1_s_515_diag_p_nh_3) + _for_it_12))) + tmp_index_337)] = p_nh_out_diag_mass_fl_e_0;
                    }
                    {
                        double p_nh_0_in_diag_mass_fl_e_0 = v_v_p_nh_diag_mass_fl_e[((((__f2dace_SA_mass_fl_e_d_0_s_514_diag_p_nh_3 * __f2dace_SA_mass_fl_e_d_1_s_515_diag_p_nh_3) * tmp_index_351) + (__f2dace_SA_mass_fl_e_d_0_s_514_diag_p_nh_3 * ((- __f2dace_SOA_mass_fl_e_d_1_s_515_diag_p_nh_3) + _for_it_12))) + tmp_index_349)];
    ...
    for (_for_it_13 = i_startblk; (_for_it_13 <= i_endblk); _for_it_13 = (_for_it_13 + 1)) {
        ...
        i_startidx_in_var_57_2 = v_v_p_patch_var_48_cells_start_index[(3 - __f2dace_SOA_start_index_d_0_s_174_cells_p_patch_8)];
        {


        }
        i_endidx_in_var_58_2 = v_v_p_patch_var_48_cells_end_index[((- __f2dace_SOA_end_index_d_0_s_175_cells_p_patch_8) - 5)];
        ...
        for (_for_it_18 = i_startidx; (_for_it_18 <= i_endidx); _for_it_18 = (_for_it_18 + 1)) {
            ...
            tmp_index_411 = (nlevp1 - __f2dace_SOA_w_concorr_c_d_1_s_596_diag_p_nh_3);
            ...
            tmp_index_427 = ((nlev - 2) - 1);
            {
...

                {
                    ...
                    v_v_p_nh_diag_w_concorr_c[(((((__f2dace_SA_w_concorr_c_d_0_s_595_diag_p_nh_3 * __f2dace_SA_w_concorr_c_d_1_s_596_diag_p_nh_3) * ((- __f2dace_SOA_w_concorr_c_d_2_s_597_diag_p_nh_3) + _for_it_13)) + (__f2dace_SA_w_concorr_c_d_0_s_595_diag_p_nh_3 * tmp_index_411)) - __f2dace_SOA_w_concorr_c_d_0_s_595_diag_p_nh_3) + _for_it_18)] = p_nh_out_diag_w_concorr_c_0;
                }
    ...
    for (_for_it_19 = i_startblk; (_for_it_19 <= i_endblk); _for_it_19 = (_for_it_19 + 1)) {
        ...
        i_startidx_in_var_57_1 = v_v_p_patch_var_48_cells_start_index[(5 - __f2dace_SOA_start_index_d_0_s_174_cells_p_patch_8)];
        {


        }
        i_endidx_in_var_58_1 = v_v_p_patch_var_48_cells_end_index[((- __f2dace_SOA_end_index_d_0_s_175_cells_p_patch_8) - 4)];
        ...
        for (_for_it_20 = 1; (_for_it_20 <= nlev); _for_it_20 = (_for_it_20 + 1)) {
            for (_for_it_21 = i_startidx; (_for_it_21 <= i_endidx); _for_it_21 = (_for_it_21 + 1)) {
                ...
                tmp_index_439 = (v_v_p_patch_cells_edge_idx[(((((__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_8 * __f2dace_SA_edge_idx_d_1_s_167_cells_p_patch_8) * (1 - __f2dace_SOA_edge_idx_d_2_s_168_cells_p_patch_8)) + (__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_8 * ((- __f2dace_SOA_edge_idx_d_1_s_167_cells_p_patch_8) + _for_it_19))) - __f2dace_SOA_edge_idx_d_0_s_166_cells_p_patch_8) + _for_it_21)] - __f2dace_SOA_mass_fl_e_d_0_s_514_diag_p_nh_3);
                {


                }
                tmp_index_441 = (v_v_p_patch_cells_edge_blk[(((((__f2dace_SA_edge_blk_d_0_s_169_cells_p_patch_8 * __f2dace_SA_edge_blk_d_1_s_170_cells_p_patch_8) * (1 - __f2dace_SOA_edge_blk_d_2_s_171_cells_p_patch_8)) + (__f2dace_SA_edge_blk_d_0_s_169_cells_p_patch_8 * ((- __f2dace_SOA_edge_blk_d_1_s_170_cells_p_patch_8) + _for_it_19))) - __f2dace_SOA_edge_blk_d_0_s_169_cells_p_patch_8) + _for_it_21)] - __f2dace_SOA_mass_fl_e_d_2_s_516_diag_p_nh_3);
                {


                }
                tmp_index_451 = (v_v_p_patch_cells_edge_idx[(((((__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_8 * __f2dace_SA_edge_idx_d_1_s_167_cells_p_patch_8) * (2 - __f2dace_SOA_edge_idx_d_2_s_168_cells_p_patch_8)) + (__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_8 * ((- __f2dace_SOA_edge_idx_d_1_s_167_cells_p_patch_8) + _for_it_19))) - __f2dace_SOA_edge_idx_d_0_s_166_cells_p_patch_8) + _for_it_21)] - __f2dace_SOA_mass_fl_e_d_0_s_514_diag_p_nh_3);
                {
                ...
                tmp_index_465 = (v_v_p_patch_cells_edge_blk[(((((__f2dace_SA_edge_blk_d_0_s_169_cells_p_patch_8 * __f2dace_SA_edge_blk_d_1_s_170_cells_p_patch_8) * (3 - __f2dace_SOA_edge_blk_d_2_s_171_cells_p_patch_8)) + (__f2dace_SA_edge_blk_d_0_s_169_cells_p_patch_8 * ((- __f2dace_SOA_edge_blk_d_1_s_170_cells_p_patch_8) + _for_it_19))) - __f2dace_SOA_edge_blk_d_0_s_169_cells_p_patch_8) + _for_it_21)] - __f2dace_SOA_mass_fl_e_d_2_s_516_diag_p_nh_3);
                {


                }
                tmp_index_478 = (v_v_p_patch_cells_edge_idx[(((((__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_8 * __f2dace_SA_edge_idx_d_1_s_167_cells_p_patch_8) * (1 - __f2dace_SOA_edge_idx_d_2_s_168_cells_p_patch_8)) + (__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_8 * ((- __f2dace_SOA_edge_idx_d_1_s_167_cells_p_patch_8) + _for_it_19))) - __f2dace_SOA_edge_idx_d_0_s_166_cells_p_patch_8) + _for_it_21)] - 1);
                {

                    {
                        ...
                        double p_int_1_in_geofac_div_0 = v_p_int_geofac_div[(((((__f2dace_SA_geofac_div_d_0_s_56_p_int_6 * __f2dace_SA_geofac_div_d_1_s_57_p_int_6) * ((- __f2dace_SOA_geofac_div_d_2_s_58_p_int_6) + _for_it_19)) + (__f2dace_SA_geofac_div_d_0_s_56_p_int_6 * (2 - __f2dace_SOA_geofac_div_d_1_s_57_p_int_6))) - __f2dace_SOA_geofac_div_d_0_s_56_p_int_6) + _for_it_21)];
                        double p_int_2_in_geofac_div_0 = v_p_int_geofac_div[(((((__f2dace_SA_geofac_div_d_0_s_56_p_int_6 * __f2dace_SA_geofac_div_d_1_s_57_p_int_6) * ((- __f2dace_SOA_geofac_div_d_2_s_58_p_int_6) + _for_it_19)) + (__f2dace_SA_geofac_div_d_0_s_56_p_int_6 * (3 - __f2dace_SOA_geofac_div_d_1_s_57_p_int_6))) - __f2dace_SOA_geofac_div_d_0_s_56_p_int_6) + _for_it_21)];
                        double p_nh_0_in_metrics_deepatmo_divh_mc_0 = v_v_p_nh_metrics_deepatmo_divh_mc[((- __f2dace_SOA_deepatmo_divh_mc_d_0_s_743_metrics_p_nh_5) + _for_it_20)];
                        double p_nh_1_in_diag_mass_fl_e_0 = v_v_p_nh_diag_mass_fl_e[((((__f2dace_SA_mass_fl_e_d_0_s_514_diag_p_nh_3 * __f2dace_SA_mass_fl_e_d_1_s_515_diag_p_nh_3) * tmp_index_441) + (__f2dace_SA_mass_fl_e_d_0_s_514_diag_p_nh_3 * ((- __f2dace_SOA_mass_fl_e_d_1_s_515_diag_p_nh_3) + _for_it_20))) + tmp_index_439)];
                        double p_nh_2_in_diag_mass_fl_e_0 = v_v_p_nh_diag_mass_fl_e[((((__f2dace_SA_mass_fl_e_d_0_s_514_diag_p_nh_3 * __f2dace_SA_mass_fl_e_d_1_s_515_diag_p_nh_3) * tmp_index_453) + (__f2dace_SA_mass_fl_e_d_0_s_514_diag_p_nh_3 * ((- __f2dace_SOA_mass_fl_e_d_1_s_515_diag_p_nh_3) + _for_it_20))) + tmp_index_451)];
                        double p_nh_3_in_diag_mass_fl_e_0 = v_v_p_nh_diag_mass_fl_e[((((__f2dace_SA_mass_fl_e_d_0_s_514_diag_p_nh_3 * __f2dace_SA_mass_fl_e_d_1_s_515_diag_p_nh_3) * tmp_index_465) + (__f2dace_SA_mass_fl_e_d_0_s_514_diag_p_nh_3 * ((- __f2dace_SOA_mass_fl_e_d_1_s_515_diag_p_nh_3) + _for_it_20))) + tmp_index_463)];
                ...
                tmp_index_480 = (v_v_p_patch_cells_edge_blk[(((((__f2dace_SA_edge_blk_d_0_s_169_cells_p_patch_8 * __f2dace_SA_edge_blk_d_1_s_170_cells_p_patch_8) * (1 - __f2dace_SOA_edge_blk_d_2_s_171_cells_p_patch_8)) + (__f2dace_SA_edge_blk_d_0_s_169_cells_p_patch_8 * ((- __f2dace_SOA_edge_blk_d_1_s_170_cells_p_patch_8) + _for_it_19))) - __f2dace_SOA_edge_blk_d_0_s_169_cells_p_patch_8) + _for_it_21)] - 1);
                {


                }
                tmp_index_490 = (v_v_p_patch_cells_edge_idx[(((((__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_8 * __f2dace_SA_edge_idx_d_1_s_167_cells_p_patch_8) * (2 - __f2dace_SOA_edge_idx_d_2_s_168_cells_p_patch_8)) + (__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_8 * ((- __f2dace_SOA_edge_idx_d_1_s_167_cells_p_patch_8) + _for_it_19))) - __f2dace_SOA_edge_idx_d_0_s_166_cells_p_patch_8) + _for_it_21)] - 1);
                {


                }
                tmp_index_492 = (v_v_p_patch_cells_edge_blk[(((((__f2dace_SA_edge_blk_d_0_s_169_cells_p_patch_8 * __f2dace_SA_edge_blk_d_1_s_170_cells_p_patch_8) * (2 - __f2dace_SOA_edge_blk_d_2_s_171_cells_p_patch_8)) + (__f2dace_SA_edge_blk_d_0_s_169_cells_p_patch_8 * ((- __f2dace_SOA_edge_blk_d_1_s_170_cells_p_patch_8) + _for_it_19))) - __f2dace_SOA_edge_blk_d_0_s_169_cells_p_patch_8) + _for_it_21)] - 1);
                {


                }
                tmp_index_502 = (v_v_p_patch_cells_edge_idx[(((((__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_8 * __f2dace_SA_edge_idx_d_1_s_167_cells_p_patch_8) * (3 - __f2dace_SOA_edge_idx_d_2_s_168_cells_p_patch_8)) + (__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_8 * ((- __f2dace_SOA_edge_idx_d_1_s_167_cells_p_patch_8) + _for_it_19))) - __f2dace_SOA_edge_idx_d_0_s_166_cells_p_patch_8) + _for_it_21)] - 1);
                {


                }
                tmp_index_504 = (v_v_p_patch_cells_edge_blk[(((((__f2dace_SA_edge_blk_d_0_s_169_cells_p_patch_8 * __f2dace_SA_edge_blk_d_1_s_170_cells_p_patch_8) * (3 - __f2dace_SOA_edge_blk_d_2_s_171_cells_p_patch_8)) + (__f2dace_SA_edge_blk_d_0_s_169_cells_p_patch_8 * ((- __f2dace_SOA_edge_blk_d_1_s_170_cells_p_patch_8) + _for_it_19))) - __f2dace_SOA_edge_blk_d_0_s_169_cells_p_patch_8) + _for_it_21)] - 1);
                {
            ...
            for (_for_it_22 = i_startidx; (_for_it_22 <= i_endidx); _for_it_22 = (_for_it_22 + 1)) {
                {
...

                    {
                        ...
                        v_v_p_nh_diag_theta_v_ic[(((((__f2dace_SA_theta_v_ic_d_0_s_520_diag_p_nh_3 * __f2dace_SA_theta_v_ic_d_1_s_521_diag_p_nh_3) * ((- __f2dace_SOA_theta_v_ic_d_2_s_522_diag_p_nh_3) + _for_it_19)) + (__f2dace_SA_theta_v_ic_d_0_s_520_diag_p_nh_3 * (1 - __f2dace_SOA_theta_v_ic_d_1_s_521_diag_p_nh_3))) - __f2dace_SOA_theta_v_ic_d_0_s_520_diag_p_nh_3) + _for_it_22)] = p_nh_out_diag_theta_v_ic_0;
                    }
                    {
                        double dt_linintp_ubc_0_in = dt_linintp_ubc;
                        double p_nh_0_in_diag_rho_ic_ubc_0 = v_v_p_nh_diag_rho_ic_ubc[(((((__f2dace_SA_rho_ic_ubc_d_0_s_562_diag_p_nh_3 * __f2dace_SA_rho_ic_ubc_d_1_s_563_diag_p_nh_3) * (1 - __f2dace_SOA_rho_ic_ubc_d_2_s_564_diag_p_nh_3)) + (__f2dace_SA_rho_ic_ubc_d_0_s_562_diag_p_nh_3 * ((- __f2dace_SOA_rho_ic_ubc_d_1_s_563_diag_p_nh_3) + _for_it_19))) - __f2dace_SOA_rho_ic_ubc_d_0_s_562_diag_p_nh_3) + _for_it_22)];
                        double p_nh_1_in_diag_rho_ic_ubc_0 = v_v_p_nh_diag_rho_ic_ubc[(((((__f2dace_SA_rho_ic_ubc_d_0_s_562_diag_p_nh_3 * __f2dace_SA_rho_ic_ubc_d_1_s_563_diag_p_nh_3) * (2 - __f2dace_SOA_rho_ic_ubc_d_2_s_564_diag_p_nh_3)) + (__f2dace_SA_rho_ic_ubc_d_0_s_562_diag_p_nh_3 * ((- __f2dace_SOA_rho_ic_ubc_d_1_s_563_diag_p_nh_3) + _for_it_19))) - __f2dace_SOA_rho_ic_ubc_d_0_s_562_diag_p_nh_3) + _for_it_22)];
                        ...
                        v_v_p_nh_diag_rho_ic[(((((__f2dace_SA_rho_ic_d_0_s_517_diag_p_nh_3 * __f2dace_SA_rho_ic_d_1_s_518_diag_p_nh_3) * ((- __f2dace_SOA_rho_ic_d_2_s_519_diag_p_nh_3) + _for_it_19)) + (__f2dace_SA_rho_ic_d_0_s_517_diag_p_nh_3 * (1 - __f2dace_SOA_rho_ic_d_1_s_518_diag_p_nh_3))) - __f2dace_SOA_rho_ic_d_0_s_517_diag_p_nh_3) + _for_it_22)] = p_nh_out_diag_rho_ic_0;
                    }
                    {
                        double dt_linintp_ubc_0_in = dt_linintp_ubc;
                        double p_nh_0_in_diag_mflx_ic_ubc_0 = v_v_p_nh_diag_mflx_ic_ubc[(((((__f2dace_SA_mflx_ic_ubc_d_0_s_568_diag_p_nh_3 * __f2dace_SA_mflx_ic_ubc_d_1_s_569_diag_p_nh_3) * (1 - __f2dace_SOA_mflx_ic_ubc_d_2_s_570_diag_p_nh_3)) + (__f2dace_SA_mflx_ic_ubc_d_0_s_568_diag_p_nh_3 * ((- __f2dace_SOA_mflx_ic_ubc_d_1_s_569_diag_p_nh_3) + _for_it_19))) - __f2dace_SOA_mflx_ic_ubc_d_0_s_568_diag_p_nh_3) + _for_it_22)];
                        double p_nh_1_in_diag_mflx_ic_ubc_0 = v_v_p_nh_diag_mflx_ic_ubc[(((((__f2dace_SA_mflx_ic_ubc_d_0_s_568_diag_p_nh_3 * __f2dace_SA_mflx_ic_ubc_d_1_s_569_diag_p_nh_3) * (2 - __f2dace_SOA_mflx_ic_ubc_d_2_s_570_diag_p_nh_3)) + (__f2dace_SA_mflx_ic_ubc_d_0_s_568_diag_p_nh_3 * ((- __f2dace_SOA_mflx_ic_ubc_d_1_s_569_diag_p_nh_3) + _for_it_19))) - __f2dace_SOA_mflx_ic_ubc_d_0_s_568_diag_p_nh_3) + _for_it_22)];
        ...
        for (_for_it_23 = 2; (_for_it_23 <= nlev); _for_it_23 = (_for_it_23 + 1)) {
            for (_for_it_24 = i_startidx; (_for_it_24 <= i_endidx); _for_it_24 = (_for_it_24 + 1)) {
                ...
                tmp_index_542 = (ntl1 - __f2dace_SOA_ddt_w_adv_pc_d_3_s_612_diag_p_nh_3);
                {
                ...
                }
                {

                    {
                        ...
                        double p_nh_1_in_metrics_vwind_expl_wgt_0 = v_v_p_nh_metrics_vwind_expl_wgt[(((__f2dace_SA_vwind_expl_wgt_d_0_s_651_metrics_p_nh_5 * ((- __f2dace_SOA_vwind_expl_wgt_d_1_s_652_metrics_p_nh_5) + _for_it_19)) - __f2dace_SOA_vwind_expl_wgt_d_0_s_651_metrics_p_nh_5) + _for_it_24)];
            ...
            for (_for_it_26 = i_startidx; (_for_it_26 <= i_endidx); _for_it_26 = (_for_it_26 + 1)) {
                {

                    {
                        ...
                        double p_nh_prog_nnow_1_in_rho_0 = v_p_nh_prog_nnow_rho[(((((__f2dace_SA_rho_d_0_s_502_p_nh_prog_nnow_15 * __f2dace_SA_rho_d_1_s_503_p_nh_prog_nnow_15) * ((- __f2dace_SOA_rho_d_2_s_504_p_nh_prog_nnew_16) + _for_it_19)) + (__f2dace_SA_rho_d_0_s_502_p_nh_prog_nnow_15 * ((- __f2dace_SOA_rho_d_1_s_503_p_nh_prog_nnew_16) + _for_it_25))) - __f2dace_SOA_rho_d_0_s_502_p_nh_prog_nnew_16) + _for_it_26)];
                ...
                }
                {
                    ...
                    {
                        double p_nh_0_in_metrics_vwind_impl_wgt_0 = v_v_p_nh_metrics_vwind_impl_wgt[(((__f2dace_SA_vwind_impl_wgt_d_0_s_653_metrics_p_nh_5 * ((- __f2dace_SOA_vwind_impl_wgt_d_1_s_654_metrics_p_nh_5) + _for_it_19)) - __f2dace_SOA_vwind_impl_wgt_d_0_s_653_metrics_p_nh_5) + _for_it_26)];
            ...
            for (_for_it_28 = i_startidx; (_for_it_28 <= i_endidx); _for_it_28 = (_for_it_28 + 1)) {
                {

                    {
                        ...
                        v_p_nh_prog_nnew_w[(((((__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * __f2dace_SA_w_d_1_s_497_p_nh_prog_nnew_16) * ((- __f2dace_SOA_w_d_2_s_498_p_nh_prog_nnew_16) + _for_it_19)) + (__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * (1 - __f2dace_SOA_w_d_1_s_497_p_nh_prog_nnew_16))) - __f2dace_SOA_w_d_0_s_496_p_nh_prog_nnew_16) + _for_it_28)] = p_nh_prog_nnew_out_w_0;
                    }
                    {
                        double z_contr_w_fl_l_out_0;
            ...
            for (_for_it_29 = i_startidx; (_for_it_29 <= i_endidx); _for_it_29 = (_for_it_29 + 1)) {
                {
                    ...
                    {
                        double p_nh_0_in_metrics_vwind_expl_wgt_0 = v_v_p_nh_metrics_vwind_expl_wgt[(((__f2dace_SA_vwind_expl_wgt_d_0_s_651_metrics_p_nh_5 * ((- __f2dace_SOA_vwind_expl_wgt_d_1_s_652_metrics_p_nh_5) + _for_it_19)) - __f2dace_SOA_vwind_expl_wgt_d_0_s_651_metrics_p_nh_5) + _for_it_29)];
        ...
        for (_for_it_30 = i_startidx; (_for_it_30 <= i_endidx); _for_it_30 = (_for_it_30 + 1)) {
            ...
            tmp_index_608 = (nlevp1 - __f2dace_SOA_w_d_1_s_497_p_nh_prog_nnew_16);
            tmp_index_611 = (nlevp1 - __f2dace_SOA_w_concorr_c_d_1_s_596_diag_p_nh_3);
            tmp_index_614 = (nlevp1 - 1);
            {

                {
                    double p_nh_0_in_diag_w_concorr_c_0 = v_v_p_nh_diag_w_concorr_c[(((((__f2dace_SA_w_concorr_c_d_0_s_595_diag_p_nh_3 * __f2dace_SA_w_concorr_c_d_1_s_596_diag_p_nh_3) * ((- __f2dace_SOA_w_concorr_c_d_2_s_597_diag_p_nh_3) + _for_it_19)) + (__f2dace_SA_w_concorr_c_d_0_s_595_diag_p_nh_3 * tmp_index_611)) - __f2dace_SOA_w_concorr_c_d_0_s_595_diag_p_nh_3) + _for_it_30)];
                    double p_nh_prog_nnew_out_w_0;
                    ...
                    v_p_nh_prog_nnew_w[(((((__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * __f2dace_SA_w_d_1_s_497_p_nh_prog_nnew_16) * ((- __f2dace_SOA_w_d_2_s_498_p_nh_prog_nnew_16) + _for_it_19)) + (__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * tmp_index_608)) - __f2dace_SOA_w_d_0_s_496_p_nh_prog_nnew_16) + _for_it_30)] = p_nh_prog_nnew_out_w_0;
                }
                {
                    double z_contr_w_fl_l_out_0;
        ...
        for (_for_it_31 = i_startidx; (_for_it_31 <= i_endidx); _for_it_31 = (_for_it_31 + 1)) {
            {

                {
                    ...
                    double p_nh_prog_nnow_0_in_rho_0 = v_p_nh_prog_nnow_rho[(((((__f2dace_SA_rho_d_0_s_502_p_nh_prog_nnow_15 * __f2dace_SA_rho_d_1_s_503_p_nh_prog_nnow_15) * ((- __f2dace_SOA_rho_d_2_s_504_p_nh_prog_nnew_16) + _for_it_19)) + (__f2dace_SA_rho_d_0_s_502_p_nh_prog_nnow_15 * (1 - __f2dace_SOA_rho_d_1_s_503_p_nh_prog_nnew_16))) - __f2dace_SOA_rho_d_0_s_502_p_nh_prog_nnew_16) + _for_it_31)];
            ...
            }
            {
                ...
                {
                    double dtime_0_in = dtime;
                    double p_nh_0_in_diag_exner_pr_0 = v_v_p_nh_diag_exner_pr[(((((__f2dace_SA_exner_pr_d_0_s_511_diag_p_nh_3 * __f2dace_SA_exner_pr_d_1_s_512_diag_p_nh_3) * ((- __f2dace_SOA_exner_pr_d_2_s_513_diag_p_nh_3) + _for_it_19)) + (__f2dace_SA_exner_pr_d_0_s_511_diag_p_nh_3 * (1 - __f2dace_SOA_exner_pr_d_1_s_512_diag_p_nh_3))) - __f2dace_SOA_exner_pr_d_0_s_511_diag_p_nh_3) + _for_it_31)];
                    ...
                    double p_nh_5_in_diag_ddt_exner_phy_0 = v_v_p_nh_diag_ddt_exner_phy[(((((__f2dace_SA_ddt_exner_phy_d_0_s_583_diag_p_nh_3 * __f2dace_SA_ddt_exner_phy_d_1_s_584_diag_p_nh_3) * ((- __f2dace_SOA_ddt_exner_phy_d_2_s_585_diag_p_nh_3) + _for_it_19)) + (__f2dace_SA_ddt_exner_phy_d_0_s_583_diag_p_nh_3 * (1 - __f2dace_SOA_ddt_exner_phy_d_1_s_584_diag_p_nh_3))) - __f2dace_SOA_ddt_exner_phy_d_0_s_583_diag_p_nh_3) + _for_it_31)];
            ...
            for (_for_it_33 = i_startidx; (_for_it_33 <= i_endidx); _for_it_33 = (_for_it_33 + 1)) {
                {

                    {
                        ...
                        double p_nh_1_in_metrics_deepatmo_divzu_mc_0 = v_v_p_nh_metrics_deepatmo_divzu_mc[((- __f2dace_SOA_deepatmo_divzu_mc_d_0_s_745_metrics_p_nh_5) + _for_it_32)];
                        double p_nh_2_in_metrics_deepatmo_divzl_mc_0 = v_v_p_nh_metrics_deepatmo_divzl_mc[((- __f2dace_SOA_deepatmo_divzl_mc_d_0_s_746_metrics_p_nh_5) + _for_it_32)];
                        double p_nh_prog_nnow_0_in_rho_0 = v_p_nh_prog_nnow_rho[(((((__f2dace_SA_rho_d_0_s_502_p_nh_prog_nnow_15 * __f2dace_SA_rho_d_1_s_503_p_nh_prog_nnow_15) * ((- __f2dace_SOA_rho_d_2_s_504_p_nh_prog_nnew_16) + _for_it_19)) + (__f2dace_SA_rho_d_0_s_502_p_nh_prog_nnow_15 * ((- __f2dace_SOA_rho_d_1_s_503_p_nh_prog_nnew_16) + _for_it_32))) - __f2dace_SOA_rho_d_0_s_502_p_nh_prog_nnew_16) + _for_it_33)];
                ...
                }
                {

                    {
                        ...
                        double p_nh_2_in_metrics_deepatmo_divzu_mc_0 = v_v_p_nh_metrics_deepatmo_divzu_mc[((- __f2dace_SOA_deepatmo_divzu_mc_d_0_s_745_metrics_p_nh_5) + _for_it_32)];
                        double p_nh_3_in_diag_theta_v_ic_0 = v_v_p_nh_diag_theta_v_ic[(((((__f2dace_SA_theta_v_ic_d_0_s_520_diag_p_nh_3 * __f2dace_SA_theta_v_ic_d_1_s_521_diag_p_nh_3) * ((- __f2dace_SOA_theta_v_ic_d_2_s_522_diag_p_nh_3) + _for_it_19)) + (__f2dace_SA_theta_v_ic_d_0_s_520_diag_p_nh_3 * (((- __f2dace_SOA_theta_v_ic_d_1_s_521_diag_p_nh_3) + _for_it_32) + 1))) - __f2dace_SOA_theta_v_ic_d_0_s_520_diag_p_nh_3) + _for_it_33)];
                        double p_nh_4_in_metrics_deepatmo_divzl_mc_0 = v_v_p_nh_metrics_deepatmo_divzl_mc[((- __f2dace_SOA_deepatmo_divzl_mc_d_0_s_746_metrics_p_nh_5) + _for_it_32)];
                        double p_nh_5_in_diag_ddt_exner_phy_0 = v_v_p_nh_diag_ddt_exner_phy[(((((__f2dace_SA_ddt_exner_phy_d_0_s_583_diag_p_nh_3 * __f2dace_SA_ddt_exner_phy_d_1_s_584_diag_p_nh_3) * ((- __f2dace_SOA_ddt_exner_phy_d_2_s_585_diag_p_nh_3) + _for_it_19)) + (__f2dace_SA_ddt_exner_phy_d_0_s_583_diag_p_nh_3 * ((- __f2dace_SOA_ddt_exner_phy_d_1_s_584_diag_p_nh_3) + _for_it_32))) - __f2dace_SOA_ddt_exner_phy_d_0_s_583_diag_p_nh_3) + _for_it_33)];
            ...
            for (_for_it_37 = i_startidx; (_for_it_37 <= i_endidx); _for_it_37 = (_for_it_37 + 1)) {
                {
                    ...
                    {
                        double dtime_0_in = dtime;
                        double p_nh_0_in_metrics_vwind_impl_wgt_0 = v_v_p_nh_metrics_vwind_impl_wgt[(((__f2dace_SA_vwind_impl_wgt_d_0_s_653_metrics_p_nh_5 * ((- __f2dace_SOA_vwind_impl_wgt_d_1_s_654_metrics_p_nh_5) + _for_it_19)) - __f2dace_SOA_vwind_impl_wgt_d_0_s_653_metrics_p_nh_5) + _for_it_37)];
                        double p_nh_1_in_diag_theta_v_ic_0 = v_v_p_nh_diag_theta_v_ic[(((((__f2dace_SA_theta_v_ic_d_0_s_520_diag_p_nh_3 * __f2dace_SA_theta_v_ic_d_1_s_521_diag_p_nh_3) * ((- __f2dace_SOA_theta_v_ic_d_2_s_522_diag_p_nh_3) + _for_it_19)) + (__f2dace_SA_theta_v_ic_d_0_s_520_diag_p_nh_3 * ((- __f2dace_SOA_theta_v_ic_d_1_s_521_diag_p_nh_3) + _for_it_36))) - __f2dace_SOA_theta_v_ic_d_0_s_520_diag_p_nh_3) + _for_it_37)];
                        double p_nh_2_in_metrics_ddqz_z_half_0 = v_v_p_nh_metrics_ddqz_z_half[(((((__f2dace_SA_ddqz_z_half_d_0_s_664_metrics_p_nh_5 * __f2dace_SA_ddqz_z_half_d_1_s_665_metrics_p_nh_5) * ((- __f2dace_SOA_ddqz_z_half_d_2_s_666_metrics_p_nh_5) + _for_it_19)) + (__f2dace_SA_ddqz_z_half_d_0_s_664_metrics_p_nh_5 * ((- __f2dace_SOA_ddqz_z_half_d_1_s_665_metrics_p_nh_5) + _for_it_36))) - __f2dace_SOA_ddqz_z_half_d_0_s_664_metrics_p_nh_5) + _for_it_37)];
                        double z_gamma_out;
                ...
                }
                {
                    ...
                    {
                        double p_nh_0_in_metrics_deepatmo_divzu_mc_0 = v_v_p_nh_metrics_deepatmo_divzu_mc[(((- __f2dace_SOA_deepatmo_divzu_mc_d_0_s_745_metrics_p_nh_5) + _for_it_36) - 1)];
                ...
                }
                {
                    ...
                    {
                        double p_nh_0_in_metrics_deepatmo_divzl_mc_0 = v_v_p_nh_metrics_deepatmo_divzl_mc[((- __f2dace_SOA_deepatmo_divzl_mc_d_0_s_746_metrics_p_nh_5) + _for_it_36)];
                ...
                }
                {
                    ...
                    {
                        double p_nh_0_in_metrics_deepatmo_divzl_mc_0 = v_v_p_nh_metrics_deepatmo_divzl_mc[(((- __f2dace_SOA_deepatmo_divzl_mc_d_0_s_746_metrics_p_nh_5) + _for_it_36) - 1)];
                        double p_nh_1_in_metrics_deepatmo_divzu_mc_0 = v_v_p_nh_metrics_deepatmo_divzu_mc[((- __f2dace_SOA_deepatmo_divzu_mc_d_0_s_745_metrics_p_nh_5) + _for_it_36)];
                    ...
                    }
                    {
                        ...
                        v_p_nh_prog_nnew_w[(((((__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * __f2dace_SA_w_d_1_s_497_p_nh_prog_nnew_16) * ((- __f2dace_SOA_w_d_2_s_498_p_nh_prog_nnew_16) + _for_it_19)) + (__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * ((- __f2dace_SOA_w_d_1_s_497_p_nh_prog_nnew_16) + _for_it_36))) - __f2dace_SOA_w_d_0_s_496_p_nh_prog_nnew_16) + _for_it_37)] = p_nh_prog_nnew_out_w_0;
                    }
                    {
                        double p_nh_prog_nnew_0_in_w_0 = v_p_nh_prog_nnew_w[(((((__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * __f2dace_SA_w_d_1_s_497_p_nh_prog_nnew_16) * ((- __f2dace_SOA_w_d_2_s_498_p_nh_prog_nnew_16) + _for_it_19)) + (__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * ((- __f2dace_SOA_w_d_1_s_497_p_nh_prog_nnew_16) + _for_it_36))) - __f2dace_SOA_w_d_0_s_496_p_nh_prog_nnew_16) + _for_it_37)];
                        double p_nh_prog_nnew_1_in_w_0 = v_p_nh_prog_nnew_w[(((((__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * __f2dace_SA_w_d_1_s_497_p_nh_prog_nnew_16) * ((- __f2dace_SOA_w_d_2_s_498_p_nh_prog_nnew_16) + _for_it_19)) + (__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * (((- __f2dace_SOA_w_d_1_s_497_p_nh_prog_nnew_16) + _for_it_36) - 1))) - __f2dace_SOA_w_d_0_s_496_p_nh_prog_nnew_16) + _for_it_37)];
                        double z_a_0_in = z_a;
                        double z_g_0_in = z_g;
                        double p_nh_prog_nnew_out_w_0;
            ...
            for (_for_it_39 = i_startidx; (_for_it_39 <= i_endidx); _for_it_39 = (_for_it_39 + 1)) {
                {
                    ...
                    {
                        double p_nh_prog_nnew_0_in_w_0 = v_p_nh_prog_nnew_w[(((((__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * __f2dace_SA_w_d_1_s_497_p_nh_prog_nnew_16) * ((- __f2dace_SOA_w_d_2_s_498_p_nh_prog_nnew_16) + _for_it_19)) + (__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * ((- __f2dace_SOA_w_d_1_s_497_p_nh_prog_nnew_16) + _for_it_38))) - __f2dace_SOA_w_d_0_s_496_p_nh_prog_nnew_16) + _for_it_39)];
                        double p_nh_prog_nnew_1_in_w_0 = v_p_nh_prog_nnew_w[(((((__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * __f2dace_SA_w_d_1_s_497_p_nh_prog_nnew_16) * ((- __f2dace_SOA_w_d_2_s_498_p_nh_prog_nnew_16) + _for_it_19)) + (__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * (((- __f2dace_SOA_w_d_1_s_497_p_nh_prog_nnew_16) + _for_it_38) + 1))) - __f2dace_SOA_w_d_0_s_496_p_nh_prog_nnew_16) + _for_it_39)];
                        ...
                        v_p_nh_prog_nnew_w[(((((__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * __f2dace_SA_w_d_1_s_497_p_nh_prog_nnew_16) * ((- __f2dace_SOA_w_d_2_s_498_p_nh_prog_nnew_16) + _for_it_19)) + (__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * ((- __f2dace_SOA_w_d_1_s_497_p_nh_prog_nnew_16) + _for_it_38))) - __f2dace_SOA_w_d_0_s_496_p_nh_prog_nnew_16) + _for_it_39)] = p_nh_prog_nnew_out_w_0;
                    }
                ...
                for (_for_it_41 = i_startidx; (_for_it_41 <= i_endidx); _for_it_41 = (_for_it_41 + 1)) {
                    {
                        ...
                        {
                            double p_nh_prog_nnew_0_in_w_0 = v_p_nh_prog_nnew_w[(((((__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * __f2dace_SA_w_d_1_s_497_p_nh_prog_nnew_16) * ((- __f2dace_SOA_w_d_2_s_498_p_nh_prog_nnew_16) + _for_it_19)) + (__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * ((- __f2dace_SOA_w_d_1_s_497_p_nh_prog_nnew_16) + _for_it_40))) - __f2dace_SOA_w_d_0_s_496_p_nh_prog_nnew_16) + _for_it_41)];
                            double p_nh_prog_nnew_1_in_w_0 = v_p_nh_prog_nnew_w[(((((__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * __f2dace_SA_w_d_1_s_497_p_nh_prog_nnew_16) * ((- __f2dace_SOA_w_d_2_s_498_p_nh_prog_nnew_16) + _for_it_19)) + (__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * (1 - __f2dace_SOA_w_d_1_s_497_p_nh_prog_nnew_16))) - __f2dace_SOA_w_d_0_s_496_p_nh_prog_nnew_16) + _for_it_41)];
                            ...
                            v_p_nh_prog_nnew_w[(((((__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * __f2dace_SA_w_d_1_s_497_p_nh_prog_nnew_16) * ((- __f2dace_SOA_w_d_2_s_498_p_nh_prog_nnew_16) + _for_it_19)) + (__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * ((- __f2dace_SOA_w_d_1_s_497_p_nh_prog_nnew_16) + _for_it_40))) - __f2dace_SOA_w_d_0_s_496_p_nh_prog_nnew_16) + _for_it_41)] = p_nh_prog_nnew_out_w_0;
                        }
                    ...
                    for (_for_it_43 = i_startidx; (_for_it_43 <= i_endidx); _for_it_43 = (_for_it_43 + 1)) {
                        {
                            ...
                            {
                                double dtime_0_in = dtime;
                                double p_nh_0_in_metrics_rayleigh_w_0 = v_v_p_nh_metrics_rayleigh_w[((- __f2dace_SOA_rayleigh_w_d_0_s_646_metrics_p_nh_5) + _for_it_42)];
                                double p_nh_1_in_ref_w_ref_0 = v_v_p_nh_ref_w_ref[(((((__f2dace_SA_w_ref_d_0_s_643_ref_p_nh_4 * __f2dace_SA_w_ref_d_1_s_644_ref_p_nh_4) * ((- __f2dace_SOA_w_ref_d_2_s_645_ref_p_nh_4) + _for_it_19)) + (__f2dace_SA_w_ref_d_0_s_643_ref_p_nh_4 * ((- __f2dace_SOA_w_ref_d_1_s_644_ref_p_nh_4) + _for_it_42))) - __f2dace_SOA_w_ref_d_0_s_643_ref_p_nh_4) + _for_it_43)];
                                double p_nh_prog_nnew_0_in_w_0 = v_p_nh_prog_nnew_w[(((((__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * __f2dace_SA_w_d_1_s_497_p_nh_prog_nnew_16) * ((- __f2dace_SOA_w_d_2_s_498_p_nh_prog_nnew_16) + _for_it_19)) + (__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * ((- __f2dace_SOA_w_d_1_s_497_p_nh_prog_nnew_16) + _for_it_42))) - __f2dace_SOA_w_d_0_s_496_p_nh_prog_nnew_16) + _for_it_43)];
                                double p_nh_prog_nnew_1_in_w_0 = v_p_nh_prog_nnew_w[(((((__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * __f2dace_SA_w_d_1_s_497_p_nh_prog_nnew_16) * ((- __f2dace_SOA_w_d_2_s_498_p_nh_prog_nnew_16) + _for_it_19)) + (__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * ((- __f2dace_SOA_w_d_1_s_497_p_nh_prog_nnew_16) + _for_it_42))) - __f2dace_SOA_w_d_0_s_496_p_nh_prog_nnew_16) + _for_it_43)];
                                double p_nh_prog_nnew_out_w_0;
                                ...
                                v_p_nh_prog_nnew_w[(((((__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * __f2dace_SA_w_d_1_s_497_p_nh_prog_nnew_16) * ((- __f2dace_SOA_w_d_2_s_498_p_nh_prog_nnew_16) + _for_it_19)) + (__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * ((- __f2dace_SOA_w_d_1_s_497_p_nh_prog_nnew_16) + _for_it_42))) - __f2dace_SOA_w_d_0_s_496_p_nh_prog_nnew_16) + _for_it_43)] = p_nh_prog_nnew_out_w_0;
                            }
            ...
            for (_for_it_45 = i_startidx; (_for_it_45 <= i_endidx); _for_it_45 = (_for_it_45 + 1)) {
                {
                    ...
                    {
                        double dtime_0_in = dtime;
                        double p_nh_0_in_metrics_vwind_impl_wgt_0 = v_v_p_nh_metrics_vwind_impl_wgt[(((__f2dace_SA_vwind_impl_wgt_d_0_s_653_metrics_p_nh_5 * ((- __f2dace_SOA_vwind_impl_wgt_d_1_s_654_metrics_p_nh_5) + _for_it_19)) - __f2dace_SOA_vwind_impl_wgt_d_0_s_653_metrics_p_nh_5) + _for_it_45)];
                        ...
                        double p_nh_3_in_metrics_deepatmo_divzu_mc_0 = v_v_p_nh_metrics_deepatmo_divzu_mc[((- __f2dace_SOA_deepatmo_divzu_mc_d_0_s_745_metrics_p_nh_5) + _for_it_44)];
                        ...
                        double p_nh_5_in_metrics_deepatmo_divzl_mc_0 = v_v_p_nh_metrics_deepatmo_divzl_mc[((- __f2dace_SOA_deepatmo_divzl_mc_d_0_s_746_metrics_p_nh_5) + _for_it_44)];
                        double p_nh_prog_nnew_0_in_w_0 = v_p_nh_prog_nnew_w[(((((__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * __f2dace_SA_w_d_1_s_497_p_nh_prog_nnew_16) * ((- __f2dace_SOA_w_d_2_s_498_p_nh_prog_nnew_16) + _for_it_19)) + (__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * ((- __f2dace_SOA_w_d_1_s_497_p_nh_prog_nnew_16) + _for_it_44))) - __f2dace_SOA_w_d_0_s_496_p_nh_prog_nnew_16) + _for_it_45)];
                        double p_nh_prog_nnew_1_in_w_0 = v_p_nh_prog_nnew_w[(((((__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * __f2dace_SA_w_d_1_s_497_p_nh_prog_nnew_16) * ((- __f2dace_SOA_w_d_2_s_498_p_nh_prog_nnew_16) + _for_it_19)) + (__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * (((- __f2dace_SOA_w_d_1_s_497_p_nh_prog_nnew_16) + _for_it_44) + 1))) - __f2dace_SOA_w_d_0_s_496_p_nh_prog_nnew_16) + _for_it_45)];
                ...
                }
                {

                    {
                        ...
                        double p_nh_1_in_metrics_deepatmo_divzu_mc_0 = v_v_p_nh_metrics_deepatmo_divzu_mc[((- __f2dace_SOA_deepatmo_divzu_mc_d_0_s_745_metrics_p_nh_5) + _for_it_44)];
                        double p_nh_2_in_metrics_deepatmo_divzl_mc_0 = v_v_p_nh_metrics_deepatmo_divzl_mc[((- __f2dace_SOA_deepatmo_divzl_mc_d_0_s_746_metrics_p_nh_5) + _for_it_44)];
                        double p_nh_prog_nnew_0_in_w_0 = v_p_nh_prog_nnew_w[(((((__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * __f2dace_SA_w_d_1_s_497_p_nh_prog_nnew_16) * ((- __f2dace_SOA_w_d_2_s_498_p_nh_prog_nnew_16) + _for_it_19)) + (__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * ((- __f2dace_SOA_w_d_1_s_497_p_nh_prog_nnew_16) + _for_it_44))) - __f2dace_SOA_w_d_0_s_496_p_nh_prog_nnew_16) + _for_it_45)];
                        double p_nh_prog_nnew_1_in_w_0 = v_p_nh_prog_nnew_w[(((((__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * __f2dace_SA_w_d_1_s_497_p_nh_prog_nnew_16) * ((- __f2dace_SOA_w_d_2_s_498_p_nh_prog_nnew_16) + _for_it_19)) + (__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * (((- __f2dace_SOA_w_d_1_s_497_p_nh_prog_nnew_16) + _for_it_44) + 1))) - __f2dace_SOA_w_d_0_s_496_p_nh_prog_nnew_16) + _for_it_45)];
                        ...
                        v_p_nh_prog_nnew_exner[(((((__f2dace_SA_exner_d_0_s_505_p_nh_prog_nnew_16 * __f2dace_SA_exner_d_1_s_506_p_nh_prog_nnew_16) * ((- __f2dace_SOA_exner_d_2_s_507_p_nh_prog_nnew_16) + _for_it_19)) + (__f2dace_SA_exner_d_0_s_505_p_nh_prog_nnew_16 * ((- __f2dace_SOA_exner_d_1_s_506_p_nh_prog_nnew_16) + _for_it_44))) - __f2dace_SOA_exner_d_0_s_505_p_nh_prog_nnew_16) + _for_it_45)] = p_nh_prog_nnew_out_exner_0;
                    }
                    {
                        double p_nh_prog_nnew_0_in_exner_0 = v_p_nh_prog_nnew_exner[(((((__f2dace_SA_exner_d_0_s_505_p_nh_prog_nnew_16 * __f2dace_SA_exner_d_1_s_506_p_nh_prog_nnew_16) * ((- __f2dace_SOA_exner_d_2_s_507_p_nh_prog_nnew_16) + _for_it_19)) + (__f2dace_SA_exner_d_0_s_505_p_nh_prog_nnew_16 * ((- __f2dace_SOA_exner_d_1_s_506_p_nh_prog_nnew_16) + _for_it_44))) - __f2dace_SOA_exner_d_0_s_505_p_nh_prog_nnew_16) + _for_it_45)];
                        double p_nh_prog_nnew_1_in_rho_0 = v_p_nh_prog_nnew_rho[(((((__f2dace_SA_rho_d_0_s_502_p_nh_prog_nnew_16 * __f2dace_SA_rho_d_1_s_503_p_nh_prog_nnew_16) * ((- __f2dace_SOA_rho_d_2_s_504_p_nh_prog_nnew_16) + _for_it_19)) + (__f2dace_SA_rho_d_0_s_502_p_nh_prog_nnew_16 * ((- __f2dace_SOA_rho_d_1_s_503_p_nh_prog_nnew_16) + _for_it_44))) - __f2dace_SOA_rho_d_0_s_502_p_nh_prog_nnew_16) + _for_it_45)];
                        double p_nh_prog_nnow_0_in_rho_0 = v_p_nh_prog_nnow_rho[(((((__f2dace_SA_rho_d_0_s_502_p_nh_prog_nnow_15 * __f2dace_SA_rho_d_1_s_503_p_nh_prog_nnow_15) * ((- __f2dace_SOA_rho_d_2_s_504_p_nh_prog_nnew_16) + _for_it_19)) + (__f2dace_SA_rho_d_0_s_502_p_nh_prog_nnow_15 * ((- __f2dace_SOA_rho_d_1_s_503_p_nh_prog_nnew_16) + _for_it_44))) - __f2dace_SOA_rho_d_0_s_502_p_nh_prog_nnew_16) + _for_it_45)];
            ...
            for (_for_it_46 = i_startidx; (_for_it_46 <= i_endidx); _for_it_46 = (_for_it_46 + 1)) {
                {
                    ...
                    {
                        double dtime_0_in = dtime;
                        double p_nh_0_in_metrics_vwind_impl_wgt_0 = v_v_p_nh_metrics_vwind_impl_wgt[(((__f2dace_SA_vwind_impl_wgt_d_0_s_653_metrics_p_nh_5 * ((- __f2dace_SOA_vwind_impl_wgt_d_1_s_654_metrics_p_nh_5) + _for_it_19)) - __f2dace_SOA_vwind_impl_wgt_d_0_s_653_metrics_p_nh_5) + _for_it_46)];
                        ...
                        double p_nh_4_in_metrics_deepatmo_divzl_mc_0 = v_v_p_nh_metrics_deepatmo_divzl_mc[(1 - __f2dace_SOA_deepatmo_divzl_mc_d_0_s_746_metrics_p_nh_5)];
                        double p_nh_prog_nnew_0_in_w_0 = v_p_nh_prog_nnew_w[(((((__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * __f2dace_SA_w_d_1_s_497_p_nh_prog_nnew_16) * ((- __f2dace_SOA_w_d_2_s_498_p_nh_prog_nnew_16) + _for_it_19)) + (__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * (2 - __f2dace_SOA_w_d_1_s_497_p_nh_prog_nnew_16))) - __f2dace_SOA_w_d_0_s_496_p_nh_prog_nnew_16) + _for_it_46)];
                ...
                }
                {

                    {
                        ...
                        double p_nh_1_in_metrics_vwind_impl_wgt_0 = v_v_p_nh_metrics_vwind_impl_wgt[(((__f2dace_SA_vwind_impl_wgt_d_0_s_653_metrics_p_nh_5 * ((- __f2dace_SOA_vwind_impl_wgt_d_1_s_654_metrics_p_nh_5) + _for_it_19)) - __f2dace_SOA_vwind_impl_wgt_d_0_s_653_metrics_p_nh_5) + _for_it_46)];
                        ...
                        v_p_nh_prog_nnew_exner[(((((__f2dace_SA_exner_d_0_s_505_p_nh_prog_nnew_16 * __f2dace_SA_exner_d_1_s_506_p_nh_prog_nnew_16) * ((- __f2dace_SOA_exner_d_2_s_507_p_nh_prog_nnew_16) + _for_it_19)) + (__f2dace_SA_exner_d_0_s_505_p_nh_prog_nnew_16 * (1 - __f2dace_SOA_exner_d_1_s_506_p_nh_prog_nnew_16))) - __f2dace_SOA_exner_d_0_s_505_p_nh_prog_nnew_16) + _for_it_46)] = p_nh_prog_nnew_out_exner_0;
                    }
                    {
                        double p_nh_prog_nnew_0_in_exner_0 = v_p_nh_prog_nnew_exner[(((((__f2dace_SA_exner_d_0_s_505_p_nh_prog_nnew_16 * __f2dace_SA_exner_d_1_s_506_p_nh_prog_nnew_16) * ((- __f2dace_SOA_exner_d_2_s_507_p_nh_prog_nnew_16) + _for_it_19)) + (__f2dace_SA_exner_d_0_s_505_p_nh_prog_nnew_16 * (1 - __f2dace_SOA_exner_d_1_s_506_p_nh_prog_nnew_16))) - __f2dace_SOA_exner_d_0_s_505_p_nh_prog_nnew_16) + _for_it_46)];
                        double p_nh_prog_nnew_1_in_rho_0 = v_p_nh_prog_nnew_rho[(((((__f2dace_SA_rho_d_0_s_502_p_nh_prog_nnew_16 * __f2dace_SA_rho_d_1_s_503_p_nh_prog_nnew_16) * ((- __f2dace_SOA_rho_d_2_s_504_p_nh_prog_nnew_16) + _for_it_19)) + (__f2dace_SA_rho_d_0_s_502_p_nh_prog_nnew_16 * (1 - __f2dace_SOA_rho_d_1_s_503_p_nh_prog_nnew_16))) - __f2dace_SOA_rho_d_0_s_502_p_nh_prog_nnew_16) + _for_it_46)];
                        double p_nh_prog_nnow_0_in_rho_0 = v_p_nh_prog_nnow_rho[(((((__f2dace_SA_rho_d_0_s_502_p_nh_prog_nnow_15 * __f2dace_SA_rho_d_1_s_503_p_nh_prog_nnow_15) * ((- __f2dace_SOA_rho_d_2_s_504_p_nh_prog_nnew_16) + _for_it_19)) + (__f2dace_SA_rho_d_0_s_502_p_nh_prog_nnow_15 * (1 - __f2dace_SOA_rho_d_1_s_503_p_nh_prog_nnew_16))) - __f2dace_SOA_rho_d_0_s_502_p_nh_prog_nnew_16) + _for_it_46)];
                ...
                for (_for_it_48 = i_startidx; (_for_it_48 <= i_endidx); _for_it_48 = (_for_it_48 + 1)) {
                    {
                        ...
                        }
                        {
                            ...
                            double p_nh_prog_nnew_0_in_w_0 = v_p_nh_prog_nnew_w[(((((__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * __f2dace_SA_w_d_1_s_497_p_nh_prog_nnew_16) * ((- __f2dace_SOA_w_d_2_s_498_p_nh_prog_nnew_16) + _for_it_19)) + (__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * ((- __f2dace_SOA_w_d_1_s_497_p_nh_prog_nnew_16) + _for_it_47))) - __f2dace_SOA_w_d_0_s_496_p_nh_prog_nnew_16) + _for_it_48)];
                            double p_nh_prog_nnew_1_in_w_0 = v_p_nh_prog_nnew_w[(((((__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * __f2dace_SA_w_d_1_s_497_p_nh_prog_nnew_16) * ((- __f2dace_SOA_w_d_2_s_498_p_nh_prog_nnew_16) + _for_it_19)) + (__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * (((- __f2dace_SOA_w_d_1_s_497_p_nh_prog_nnew_16) + _for_it_47) + 1))) - __f2dace_SOA_w_d_0_s_496_p_nh_prog_nnew_16) + _for_it_48)];
    ...
    if ((_if_cond_16 == 1)) {
        ...
        for (_for_it_53 = i_startblk; (_for_it_53 <= i_endblk); _for_it_53 = (_for_it_53 + 1)) {
            ...
            i_startidx_in_var_57_0 = v_v_p_patch_var_48_cells_start_index[(1 - __f2dace_SOA_start_index_d_0_s_174_cells_p_patch_8)];
            {


            }
            i_endidx_in_var_58_0 = v_v_p_patch_var_48_cells_end_index[(4 - __f2dace_SOA_end_index_d_0_s_175_cells_p_patch_8)];
            ...
            if (((1 && 1) == 1)) {
                    ...
                    for (_for_it_55 = i_startidx; (_for_it_55 <= i_endidx); _for_it_55 = (_for_it_55 + 1)) {
                        {
                            ...
                            {
                                double dtime_0_in = dtime;
                                double p_nh_0_in_diag_grf_tend_rho_0 = v_v_p_nh_diag_grf_tend_rho[(((((__f2dace_SA_grf_tend_rho_d_0_s_529_diag_p_nh_3 * __f2dace_SA_grf_tend_rho_d_1_s_530_diag_p_nh_3) * ((- __f2dace_SOA_grf_tend_rho_d_2_s_531_diag_p_nh_3) + _for_it_53)) + (__f2dace_SA_grf_tend_rho_d_0_s_529_diag_p_nh_3 * ((- __f2dace_SOA_grf_tend_rho_d_1_s_530_diag_p_nh_3) + _for_it_54))) - __f2dace_SOA_grf_tend_rho_d_0_s_529_diag_p_nh_3) + _for_it_55)];
                                double p_nh_prog_nnow_0_in_rho_0 = v_p_nh_prog_nnow_rho[(((((__f2dace_SA_rho_d_0_s_502_p_nh_prog_nnow_15 * __f2dace_SA_rho_d_1_s_503_p_nh_prog_nnow_15) * ((- __f2dace_SOA_rho_d_2_s_504_p_nh_prog_nnew_16) + _for_it_53)) + (__f2dace_SA_rho_d_0_s_502_p_nh_prog_nnow_15 * ((- __f2dace_SOA_rho_d_1_s_503_p_nh_prog_nnew_16) + _for_it_54))) - __f2dace_SOA_rho_d_0_s_502_p_nh_prog_nnew_16) + _for_it_55)];
                                double p_nh_prog_nnew_out_rho_0;
                                ...
                                v_p_nh_prog_nnew_rho[(((((__f2dace_SA_rho_d_0_s_502_p_nh_prog_nnew_16 * __f2dace_SA_rho_d_1_s_503_p_nh_prog_nnew_16) * ((- __f2dace_SOA_rho_d_2_s_504_p_nh_prog_nnew_16) + _for_it_53)) + (__f2dace_SA_rho_d_0_s_502_p_nh_prog_nnew_16 * ((- __f2dace_SOA_rho_d_1_s_503_p_nh_prog_nnew_16) + _for_it_54))) - __f2dace_SOA_rho_d_0_s_502_p_nh_prog_nnew_16) + _for_it_55)] = p_nh_prog_nnew_out_rho_0;
                            }
                        ...
                        }
                        {
                            ...
                            }
                            {
                                ...
                                v_p_nh_prog_nnew_exner[(((((__f2dace_SA_exner_d_0_s_505_p_nh_prog_nnew_16 * __f2dace_SA_exner_d_1_s_506_p_nh_prog_nnew_16) * ((- __f2dace_SOA_exner_d_2_s_507_p_nh_prog_nnew_16) + _for_it_53)) + (__f2dace_SA_exner_d_0_s_505_p_nh_prog_nnew_16 * ((- __f2dace_SOA_exner_d_1_s_506_p_nh_prog_nnew_16) + _for_it_54))) - __f2dace_SOA_exner_d_0_s_505_p_nh_prog_nnew_16) + _for_it_55)] = p_nh_prog_nnew_out_exner_0;
                            }
                        ...
                        }
                        {
                            ...
                            {
                                double dtime_0_in = dtime;
                                double p_nh_0_in_diag_grf_tend_w_0 = v_v_p_nh_diag_grf_tend_w[(((((__f2dace_SA_grf_tend_w_d_0_s_526_diag_p_nh_3 * __f2dace_SA_grf_tend_w_d_1_s_527_diag_p_nh_3) * ((- __f2dace_SOA_grf_tend_w_d_2_s_528_diag_p_nh_3) + _for_it_53)) + (__f2dace_SA_grf_tend_w_d_0_s_526_diag_p_nh_3 * ((- __f2dace_SOA_grf_tend_w_d_1_s_527_diag_p_nh_3) + _for_it_54))) - __f2dace_SOA_grf_tend_w_d_0_s_526_diag_p_nh_3) + _for_it_55)];
                                double p_nh_prog_nnow_0_in_w_0 = v_p_nh_prog_nnow_w[(((((__f2dace_SA_w_d_0_s_496_p_nh_prog_nnow_15 * __f2dace_SA_w_d_1_s_497_p_nh_prog_nnow_15) * ((- __f2dace_SOA_w_d_2_s_498_p_nh_prog_nnew_16) + _for_it_53)) + (__f2dace_SA_w_d_0_s_496_p_nh_prog_nnow_15 * ((- __f2dace_SOA_w_d_1_s_497_p_nh_prog_nnew_16) + _for_it_54))) - __f2dace_SOA_w_d_0_s_496_p_nh_prog_nnew_16) + _for_it_55)];
                                double p_nh_prog_nnew_out_w_0;
                                ...
                                v_p_nh_prog_nnew_w[(((((__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * __f2dace_SA_w_d_1_s_497_p_nh_prog_nnew_16) * ((- __f2dace_SOA_w_d_2_s_498_p_nh_prog_nnew_16) + _for_it_53)) + (__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * ((- __f2dace_SOA_w_d_1_s_497_p_nh_prog_nnew_16) + _for_it_54))) - __f2dace_SOA_w_d_0_s_496_p_nh_prog_nnew_16) + _for_it_55)] = p_nh_prog_nnew_out_w_0;
                            }
                ...
                for (_for_it_56 = i_startidx; (_for_it_56 <= i_endidx); _for_it_56 = (_for_it_56 + 1)) {
                    ...
                    tmp_index_999 = (nlevp1 - __f2dace_SOA_w_d_1_s_497_p_nh_prog_nnew_16);
                    tmp_index_1002 = (nlevp1 - __f2dace_SOA_w_d_1_s_497_p_nh_prog_nnew_16);
                    tmp_index_1005 = (nlevp1 - __f2dace_SOA_grf_tend_w_d_1_s_527_diag_p_nh_3);
                    {

                        {
                            double dtime_0_in = dtime;
                            double p_nh_0_in_diag_grf_tend_w_0 = v_v_p_nh_diag_grf_tend_w[(((((__f2dace_SA_grf_tend_w_d_0_s_526_diag_p_nh_3 * __f2dace_SA_grf_tend_w_d_1_s_527_diag_p_nh_3) * ((- __f2dace_SOA_grf_tend_w_d_2_s_528_diag_p_nh_3) + _for_it_53)) + (__f2dace_SA_grf_tend_w_d_0_s_526_diag_p_nh_3 * tmp_index_1005)) - __f2dace_SOA_grf_tend_w_d_0_s_526_diag_p_nh_3) + _for_it_56)];
                            double p_nh_prog_nnow_0_in_w_0 = v_p_nh_prog_nnow_w[(((((__f2dace_SA_w_d_0_s_496_p_nh_prog_nnow_15 * __f2dace_SA_w_d_1_s_497_p_nh_prog_nnow_15) * ((- __f2dace_SOA_w_d_2_s_498_p_nh_prog_nnew_16) + _for_it_53)) + (__f2dace_SA_w_d_0_s_496_p_nh_prog_nnow_15 * tmp_index_1002)) - __f2dace_SOA_w_d_0_s_496_p_nh_prog_nnew_16) + _for_it_56)];
                            double p_nh_prog_nnew_out_w_0;
                            ...
                            v_p_nh_prog_nnew_w[(((((__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * __f2dace_SA_w_d_1_s_497_p_nh_prog_nnew_16) * ((- __f2dace_SOA_w_d_2_s_498_p_nh_prog_nnew_16) + _for_it_53)) + (__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * tmp_index_999)) - __f2dace_SOA_w_d_0_s_496_p_nh_prog_nnew_16) + _for_it_56)] = p_nh_prog_nnew_out_w_0;
                        }
                ...
                if ((1 == 1)) {
                        ...
                        for (_for_it_58 = i_startidx; (_for_it_58 <= i_endidx); _for_it_58 = (_for_it_58 + 1)) {
                            {

                                {
                                    ...
                                    double p_nh_prog_nnow_0_in_rho_0 = v_p_nh_prog_nnow_rho[(((((__f2dace_SA_rho_d_0_s_502_p_nh_prog_nnow_15 * __f2dace_SA_rho_d_1_s_503_p_nh_prog_nnow_15) * ((- __f2dace_SOA_rho_d_2_s_504_p_nh_prog_nnew_16) + _for_it_53)) + (__f2dace_SA_rho_d_0_s_502_p_nh_prog_nnow_15 * ((- __f2dace_SOA_rho_d_1_s_503_p_nh_prog_nnew_16) + _for_it_57))) - __f2dace_SOA_rho_d_0_s_502_p_nh_prog_nnew_16) + _for_it_58)];
                                    double p_nh_prog_nnew_out_rho_0;
                            ...
                            }
                            {

                                {
                                    ...
                                    v_p_nh_prog_nnew_exner[(((((__f2dace_SA_exner_d_0_s_505_p_nh_prog_nnew_16 * __f2dace_SA_exner_d_1_s_506_p_nh_prog_nnew_16) * ((- __f2dace_SOA_exner_d_2_s_507_p_nh_prog_nnew_16) + _for_it_53)) + (__f2dace_SA_exner_d_0_s_505_p_nh_prog_nnew_16 * ((- __f2dace_SOA_exner_d_1_s_506_p_nh_prog_nnew_16) + _for_it_57))) - __f2dace_SOA_exner_d_0_s_505_p_nh_prog_nnew_16) + _for_it_58)] = p_nh_prog_nnew_out_exner_0;
                                }
                            ...
                            }
                            {
                                ...
                                {
                                    double dtime_0_in = dtime;
                                    double p_nh_0_in_diag_grf_tend_w_0 = v_v_p_nh_diag_grf_tend_w[(((((__f2dace_SA_grf_tend_w_d_0_s_526_diag_p_nh_3 * __f2dace_SA_grf_tend_w_d_1_s_527_diag_p_nh_3) * ((- __f2dace_SOA_grf_tend_w_d_2_s_528_diag_p_nh_3) + _for_it_53)) + (__f2dace_SA_grf_tend_w_d_0_s_526_diag_p_nh_3 * ((- __f2dace_SOA_grf_tend_w_d_1_s_527_diag_p_nh_3) + _for_it_57))) - __f2dace_SOA_grf_tend_w_d_0_s_526_diag_p_nh_3) + _for_it_58)];
                                    ...
                                    v_p_nh_prog_nnew_w[(((((__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * __f2dace_SA_w_d_1_s_497_p_nh_prog_nnew_16) * ((- __f2dace_SOA_w_d_2_s_498_p_nh_prog_nnew_16) + _for_it_53)) + (__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * ((- __f2dace_SOA_w_d_1_s_497_p_nh_prog_nnew_16) + _for_it_57))) - __f2dace_SOA_w_d_0_s_496_p_nh_prog_nnew_16) + _for_it_58)] = p_nh_prog_nnew_out_w_0;
                                }
                    ...
                    for (_for_it_59 = i_startidx; (_for_it_59 <= i_endidx); _for_it_59 = (_for_it_59 + 1)) {
                        ...
                        tmp_index_1035 = (nlevp1 - __f2dace_SOA_w_d_1_s_497_p_nh_prog_nnew_16);
                        tmp_index_1038 = (nlevp1 - __f2dace_SOA_w_d_1_s_497_p_nh_prog_nnew_16);
                        tmp_index_1041 = (nlevp1 - __f2dace_SOA_grf_tend_w_d_1_s_527_diag_p_nh_3);
                        {

                            {
                                double dtime_0_in = dtime;
                                double p_nh_0_in_diag_grf_tend_w_0 = v_v_p_nh_diag_grf_tend_w[(((((__f2dace_SA_grf_tend_w_d_0_s_526_diag_p_nh_3 * __f2dace_SA_grf_tend_w_d_1_s_527_diag_p_nh_3) * ((- __f2dace_SOA_grf_tend_w_d_2_s_528_diag_p_nh_3) + _for_it_53)) + (__f2dace_SA_grf_tend_w_d_0_s_526_diag_p_nh_3 * tmp_index_1041)) - __f2dace_SOA_grf_tend_w_d_0_s_526_diag_p_nh_3) + _for_it_59)];
                                double p_nh_prog_nnow_0_in_w_0 = v_p_nh_prog_nnow_w[(((((__f2dace_SA_w_d_0_s_496_p_nh_prog_nnow_15 * __f2dace_SA_w_d_1_s_497_p_nh_prog_nnow_15) * ((- __f2dace_SOA_w_d_2_s_498_p_nh_prog_nnew_16) + _for_it_53)) + (__f2dace_SA_w_d_0_s_496_p_nh_prog_nnow_15 * tmp_index_1038)) - __f2dace_SOA_w_d_0_s_496_p_nh_prog_nnew_16) + _for_it_59)];
                                double p_nh_prog_nnew_out_w_0;
                                ...
                                v_p_nh_prog_nnew_w[(((((__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * __f2dace_SA_w_d_1_s_497_p_nh_prog_nnew_16) * ((- __f2dace_SOA_w_d_2_s_498_p_nh_prog_nnew_16) + _for_it_53)) + (__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * tmp_index_1035)) - __f2dace_SOA_w_d_0_s_496_p_nh_prog_nnew_16) + _for_it_59)] = p_nh_prog_nnew_out_w_0;
                            }
                    ...
                    for (_for_it_61 = i_startidx; (_for_it_61 <= i_endidx); _for_it_61 = (_for_it_61 + 1)) {
                        {
                            ...
                            }
                            {
                                ...
                                double p_nh_prog_nnew_0_in_w_0 = v_p_nh_prog_nnew_w[(((((__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * __f2dace_SA_w_d_1_s_497_p_nh_prog_nnew_16) * ((- __f2dace_SOA_w_d_2_s_498_p_nh_prog_nnew_16) + _for_it_53)) + (__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * ((- __f2dace_SOA_w_d_1_s_497_p_nh_prog_nnew_16) + _for_it_60))) - __f2dace_SOA_w_d_0_s_496_p_nh_prog_nnew_16) + _for_it_61)];
                                double p_nh_prog_nnew_1_in_w_0 = v_p_nh_prog_nnew_w[(((((__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * __f2dace_SA_w_d_1_s_497_p_nh_prog_nnew_16) * ((- __f2dace_SOA_w_d_2_s_498_p_nh_prog_nnew_16) + _for_it_53)) + (__f2dace_SA_w_d_0_s_496_p_nh_prog_nnew_16 * (((- __f2dace_SOA_w_d_1_s_497_p_nh_prog_nnew_16) + _for_it_60) + 1))) - __f2dace_SOA_w_d_0_s_496_p_nh_prog_nnew_16) + _for_it_61)];
