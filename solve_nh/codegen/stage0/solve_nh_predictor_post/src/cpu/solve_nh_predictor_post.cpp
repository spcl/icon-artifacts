...
void __program_solve_nh_predictor_post_internal(solve_nh_predictor_post_state_t*__state, double * __restrict__ bdy_divdamp, double * __restrict__ enh_divdamp_fac, global_data_type* global_data, t_int_state* p_int, t_nh_state* p_nh, t_nh_prog* p_nh_prog_nnew, t_nh_prog* p_nh_prog_nnow, t_patch* p_patch, t_prepare_adv* prep_adv, double * __restrict__ scal_divdamp, double * __restrict__ z_alpha, double * __restrict__ z_beta, double * __restrict__ z_contr_w_fl_l, double * __restrict__ z_dexner_dz_c, double * __restrict__ z_dwdz_dd, double * __restrict__ z_exner_ex_pr, double * __restrict__ z_exner_expl, double * __restrict__ z_exner_ic, double * __restrict__ z_flxdiv_mass, double * __restrict__ z_flxdiv_theta, double * __restrict__ z_grad_rth, double * __restrict__ z_graddiv2_vn, double * __restrict__ z_graddiv_vn, double * __restrict__ z_gradh_exner, double * __restrict__ z_hydro_corr, double * __restrict__ z_kin_hor_e, double * __restrict__ z_mflx_top, double * __restrict__ z_q, double * __restrict__ z_raylfac, double * __restrict__ z_rho_e, double * __restrict__ z_rho_expl, double * __restrict__ z_rho_v, double * __restrict__ z_rth_pr, double * __restrict__ z_th_ddz_exner_c, double * __restrict__ z_theta_v_e, double * __restrict__ z_theta_v_fl_e, double * __restrict__ z_theta_v_pr_ic, double * __restrict__ z_theta_v_v, double * __restrict__ z_vn_avg, double * __restrict__ z_vt_ie, double * __restrict__ z_w_concorr_mc, double * __restrict__ z_w_concorr_me, double * __restrict__ z_w_expl, int __f2dace_OPTIONAL_lacc, double alin, double aqdr, double bqdr, double df32, double df42, double distv_bary_1, double distv_bary_2, double dt_linintp_ubc, double dt_linintp_ubc_nnew, double dt_linintp_ubc_nnow, double dt_shift, double dthalf, double dtime, double dz32, double dz42, double dzlin, double dzqdr, int i_endblk, int i_endidx, int i_startblk, int i_startidx, int idyn_timestep, int ishift, int istep, int jb, int jc, int je, int jg, int jk, int jk_start, int jks, int jstep, int l_child_vertnest, int l_init, int l_recompute, int l_vert_nested, int lacc, int lclean_mflx, int lprep_adv, int lsave_mflx, int lvn_only, int lvn_pos, int nblks_gradp, int nlen_gradp, int nlev, int nlevp1, int nnew, int nnow, int nproma_gradp, int npromz_gradp, int nshift, int nshift_total, int ntl1, int ntl2, int nvar, double r_dtimensubsteps, double r_nsubsteps, int rl_end, int rl_start, double scal_divdamp_o2, double wgt_nnew_rth, double wgt_nnew_vel, double wgt_nnow_rth, double wgt_nnow_vel, double z_a, double z_b, double z_c, double z_d_vn_dmp, double z_d_vn_iau, double z_ddt_vn_apc, double z_ddt_vn_cor, double z_ddt_vn_dyn, double z_ddt_vn_pgr, double z_ddt_vn_ray, double z_g, double z_gamma, double z_ntdistv_bary_1, double z_ntdistv_bary_2, double z_rho_tavg, double z_rho_tavg_m1, double z_theta1, double z_theta2, double z_theta_tavg, double z_theta_tavg_m1, double z_theta_v_pr_mc, double z_theta_v_pr_mc_m1, double z_w_backtraj, double zf)
{
    ...
    global_data_type** global_data_var_47_0;
    global_data_var_47_0 = &global_data;
    int* global_data_var_47_nproma_4;
    global_data_var_47_nproma_4 = (int*)(&((*global_data_var_47_0)->nproma));
    t_patch** p_patch_var_48_2;
    p_patch_var_48_2 = &p_patch;
    t_grid_cells** v_p_patch_var_48_cells;
    v_p_patch_var_48_cells = (t_grid_cells**)(&((*p_patch_var_48_2)->cells));
    int* v_v_p_patch_var_48_cells_start_index;
    v_v_p_patch_var_48_cells_start_index = (int*)(&((*v_p_patch_var_48_cells)->start_index)[0]);
    int* v_v_p_patch_var_48_cells_end_index;
    v_v_p_patch_var_48_cells_end_index = (int*)(&((*v_p_patch_var_48_cells)->end_index)[0]);
    t_patch** p_patch_var_48_0;
    p_patch_var_48_0 = &p_patch;
    global_data_type** global_data_var_47_1;
    global_data_var_47_1 = &global_data;
    int* global_data_var_47_nproma_3;
    global_data_var_47_nproma_3 = (int*)(&((*global_data_var_47_1)->nproma));
    t_patch** p_patch_var_48_1;
    p_patch_var_48_1 = &p_patch;
    global_data_type** global_data_var_47_2;
    global_data_var_47_2 = &global_data;
    int* global_data_var_47_nproma_2;
    global_data_var_47_nproma_2 = (int*)(&((*global_data_var_47_2)->nproma));
    t_patch** p_patch_var_60_0;
    p_patch_var_60_0 = &p_patch;
    t_grid_edges** v_p_patch_var_60_edges;
    v_p_patch_var_60_edges = (t_grid_edges**)(&((*p_patch_var_60_0)->edges));
    int* v_v_p_patch_var_60_edges_start_index;
    v_v_p_patch_var_60_edges_start_index = (int*)(&((*v_p_patch_var_60_edges)->start_index)[0]);
    int* v_v_p_patch_var_60_edges_end_index;
    v_v_p_patch_var_60_edges_end_index = (int*)(&((*v_p_patch_var_60_edges)->end_index)[0]);
    int _if_cond_6;
...

    {
        ...
        {
            int p_patch_0_in_edges_start_block_0 = v_v_p_patch_edges_start_block[(5 - __f2dace_SOA_start_block_d_0_s_224_edges_p_patch_9)];
            int i_startblk_out;
...

    {
        ...
        {
            int p_patch_0_in_edges_end_block_0 = v_v_p_patch_edges_end_block[((- __f2dace_SOA_end_block_d_0_s_225_edges_p_patch_9) - 10)];
            int i_endblk_out;
    ...
    for (_for_it_0 = i_startblk; (_for_it_0 <= i_endblk); _for_it_0 = (_for_it_0 + 1)) {
        ...
        i_startidx_in_var_69_0 = v_v_p_patch_var_60_edges_start_index[(5 - __f2dace_SOA_start_index_d_0_s_222_edges_p_patch_9)];
        {


        }
        i_endidx_in_var_70_0 = v_v_p_patch_var_60_edges_end_index[((- __f2dace_SOA_end_index_d_0_s_223_edges_p_patch_9) - 10)];
        ...
        if (tmp_arg_1_0_0) {
            {
                global_data_type** global_data_var_59_0;
                global_data_var_59_0 = &global_data;
                int* global_data_var_59_nproma_1;
                global_data_var_59_nproma_1 = (int*)(&((*global_data_var_59_0)->nproma));

                {
                    int nproma_var_13_0_in = global_data_var_59_nproma_1[0];
        ...
        for (_for_it_1 = 1; (_for_it_1 <= nlev); _for_it_1 = (_for_it_1 + 1)) {
            for (_for_it_2 = i_startidx; (_for_it_2 <= i_endidx); _for_it_2 = (_for_it_2 + 1)) {
                ...
                tmp_index_26 = (v_v_p_patch_edges_quad_idx[(((((__f2dace_SA_quad_idx_d_0_s_196_edges_p_patch_9 * __f2dace_SA_quad_idx_d_1_s_197_edges_p_patch_9) * (1 - __f2dace_SOA_quad_idx_d_2_s_198_edges_p_patch_9)) + (__f2dace_SA_quad_idx_d_0_s_196_edges_p_patch_9 * ((- __f2dace_SOA_quad_idx_d_1_s_197_edges_p_patch_9) + _for_it_0))) - __f2dace_SOA_quad_idx_d_0_s_196_edges_p_patch_9) + _for_it_2)] - __f2dace_SOA_vn_d_0_s_498_p_nh_prog_nnew_15);
                {


                }
                tmp_index_28 = (v_v_p_patch_edges_quad_blk[(((((__f2dace_SA_quad_blk_d_0_s_199_edges_p_patch_9 * __f2dace_SA_quad_blk_d_1_s_200_edges_p_patch_9) * (1 - __f2dace_SOA_quad_blk_d_2_s_201_edges_p_patch_9)) + (__f2dace_SA_quad_blk_d_0_s_199_edges_p_patch_9 * ((- __f2dace_SOA_quad_blk_d_1_s_200_edges_p_patch_9) + _for_it_0))) - __f2dace_SOA_quad_blk_d_0_s_199_edges_p_patch_9) + _for_it_2)] - __f2dace_SOA_vn_d_2_s_500_p_nh_prog_nnew_15);
                {


                }
                tmp_index_38 = (v_v_p_patch_edges_quad_idx[(((((__f2dace_SA_quad_idx_d_0_s_196_edges_p_patch_9 * __f2dace_SA_quad_idx_d_1_s_197_edges_p_patch_9) * (2 - __f2dace_SOA_quad_idx_d_2_s_198_edges_p_patch_9)) + (__f2dace_SA_quad_idx_d_0_s_196_edges_p_patch_9 * ((- __f2dace_SOA_quad_idx_d_1_s_197_edges_p_patch_9) + _for_it_0))) - __f2dace_SOA_quad_idx_d_0_s_196_edges_p_patch_9) + _for_it_2)] - __f2dace_SOA_vn_d_0_s_498_p_nh_prog_nnew_15);
                {


                }
                tmp_index_40 = (v_v_p_patch_edges_quad_blk[(((((__f2dace_SA_quad_blk_d_0_s_199_edges_p_patch_9 * __f2dace_SA_quad_blk_d_1_s_200_edges_p_patch_9) * (2 - __f2dace_SOA_quad_blk_d_2_s_201_edges_p_patch_9)) + (__f2dace_SA_quad_blk_d_0_s_199_edges_p_patch_9 * ((- __f2dace_SOA_quad_blk_d_1_s_200_edges_p_patch_9) + _for_it_0))) - __f2dace_SOA_quad_blk_d_0_s_199_edges_p_patch_9) + _for_it_2)] - __f2dace_SOA_vn_d_2_s_500_p_nh_prog_nnew_15);
                {


                }
                tmp_index_50 = (v_v_p_patch_edges_quad_idx[(((((__f2dace_SA_quad_idx_d_0_s_196_edges_p_patch_9 * __f2dace_SA_quad_idx_d_1_s_197_edges_p_patch_9) * (3 - __f2dace_SOA_quad_idx_d_2_s_198_edges_p_patch_9)) + (__f2dace_SA_quad_idx_d_0_s_196_edges_p_patch_9 * ((- __f2dace_SOA_quad_idx_d_1_s_197_edges_p_patch_9) + _for_it_0))) - __f2dace_SOA_quad_idx_d_0_s_196_edges_p_patch_9) + _for_it_2)] - __f2dace_SOA_vn_d_0_s_498_p_nh_prog_nnew_15);
                {


                }
                tmp_index_52 = (v_v_p_patch_edges_quad_blk[(((((__f2dace_SA_quad_blk_d_0_s_199_edges_p_patch_9 * __f2dace_SA_quad_blk_d_1_s_200_edges_p_patch_9) * (3 - __f2dace_SOA_quad_blk_d_2_s_201_edges_p_patch_9)) + (__f2dace_SA_quad_blk_d_0_s_199_edges_p_patch_9 * ((- __f2dace_SOA_quad_blk_d_1_s_200_edges_p_patch_9) + _for_it_0))) - __f2dace_SOA_quad_blk_d_0_s_199_edges_p_patch_9) + _for_it_2)] - __f2dace_SOA_vn_d_2_s_500_p_nh_prog_nnew_15);
                {


                }
                tmp_index_62 = (v_v_p_patch_edges_quad_idx[(((((__f2dace_SA_quad_idx_d_0_s_196_edges_p_patch_9 * __f2dace_SA_quad_idx_d_1_s_197_edges_p_patch_9) * (4 - __f2dace_SOA_quad_idx_d_2_s_198_edges_p_patch_9)) + (__f2dace_SA_quad_idx_d_0_s_196_edges_p_patch_9 * ((- __f2dace_SOA_quad_idx_d_1_s_197_edges_p_patch_9) + _for_it_0))) - __f2dace_SOA_quad_idx_d_0_s_196_edges_p_patch_9) + _for_it_2)] - __f2dace_SOA_vn_d_0_s_498_p_nh_prog_nnew_15);
                {


                }
                tmp_index_64 = (v_v_p_patch_edges_quad_blk[(((((__f2dace_SA_quad_blk_d_0_s_199_edges_p_patch_9 * __f2dace_SA_quad_blk_d_1_s_200_edges_p_patch_9) * (4 - __f2dace_SOA_quad_blk_d_2_s_201_edges_p_patch_9)) + (__f2dace_SA_quad_blk_d_0_s_199_edges_p_patch_9 * ((- __f2dace_SOA_quad_blk_d_1_s_200_edges_p_patch_9) + _for_it_0))) - __f2dace_SOA_quad_blk_d_0_s_199_edges_p_patch_9) + _for_it_2)] - __f2dace_SOA_vn_d_2_s_500_p_nh_prog_nnew_15);
                {


                }
                tmp_index_83 = (v_v_p_patch_edges_quad_idx[(((((__f2dace_SA_quad_idx_d_0_s_196_edges_p_patch_9 * __f2dace_SA_quad_idx_d_1_s_197_edges_p_patch_9) * (1 - __f2dace_SOA_quad_idx_d_2_s_198_edges_p_patch_9)) + (__f2dace_SA_quad_idx_d_0_s_196_edges_p_patch_9 * ((- __f2dace_SOA_quad_idx_d_1_s_197_edges_p_patch_9) + _for_it_0))) - __f2dace_SOA_quad_idx_d_0_s_196_edges_p_patch_9) + _for_it_2)] - __f2dace_SOA_vn_d_0_s_498_p_nh_prog_nnew_15);
                {
                    double* v_p_int_e_flx_avg;
                    v_p_int_e_flx_avg = (double*)(&(p_int->e_flx_avg)[0]);

                    {
                        double p_int_0_in_e_flx_avg_0 = v_p_int_e_flx_avg[(((((__f2dace_SA_e_flx_avg_d_0_s_47_p_int_5 * __f2dace_SA_e_flx_avg_d_1_s_48_p_int_5) * ((- __f2dace_SOA_e_flx_avg_d_2_s_49_p_int_5) + _for_it_0)) + (__f2dace_SA_e_flx_avg_d_0_s_47_p_int_5 * (1 - __f2dace_SOA_e_flx_avg_d_1_s_48_p_int_5))) - __f2dace_SOA_e_flx_avg_d_0_s_47_p_int_5) + _for_it_2)];
                        double p_int_1_in_e_flx_avg_0 = v_p_int_e_flx_avg[(((((__f2dace_SA_e_flx_avg_d_0_s_47_p_int_5 * __f2dace_SA_e_flx_avg_d_1_s_48_p_int_5) * ((- __f2dace_SOA_e_flx_avg_d_2_s_49_p_int_5) + _for_it_0)) + (__f2dace_SA_e_flx_avg_d_0_s_47_p_int_5 * (2 - __f2dace_SOA_e_flx_avg_d_1_s_48_p_int_5))) - __f2dace_SOA_e_flx_avg_d_0_s_47_p_int_5) + _for_it_2)];
                        double p_int_2_in_e_flx_avg_0 = v_p_int_e_flx_avg[(((((__f2dace_SA_e_flx_avg_d_0_s_47_p_int_5 * __f2dace_SA_e_flx_avg_d_1_s_48_p_int_5) * ((- __f2dace_SOA_e_flx_avg_d_2_s_49_p_int_5) + _for_it_0)) + (__f2dace_SA_e_flx_avg_d_0_s_47_p_int_5 * (3 - __f2dace_SOA_e_flx_avg_d_1_s_48_p_int_5))) - __f2dace_SOA_e_flx_avg_d_0_s_47_p_int_5) + _for_it_2)];
                        double p_int_3_in_e_flx_avg_0 = v_p_int_e_flx_avg[(((((__f2dace_SA_e_flx_avg_d_0_s_47_p_int_5 * __f2dace_SA_e_flx_avg_d_1_s_48_p_int_5) * ((- __f2dace_SOA_e_flx_avg_d_2_s_49_p_int_5) + _for_it_0)) + (__f2dace_SA_e_flx_avg_d_0_s_47_p_int_5 * (4 - __f2dace_SOA_e_flx_avg_d_1_s_48_p_int_5))) - __f2dace_SOA_e_flx_avg_d_0_s_47_p_int_5) + _for_it_2)];
                        double p_int_4_in_e_flx_avg_0 = v_p_int_e_flx_avg[(((((__f2dace_SA_e_flx_avg_d_0_s_47_p_int_5 * __f2dace_SA_e_flx_avg_d_1_s_48_p_int_5) * ((- __f2dace_SOA_e_flx_avg_d_2_s_49_p_int_5) + _for_it_0)) + (__f2dace_SA_e_flx_avg_d_0_s_47_p_int_5 * (5 - __f2dace_SOA_e_flx_avg_d_1_s_48_p_int_5))) - __f2dace_SOA_e_flx_avg_d_0_s_47_p_int_5) + _for_it_2)];
                        double p_nh_prog_nnew_0_in_vn_0 = v_p_nh_prog_nnew_vn[(((((__f2dace_SA_vn_d_0_s_498_p_nh_prog_nnew_15 * __f2dace_SA_vn_d_1_s_499_p_nh_prog_nnew_15) * ((- __f2dace_SOA_vn_d_2_s_500_p_nh_prog_nnew_15) + _for_it_0)) + (__f2dace_SA_vn_d_0_s_498_p_nh_prog_nnew_15 * ((- __f2dace_SOA_vn_d_1_s_499_p_nh_prog_nnew_15) + _for_it_1))) - __f2dace_SOA_vn_d_0_s_498_p_nh_prog_nnew_15) + _for_it_2)];
                        double p_nh_prog_nnew_1_in_vn_0 = v_p_nh_prog_nnew_vn[((((__f2dace_SA_vn_d_0_s_498_p_nh_prog_nnew_15 * __f2dace_SA_vn_d_1_s_499_p_nh_prog_nnew_15) * tmp_index_28) + (__f2dace_SA_vn_d_0_s_498_p_nh_prog_nnew_15 * ((- __f2dace_SOA_vn_d_1_s_499_p_nh_prog_nnew_15) + _for_it_1))) + tmp_index_26)];
                        double p_nh_prog_nnew_2_in_vn_0 = v_p_nh_prog_nnew_vn[((((__f2dace_SA_vn_d_0_s_498_p_nh_prog_nnew_15 * __f2dace_SA_vn_d_1_s_499_p_nh_prog_nnew_15) * tmp_index_40) + (__f2dace_SA_vn_d_0_s_498_p_nh_prog_nnew_15 * ((- __f2dace_SOA_vn_d_1_s_499_p_nh_prog_nnew_15) + _for_it_1))) + tmp_index_38)];
                        double p_nh_prog_nnew_3_in_vn_0 = v_p_nh_prog_nnew_vn[((((__f2dace_SA_vn_d_0_s_498_p_nh_prog_nnew_15 * __f2dace_SA_vn_d_1_s_499_p_nh_prog_nnew_15) * tmp_index_52) + (__f2dace_SA_vn_d_0_s_498_p_nh_prog_nnew_15 * ((- __f2dace_SOA_vn_d_1_s_499_p_nh_prog_nnew_15) + _for_it_1))) + tmp_index_50)];
                        double p_nh_prog_nnew_4_in_vn_0 = v_p_nh_prog_nnew_vn[((((__f2dace_SA_vn_d_0_s_498_p_nh_prog_nnew_15 * __f2dace_SA_vn_d_1_s_499_p_nh_prog_nnew_15) * tmp_index_64) + (__f2dace_SA_vn_d_0_s_498_p_nh_prog_nnew_15 * ((- __f2dace_SOA_vn_d_1_s_499_p_nh_prog_nnew_15) + _for_it_1))) + tmp_index_62)];
                ...
                tmp_index_85 = (v_v_p_patch_edges_quad_blk[(((((__f2dace_SA_quad_blk_d_0_s_199_edges_p_patch_9 * __f2dace_SA_quad_blk_d_1_s_200_edges_p_patch_9) * (1 - __f2dace_SOA_quad_blk_d_2_s_201_edges_p_patch_9)) + (__f2dace_SA_quad_blk_d_0_s_199_edges_p_patch_9 * ((- __f2dace_SOA_quad_blk_d_1_s_200_edges_p_patch_9) + _for_it_0))) - __f2dace_SOA_quad_blk_d_0_s_199_edges_p_patch_9) + _for_it_2)] - __f2dace_SOA_vn_d_2_s_500_p_nh_prog_nnew_15);
                {
                ...
                tmp_index_97 = (v_v_p_patch_edges_quad_blk[(((((__f2dace_SA_quad_blk_d_0_s_199_edges_p_patch_9 * __f2dace_SA_quad_blk_d_1_s_200_edges_p_patch_9) * (2 - __f2dace_SOA_quad_blk_d_2_s_201_edges_p_patch_9)) + (__f2dace_SA_quad_blk_d_0_s_199_edges_p_patch_9 * ((- __f2dace_SOA_quad_blk_d_1_s_200_edges_p_patch_9) + _for_it_0))) - __f2dace_SOA_quad_blk_d_0_s_199_edges_p_patch_9) + _for_it_2)] - __f2dace_SOA_vn_d_2_s_500_p_nh_prog_nnew_15);
                {


                }
                tmp_index_107 = (v_v_p_patch_edges_quad_idx[(((((__f2dace_SA_quad_idx_d_0_s_196_edges_p_patch_9 * __f2dace_SA_quad_idx_d_1_s_197_edges_p_patch_9) * (3 - __f2dace_SOA_quad_idx_d_2_s_198_edges_p_patch_9)) + (__f2dace_SA_quad_idx_d_0_s_196_edges_p_patch_9 * ((- __f2dace_SOA_quad_idx_d_1_s_197_edges_p_patch_9) + _for_it_0))) - __f2dace_SOA_quad_idx_d_0_s_196_edges_p_patch_9) + _for_it_2)] - __f2dace_SOA_vn_d_0_s_498_p_nh_prog_nnew_15);
                {


                }
                tmp_index_109 = (v_v_p_patch_edges_quad_blk[(((((__f2dace_SA_quad_blk_d_0_s_199_edges_p_patch_9 * __f2dace_SA_quad_blk_d_1_s_200_edges_p_patch_9) * (3 - __f2dace_SOA_quad_blk_d_2_s_201_edges_p_patch_9)) + (__f2dace_SA_quad_blk_d_0_s_199_edges_p_patch_9 * ((- __f2dace_SOA_quad_blk_d_1_s_200_edges_p_patch_9) + _for_it_0))) - __f2dace_SOA_quad_blk_d_0_s_199_edges_p_patch_9) + _for_it_2)] - __f2dace_SOA_vn_d_2_s_500_p_nh_prog_nnew_15);
                {


                }
                tmp_index_119 = (v_v_p_patch_edges_quad_idx[(((((__f2dace_SA_quad_idx_d_0_s_196_edges_p_patch_9 * __f2dace_SA_quad_idx_d_1_s_197_edges_p_patch_9) * (4 - __f2dace_SOA_quad_idx_d_2_s_198_edges_p_patch_9)) + (__f2dace_SA_quad_idx_d_0_s_196_edges_p_patch_9 * ((- __f2dace_SOA_quad_idx_d_1_s_197_edges_p_patch_9) + _for_it_0))) - __f2dace_SOA_quad_idx_d_0_s_196_edges_p_patch_9) + _for_it_2)] - __f2dace_SOA_vn_d_0_s_498_p_nh_prog_nnew_15);
                {


                }
                tmp_index_121 = (v_v_p_patch_edges_quad_blk[(((((__f2dace_SA_quad_blk_d_0_s_199_edges_p_patch_9 * __f2dace_SA_quad_blk_d_1_s_200_edges_p_patch_9) * (4 - __f2dace_SOA_quad_blk_d_2_s_201_edges_p_patch_9)) + (__f2dace_SA_quad_blk_d_0_s_199_edges_p_patch_9 * ((- __f2dace_SOA_quad_blk_d_1_s_200_edges_p_patch_9) + _for_it_0))) - __f2dace_SOA_quad_blk_d_0_s_199_edges_p_patch_9) + _for_it_2)] - __f2dace_SOA_vn_d_2_s_500_p_nh_prog_nnew_15);
                {


                }
                tmp_index_134 = (v_v_p_patch_edges_quad_idx[(((((__f2dace_SA_quad_idx_d_0_s_196_edges_p_patch_9 * __f2dace_SA_quad_idx_d_1_s_197_edges_p_patch_9) * (1 - __f2dace_SOA_quad_idx_d_2_s_198_edges_p_patch_9)) + (__f2dace_SA_quad_idx_d_0_s_196_edges_p_patch_9 * ((- __f2dace_SOA_quad_idx_d_1_s_197_edges_p_patch_9) + _for_it_0))) - __f2dace_SOA_quad_idx_d_0_s_196_edges_p_patch_9) + _for_it_2)] - __f2dace_SOA_vn_d_0_s_498_p_nh_prog_nnew_15);
                {
                    double* v_p_int_geofac_grdiv;
                    v_p_int_geofac_grdiv = (double*)(&(p_int->geofac_grdiv)[0]);

                    {
                        double p_int_0_in_geofac_grdiv_0 = v_p_int_geofac_grdiv[(((((__f2dace_SA_geofac_grdiv_d_0_s_59_p_int_5 * __f2dace_SA_geofac_grdiv_d_1_s_60_p_int_5) * ((- __f2dace_SOA_geofac_grdiv_d_2_s_61_p_int_5) + _for_it_0)) + (__f2dace_SA_geofac_grdiv_d_0_s_59_p_int_5 * (1 - __f2dace_SOA_geofac_grdiv_d_1_s_60_p_int_5))) - __f2dace_SOA_geofac_grdiv_d_0_s_59_p_int_5) + _for_it_2)];
                        double p_int_1_in_geofac_grdiv_0 = v_p_int_geofac_grdiv[(((((__f2dace_SA_geofac_grdiv_d_0_s_59_p_int_5 * __f2dace_SA_geofac_grdiv_d_1_s_60_p_int_5) * ((- __f2dace_SOA_geofac_grdiv_d_2_s_61_p_int_5) + _for_it_0)) + (__f2dace_SA_geofac_grdiv_d_0_s_59_p_int_5 * (2 - __f2dace_SOA_geofac_grdiv_d_1_s_60_p_int_5))) - __f2dace_SOA_geofac_grdiv_d_0_s_59_p_int_5) + _for_it_2)];
                        double p_int_2_in_geofac_grdiv_0 = v_p_int_geofac_grdiv[(((((__f2dace_SA_geofac_grdiv_d_0_s_59_p_int_5 * __f2dace_SA_geofac_grdiv_d_1_s_60_p_int_5) * ((- __f2dace_SOA_geofac_grdiv_d_2_s_61_p_int_5) + _for_it_0)) + (__f2dace_SA_geofac_grdiv_d_0_s_59_p_int_5 * (3 - __f2dace_SOA_geofac_grdiv_d_1_s_60_p_int_5))) - __f2dace_SOA_geofac_grdiv_d_0_s_59_p_int_5) + _for_it_2)];
                        ...
                        double p_nh_prog_nnew_0_in_vn_0 = v_p_nh_prog_nnew_vn[(((((__f2dace_SA_vn_d_0_s_498_p_nh_prog_nnew_15 * __f2dace_SA_vn_d_1_s_499_p_nh_prog_nnew_15) * ((- __f2dace_SOA_vn_d_2_s_500_p_nh_prog_nnew_15) + _for_it_0)) + (__f2dace_SA_vn_d_0_s_498_p_nh_prog_nnew_15 * ((- __f2dace_SOA_vn_d_1_s_499_p_nh_prog_nnew_15) + _for_it_1))) - __f2dace_SOA_vn_d_0_s_498_p_nh_prog_nnew_15) + _for_it_2)];
                        double p_nh_prog_nnew_1_in_vn_0 = v_p_nh_prog_nnew_vn[((((__f2dace_SA_vn_d_0_s_498_p_nh_prog_nnew_15 * __f2dace_SA_vn_d_1_s_499_p_nh_prog_nnew_15) * tmp_index_85) + (__f2dace_SA_vn_d_0_s_498_p_nh_prog_nnew_15 * ((- __f2dace_SOA_vn_d_1_s_499_p_nh_prog_nnew_15) + _for_it_1))) + tmp_index_83)];
                        double p_nh_prog_nnew_2_in_vn_0 = v_p_nh_prog_nnew_vn[((((__f2dace_SA_vn_d_0_s_498_p_nh_prog_nnew_15 * __f2dace_SA_vn_d_1_s_499_p_nh_prog_nnew_15) * tmp_index_97) + (__f2dace_SA_vn_d_0_s_498_p_nh_prog_nnew_15 * ((- __f2dace_SOA_vn_d_1_s_499_p_nh_prog_nnew_15) + _for_it_1))) + tmp_index_95)];
                        double p_nh_prog_nnew_3_in_vn_0 = v_p_nh_prog_nnew_vn[((((__f2dace_SA_vn_d_0_s_498_p_nh_prog_nnew_15 * __f2dace_SA_vn_d_1_s_499_p_nh_prog_nnew_15) * tmp_index_109) + (__f2dace_SA_vn_d_0_s_498_p_nh_prog_nnew_15 * ((- __f2dace_SOA_vn_d_1_s_499_p_nh_prog_nnew_15) + _for_it_1))) + tmp_index_107)];
                        double p_nh_prog_nnew_4_in_vn_0 = v_p_nh_prog_nnew_vn[((((__f2dace_SA_vn_d_0_s_498_p_nh_prog_nnew_15 * __f2dace_SA_vn_d_1_s_499_p_nh_prog_nnew_15) * tmp_index_121) + (__f2dace_SA_vn_d_0_s_498_p_nh_prog_nnew_15 * ((- __f2dace_SOA_vn_d_1_s_499_p_nh_prog_nnew_15) + _for_it_1))) + tmp_index_119)];
                ...
                tmp_index_136 = (v_v_p_patch_edges_quad_blk[(((((__f2dace_SA_quad_blk_d_0_s_199_edges_p_patch_9 * __f2dace_SA_quad_blk_d_1_s_200_edges_p_patch_9) * (1 - __f2dace_SOA_quad_blk_d_2_s_201_edges_p_patch_9)) + (__f2dace_SA_quad_blk_d_0_s_199_edges_p_patch_9 * ((- __f2dace_SOA_quad_blk_d_1_s_200_edges_p_patch_9) + _for_it_0))) - __f2dace_SOA_quad_blk_d_0_s_199_edges_p_patch_9) + _for_it_2)] - __f2dace_SOA_vn_d_2_s_500_p_nh_prog_nnew_15);
                {


                }
                tmp_index_146 = (v_v_p_patch_edges_quad_idx[(((((__f2dace_SA_quad_idx_d_0_s_196_edges_p_patch_9 * __f2dace_SA_quad_idx_d_1_s_197_edges_p_patch_9) * (2 - __f2dace_SOA_quad_idx_d_2_s_198_edges_p_patch_9)) + (__f2dace_SA_quad_idx_d_0_s_196_edges_p_patch_9 * ((- __f2dace_SOA_quad_idx_d_1_s_197_edges_p_patch_9) + _for_it_0))) - __f2dace_SOA_quad_idx_d_0_s_196_edges_p_patch_9) + _for_it_2)] - __f2dace_SOA_vn_d_0_s_498_p_nh_prog_nnew_15);
                {


                }
                tmp_index_148 = (v_v_p_patch_edges_quad_blk[(((((__f2dace_SA_quad_blk_d_0_s_199_edges_p_patch_9 * __f2dace_SA_quad_blk_d_1_s_200_edges_p_patch_9) * (2 - __f2dace_SOA_quad_blk_d_2_s_201_edges_p_patch_9)) + (__f2dace_SA_quad_blk_d_0_s_199_edges_p_patch_9 * ((- __f2dace_SOA_quad_blk_d_1_s_200_edges_p_patch_9) + _for_it_0))) - __f2dace_SOA_quad_blk_d_0_s_199_edges_p_patch_9) + _for_it_2)] - __f2dace_SOA_vn_d_2_s_500_p_nh_prog_nnew_15);
                {
                ...
                tmp_index_160 = (v_v_p_patch_edges_quad_blk[(((((__f2dace_SA_quad_blk_d_0_s_199_edges_p_patch_9 * __f2dace_SA_quad_blk_d_1_s_200_edges_p_patch_9) * (3 - __f2dace_SOA_quad_blk_d_2_s_201_edges_p_patch_9)) + (__f2dace_SA_quad_blk_d_0_s_199_edges_p_patch_9 * ((- __f2dace_SOA_quad_blk_d_1_s_200_edges_p_patch_9) + _for_it_0))) - __f2dace_SOA_quad_blk_d_0_s_199_edges_p_patch_9) + _for_it_2)] - __f2dace_SOA_vn_d_2_s_500_p_nh_prog_nnew_15);
                {


                }
                tmp_index_170 = (v_v_p_patch_edges_quad_idx[(((((__f2dace_SA_quad_idx_d_0_s_196_edges_p_patch_9 * __f2dace_SA_quad_idx_d_1_s_197_edges_p_patch_9) * (4 - __f2dace_SOA_quad_idx_d_2_s_198_edges_p_patch_9)) + (__f2dace_SA_quad_idx_d_0_s_196_edges_p_patch_9 * ((- __f2dace_SOA_quad_idx_d_1_s_197_edges_p_patch_9) + _for_it_0))) - __f2dace_SOA_quad_idx_d_0_s_196_edges_p_patch_9) + _for_it_2)] - __f2dace_SOA_vn_d_0_s_498_p_nh_prog_nnew_15);
                {
                ...
                tmp_index_172 = (v_v_p_patch_edges_quad_blk[(((((__f2dace_SA_quad_blk_d_0_s_199_edges_p_patch_9 * __f2dace_SA_quad_blk_d_1_s_200_edges_p_patch_9) * (4 - __f2dace_SOA_quad_blk_d_2_s_201_edges_p_patch_9)) + (__f2dace_SA_quad_blk_d_0_s_199_edges_p_patch_9 * ((- __f2dace_SOA_quad_blk_d_1_s_200_edges_p_patch_9) + _for_it_0))) - __f2dace_SOA_quad_blk_d_0_s_199_edges_p_patch_9) + _for_it_2)] - __f2dace_SOA_vn_d_2_s_500_p_nh_prog_nnew_15);
                {
                    ...
                    {
                        double p_int_0_in_rbf_vec_coeff_e_0 = v_p_int_rbf_vec_coeff_e[(((((__f2dace_SA_rbf_vec_coeff_e_d_0_s_53_p_int_5 * __f2dace_SA_rbf_vec_coeff_e_d_1_s_54_p_int_5) * ((- __f2dace_SOA_rbf_vec_coeff_e_d_2_s_55_p_int_5) + _for_it_0)) + (__f2dace_SA_rbf_vec_coeff_e_d_0_s_53_p_int_5 * ((- __f2dace_SOA_rbf_vec_coeff_e_d_1_s_54_p_int_5) + _for_it_2))) - __f2dace_SOA_rbf_vec_coeff_e_d_0_s_53_p_int_5) + 1)];
                        double p_int_1_in_rbf_vec_coeff_e_0 = v_p_int_rbf_vec_coeff_e[(((((__f2dace_SA_rbf_vec_coeff_e_d_0_s_53_p_int_5 * __f2dace_SA_rbf_vec_coeff_e_d_1_s_54_p_int_5) * ((- __f2dace_SOA_rbf_vec_coeff_e_d_2_s_55_p_int_5) + _for_it_0)) + (__f2dace_SA_rbf_vec_coeff_e_d_0_s_53_p_int_5 * ((- __f2dace_SOA_rbf_vec_coeff_e_d_1_s_54_p_int_5) + _for_it_2))) - __f2dace_SOA_rbf_vec_coeff_e_d_0_s_53_p_int_5) + 2)];
                        double p_int_2_in_rbf_vec_coeff_e_0 = v_p_int_rbf_vec_coeff_e[(((((__f2dace_SA_rbf_vec_coeff_e_d_0_s_53_p_int_5 * __f2dace_SA_rbf_vec_coeff_e_d_1_s_54_p_int_5) * ((- __f2dace_SOA_rbf_vec_coeff_e_d_2_s_55_p_int_5) + _for_it_0)) + (__f2dace_SA_rbf_vec_coeff_e_d_0_s_53_p_int_5 * ((- __f2dace_SOA_rbf_vec_coeff_e_d_1_s_54_p_int_5) + _for_it_2))) - __f2dace_SOA_rbf_vec_coeff_e_d_0_s_53_p_int_5) + 3)];
                        double p_int_3_in_rbf_vec_coeff_e_0 = v_p_int_rbf_vec_coeff_e[(((((__f2dace_SA_rbf_vec_coeff_e_d_0_s_53_p_int_5 * __f2dace_SA_rbf_vec_coeff_e_d_1_s_54_p_int_5) * ((- __f2dace_SOA_rbf_vec_coeff_e_d_2_s_55_p_int_5) + _for_it_0)) + (__f2dace_SA_rbf_vec_coeff_e_d_0_s_53_p_int_5 * ((- __f2dace_SOA_rbf_vec_coeff_e_d_1_s_54_p_int_5) + _for_it_2))) - __f2dace_SOA_rbf_vec_coeff_e_d_0_s_53_p_int_5) + 4)];
                        double p_nh_prog_nnew_0_in_vn_0 = v_p_nh_prog_nnew_vn[((((__f2dace_SA_vn_d_0_s_498_p_nh_prog_nnew_15 * __f2dace_SA_vn_d_1_s_499_p_nh_prog_nnew_15) * tmp_index_136) + (__f2dace_SA_vn_d_0_s_498_p_nh_prog_nnew_15 * ((- __f2dace_SOA_vn_d_1_s_499_p_nh_prog_nnew_15) + _for_it_1))) + tmp_index_134)];
                        double p_nh_prog_nnew_1_in_vn_0 = v_p_nh_prog_nnew_vn[((((__f2dace_SA_vn_d_0_s_498_p_nh_prog_nnew_15 * __f2dace_SA_vn_d_1_s_499_p_nh_prog_nnew_15) * tmp_index_148) + (__f2dace_SA_vn_d_0_s_498_p_nh_prog_nnew_15 * ((- __f2dace_SOA_vn_d_1_s_499_p_nh_prog_nnew_15) + _for_it_1))) + tmp_index_146)];
                        double p_nh_prog_nnew_2_in_vn_0 = v_p_nh_prog_nnew_vn[((((__f2dace_SA_vn_d_0_s_498_p_nh_prog_nnew_15 * __f2dace_SA_vn_d_1_s_499_p_nh_prog_nnew_15) * tmp_index_160) + (__f2dace_SA_vn_d_0_s_498_p_nh_prog_nnew_15 * ((- __f2dace_SOA_vn_d_1_s_499_p_nh_prog_nnew_15) + _for_it_1))) + tmp_index_158)];
                        double p_nh_prog_nnew_3_in_vn_0 = v_p_nh_prog_nnew_vn[((((__f2dace_SA_vn_d_0_s_498_p_nh_prog_nnew_15 * __f2dace_SA_vn_d_1_s_499_p_nh_prog_nnew_15) * tmp_index_172) + (__f2dace_SA_vn_d_0_s_498_p_nh_prog_nnew_15 * ((- __f2dace_SOA_vn_d_1_s_499_p_nh_prog_nnew_15) + _for_it_1))) + tmp_index_170)];
                        ...
                        v_v_p_nh_diag_vt[(((((__f2dace_SA_vt_d_0_s_579_diag_p_nh_2 * __f2dace_SA_vt_d_1_s_580_diag_p_nh_2) * ((- __f2dace_SOA_vt_d_2_s_581_diag_p_nh_2) + _for_it_0)) + (__f2dace_SA_vt_d_0_s_579_diag_p_nh_2 * ((- __f2dace_SOA_vt_d_1_s_580_diag_p_nh_2) + _for_it_1))) - __f2dace_SOA_vt_d_0_s_579_diag_p_nh_2) + _for_it_2)] = p_nh_out_diag_vt_0;
                    }
            ...
            for (_for_it_6 = i_startidx; (_for_it_6 <= i_endidx); _for_it_6 = (_for_it_6 + 1)) {
                {
                    ...
                    {
                        double p_nh_0_in_metrics_ddxn_z_full_0 = v_v_p_nh_metrics_ddxn_z_full[(((((__f2dace_SA_ddxn_z_full_d_0_s_654_metrics_p_nh_4 * __f2dace_SA_ddxn_z_full_d_1_s_655_metrics_p_nh_4) * ((- __f2dace_SOA_ddxn_z_full_d_2_s_656_metrics_p_nh_4) + _for_it_0)) + (__f2dace_SA_ddxn_z_full_d_0_s_654_metrics_p_nh_4 * ((- __f2dace_SOA_ddxn_z_full_d_1_s_655_metrics_p_nh_4) + _for_it_5))) - __f2dace_SOA_ddxn_z_full_d_0_s_654_metrics_p_nh_4) + _for_it_6)];
                        double p_nh_1_in_diag_vt_0 = v_v_p_nh_diag_vt[(((((__f2dace_SA_vt_d_0_s_579_diag_p_nh_2 * __f2dace_SA_vt_d_1_s_580_diag_p_nh_2) * ((- __f2dace_SOA_vt_d_2_s_581_diag_p_nh_2) + _for_it_0)) + (__f2dace_SA_vt_d_0_s_579_diag_p_nh_2 * ((- __f2dace_SOA_vt_d_1_s_580_diag_p_nh_2) + _for_it_5))) - __f2dace_SOA_vt_d_0_s_579_diag_p_nh_2) + _for_it_6)];
            ...
            for (_for_it_8 = i_startidx; (_for_it_8 <= i_endidx); _for_it_8 = (_for_it_8 + 1)) {
                {
...

                    {
                        ...
                        v_v_p_nh_diag_vn_ie[(((((__f2dace_SA_vn_ie_d_0_s_591_diag_p_nh_2 * __f2dace_SA_vn_ie_d_1_s_592_diag_p_nh_2) * ((- __f2dace_SOA_vn_ie_d_2_s_593_diag_p_nh_2) + _for_it_0)) + (__f2dace_SA_vn_ie_d_0_s_591_diag_p_nh_2 * ((- __f2dace_SOA_vn_ie_d_1_s_592_diag_p_nh_2) + _for_it_7))) - __f2dace_SOA_vn_ie_d_0_s_591_diag_p_nh_2) + _for_it_8)] = p_nh_out_diag_vn_ie_0;
                    }
                    {
                        double p_nh_0_in_metrics_wgtfac_e_0 = v_v_p_nh_metrics_wgtfac_e[(((((__f2dace_SA_wgtfac_e_d_0_s_672_metrics_p_nh_4 * __f2dace_SA_wgtfac_e_d_1_s_673_metrics_p_nh_4) * ((- __f2dace_SOA_wgtfac_e_d_2_s_674_metrics_p_nh_4) + _for_it_0)) + (__f2dace_SA_wgtfac_e_d_0_s_672_metrics_p_nh_4 * ((- __f2dace_SOA_wgtfac_e_d_1_s_673_metrics_p_nh_4) + _for_it_7))) - __f2dace_SOA_wgtfac_e_d_0_s_672_metrics_p_nh_4) + _for_it_8)];
                        double p_nh_1_in_diag_vt_0 = v_v_p_nh_diag_vt[(((((__f2dace_SA_vt_d_0_s_579_diag_p_nh_2 * __f2dace_SA_vt_d_1_s_580_diag_p_nh_2) * ((- __f2dace_SOA_vt_d_2_s_581_diag_p_nh_2) + _for_it_0)) + (__f2dace_SA_vt_d_0_s_579_diag_p_nh_2 * ((- __f2dace_SOA_vt_d_1_s_580_diag_p_nh_2) + _for_it_7))) - __f2dace_SOA_vt_d_0_s_579_diag_p_nh_2) + _for_it_8)];
                        double p_nh_2_in_metrics_wgtfac_e_0 = v_v_p_nh_metrics_wgtfac_e[(((((__f2dace_SA_wgtfac_e_d_0_s_672_metrics_p_nh_4 * __f2dace_SA_wgtfac_e_d_1_s_673_metrics_p_nh_4) * ((- __f2dace_SOA_wgtfac_e_d_2_s_674_metrics_p_nh_4) + _for_it_0)) + (__f2dace_SA_wgtfac_e_d_0_s_672_metrics_p_nh_4 * ((- __f2dace_SOA_wgtfac_e_d_1_s_673_metrics_p_nh_4) + _for_it_7))) - __f2dace_SOA_wgtfac_e_d_0_s_672_metrics_p_nh_4) + _for_it_8)];
                        double p_nh_3_in_diag_vt_0 = v_v_p_nh_diag_vt[(((((__f2dace_SA_vt_d_0_s_579_diag_p_nh_2 * __f2dace_SA_vt_d_1_s_580_diag_p_nh_2) * ((- __f2dace_SOA_vt_d_2_s_581_diag_p_nh_2) + _for_it_0)) + (__f2dace_SA_vt_d_0_s_579_diag_p_nh_2 * (((- __f2dace_SOA_vt_d_1_s_580_diag_p_nh_2) + _for_it_7) - 1))) - __f2dace_SOA_vt_d_0_s_579_diag_p_nh_2) + _for_it_8)];
                ...
                }
                {
                    ...
                    {
                        double p_nh_0_in_diag_vt_0 = v_v_p_nh_diag_vt[(((((__f2dace_SA_vt_d_0_s_579_diag_p_nh_2 * __f2dace_SA_vt_d_1_s_580_diag_p_nh_2) * ((- __f2dace_SOA_vt_d_2_s_581_diag_p_nh_2) + _for_it_0)) + (__f2dace_SA_vt_d_0_s_579_diag_p_nh_2 * ((- __f2dace_SOA_vt_d_1_s_580_diag_p_nh_2) + _for_it_7))) - __f2dace_SOA_vt_d_0_s_579_diag_p_nh_2) + _for_it_8)];
            ...
            for (_for_it_9 = i_startidx; (_for_it_9 <= i_endidx); _for_it_9 = (_for_it_9 + 1)) {
                {
                    ...
                    {
                        double p_nh_0_in_diag_vt_0 = v_v_p_nh_diag_vt[(((((__f2dace_SA_vt_d_0_s_579_diag_p_nh_2 * __f2dace_SA_vt_d_1_s_580_diag_p_nh_2) * ((- __f2dace_SOA_vt_d_2_s_581_diag_p_nh_2) + _for_it_0)) + (__f2dace_SA_vt_d_0_s_579_diag_p_nh_2 * (1 - __f2dace_SOA_vt_d_1_s_580_diag_p_nh_2))) - __f2dace_SOA_vt_d_0_s_579_diag_p_nh_2) + _for_it_9)];
                        double z_vt_ie_out_0;
                ...
                }
                {

                    {
                        ...
                        double p_nh_1_in_metrics_wgtfacq_e_0 = v_v_p_nh_metrics_wgtfacq_e[(((((__f2dace_SA_wgtfacq_e_d_0_s_678_metrics_p_nh_4 * __f2dace_SA_wgtfacq_e_d_1_s_679_metrics_p_nh_4) * ((- __f2dace_SOA_wgtfacq_e_d_2_s_680_metrics_p_nh_4) + _for_it_0)) + (__f2dace_SA_wgtfacq_e_d_0_s_678_metrics_p_nh_4 * (2 - __f2dace_SOA_wgtfacq_e_d_1_s_679_metrics_p_nh_4))) - __f2dace_SOA_wgtfacq_e_d_0_s_678_metrics_p_nh_4) + _for_it_9)];
                        ...
                        double p_nh_prog_nnew_2_in_vn_0 = v_p_nh_prog_nnew_vn[(((((__f2dace_SA_vn_d_0_s_498_p_nh_prog_nnew_15 * __f2dace_SA_vn_d_1_s_499_p_nh_prog_nnew_15) * ((- __f2dace_SOA_vn_d_2_s_500_p_nh_prog_nnew_15) + _for_it_0)) + (__f2dace_SA_vn_d_0_s_498_p_nh_prog_nnew_15 * tmp_index_288)) - __f2dace_SOA_vn_d_0_s_498_p_nh_prog_nnew_15) + _for_it_9)];
                        double p_nh_out_diag_vn_ie_0;
                        ...
                        v_v_p_nh_diag_vn_ie[(((((__f2dace_SA_vn_ie_d_0_s_591_diag_p_nh_2 * __f2dace_SA_vn_ie_d_1_s_592_diag_p_nh_2) * ((- __f2dace_SOA_vn_ie_d_2_s_593_diag_p_nh_2) + _for_it_0)) + (__f2dace_SA_vn_ie_d_0_s_591_diag_p_nh_2 * tmp_index_270)) - __f2dace_SOA_vn_ie_d_0_s_591_diag_p_nh_2) + _for_it_9)] = p_nh_out_diag_vn_ie_0;
                    }
            ...
            for (_for_it_10 = i_startidx; (_for_it_10 <= i_endidx); _for_it_10 = (_for_it_10 + 1)) {
                {
                    ...
                    {
                        double p_nh_0_in_diag_vt_0 = v_v_p_nh_diag_vt[(((((__f2dace_SA_vt_d_0_s_579_diag_p_nh_2 * __f2dace_SA_vt_d_1_s_580_diag_p_nh_2) * ((- __f2dace_SOA_vt_d_2_s_581_diag_p_nh_2) + _for_it_0)) + (__f2dace_SA_vt_d_0_s_579_diag_p_nh_2 * (1 - __f2dace_SOA_vt_d_1_s_580_diag_p_nh_2))) - __f2dace_SOA_vt_d_0_s_579_diag_p_nh_2) + _for_it_10)];
                        double z_vt_ie_out_0;
                ...
                }
                {

                    {
                        ...
                        v_v_p_nh_diag_vn_ie[(((((__f2dace_SA_vn_ie_d_0_s_591_diag_p_nh_2 * __f2dace_SA_vn_ie_d_1_s_592_diag_p_nh_2) * ((- __f2dace_SOA_vn_ie_d_2_s_593_diag_p_nh_2) + _for_it_0)) + (__f2dace_SA_vn_ie_d_0_s_591_diag_p_nh_2 * tmp_index_315)) - __f2dace_SOA_vn_ie_d_0_s_591_diag_p_nh_2) + _for_it_10)] = p_nh_out_diag_vn_ie_0;
                    }
        ...
        for (_for_it_11 = 1; (_for_it_11 <= *v_v_p_nh_metrics_bdy_mflx_e_dim); _for_it_11 = (_for_it_11 + 1)) {
            {
                ...
                {
                    int p_nh_0_in_metrics_bdy_mflx_e_idx_0 = v_v_p_nh_metrics_bdy_mflx_e_idx[((- __f2dace_SOA_bdy_mflx_e_idx_d_0_s_739_metrics_p_nh_4) + _for_it_11)];
                    int je_out;
            ...
            }
            {
                ...
                {
                    int p_nh_0_in_metrics_bdy_mflx_e_blk_0 = v_v_p_nh_metrics_bdy_mflx_e_blk[((- __f2dace_SOA_bdy_mflx_e_blk_d_0_s_740_metrics_p_nh_4) + _for_it_11)];
                    int jb_out;
            ...
            for (_for_it_12 = 1; (_for_it_12 <= nlev); _for_it_12 = (_for_it_12 + 1)) {
                ...
                tmp_index_354 = (jb - 1);
                {
...

                    {
                        ...
                        double p_nh_0_in_diag_grf_bdy_mflx_0 = v_v_p_nh_diag_grf_bdy_mflx[(((((__f2dace_SA_grf_bdy_mflx_d_0_s_534_diag_p_nh_2 * __f2dace_SA_grf_bdy_mflx_d_1_s_535_diag_p_nh_2) * (1 - __f2dace_SOA_grf_bdy_mflx_d_2_s_536_diag_p_nh_2)) + (__f2dace_SA_grf_bdy_mflx_d_0_s_534_diag_p_nh_2 * ((- __f2dace_SOA_grf_bdy_mflx_d_1_s_535_diag_p_nh_2) + _for_it_11))) - __f2dace_SOA_grf_bdy_mflx_d_0_s_534_diag_p_nh_2) + _for_it_12)];
                        double p_nh_1_in_diag_grf_bdy_mflx_0 = v_v_p_nh_diag_grf_bdy_mflx[(((((__f2dace_SA_grf_bdy_mflx_d_0_s_534_diag_p_nh_2 * __f2dace_SA_grf_bdy_mflx_d_1_s_535_diag_p_nh_2) * (2 - __f2dace_SOA_grf_bdy_mflx_d_2_s_536_diag_p_nh_2)) + (__f2dace_SA_grf_bdy_mflx_d_0_s_534_diag_p_nh_2 * ((- __f2dace_SOA_grf_bdy_mflx_d_1_s_535_diag_p_nh_2) + _for_it_11))) - __f2dace_SOA_grf_bdy_mflx_d_0_s_534_diag_p_nh_2) + _for_it_12)];
                        ...
                        v_v_p_nh_diag_mass_fl_e[((((__f2dace_SA_mass_fl_e_d_0_s_513_diag_p_nh_2 * __f2dace_SA_mass_fl_e_d_1_s_514_diag_p_nh_2) * tmp_index_339) + (__f2dace_SA_mass_fl_e_d_0_s_513_diag_p_nh_2 * ((- __f2dace_SOA_mass_fl_e_d_1_s_514_diag_p_nh_2) + _for_it_12))) + tmp_index_337)] = p_nh_out_diag_mass_fl_e_0;
                    }
                    {
                        double p_nh_0_in_diag_mass_fl_e_0 = v_v_p_nh_diag_mass_fl_e[((((__f2dace_SA_mass_fl_e_d_0_s_513_diag_p_nh_2 * __f2dace_SA_mass_fl_e_d_1_s_514_diag_p_nh_2) * tmp_index_351) + (__f2dace_SA_mass_fl_e_d_0_s_513_diag_p_nh_2 * ((- __f2dace_SOA_mass_fl_e_d_1_s_514_diag_p_nh_2) + _for_it_12))) + tmp_index_349)];
...

    {
        ...
        {
            int p_patch_0_in_cells_start_block_0 = v_v_p_patch_cells_start_block[(3 - __f2dace_SOA_start_block_d_0_s_178_cells_p_patch_7)];
            int i_startblk_out;
...

    {
        ...
        {
            int p_patch_0_in_cells_end_block_0 = v_v_p_patch_cells_end_block[((- __f2dace_SOA_end_block_d_0_s_181_cells_p_patch_7) - 5)];
            int i_endblk_out;
    ...
    for (_for_it_13 = i_startblk; (_for_it_13 <= i_endblk); _for_it_13 = (_for_it_13 + 1)) {
        ...
        i_startidx_in_var_57_2 = v_v_p_patch_var_48_cells_start_index[(3 - __f2dace_SOA_start_index_d_0_s_174_cells_p_patch_7)];
        {


        }
        _if_cond_0_0_2 = (_for_it_13 == i_startblk);
        i_endidx_in_var_58_2 = v_v_p_patch_var_48_cells_end_index[((- __f2dace_SOA_end_index_d_0_s_175_cells_p_patch_7) - 5)];
        if ((_if_cond_0_0_2 == 1)) {
            {
                ...
                {
                    int nproma_var_4_0_in = global_data_var_47_nproma_2[0];
        ...
        for (_for_it_14 = (v_global_data_nflatlev[tmp_index_357] + 1); (_for_it_14 <= nlev); _for_it_14 = (_for_it_14 + 1)) {
            for (_for_it_15 = i_startidx; (_for_it_15 <= i_endidx); _for_it_15 = (_for_it_15 + 1)) {
                {


                }
                tmp_index_367 = (v_v_p_patch_cells_edge_idx[(((((__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_7 * __f2dace_SA_edge_idx_d_1_s_167_cells_p_patch_7) * (1 - __f2dace_SOA_edge_idx_d_2_s_168_cells_p_patch_7)) + (__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_7 * ((- __f2dace_SOA_edge_idx_d_1_s_167_cells_p_patch_7) + _for_it_13))) - __f2dace_SOA_edge_idx_d_0_s_166_cells_p_patch_7) + _for_it_15)] - 1);
                {


                }
                tmp_index_369 = (v_v_p_patch_cells_edge_blk[(((((__f2dace_SA_edge_blk_d_0_s_169_cells_p_patch_7 * __f2dace_SA_edge_blk_d_1_s_170_cells_p_patch_7) * (1 - __f2dace_SOA_edge_blk_d_2_s_171_cells_p_patch_7)) + (__f2dace_SA_edge_blk_d_0_s_169_cells_p_patch_7 * ((- __f2dace_SOA_edge_blk_d_1_s_170_cells_p_patch_7) + _for_it_13))) - __f2dace_SOA_edge_blk_d_0_s_169_cells_p_patch_7) + _for_it_15)] - 1);
                {


                }
                tmp_index_379 = (v_v_p_patch_cells_edge_idx[(((((__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_7 * __f2dace_SA_edge_idx_d_1_s_167_cells_p_patch_7) * (2 - __f2dace_SOA_edge_idx_d_2_s_168_cells_p_patch_7)) + (__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_7 * ((- __f2dace_SOA_edge_idx_d_1_s_167_cells_p_patch_7) + _for_it_13))) - __f2dace_SOA_edge_idx_d_0_s_166_cells_p_patch_7) + _for_it_15)] - 1);
                {


                }
                tmp_index_381 = (v_v_p_patch_cells_edge_blk[(((((__f2dace_SA_edge_blk_d_0_s_169_cells_p_patch_7 * __f2dace_SA_edge_blk_d_1_s_170_cells_p_patch_7) * (2 - __f2dace_SOA_edge_blk_d_2_s_171_cells_p_patch_7)) + (__f2dace_SA_edge_blk_d_0_s_169_cells_p_patch_7 * ((- __f2dace_SOA_edge_blk_d_1_s_170_cells_p_patch_7) + _for_it_13))) - __f2dace_SOA_edge_blk_d_0_s_169_cells_p_patch_7) + _for_it_15)] - 1);
                {


                }
                tmp_index_391 = (v_v_p_patch_cells_edge_idx[(((((__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_7 * __f2dace_SA_edge_idx_d_1_s_167_cells_p_patch_7) * (3 - __f2dace_SOA_edge_idx_d_2_s_168_cells_p_patch_7)) + (__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_7 * ((- __f2dace_SOA_edge_idx_d_1_s_167_cells_p_patch_7) + _for_it_13))) - __f2dace_SOA_edge_idx_d_0_s_166_cells_p_patch_7) + _for_it_15)] - 1);
                {


                }
                tmp_index_393 = (v_v_p_patch_cells_edge_blk[(((((__f2dace_SA_edge_blk_d_0_s_169_cells_p_patch_7 * __f2dace_SA_edge_blk_d_1_s_170_cells_p_patch_7) * (3 - __f2dace_SOA_edge_blk_d_2_s_171_cells_p_patch_7)) + (__f2dace_SA_edge_blk_d_0_s_169_cells_p_patch_7 * ((- __f2dace_SOA_edge_blk_d_1_s_170_cells_p_patch_7) + _for_it_13))) - __f2dace_SOA_edge_blk_d_0_s_169_cells_p_patch_7) + _for_it_15)] - 1);
                {


                }
                tmp_index_403 = (v_v_p_patch_cells_edge_idx[(((((__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_7 * __f2dace_SA_edge_idx_d_1_s_167_cells_p_patch_7) * (1 - __f2dace_SOA_edge_idx_d_2_s_168_cells_p_patch_7)) + (__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_7 * ((- __f2dace_SOA_edge_idx_d_1_s_167_cells_p_patch_7) + _for_it_13))) - __f2dace_SOA_edge_idx_d_0_s_166_cells_p_patch_7) + _for_it_15)] - 1);
                {

                    {
                        double p_int_0_in_e_bln_c_s_0 = v_p_int_e_bln_c_s[(((((__f2dace_SA_e_bln_c_s_d_0_s_44_p_int_5 * __f2dace_SA_e_bln_c_s_d_1_s_45_p_int_5) * ((- __f2dace_SOA_e_bln_c_s_d_2_s_46_p_int_5) + _for_it_13)) + (__f2dace_SA_e_bln_c_s_d_0_s_44_p_int_5 * (1 - __f2dace_SOA_e_bln_c_s_d_1_s_45_p_int_5))) - __f2dace_SOA_e_bln_c_s_d_0_s_44_p_int_5) + _for_it_15)];
                        double p_int_1_in_e_bln_c_s_0 = v_p_int_e_bln_c_s[(((((__f2dace_SA_e_bln_c_s_d_0_s_44_p_int_5 * __f2dace_SA_e_bln_c_s_d_1_s_45_p_int_5) * ((- __f2dace_SOA_e_bln_c_s_d_2_s_46_p_int_5) + _for_it_13)) + (__f2dace_SA_e_bln_c_s_d_0_s_44_p_int_5 * (2 - __f2dace_SOA_e_bln_c_s_d_1_s_45_p_int_5))) - __f2dace_SOA_e_bln_c_s_d_0_s_44_p_int_5) + _for_it_15)];
                        double p_int_2_in_e_bln_c_s_0 = v_p_int_e_bln_c_s[(((((__f2dace_SA_e_bln_c_s_d_0_s_44_p_int_5 * __f2dace_SA_e_bln_c_s_d_1_s_45_p_int_5) * ((- __f2dace_SOA_e_bln_c_s_d_2_s_46_p_int_5) + _for_it_13)) + (__f2dace_SA_e_bln_c_s_d_0_s_44_p_int_5 * (3 - __f2dace_SOA_e_bln_c_s_d_1_s_45_p_int_5))) - __f2dace_SOA_e_bln_c_s_d_0_s_44_p_int_5) + _for_it_15)];
                ...
                tmp_index_405 = (v_v_p_patch_cells_edge_blk[(((((__f2dace_SA_edge_blk_d_0_s_169_cells_p_patch_7 * __f2dace_SA_edge_blk_d_1_s_170_cells_p_patch_7) * (1 - __f2dace_SOA_edge_blk_d_2_s_171_cells_p_patch_7)) + (__f2dace_SA_edge_blk_d_0_s_169_cells_p_patch_7 * ((- __f2dace_SOA_edge_blk_d_1_s_170_cells_p_patch_7) + _for_it_13))) - __f2dace_SOA_edge_blk_d_0_s_169_cells_p_patch_7) + _for_it_15)] - 1);
                {


                }
                tmp_index_415 = (v_v_p_patch_cells_edge_idx[(((((__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_7 * __f2dace_SA_edge_idx_d_1_s_167_cells_p_patch_7) * (2 - __f2dace_SOA_edge_idx_d_2_s_168_cells_p_patch_7)) + (__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_7 * ((- __f2dace_SOA_edge_idx_d_1_s_167_cells_p_patch_7) + _for_it_13))) - __f2dace_SOA_edge_idx_d_0_s_166_cells_p_patch_7) + _for_it_15)] - 1);
                {


                }
                tmp_index_417 = (v_v_p_patch_cells_edge_blk[(((((__f2dace_SA_edge_blk_d_0_s_169_cells_p_patch_7 * __f2dace_SA_edge_blk_d_1_s_170_cells_p_patch_7) * (2 - __f2dace_SOA_edge_blk_d_2_s_171_cells_p_patch_7)) + (__f2dace_SA_edge_blk_d_0_s_169_cells_p_patch_7 * ((- __f2dace_SOA_edge_blk_d_1_s_170_cells_p_patch_7) + _for_it_13))) - __f2dace_SOA_edge_blk_d_0_s_169_cells_p_patch_7) + _for_it_15)] - 1);
                {


                }
                tmp_index_427 = (v_v_p_patch_cells_edge_idx[(((((__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_7 * __f2dace_SA_edge_idx_d_1_s_167_cells_p_patch_7) * (3 - __f2dace_SOA_edge_idx_d_2_s_168_cells_p_patch_7)) + (__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_7 * ((- __f2dace_SOA_edge_idx_d_1_s_167_cells_p_patch_7) + _for_it_13))) - __f2dace_SOA_edge_idx_d_0_s_166_cells_p_patch_7) + _for_it_15)] - 1);
                {
                ...
                tmp_index_429 = (v_v_p_patch_cells_edge_blk[(((((__f2dace_SA_edge_blk_d_0_s_169_cells_p_patch_7 * __f2dace_SA_edge_blk_d_1_s_170_cells_p_patch_7) * (3 - __f2dace_SOA_edge_blk_d_2_s_171_cells_p_patch_7)) + (__f2dace_SA_edge_blk_d_0_s_169_cells_p_patch_7 * ((- __f2dace_SOA_edge_blk_d_1_s_170_cells_p_patch_7) + _for_it_13))) - __f2dace_SOA_edge_blk_d_0_s_169_cells_p_patch_7) + _for_it_15)] - 1);
                {
                    ...
                    }
                    {
                        ...
                        v_v_p_nh_diag_w_concorr_c[(((((__f2dace_SA_w_concorr_c_d_0_s_594_diag_p_nh_2 * __f2dace_SA_w_concorr_c_d_1_s_595_diag_p_nh_2) * ((- __f2dace_SOA_w_concorr_c_d_2_s_596_diag_p_nh_2) + _for_it_13)) + (__f2dace_SA_w_concorr_c_d_0_s_594_diag_p_nh_2 * ((- __f2dace_SOA_w_concorr_c_d_1_s_595_diag_p_nh_2) + _for_it_14))) - __f2dace_SOA_w_concorr_c_d_0_s_594_diag_p_nh_2) + _for_it_15)] = p_nh_out_diag_w_concorr_c_0;
                    }
        ...
        for (_for_it_16 = i_startidx; (_for_it_16 <= i_endidx); _for_it_16 = (_for_it_16 + 1)) {
            {


            }
            tmp_index_448 = (v_v_p_patch_cells_edge_idx[(((((__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_7 * __f2dace_SA_edge_idx_d_1_s_167_cells_p_patch_7) * (1 - __f2dace_SOA_edge_idx_d_2_s_168_cells_p_patch_7)) + (__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_7 * ((- __f2dace_SOA_edge_idx_d_1_s_167_cells_p_patch_7) + _for_it_13))) - __f2dace_SOA_edge_idx_d_0_s_166_cells_p_patch_7) + _for_it_16)] - 1);
            tmp_index_449 = ((nlev - 2) - 1);
            {


            }
            tmp_index_450 = (v_v_p_patch_cells_edge_blk[(((((__f2dace_SA_edge_blk_d_0_s_169_cells_p_patch_7 * __f2dace_SA_edge_blk_d_1_s_170_cells_p_patch_7) * (1 - __f2dace_SOA_edge_blk_d_2_s_171_cells_p_patch_7)) + (__f2dace_SA_edge_blk_d_0_s_169_cells_p_patch_7 * ((- __f2dace_SOA_edge_blk_d_1_s_170_cells_p_patch_7) + _for_it_13))) - __f2dace_SOA_edge_blk_d_0_s_169_cells_p_patch_7) + _for_it_16)] - 1);
            {


            }
            tmp_index_460 = (v_v_p_patch_cells_edge_idx[(((((__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_7 * __f2dace_SA_edge_idx_d_1_s_167_cells_p_patch_7) * (2 - __f2dace_SOA_edge_idx_d_2_s_168_cells_p_patch_7)) + (__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_7 * ((- __f2dace_SOA_edge_idx_d_1_s_167_cells_p_patch_7) + _for_it_13))) - __f2dace_SOA_edge_idx_d_0_s_166_cells_p_patch_7) + _for_it_16)] - 1);
            ...
            tmp_index_472 = (v_v_p_patch_cells_edge_idx[(((((__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_7 * __f2dace_SA_edge_idx_d_1_s_167_cells_p_patch_7) * (3 - __f2dace_SOA_edge_idx_d_2_s_168_cells_p_patch_7)) + (__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_7 * ((- __f2dace_SOA_edge_idx_d_1_s_167_cells_p_patch_7) + _for_it_13))) - __f2dace_SOA_edge_idx_d_0_s_166_cells_p_patch_7) + _for_it_16)] - 1);
            tmp_index_473 = ((nlev - 2) - 1);
            {


            }
            tmp_index_474 = (v_v_p_patch_cells_edge_blk[(((((__f2dace_SA_edge_blk_d_0_s_169_cells_p_patch_7 * __f2dace_SA_edge_blk_d_1_s_170_cells_p_patch_7) * (3 - __f2dace_SOA_edge_blk_d_2_s_171_cells_p_patch_7)) + (__f2dace_SA_edge_blk_d_0_s_169_cells_p_patch_7 * ((- __f2dace_SOA_edge_blk_d_1_s_170_cells_p_patch_7) + _for_it_13))) - __f2dace_SOA_edge_blk_d_0_s_169_cells_p_patch_7) + _for_it_16)] - 1);
            {


            }
            tmp_index_484 = (v_v_p_patch_cells_edge_idx[(((((__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_7 * __f2dace_SA_edge_idx_d_1_s_167_cells_p_patch_7) * (1 - __f2dace_SOA_edge_idx_d_2_s_168_cells_p_patch_7)) + (__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_7 * ((- __f2dace_SOA_edge_idx_d_1_s_167_cells_p_patch_7) + _for_it_13))) - __f2dace_SOA_edge_idx_d_0_s_166_cells_p_patch_7) + _for_it_16)] - 1);
            ...
            tmp_index_486 = (v_v_p_patch_cells_edge_blk[(((((__f2dace_SA_edge_blk_d_0_s_169_cells_p_patch_7 * __f2dace_SA_edge_blk_d_1_s_170_cells_p_patch_7) * (1 - __f2dace_SOA_edge_blk_d_2_s_171_cells_p_patch_7)) + (__f2dace_SA_edge_blk_d_0_s_169_cells_p_patch_7 * ((- __f2dace_SOA_edge_blk_d_1_s_170_cells_p_patch_7) + _for_it_13))) - __f2dace_SOA_edge_blk_d_0_s_169_cells_p_patch_7) + _for_it_16)] - 1);
            {


            }
            tmp_index_496 = (v_v_p_patch_cells_edge_idx[(((((__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_7 * __f2dace_SA_edge_idx_d_1_s_167_cells_p_patch_7) * (2 - __f2dace_SOA_edge_idx_d_2_s_168_cells_p_patch_7)) + (__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_7 * ((- __f2dace_SOA_edge_idx_d_1_s_167_cells_p_patch_7) + _for_it_13))) - __f2dace_SOA_edge_idx_d_0_s_166_cells_p_patch_7) + _for_it_16)] - 1);
            tmp_index_497 = ((nlev - 1) - 1);
            {


            }
            tmp_index_498 = (v_v_p_patch_cells_edge_blk[(((((__f2dace_SA_edge_blk_d_0_s_169_cells_p_patch_7 * __f2dace_SA_edge_blk_d_1_s_170_cells_p_patch_7) * (2 - __f2dace_SOA_edge_blk_d_2_s_171_cells_p_patch_7)) + (__f2dace_SA_edge_blk_d_0_s_169_cells_p_patch_7 * ((- __f2dace_SOA_edge_blk_d_1_s_170_cells_p_patch_7) + _for_it_13))) - __f2dace_SOA_edge_blk_d_0_s_169_cells_p_patch_7) + _for_it_16)] - 1);
            {


            }
            tmp_index_508 = (v_v_p_patch_cells_edge_idx[(((((__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_7 * __f2dace_SA_edge_idx_d_1_s_167_cells_p_patch_7) * (3 - __f2dace_SOA_edge_idx_d_2_s_168_cells_p_patch_7)) + (__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_7 * ((- __f2dace_SOA_edge_idx_d_1_s_167_cells_p_patch_7) + _for_it_13))) - __f2dace_SOA_edge_idx_d_0_s_166_cells_p_patch_7) + _for_it_16)] - 1);
            tmp_index_509 = ((nlev - 1) - 1);
            {


            }
            tmp_index_510 = (v_v_p_patch_cells_edge_blk[(((((__f2dace_SA_edge_blk_d_0_s_169_cells_p_patch_7 * __f2dace_SA_edge_blk_d_1_s_170_cells_p_patch_7) * (3 - __f2dace_SOA_edge_blk_d_2_s_171_cells_p_patch_7)) + (__f2dace_SA_edge_blk_d_0_s_169_cells_p_patch_7 * ((- __f2dace_SOA_edge_blk_d_1_s_170_cells_p_patch_7) + _for_it_13))) - __f2dace_SOA_edge_blk_d_0_s_169_cells_p_patch_7) + _for_it_16)] - 1);
            {


            }
            tmp_index_520 = (v_v_p_patch_cells_edge_idx[(((((__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_7 * __f2dace_SA_edge_idx_d_1_s_167_cells_p_patch_7) * (1 - __f2dace_SOA_edge_idx_d_2_s_168_cells_p_patch_7)) + (__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_7 * ((- __f2dace_SOA_edge_idx_d_1_s_167_cells_p_patch_7) + _for_it_13))) - __f2dace_SOA_edge_idx_d_0_s_166_cells_p_patch_7) + _for_it_16)] - 1);
            ...
            tmp_index_522 = (v_v_p_patch_cells_edge_blk[(((((__f2dace_SA_edge_blk_d_0_s_169_cells_p_patch_7 * __f2dace_SA_edge_blk_d_1_s_170_cells_p_patch_7) * (1 - __f2dace_SOA_edge_blk_d_2_s_171_cells_p_patch_7)) + (__f2dace_SA_edge_blk_d_0_s_169_cells_p_patch_7 * ((- __f2dace_SOA_edge_blk_d_1_s_170_cells_p_patch_7) + _for_it_13))) - __f2dace_SOA_edge_blk_d_0_s_169_cells_p_patch_7) + _for_it_16)] - 1);
            {


            }
            tmp_index_532 = (v_v_p_patch_cells_edge_idx[(((((__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_7 * __f2dace_SA_edge_idx_d_1_s_167_cells_p_patch_7) * (2 - __f2dace_SOA_edge_idx_d_2_s_168_cells_p_patch_7)) + (__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_7 * ((- __f2dace_SOA_edge_idx_d_1_s_167_cells_p_patch_7) + _for_it_13))) - __f2dace_SOA_edge_idx_d_0_s_166_cells_p_patch_7) + _for_it_16)] - 1);
            tmp_index_533 = (nlev - 1);
            {


            }
            tmp_index_534 = (v_v_p_patch_cells_edge_blk[(((((__f2dace_SA_edge_blk_d_0_s_169_cells_p_patch_7 * __f2dace_SA_edge_blk_d_1_s_170_cells_p_patch_7) * (2 - __f2dace_SOA_edge_blk_d_2_s_171_cells_p_patch_7)) + (__f2dace_SA_edge_blk_d_0_s_169_cells_p_patch_7 * ((- __f2dace_SOA_edge_blk_d_1_s_170_cells_p_patch_7) + _for_it_13))) - __f2dace_SOA_edge_blk_d_0_s_169_cells_p_patch_7) + _for_it_16)] - 1);
            {


            }
            tmp_index_544 = (v_v_p_patch_cells_edge_idx[(((((__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_7 * __f2dace_SA_edge_idx_d_1_s_167_cells_p_patch_7) * (3 - __f2dace_SOA_edge_idx_d_2_s_168_cells_p_patch_7)) + (__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_7 * ((- __f2dace_SOA_edge_idx_d_1_s_167_cells_p_patch_7) + _for_it_13))) - __f2dace_SOA_edge_idx_d_0_s_166_cells_p_patch_7) + _for_it_16)] - 1);
            tmp_index_545 = (nlev - 1);
            {


            }
            tmp_index_546 = (v_v_p_patch_cells_edge_blk[(((((__f2dace_SA_edge_blk_d_0_s_169_cells_p_patch_7 * __f2dace_SA_edge_blk_d_1_s_170_cells_p_patch_7) * (3 - __f2dace_SOA_edge_blk_d_2_s_171_cells_p_patch_7)) + (__f2dace_SA_edge_blk_d_0_s_169_cells_p_patch_7 * ((- __f2dace_SOA_edge_blk_d_1_s_170_cells_p_patch_7) + _for_it_13))) - __f2dace_SOA_edge_blk_d_0_s_169_cells_p_patch_7) + _for_it_16)] - 1);
            tmp_index_548 = (nlevp1 - __f2dace_SOA_w_concorr_c_d_1_s_595_diag_p_nh_2);
            {
                ...
                }
                {
                    ...
                    v_v_p_nh_diag_w_concorr_c[(((((__f2dace_SA_w_concorr_c_d_0_s_594_diag_p_nh_2 * __f2dace_SA_w_concorr_c_d_1_s_595_diag_p_nh_2) * ((- __f2dace_SOA_w_concorr_c_d_2_s_596_diag_p_nh_2) + _for_it_13)) + (__f2dace_SA_w_concorr_c_d_0_s_594_diag_p_nh_2 * tmp_index_548)) - __f2dace_SOA_w_concorr_c_d_0_s_594_diag_p_nh_2) + _for_it_16)] = p_nh_out_diag_w_concorr_c_0;
                }
...

    {
        ...
        {
            int p_patch_0_in_cells_start_block_0 = v_v_p_patch_cells_start_block[(5 - __f2dace_SOA_start_block_d_0_s_178_cells_p_patch_7)];
            int i_startblk_out;
...

    {
        ...
        {
            int p_patch_0_in_cells_end_block_0 = v_v_p_patch_cells_end_block[((- __f2dace_SOA_end_block_d_0_s_181_cells_p_patch_7) - 4)];
            int i_endblk_out;
    ...
    for (_for_it_17 = i_startblk; (_for_it_17 <= i_endblk); _for_it_17 = (_for_it_17 + 1)) {
        ...
        i_startidx_in_var_57_1 = v_v_p_patch_var_48_cells_start_index[(5 - __f2dace_SOA_start_index_d_0_s_174_cells_p_patch_7)];
        {


        }
        _if_cond_0_0_1 = (_for_it_17 == i_startblk);
        i_endidx_in_var_58_1 = v_v_p_patch_var_48_cells_end_index[((- __f2dace_SOA_end_index_d_0_s_175_cells_p_patch_7) - 4)];
        if ((_if_cond_0_0_1 == 1)) {
            {
                ...
                {
                    int nproma_var_4_0_in = global_data_var_47_nproma_3[0];
                    int i_endidx_out_var_9_out;
        ...
        for (_for_it_18 = 1; (_for_it_18 <= nlev); _for_it_18 = (_for_it_18 + 1)) {
            for (_for_it_19 = i_startidx; (_for_it_19 <= i_endidx); _for_it_19 = (_for_it_19 + 1)) {
                {


                }
                tmp_index_570 = (v_v_p_patch_cells_edge_idx[(((((__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_7 * __f2dace_SA_edge_idx_d_1_s_167_cells_p_patch_7) * (1 - __f2dace_SOA_edge_idx_d_2_s_168_cells_p_patch_7)) + (__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_7 * ((- __f2dace_SOA_edge_idx_d_1_s_167_cells_p_patch_7) + _for_it_17))) - __f2dace_SOA_edge_idx_d_0_s_166_cells_p_patch_7) + _for_it_19)] - __f2dace_SOA_mass_fl_e_d_0_s_513_diag_p_nh_2);
                {


                }
                tmp_index_572 = (v_v_p_patch_cells_edge_blk[(((((__f2dace_SA_edge_blk_d_0_s_169_cells_p_patch_7 * __f2dace_SA_edge_blk_d_1_s_170_cells_p_patch_7) * (1 - __f2dace_SOA_edge_blk_d_2_s_171_cells_p_patch_7)) + (__f2dace_SA_edge_blk_d_0_s_169_cells_p_patch_7 * ((- __f2dace_SOA_edge_blk_d_1_s_170_cells_p_patch_7) + _for_it_17))) - __f2dace_SOA_edge_blk_d_0_s_169_cells_p_patch_7) + _for_it_19)] - __f2dace_SOA_mass_fl_e_d_2_s_515_diag_p_nh_2);
                {


                }
                tmp_index_582 = (v_v_p_patch_cells_edge_idx[(((((__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_7 * __f2dace_SA_edge_idx_d_1_s_167_cells_p_patch_7) * (2 - __f2dace_SOA_edge_idx_d_2_s_168_cells_p_patch_7)) + (__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_7 * ((- __f2dace_SOA_edge_idx_d_1_s_167_cells_p_patch_7) + _for_it_17))) - __f2dace_SOA_edge_idx_d_0_s_166_cells_p_patch_7) + _for_it_19)] - __f2dace_SOA_mass_fl_e_d_0_s_513_diag_p_nh_2);
                {


                }
                tmp_index_584 = (v_v_p_patch_cells_edge_blk[(((((__f2dace_SA_edge_blk_d_0_s_169_cells_p_patch_7 * __f2dace_SA_edge_blk_d_1_s_170_cells_p_patch_7) * (2 - __f2dace_SOA_edge_blk_d_2_s_171_cells_p_patch_7)) + (__f2dace_SA_edge_blk_d_0_s_169_cells_p_patch_7 * ((- __f2dace_SOA_edge_blk_d_1_s_170_cells_p_patch_7) + _for_it_17))) - __f2dace_SOA_edge_blk_d_0_s_169_cells_p_patch_7) + _for_it_19)] - __f2dace_SOA_mass_fl_e_d_2_s_515_diag_p_nh_2);
                {


                }
                tmp_index_594 = (v_v_p_patch_cells_edge_idx[(((((__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_7 * __f2dace_SA_edge_idx_d_1_s_167_cells_p_patch_7) * (3 - __f2dace_SOA_edge_idx_d_2_s_168_cells_p_patch_7)) + (__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_7 * ((- __f2dace_SOA_edge_idx_d_1_s_167_cells_p_patch_7) + _for_it_17))) - __f2dace_SOA_edge_idx_d_0_s_166_cells_p_patch_7) + _for_it_19)] - __f2dace_SOA_mass_fl_e_d_0_s_513_diag_p_nh_2);
                {


                }
                tmp_index_596 = (v_v_p_patch_cells_edge_blk[(((((__f2dace_SA_edge_blk_d_0_s_169_cells_p_patch_7 * __f2dace_SA_edge_blk_d_1_s_170_cells_p_patch_7) * (3 - __f2dace_SOA_edge_blk_d_2_s_171_cells_p_patch_7)) + (__f2dace_SA_edge_blk_d_0_s_169_cells_p_patch_7 * ((- __f2dace_SOA_edge_blk_d_1_s_170_cells_p_patch_7) + _for_it_17))) - __f2dace_SOA_edge_blk_d_0_s_169_cells_p_patch_7) + _for_it_19)] - __f2dace_SOA_mass_fl_e_d_2_s_515_diag_p_nh_2);
                {


                }
                tmp_index_609 = (v_v_p_patch_cells_edge_idx[(((((__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_7 * __f2dace_SA_edge_idx_d_1_s_167_cells_p_patch_7) * (1 - __f2dace_SOA_edge_idx_d_2_s_168_cells_p_patch_7)) + (__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_7 * ((- __f2dace_SOA_edge_idx_d_1_s_167_cells_p_patch_7) + _for_it_17))) - __f2dace_SOA_edge_idx_d_0_s_166_cells_p_patch_7) + _for_it_19)] - 1);
                {

                    {
                        double p_int_0_in_geofac_div_0 = v_p_int_geofac_div[(((((__f2dace_SA_geofac_div_d_0_s_56_p_int_5 * __f2dace_SA_geofac_div_d_1_s_57_p_int_5) * ((- __f2dace_SOA_geofac_div_d_2_s_58_p_int_5) + _for_it_17)) + (__f2dace_SA_geofac_div_d_0_s_56_p_int_5 * (1 - __f2dace_SOA_geofac_div_d_1_s_57_p_int_5))) - __f2dace_SOA_geofac_div_d_0_s_56_p_int_5) + _for_it_19)];
                        double p_int_1_in_geofac_div_0 = v_p_int_geofac_div[(((((__f2dace_SA_geofac_div_d_0_s_56_p_int_5 * __f2dace_SA_geofac_div_d_1_s_57_p_int_5) * ((- __f2dace_SOA_geofac_div_d_2_s_58_p_int_5) + _for_it_17)) + (__f2dace_SA_geofac_div_d_0_s_56_p_int_5 * (2 - __f2dace_SOA_geofac_div_d_1_s_57_p_int_5))) - __f2dace_SOA_geofac_div_d_0_s_56_p_int_5) + _for_it_19)];
                        double p_int_2_in_geofac_div_0 = v_p_int_geofac_div[(((((__f2dace_SA_geofac_div_d_0_s_56_p_int_5 * __f2dace_SA_geofac_div_d_1_s_57_p_int_5) * ((- __f2dace_SOA_geofac_div_d_2_s_58_p_int_5) + _for_it_17)) + (__f2dace_SA_geofac_div_d_0_s_56_p_int_5 * (3 - __f2dace_SOA_geofac_div_d_1_s_57_p_int_5))) - __f2dace_SOA_geofac_div_d_0_s_56_p_int_5) + _for_it_19)];
                        double p_nh_0_in_metrics_deepatmo_divh_mc_0 = v_v_p_nh_metrics_deepatmo_divh_mc[((- __f2dace_SOA_deepatmo_divh_mc_d_0_s_742_metrics_p_nh_4) + _for_it_18)];
                        double p_nh_1_in_diag_mass_fl_e_0 = v_v_p_nh_diag_mass_fl_e[((((__f2dace_SA_mass_fl_e_d_0_s_513_diag_p_nh_2 * __f2dace_SA_mass_fl_e_d_1_s_514_diag_p_nh_2) * tmp_index_572) + (__f2dace_SA_mass_fl_e_d_0_s_513_diag_p_nh_2 * ((- __f2dace_SOA_mass_fl_e_d_1_s_514_diag_p_nh_2) + _for_it_18))) + tmp_index_570)];
                        double p_nh_2_in_diag_mass_fl_e_0 = v_v_p_nh_diag_mass_fl_e[((((__f2dace_SA_mass_fl_e_d_0_s_513_diag_p_nh_2 * __f2dace_SA_mass_fl_e_d_1_s_514_diag_p_nh_2) * tmp_index_584) + (__f2dace_SA_mass_fl_e_d_0_s_513_diag_p_nh_2 * ((- __f2dace_SOA_mass_fl_e_d_1_s_514_diag_p_nh_2) + _for_it_18))) + tmp_index_582)];
                        double p_nh_3_in_diag_mass_fl_e_0 = v_v_p_nh_diag_mass_fl_e[((((__f2dace_SA_mass_fl_e_d_0_s_513_diag_p_nh_2 * __f2dace_SA_mass_fl_e_d_1_s_514_diag_p_nh_2) * tmp_index_596) + (__f2dace_SA_mass_fl_e_d_0_s_513_diag_p_nh_2 * ((- __f2dace_SOA_mass_fl_e_d_1_s_514_diag_p_nh_2) + _for_it_18))) + tmp_index_594)];
                ...
                tmp_index_611 = (v_v_p_patch_cells_edge_blk[(((((__f2dace_SA_edge_blk_d_0_s_169_cells_p_patch_7 * __f2dace_SA_edge_blk_d_1_s_170_cells_p_patch_7) * (1 - __f2dace_SOA_edge_blk_d_2_s_171_cells_p_patch_7)) + (__f2dace_SA_edge_blk_d_0_s_169_cells_p_patch_7 * ((- __f2dace_SOA_edge_blk_d_1_s_170_cells_p_patch_7) + _for_it_17))) - __f2dace_SOA_edge_blk_d_0_s_169_cells_p_patch_7) + _for_it_19)] - 1);
                {


                }
                tmp_index_621 = (v_v_p_patch_cells_edge_idx[(((((__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_7 * __f2dace_SA_edge_idx_d_1_s_167_cells_p_patch_7) * (2 - __f2dace_SOA_edge_idx_d_2_s_168_cells_p_patch_7)) + (__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_7 * ((- __f2dace_SOA_edge_idx_d_1_s_167_cells_p_patch_7) + _for_it_17))) - __f2dace_SOA_edge_idx_d_0_s_166_cells_p_patch_7) + _for_it_19)] - 1);
                {


                }
                tmp_index_623 = (v_v_p_patch_cells_edge_blk[(((((__f2dace_SA_edge_blk_d_0_s_169_cells_p_patch_7 * __f2dace_SA_edge_blk_d_1_s_170_cells_p_patch_7) * (2 - __f2dace_SOA_edge_blk_d_2_s_171_cells_p_patch_7)) + (__f2dace_SA_edge_blk_d_0_s_169_cells_p_patch_7 * ((- __f2dace_SOA_edge_blk_d_1_s_170_cells_p_patch_7) + _for_it_17))) - __f2dace_SOA_edge_blk_d_0_s_169_cells_p_patch_7) + _for_it_19)] - 1);
                {


                }
                tmp_index_633 = (v_v_p_patch_cells_edge_idx[(((((__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_7 * __f2dace_SA_edge_idx_d_1_s_167_cells_p_patch_7) * (3 - __f2dace_SOA_edge_idx_d_2_s_168_cells_p_patch_7)) + (__f2dace_SA_edge_idx_d_0_s_166_cells_p_patch_7 * ((- __f2dace_SOA_edge_idx_d_1_s_167_cells_p_patch_7) + _for_it_17))) - __f2dace_SOA_edge_idx_d_0_s_166_cells_p_patch_7) + _for_it_19)] - 1);
                {


                }
                tmp_index_635 = (v_v_p_patch_cells_edge_blk[(((((__f2dace_SA_edge_blk_d_0_s_169_cells_p_patch_7 * __f2dace_SA_edge_blk_d_1_s_170_cells_p_patch_7) * (3 - __f2dace_SOA_edge_blk_d_2_s_171_cells_p_patch_7)) + (__f2dace_SA_edge_blk_d_0_s_169_cells_p_patch_7 * ((- __f2dace_SOA_edge_blk_d_1_s_170_cells_p_patch_7) + _for_it_17))) - __f2dace_SOA_edge_blk_d_0_s_169_cells_p_patch_7) + _for_it_19)] - 1);
                {
        ...
        if ((_if_cond_7 == 1)) {
            for (_for_it_20 = i_startidx; (_for_it_20 <= i_endidx); _for_it_20 = (_for_it_20 + 1)) {
                {
...

                    {
                        ...
                        double p_nh_0_in_diag_theta_v_ic_ubc_0 = v_v_p_nh_diag_theta_v_ic_ubc[(((((__f2dace_SA_theta_v_ic_ubc_d_0_s_555_diag_p_nh_2 * __f2dace_SA_theta_v_ic_ubc_d_1_s_556_diag_p_nh_2) * (1 - __f2dace_SOA_theta_v_ic_ubc_d_2_s_557_diag_p_nh_2)) + (__f2dace_SA_theta_v_ic_ubc_d_0_s_555_diag_p_nh_2 * ((- __f2dace_SOA_theta_v_ic_ubc_d_1_s_556_diag_p_nh_2) + _for_it_17))) - __f2dace_SOA_theta_v_ic_ubc_d_0_s_555_diag_p_nh_2) + _for_it_20)];
                        double p_nh_1_in_diag_theta_v_ic_ubc_0 = v_v_p_nh_diag_theta_v_ic_ubc[(((((__f2dace_SA_theta_v_ic_ubc_d_0_s_555_diag_p_nh_2 * __f2dace_SA_theta_v_ic_ubc_d_1_s_556_diag_p_nh_2) * (2 - __f2dace_SOA_theta_v_ic_ubc_d_2_s_557_diag_p_nh_2)) + (__f2dace_SA_theta_v_ic_ubc_d_0_s_555_diag_p_nh_2 * ((- __f2dace_SOA_theta_v_ic_ubc_d_1_s_556_diag_p_nh_2) + _for_it_17))) - __f2dace_SOA_theta_v_ic_ubc_d_0_s_555_diag_p_nh_2) + _for_it_20)];
                        ...
                        v_v_p_nh_diag_theta_v_ic[(((((__f2dace_SA_theta_v_ic_d_0_s_519_diag_p_nh_2 * __f2dace_SA_theta_v_ic_d_1_s_520_diag_p_nh_2) * ((- __f2dace_SOA_theta_v_ic_d_2_s_521_diag_p_nh_2) + _for_it_17)) + (__f2dace_SA_theta_v_ic_d_0_s_519_diag_p_nh_2 * (1 - __f2dace_SOA_theta_v_ic_d_1_s_520_diag_p_nh_2))) - __f2dace_SOA_theta_v_ic_d_0_s_519_diag_p_nh_2) + _for_it_20)] = p_nh_out_diag_theta_v_ic_0;
                    }
                    {
                        double dt_linintp_ubc_0_in = dt_linintp_ubc;
                        double p_nh_0_in_diag_rho_ic_ubc_0 = v_v_p_nh_diag_rho_ic_ubc[(((((__f2dace_SA_rho_ic_ubc_d_0_s_561_diag_p_nh_2 * __f2dace_SA_rho_ic_ubc_d_1_s_562_diag_p_nh_2) * (1 - __f2dace_SOA_rho_ic_ubc_d_2_s_563_diag_p_nh_2)) + (__f2dace_SA_rho_ic_ubc_d_0_s_561_diag_p_nh_2 * ((- __f2dace_SOA_rho_ic_ubc_d_1_s_562_diag_p_nh_2) + _for_it_17))) - __f2dace_SOA_rho_ic_ubc_d_0_s_561_diag_p_nh_2) + _for_it_20)];
                        double p_nh_1_in_diag_rho_ic_ubc_0 = v_v_p_nh_diag_rho_ic_ubc[(((((__f2dace_SA_rho_ic_ubc_d_0_s_561_diag_p_nh_2 * __f2dace_SA_rho_ic_ubc_d_1_s_562_diag_p_nh_2) * (2 - __f2dace_SOA_rho_ic_ubc_d_2_s_563_diag_p_nh_2)) + (__f2dace_SA_rho_ic_ubc_d_0_s_561_diag_p_nh_2 * ((- __f2dace_SOA_rho_ic_ubc_d_1_s_562_diag_p_nh_2) + _for_it_17))) - __f2dace_SOA_rho_ic_ubc_d_0_s_561_diag_p_nh_2) + _for_it_20)];
                        ...
                        v_v_p_nh_diag_rho_ic[(((((__f2dace_SA_rho_ic_d_0_s_516_diag_p_nh_2 * __f2dace_SA_rho_ic_d_1_s_517_diag_p_nh_2) * ((- __f2dace_SOA_rho_ic_d_2_s_518_diag_p_nh_2) + _for_it_17)) + (__f2dace_SA_rho_ic_d_0_s_516_diag_p_nh_2 * (1 - __f2dace_SOA_rho_ic_d_1_s_517_diag_p_nh_2))) - __f2dace_SOA_rho_ic_d_0_s_516_diag_p_nh_2) + _for_it_20)] = p_nh_out_diag_rho_ic_0;
                    }
                    {
                        double dt_linintp_ubc_0_in = dt_linintp_ubc;
        ...
        for (_for_it_21 = 2; (_for_it_21 <= nlev); _for_it_21 = (_for_it_21 + 1)) {
            for (_for_it_22 = i_startidx; (_for_it_22 <= i_endidx); _for_it_22 = (_for_it_22 + 1)) {
                ...
                }
                {
                    ...
                    {
                        double p_nh_0_in_diag_rho_ic_0 = v_v_p_nh_diag_rho_ic[(((((__f2dace_SA_rho_ic_d_0_s_516_diag_p_nh_2 * __f2dace_SA_rho_ic_d_1_s_517_diag_p_nh_2) * ((- __f2dace_SOA_rho_ic_d_2_s_518_diag_p_nh_2) + _for_it_17)) + (__f2dace_SA_rho_ic_d_0_s_516_diag_p_nh_2 * ((- __f2dace_SOA_rho_ic_d_1_s_517_diag_p_nh_2) + _for_it_21))) - __f2dace_SOA_rho_ic_d_0_s_516_diag_p_nh_2) + _for_it_22)];
                        double p_nh_1_in_metrics_vwind_expl_wgt_0 = v_v_p_nh_metrics_vwind_expl_wgt[(((__f2dace_SA_vwind_expl_wgt_d_0_s_650_metrics_p_nh_4 * ((- __f2dace_SOA_vwind_expl_wgt_d_1_s_651_metrics_p_nh_4) + _for_it_17)) - __f2dace_SOA_vwind_expl_wgt_d_0_s_650_metrics_p_nh_4) + _for_it_22)];
                        double p_nh_2_in_diag_w_concorr_c_0 = v_v_p_nh_diag_w_concorr_c[(((((__f2dace_SA_w_concorr_c_d_0_s_594_diag_p_nh_2 * __f2dace_SA_w_concorr_c_d_1_s_595_diag_p_nh_2) * ((- __f2dace_SOA_w_concorr_c_d_2_s_596_diag_p_nh_2) + _for_it_17)) + (__f2dace_SA_w_concorr_c_d_0_s_594_diag_p_nh_2 * ((- __f2dace_SOA_w_concorr_c_d_1_s_595_diag_p_nh_2) + _for_it_21))) - __f2dace_SOA_w_concorr_c_d_0_s_594_diag_p_nh_2) + _for_it_22)];
                        double p_nh_prog_nnow_0_in_w_0 = v_p_nh_prog_nnow_w[(((((__f2dace_SA_w_d_0_s_495_p_nh_prog_nnow_14 * __f2dace_SA_w_d_1_s_496_p_nh_prog_nnow_14) * ((- __f2dace_SOA_w_d_2_s_497_p_nh_prog_nnew_15) + _for_it_17)) + (__f2dace_SA_w_d_0_s_495_p_nh_prog_nnow_14 * ((- __f2dace_SOA_w_d_1_s_496_p_nh_prog_nnew_15) + _for_it_21))) - __f2dace_SOA_w_d_0_s_495_p_nh_prog_nnew_15) + _for_it_22)];
        ...
        for (_for_it_23 = 1; (_for_it_23 <= nlev); _for_it_23 = (_for_it_23 + 1)) {
            for (_for_it_24 = i_startidx; (_for_it_24 <= i_endidx); _for_it_24 = (_for_it_24 + 1)) {
                {

                    {
                        ...
                        double p_nh_prog_nnow_1_in_rho_0 = v_p_nh_prog_nnow_rho[(((((__f2dace_SA_rho_d_0_s_501_p_nh_prog_nnow_14 * __f2dace_SA_rho_d_1_s_502_p_nh_prog_nnow_14) * ((- __f2dace_SOA_rho_d_2_s_503_p_nh_prog_nnew_15) + _for_it_17)) + (__f2dace_SA_rho_d_0_s_501_p_nh_prog_nnow_14 * ((- __f2dace_SOA_rho_d_1_s_502_p_nh_prog_nnew_15) + _for_it_23))) - __f2dace_SOA_rho_d_0_s_501_p_nh_prog_nnew_15) + _for_it_24)];
                ...
                }
                {
                    ...
                    {
                        double p_nh_0_in_metrics_vwind_impl_wgt_0 = v_v_p_nh_metrics_vwind_impl_wgt[(((__f2dace_SA_vwind_impl_wgt_d_0_s_652_metrics_p_nh_4 * ((- __f2dace_SOA_vwind_impl_wgt_d_1_s_653_metrics_p_nh_4) + _for_it_17)) - __f2dace_SOA_vwind_impl_wgt_d_0_s_652_metrics_p_nh_4) + _for_it_24)];
                        ...
                        double p_nh_2_in_diag_rho_ic_0 = v_v_p_nh_diag_rho_ic[(((((__f2dace_SA_rho_ic_d_0_s_516_diag_p_nh_2 * __f2dace_SA_rho_ic_d_1_s_517_diag_p_nh_2) * ((- __f2dace_SOA_rho_ic_d_2_s_518_diag_p_nh_2) + _for_it_17)) + (__f2dace_SA_rho_ic_d_0_s_516_diag_p_nh_2 * ((- __f2dace_SOA_rho_ic_d_1_s_517_diag_p_nh_2) + _for_it_23))) - __f2dace_SOA_rho_ic_d_0_s_516_diag_p_nh_2) + _for_it_24)];
            ...
            for (_for_it_27 = i_startidx; (_for_it_27 <= i_endidx); _for_it_27 = (_for_it_27 + 1)) {
                {
                    ...
                    {
                        double p_nh_0_in_metrics_vwind_expl_wgt_0 = v_v_p_nh_metrics_vwind_expl_wgt[(((__f2dace_SA_vwind_expl_wgt_d_0_s_650_metrics_p_nh_4 * ((- __f2dace_SOA_vwind_expl_wgt_d_1_s_651_metrics_p_nh_4) + _for_it_17)) - __f2dace_SOA_vwind_expl_wgt_d_0_s_650_metrics_p_nh_4) + _for_it_27)];
        ...
        for (_for_it_28 = i_startidx; (_for_it_28 <= i_endidx); _for_it_28 = (_for_it_28 + 1)) {
            ...
            tmp_index_745 = (nlevp1 - 1);
            {
                ...
                {
                    double p_nh_0_in_diag_w_concorr_c_0 = v_v_p_nh_diag_w_concorr_c[(((((__f2dace_SA_w_concorr_c_d_0_s_594_diag_p_nh_2 * __f2dace_SA_w_concorr_c_d_1_s_595_diag_p_nh_2) * ((- __f2dace_SOA_w_concorr_c_d_2_s_596_diag_p_nh_2) + _for_it_17)) + (__f2dace_SA_w_concorr_c_d_0_s_594_diag_p_nh_2 * tmp_index_742)) - __f2dace_SOA_w_concorr_c_d_0_s_594_diag_p_nh_2) + _for_it_28)];
                    double p_nh_prog_nnew_out_w_0;
                    ...
                    v_p_nh_prog_nnew_w[(((((__f2dace_SA_w_d_0_s_495_p_nh_prog_nnew_15 * __f2dace_SA_w_d_1_s_496_p_nh_prog_nnew_15) * ((- __f2dace_SOA_w_d_2_s_497_p_nh_prog_nnew_15) + _for_it_17)) + (__f2dace_SA_w_d_0_s_495_p_nh_prog_nnew_15 * tmp_index_739)) - __f2dace_SOA_w_d_0_s_495_p_nh_prog_nnew_15) + _for_it_28)] = p_nh_prog_nnew_out_w_0;
                }
                {
                    double z_contr_w_fl_l_out_0;
        ...
        for (_for_it_29 = i_startidx; (_for_it_29 <= i_endidx); _for_it_29 = (_for_it_29 + 1)) {
            {

                {
                    ...
                    double p_nh_prog_nnow_0_in_rho_0 = v_p_nh_prog_nnow_rho[(((((__f2dace_SA_rho_d_0_s_501_p_nh_prog_nnow_14 * __f2dace_SA_rho_d_1_s_502_p_nh_prog_nnow_14) * ((- __f2dace_SOA_rho_d_2_s_503_p_nh_prog_nnew_15) + _for_it_17)) + (__f2dace_SA_rho_d_0_s_501_p_nh_prog_nnow_14 * (1 - __f2dace_SOA_rho_d_1_s_502_p_nh_prog_nnew_15))) - __f2dace_SOA_rho_d_0_s_501_p_nh_prog_nnew_15) + _for_it_29)];
            ...
            }
            {

                {
                    ...
                    double p_nh_5_in_diag_ddt_exner_phy_0 = v_v_p_nh_diag_ddt_exner_phy[(((((__f2dace_SA_ddt_exner_phy_d_0_s_582_diag_p_nh_2 * __f2dace_SA_ddt_exner_phy_d_1_s_583_diag_p_nh_2) * ((- __f2dace_SOA_ddt_exner_phy_d_2_s_584_diag_p_nh_2) + _for_it_17)) + (__f2dace_SA_ddt_exner_phy_d_0_s_582_diag_p_nh_2 * (1 - __f2dace_SOA_ddt_exner_phy_d_1_s_583_diag_p_nh_2))) - __f2dace_SOA_ddt_exner_phy_d_0_s_582_diag_p_nh_2) + _for_it_29)];
            ...
            for (_for_it_31 = i_startidx; (_for_it_31 <= i_endidx); _for_it_31 = (_for_it_31 + 1)) {
                {

                    {
                        ...
                        double p_nh_1_in_metrics_deepatmo_divzu_mc_0 = v_v_p_nh_metrics_deepatmo_divzu_mc[((- __f2dace_SOA_deepatmo_divzu_mc_d_0_s_744_metrics_p_nh_4) + _for_it_30)];
                        double p_nh_2_in_metrics_deepatmo_divzl_mc_0 = v_v_p_nh_metrics_deepatmo_divzl_mc[((- __f2dace_SOA_deepatmo_divzl_mc_d_0_s_745_metrics_p_nh_4) + _for_it_30)];
                        double p_nh_prog_nnow_0_in_rho_0 = v_p_nh_prog_nnow_rho[(((((__f2dace_SA_rho_d_0_s_501_p_nh_prog_nnow_14 * __f2dace_SA_rho_d_1_s_502_p_nh_prog_nnow_14) * ((- __f2dace_SOA_rho_d_2_s_503_p_nh_prog_nnew_15) + _for_it_17)) + (__f2dace_SA_rho_d_0_s_501_p_nh_prog_nnow_14 * ((- __f2dace_SOA_rho_d_1_s_502_p_nh_prog_nnew_15) + _for_it_30))) - __f2dace_SOA_rho_d_0_s_501_p_nh_prog_nnew_15) + _for_it_31)];
                ...
                }
                {

                    {
                        ...
                        double p_nh_2_in_metrics_deepatmo_divzu_mc_0 = v_v_p_nh_metrics_deepatmo_divzu_mc[((- __f2dace_SOA_deepatmo_divzu_mc_d_0_s_744_metrics_p_nh_4) + _for_it_30)];
                        ...
                        double p_nh_4_in_metrics_deepatmo_divzl_mc_0 = v_v_p_nh_metrics_deepatmo_divzl_mc[((- __f2dace_SOA_deepatmo_divzl_mc_d_0_s_745_metrics_p_nh_4) + _for_it_30)];
                        double p_nh_5_in_diag_ddt_exner_phy_0 = v_v_p_nh_diag_ddt_exner_phy[(((((__f2dace_SA_ddt_exner_phy_d_0_s_582_diag_p_nh_2 * __f2dace_SA_ddt_exner_phy_d_1_s_583_diag_p_nh_2) * ((- __f2dace_SOA_ddt_exner_phy_d_2_s_584_diag_p_nh_2) + _for_it_17)) + (__f2dace_SA_ddt_exner_phy_d_0_s_582_diag_p_nh_2 * ((- __f2dace_SOA_ddt_exner_phy_d_1_s_583_diag_p_nh_2) + _for_it_30))) - __f2dace_SOA_ddt_exner_phy_d_0_s_582_diag_p_nh_2) + _for_it_31)];
            ...
            for (_for_it_32 = 1; (_for_it_32 <= nlev); _for_it_32 = (_for_it_32 + 1)) {
                for (_for_it_33 = i_startidx; (_for_it_33 <= i_endidx); _for_it_33 = (_for_it_33 + 1)) {
                    ...
                    }
                    {
                        ...
                        {
                            double global_data_0_in_iau_wgt_dyn = v_global_data_iau_wgt_dyn[0];
                            double p_nh_0_in_diag_exner_incr_0 = v_v_p_nh_diag_exner_incr[(((((__f2dace_SA_exner_incr_d_0_s_573_diag_p_nh_2 * __f2dace_SA_exner_incr_d_1_s_574_diag_p_nh_2) * ((- __f2dace_SOA_exner_incr_d_2_s_575_diag_p_nh_2) + _for_it_17)) + (__f2dace_SA_exner_incr_d_0_s_573_diag_p_nh_2 * ((- __f2dace_SOA_exner_incr_d_1_s_574_diag_p_nh_2) + _for_it_32))) - __f2dace_SOA_exner_incr_d_0_s_573_diag_p_nh_2) + _for_it_33)];
            ...
            for (_for_it_35 = i_startidx; (_for_it_35 <= i_endidx); _for_it_35 = (_for_it_35 + 1)) {
                {
                    ...
                    {
                        double dtime_0_in = dtime;
                        double p_nh_0_in_metrics_vwind_impl_wgt_0 = v_v_p_nh_metrics_vwind_impl_wgt[(((__f2dace_SA_vwind_impl_wgt_d_0_s_652_metrics_p_nh_4 * ((- __f2dace_SOA_vwind_impl_wgt_d_1_s_653_metrics_p_nh_4) + _for_it_17)) - __f2dace_SOA_vwind_impl_wgt_d_0_s_652_metrics_p_nh_4) + _for_it_35)];
                ...
                }
                {
                    ...
                    {
                        double p_nh_0_in_metrics_deepatmo_divzu_mc_0 = v_v_p_nh_metrics_deepatmo_divzu_mc[(((- __f2dace_SOA_deepatmo_divzu_mc_d_0_s_744_metrics_p_nh_4) + _for_it_34) - 1)];
                ...
                }
                {
                    ...
                    {
                        double p_nh_0_in_metrics_deepatmo_divzl_mc_0 = v_v_p_nh_metrics_deepatmo_divzl_mc[((- __f2dace_SOA_deepatmo_divzl_mc_d_0_s_745_metrics_p_nh_4) + _for_it_34)];
                ...
                }
                {
                    ...
                    {
                        double p_nh_0_in_metrics_deepatmo_divzl_mc_0 = v_v_p_nh_metrics_deepatmo_divzl_mc[(((- __f2dace_SOA_deepatmo_divzl_mc_d_0_s_745_metrics_p_nh_4) + _for_it_34) - 1)];
                        double p_nh_1_in_metrics_deepatmo_divzu_mc_0 = v_v_p_nh_metrics_deepatmo_divzu_mc[((- __f2dace_SOA_deepatmo_divzu_mc_d_0_s_744_metrics_p_nh_4) + _for_it_34)];
        ...
        if ((_if_cond_10 == 1)) {
            ...
            for (_for_it_38 = 2; (_for_it_38 <= v_global_data_nrdmax[tmp_index_899]); _for_it_38 = (_for_it_38 + 1)) {
            ...
            if ((_if_cond_11 == 1)) {
                ...
                for (_for_it_40 = 2; (_for_it_40 <= v_global_data_nrdmax[tmp_index_911]); _for_it_40 = (_for_it_40 + 1)) {
                    for (_for_it_41 = i_startidx; (_for_it_41 <= i_endidx); _for_it_41 = (_for_it_41 + 1)) {
                        {
                            ...
                            {
                                double dtime_0_in = dtime;
                                double p_nh_0_in_metrics_rayleigh_w_0 = v_v_p_nh_metrics_rayleigh_w[((- __f2dace_SOA_rayleigh_w_d_0_s_645_metrics_p_nh_4) + _for_it_40)];
                                double p_nh_1_in_ref_w_ref_0 = v_v_p_nh_ref_w_ref[(((((__f2dace_SA_w_ref_d_0_s_642_ref_p_nh_3 * __f2dace_SA_w_ref_d_1_s_643_ref_p_nh_3) * ((- __f2dace_SOA_w_ref_d_2_s_644_ref_p_nh_3) + _for_it_17)) + (__f2dace_SA_w_ref_d_0_s_642_ref_p_nh_3 * ((- __f2dace_SOA_w_ref_d_1_s_643_ref_p_nh_3) + _for_it_40))) - __f2dace_SOA_w_ref_d_0_s_642_ref_p_nh_3) + _for_it_41)];
            ...
            for (_for_it_43 = i_startidx; (_for_it_43 <= i_endidx); _for_it_43 = (_for_it_43 + 1)) {
                {
                    ...
                    {
                        double dtime_0_in = dtime;
                        double p_nh_0_in_metrics_vwind_impl_wgt_0 = v_v_p_nh_metrics_vwind_impl_wgt[(((__f2dace_SA_vwind_impl_wgt_d_0_s_652_metrics_p_nh_4 * ((- __f2dace_SOA_vwind_impl_wgt_d_1_s_653_metrics_p_nh_4) + _for_it_17)) - __f2dace_SOA_vwind_impl_wgt_d_0_s_652_metrics_p_nh_4) + _for_it_43)];
                        ...
                        double p_nh_2_in_diag_rho_ic_0 = v_v_p_nh_diag_rho_ic[(((((__f2dace_SA_rho_ic_d_0_s_516_diag_p_nh_2 * __f2dace_SA_rho_ic_d_1_s_517_diag_p_nh_2) * ((- __f2dace_SOA_rho_ic_d_2_s_518_diag_p_nh_2) + _for_it_17)) + (__f2dace_SA_rho_ic_d_0_s_516_diag_p_nh_2 * ((- __f2dace_SOA_rho_ic_d_1_s_517_diag_p_nh_2) + _for_it_42))) - __f2dace_SOA_rho_ic_d_0_s_516_diag_p_nh_2) + _for_it_43)];
                        double p_nh_3_in_metrics_deepatmo_divzu_mc_0 = v_v_p_nh_metrics_deepatmo_divzu_mc[((- __f2dace_SOA_deepatmo_divzu_mc_d_0_s_744_metrics_p_nh_4) + _for_it_42)];
                        double p_nh_4_in_diag_rho_ic_0 = v_v_p_nh_diag_rho_ic[(((((__f2dace_SA_rho_ic_d_0_s_516_diag_p_nh_2 * __f2dace_SA_rho_ic_d_1_s_517_diag_p_nh_2) * ((- __f2dace_SOA_rho_ic_d_2_s_518_diag_p_nh_2) + _for_it_17)) + (__f2dace_SA_rho_ic_d_0_s_516_diag_p_nh_2 * (((- __f2dace_SOA_rho_ic_d_1_s_517_diag_p_nh_2) + _for_it_42) + 1))) - __f2dace_SOA_rho_ic_d_0_s_516_diag_p_nh_2) + _for_it_43)];
                        double p_nh_5_in_metrics_deepatmo_divzl_mc_0 = v_v_p_nh_metrics_deepatmo_divzl_mc[((- __f2dace_SOA_deepatmo_divzl_mc_d_0_s_745_metrics_p_nh_4) + _for_it_42)];
                ...
                }
                {
                    ...
                    {
                        double p_nh_0_in_metrics_exner_ref_mc_0 = v_v_p_nh_metrics_exner_ref_mc[(((((__f2dace_SA_exner_ref_mc_d_0_s_713_metrics_p_nh_4 * __f2dace_SA_exner_ref_mc_d_1_s_714_metrics_p_nh_4) * ((- __f2dace_SOA_exner_ref_mc_d_2_s_715_metrics_p_nh_4) + _for_it_17)) + (__f2dace_SA_exner_ref_mc_d_0_s_713_metrics_p_nh_4 * ((- __f2dace_SOA_exner_ref_mc_d_1_s_714_metrics_p_nh_4) + _for_it_42))) - __f2dace_SOA_exner_ref_mc_d_0_s_713_metrics_p_nh_4) + _for_it_43)];
                        double p_nh_1_in_metrics_deepatmo_divzu_mc_0 = v_v_p_nh_metrics_deepatmo_divzu_mc[((- __f2dace_SOA_deepatmo_divzu_mc_d_0_s_744_metrics_p_nh_4) + _for_it_42)];
                        double p_nh_2_in_metrics_deepatmo_divzl_mc_0 = v_v_p_nh_metrics_deepatmo_divzl_mc[((- __f2dace_SOA_deepatmo_divzl_mc_d_0_s_745_metrics_p_nh_4) + _for_it_42)];
                        double p_nh_prog_nnew_0_in_w_0 = v_p_nh_prog_nnew_w[(((((__f2dace_SA_w_d_0_s_495_p_nh_prog_nnew_15 * __f2dace_SA_w_d_1_s_496_p_nh_prog_nnew_15) * ((- __f2dace_SOA_w_d_2_s_497_p_nh_prog_nnew_15) + _for_it_17)) + (__f2dace_SA_w_d_0_s_495_p_nh_prog_nnew_15 * ((- __f2dace_SOA_w_d_1_s_496_p_nh_prog_nnew_15) + _for_it_42))) - __f2dace_SOA_w_d_0_s_495_p_nh_prog_nnew_15) + _for_it_43)];
                        double p_nh_prog_nnew_1_in_w_0 = v_p_nh_prog_nnew_w[(((((__f2dace_SA_w_d_0_s_495_p_nh_prog_nnew_15 * __f2dace_SA_w_d_1_s_496_p_nh_prog_nnew_15) * ((- __f2dace_SOA_w_d_2_s_497_p_nh_prog_nnew_15) + _for_it_17)) + (__f2dace_SA_w_d_0_s_495_p_nh_prog_nnew_15 * (((- __f2dace_SOA_w_d_1_s_496_p_nh_prog_nnew_15) + _for_it_42) + 1))) - __f2dace_SOA_w_d_0_s_495_p_nh_prog_nnew_15) + _for_it_43)];
                        ...
                        v_p_nh_prog_nnew_exner[(((((__f2dace_SA_exner_d_0_s_504_p_nh_prog_nnew_15 * __f2dace_SA_exner_d_1_s_505_p_nh_prog_nnew_15) * ((- __f2dace_SOA_exner_d_2_s_506_p_nh_prog_nnew_15) + _for_it_17)) + (__f2dace_SA_exner_d_0_s_504_p_nh_prog_nnew_15 * ((- __f2dace_SOA_exner_d_1_s_505_p_nh_prog_nnew_15) + _for_it_42))) - __f2dace_SOA_exner_d_0_s_504_p_nh_prog_nnew_15) + _for_it_43)] = p_nh_prog_nnew_out_exner_0;
                    }
                    {
                        double p_nh_prog_nnew_0_in_exner_0 = v_p_nh_prog_nnew_exner[(((((__f2dace_SA_exner_d_0_s_504_p_nh_prog_nnew_15 * __f2dace_SA_exner_d_1_s_505_p_nh_prog_nnew_15) * ((- __f2dace_SOA_exner_d_2_s_506_p_nh_prog_nnew_15) + _for_it_17)) + (__f2dace_SA_exner_d_0_s_504_p_nh_prog_nnew_15 * ((- __f2dace_SOA_exner_d_1_s_505_p_nh_prog_nnew_15) + _for_it_42))) - __f2dace_SOA_exner_d_0_s_504_p_nh_prog_nnew_15) + _for_it_43)];
                        ...
                        v_p_nh_prog_nnew_theta_v[(((((__f2dace_SA_theta_v_d_0_s_507_p_nh_prog_nnew_15 * __f2dace_SA_theta_v_d_1_s_508_p_nh_prog_nnew_15) * ((- __f2dace_SOA_theta_v_d_2_s_509_p_nh_prog_nnew_15) + _for_it_17)) + (__f2dace_SA_theta_v_d_0_s_507_p_nh_prog_nnew_15 * ((- __f2dace_SOA_theta_v_d_1_s_508_p_nh_prog_nnew_15) + _for_it_42))) - __f2dace_SOA_theta_v_d_0_s_507_p_nh_prog_nnew_15) + _for_it_43)] = p_nh_prog_nnew_out_theta_v_0;
                    }
            ...
            for (_for_it_44 = i_startidx; (_for_it_44 <= i_endidx); _for_it_44 = (_for_it_44 + 1)) {
                {
                    ...
                    {
                        double dtime_0_in = dtime;
                        double p_nh_0_in_metrics_vwind_impl_wgt_0 = v_v_p_nh_metrics_vwind_impl_wgt[(((__f2dace_SA_vwind_impl_wgt_d_0_s_652_metrics_p_nh_4 * ((- __f2dace_SOA_vwind_impl_wgt_d_1_s_653_metrics_p_nh_4) + _for_it_17)) - __f2dace_SOA_vwind_impl_wgt_d_0_s_652_metrics_p_nh_4) + _for_it_44)];
                        ...
                        double p_nh_2_in_metrics_deepatmo_divzu_mc_0 = v_v_p_nh_metrics_deepatmo_divzu_mc[(1 - __f2dace_SOA_deepatmo_divzu_mc_d_0_s_744_metrics_p_nh_4)];
                        double p_nh_3_in_diag_rho_ic_0 = v_v_p_nh_diag_rho_ic[(((((__f2dace_SA_rho_ic_d_0_s_516_diag_p_nh_2 * __f2dace_SA_rho_ic_d_1_s_517_diag_p_nh_2) * ((- __f2dace_SOA_rho_ic_d_2_s_518_diag_p_nh_2) + _for_it_17)) + (__f2dace_SA_rho_ic_d_0_s_516_diag_p_nh_2 * (2 - __f2dace_SOA_rho_ic_d_1_s_517_diag_p_nh_2))) - __f2dace_SOA_rho_ic_d_0_s_516_diag_p_nh_2) + _for_it_44)];
                        double p_nh_4_in_metrics_deepatmo_divzl_mc_0 = v_v_p_nh_metrics_deepatmo_divzl_mc[(1 - __f2dace_SOA_deepatmo_divzl_mc_d_0_s_745_metrics_p_nh_4)];
                ...
                }
                {
                    ...
                    {
                        double p_nh_0_in_metrics_exner_ref_mc_0 = v_v_p_nh_metrics_exner_ref_mc[(((((__f2dace_SA_exner_ref_mc_d_0_s_713_metrics_p_nh_4 * __f2dace_SA_exner_ref_mc_d_1_s_714_metrics_p_nh_4) * ((- __f2dace_SOA_exner_ref_mc_d_2_s_715_metrics_p_nh_4) + _for_it_17)) + (__f2dace_SA_exner_ref_mc_d_0_s_713_metrics_p_nh_4 * (1 - __f2dace_SOA_exner_ref_mc_d_1_s_714_metrics_p_nh_4))) - __f2dace_SOA_exner_ref_mc_d_0_s_713_metrics_p_nh_4) + _for_it_44)];
                        double p_nh_1_in_metrics_vwind_impl_wgt_0 = v_v_p_nh_metrics_vwind_impl_wgt[(((__f2dace_SA_vwind_impl_wgt_d_0_s_652_metrics_p_nh_4 * ((- __f2dace_SOA_vwind_impl_wgt_d_1_s_653_metrics_p_nh_4) + _for_it_17)) - __f2dace_SOA_vwind_impl_wgt_d_0_s_652_metrics_p_nh_4) + _for_it_44)];
                        ...
                        v_p_nh_prog_nnew_exner[(((((__f2dace_SA_exner_d_0_s_504_p_nh_prog_nnew_15 * __f2dace_SA_exner_d_1_s_505_p_nh_prog_nnew_15) * ((- __f2dace_SOA_exner_d_2_s_506_p_nh_prog_nnew_15) + _for_it_17)) + (__f2dace_SA_exner_d_0_s_504_p_nh_prog_nnew_15 * (1 - __f2dace_SOA_exner_d_1_s_505_p_nh_prog_nnew_15))) - __f2dace_SOA_exner_d_0_s_504_p_nh_prog_nnew_15) + _for_it_44)] = p_nh_prog_nnew_out_exner_0;
                    }
                    {
                        double p_nh_prog_nnew_0_in_exner_0 = v_p_nh_prog_nnew_exner[(((((__f2dace_SA_exner_d_0_s_504_p_nh_prog_nnew_15 * __f2dace_SA_exner_d_1_s_505_p_nh_prog_nnew_15) * ((- __f2dace_SOA_exner_d_2_s_506_p_nh_prog_nnew_15) + _for_it_17)) + (__f2dace_SA_exner_d_0_s_504_p_nh_prog_nnew_15 * (1 - __f2dace_SOA_exner_d_1_s_505_p_nh_prog_nnew_15))) - __f2dace_SOA_exner_d_0_s_504_p_nh_prog_nnew_15) + _for_it_44)];
                        double p_nh_prog_nnew_1_in_rho_0 = v_p_nh_prog_nnew_rho[(((((__f2dace_SA_rho_d_0_s_501_p_nh_prog_nnew_15 * __f2dace_SA_rho_d_1_s_502_p_nh_prog_nnew_15) * ((- __f2dace_SOA_rho_d_2_s_503_p_nh_prog_nnew_15) + _for_it_17)) + (__f2dace_SA_rho_d_0_s_501_p_nh_prog_nnew_15 * (1 - __f2dace_SOA_rho_d_1_s_502_p_nh_prog_nnew_15))) - __f2dace_SOA_rho_d_0_s_501_p_nh_prog_nnew_15) + _for_it_44)];
                        double p_nh_prog_nnow_0_in_rho_0 = v_p_nh_prog_nnow_rho[(((((__f2dace_SA_rho_d_0_s_501_p_nh_prog_nnow_14 * __f2dace_SA_rho_d_1_s_502_p_nh_prog_nnow_14) * ((- __f2dace_SOA_rho_d_2_s_503_p_nh_prog_nnew_15) + _for_it_17)) + (__f2dace_SA_rho_d_0_s_501_p_nh_prog_nnow_14 * (1 - __f2dace_SOA_rho_d_1_s_502_p_nh_prog_nnew_15))) - __f2dace_SOA_rho_d_0_s_501_p_nh_prog_nnew_15) + _for_it_44)];
        ...
        if ((_if_cond_13 == 1)) {
            ...
            for (_for_it_45 = v_global_data_kstart_dd3d[tmp_index_1051]; (_for_it_45 <= nlev); _for_it_45 = (_for_it_45 + 1)) {
                for (_for_it_46 = i_startidx; (_for_it_46 <= i_endidx); _for_it_46 = (_for_it_46 + 1)) {
                    {
...

                        {
                            ...
                            int tmp_index_1053_out;

                            ///////////////////
                            // Tasklet code (T_l1451_c1451)
                            tmp_index_1053_out = (_for_it_45 - global_data_0_in_kstart_dd3d[tmp_index_6_0_in]);
                            ///////////////////

                            tmp_index_1053 = tmp_index_1053_out;
                        }
                        {
                            ...
                            double p_nh_1_in_diag_w_concorr_c_0 = v_v_p_nh_diag_w_concorr_c[(((((__f2dace_SA_w_concorr_c_d_0_s_594_diag_p_nh_2 * __f2dace_SA_w_concorr_c_d_1_s_595_diag_p_nh_2) * ((- __f2dace_SOA_w_concorr_c_d_2_s_596_diag_p_nh_2) + _for_it_17)) + (__f2dace_SA_w_concorr_c_d_0_s_594_diag_p_nh_2 * ((- __f2dace_SOA_w_concorr_c_d_1_s_595_diag_p_nh_2) + _for_it_45))) - __f2dace_SOA_w_concorr_c_d_0_s_594_diag_p_nh_2) + _for_it_46)];
                            double p_nh_2_in_diag_w_concorr_c_0 = v_v_p_nh_diag_w_concorr_c[(((((__f2dace_SA_w_concorr_c_d_0_s_594_diag_p_nh_2 * __f2dace_SA_w_concorr_c_d_1_s_595_diag_p_nh_2) * ((- __f2dace_SOA_w_concorr_c_d_2_s_596_diag_p_nh_2) + _for_it_17)) + (__f2dace_SA_w_concorr_c_d_0_s_594_diag_p_nh_2 * (((- __f2dace_SOA_w_concorr_c_d_1_s_595_diag_p_nh_2) + _for_it_45) + 1))) - __f2dace_SOA_w_concorr_c_d_0_s_594_diag_p_nh_2) + _for_it_46)];
                            ...
                            int tmp_index_1053_0_in = tmp_index_1053;
                            double* z_dwdz_dd_out = z_dwdz_dd;

                            ///////////////////
                            // Tasklet code (T_l1451_c1451)
                            z_dwdz_dd_out[(((_for_it_46 + (tmp_index_1053_0_in * tmp_struct_symbol_81)) + ((tmp_struct_symbol_81 * tmp_struct_symbol_82) * (_for_it_17 - 1))) - 1)] = (p_nh_0_in_metrics_inv_ddqz_z_full_0 * ((p_nh_prog_nnew_0_in_w_0 - p_nh_prog_nnew_1_in_w_0) - (p_nh_1_in_diag_w_concorr_c_0 - p_nh_2_in_diag_w_concorr_c_0)));
                            ///////////////////
        ...
        if ((_if_cond_14 == 1)) {
            ...
            for (_for_it_47 = v_global_data_kstart_moist[tmp_index_1070]; (_for_it_47 <= nlev); _for_it_47 = (_for_it_47 + 1)) {
    ...
    if ((_if_cond_16 == 1)) {
        {
            ...
            {
                int p_patch_0_in_cells_start_block_0 = v_v_p_patch_cells_start_block[(1 - __f2dace_SOA_start_block_d_0_s_178_cells_p_patch_7)];
                int i_startblk_out;
        ...
        }
        {
            ...
            {
                int p_patch_0_in_cells_end_block_0 = v_v_p_patch_cells_end_block[(4 - __f2dace_SOA_end_block_d_0_s_181_cells_p_patch_7)];
                int i_endblk_out;
        ...
        for (_for_it_51 = i_startblk; (_for_it_51 <= i_endblk); _for_it_51 = (_for_it_51 + 1)) {
            ...
            i_startidx_in_var_57_0 = v_v_p_patch_var_48_cells_start_index[(1 - __f2dace_SOA_start_index_d_0_s_174_cells_p_patch_7)];
            {


            }
            _if_cond_0_0_0 = (_for_it_51 == i_startblk);
            i_endidx_in_var_58_0 = v_v_p_patch_var_48_cells_end_index[(4 - __f2dace_SOA_end_index_d_0_s_175_cells_p_patch_7)];
            if ((_if_cond_0_0_0 == 1)) {
                {
                    ...
                    {
                        int nproma_var_4_0_in = global_data_var_47_nproma_4[0];
                        int i_endidx_out_var_9_out;
                    ...
                    for (_for_it_53 = i_startidx; (_for_it_53 <= i_endidx); _for_it_53 = (_for_it_53 + 1)) {
                        {

                            {
                                ...
                                v_p_nh_prog_nnew_rho[(((((__f2dace_SA_rho_d_0_s_501_p_nh_prog_nnew_15 * __f2dace_SA_rho_d_1_s_502_p_nh_prog_nnew_15) * ((- __f2dace_SOA_rho_d_2_s_503_p_nh_prog_nnew_15) + _for_it_51)) + (__f2dace_SA_rho_d_0_s_501_p_nh_prog_nnew_15 * ((- __f2dace_SOA_rho_d_1_s_502_p_nh_prog_nnew_15) + _for_it_52))) - __f2dace_SOA_rho_d_0_s_501_p_nh_prog_nnew_15) + _for_it_53)] = p_nh_prog_nnew_out_rho_0;
                            }
                        ...
                        }
                        {
                            ...
                            {
                                double dtime_0_in = dtime;
                                double p_nh_0_in_diag_grf_tend_thv_0 = v_v_p_nh_diag_grf_tend_thv[(((((__f2dace_SA_grf_tend_thv_d_0_s_537_diag_p_nh_2 * __f2dace_SA_grf_tend_thv_d_1_s_538_diag_p_nh_2) * ((- __f2dace_SOA_grf_tend_thv_d_2_s_539_diag_p_nh_2) + _for_it_51)) + (__f2dace_SA_grf_tend_thv_d_0_s_537_diag_p_nh_2 * ((- __f2dace_SOA_grf_tend_thv_d_1_s_538_diag_p_nh_2) + _for_it_52))) - __f2dace_SOA_grf_tend_thv_d_0_s_537_diag_p_nh_2) + _for_it_53)];
                                double p_nh_prog_nnow_0_in_theta_v_0 = v_p_nh_prog_nnow_theta_v[(((((__f2dace_SA_theta_v_d_0_s_507_p_nh_prog_nnow_14 * __f2dace_SA_theta_v_d_1_s_508_p_nh_prog_nnow_14) * ((- __f2dace_SOA_theta_v_d_2_s_509_p_nh_prog_nnew_15) + _for_it_51)) + (__f2dace_SA_theta_v_d_0_s_507_p_nh_prog_nnow_14 * ((- __f2dace_SOA_theta_v_d_1_s_508_p_nh_prog_nnew_15) + _for_it_52))) - __f2dace_SOA_theta_v_d_0_s_507_p_nh_prog_nnew_15) + _for_it_53)];
                                double p_nh_prog_nnew_out_theta_v_0;
                                ...
                                v_p_nh_prog_nnew_theta_v[(((((__f2dace_SA_theta_v_d_0_s_507_p_nh_prog_nnew_15 * __f2dace_SA_theta_v_d_1_s_508_p_nh_prog_nnew_15) * ((- __f2dace_SOA_theta_v_d_2_s_509_p_nh_prog_nnew_15) + _for_it_51)) + (__f2dace_SA_theta_v_d_0_s_507_p_nh_prog_nnew_15 * ((- __f2dace_SOA_theta_v_d_1_s_508_p_nh_prog_nnew_15) + _for_it_52))) - __f2dace_SOA_theta_v_d_0_s_507_p_nh_prog_nnew_15) + _for_it_53)] = p_nh_prog_nnew_out_theta_v_0;
                            }
                            {
                                double p_nh_prog_nnew_0_in_rho_0 = v_p_nh_prog_nnew_rho[(((((__f2dace_SA_rho_d_0_s_501_p_nh_prog_nnew_15 * __f2dace_SA_rho_d_1_s_502_p_nh_prog_nnew_15) * ((- __f2dace_SOA_rho_d_2_s_503_p_nh_prog_nnew_15) + _for_it_51)) + (__f2dace_SA_rho_d_0_s_501_p_nh_prog_nnew_15 * ((- __f2dace_SOA_rho_d_1_s_502_p_nh_prog_nnew_15) + _for_it_52))) - __f2dace_SOA_rho_d_0_s_501_p_nh_prog_nnew_15) + _for_it_53)];
                                double p_nh_prog_nnew_1_in_theta_v_0 = v_p_nh_prog_nnew_theta_v[(((((__f2dace_SA_theta_v_d_0_s_507_p_nh_prog_nnew_15 * __f2dace_SA_theta_v_d_1_s_508_p_nh_prog_nnew_15) * ((- __f2dace_SOA_theta_v_d_2_s_509_p_nh_prog_nnew_15) + _for_it_51)) + (__f2dace_SA_theta_v_d_0_s_507_p_nh_prog_nnew_15 * ((- __f2dace_SOA_theta_v_d_1_s_508_p_nh_prog_nnew_15) + _for_it_52))) - __f2dace_SOA_theta_v_d_0_s_507_p_nh_prog_nnew_15) + _for_it_53)];
                            ...
                            }
                            {
                                ...
                                v_p_nh_prog_nnew_exner[(((((__f2dace_SA_exner_d_0_s_504_p_nh_prog_nnew_15 * __f2dace_SA_exner_d_1_s_505_p_nh_prog_nnew_15) * ((- __f2dace_SOA_exner_d_2_s_506_p_nh_prog_nnew_15) + _for_it_51)) + (__f2dace_SA_exner_d_0_s_504_p_nh_prog_nnew_15 * ((- __f2dace_SOA_exner_d_1_s_505_p_nh_prog_nnew_15) + _for_it_52))) - __f2dace_SOA_exner_d_0_s_504_p_nh_prog_nnew_15) + _for_it_53)] = p_nh_prog_nnew_out_exner_0;
                            }
                ...
                for (_for_it_54 = i_startidx; (_for_it_54 <= i_endidx); _for_it_54 = (_for_it_54 + 1)) {
                    ...
                    tmp_index_1136 = (nlevp1 - __f2dace_SOA_grf_tend_w_d_1_s_526_diag_p_nh_2);
                    {

                        {
                            ...
                            double p_nh_prog_nnow_0_in_w_0 = v_p_nh_prog_nnow_w[(((((__f2dace_SA_w_d_0_s_495_p_nh_prog_nnow_14 * __f2dace_SA_w_d_1_s_496_p_nh_prog_nnow_14) * ((- __f2dace_SOA_w_d_2_s_497_p_nh_prog_nnew_15) + _for_it_51)) + (__f2dace_SA_w_d_0_s_495_p_nh_prog_nnow_14 * tmp_index_1133)) - __f2dace_SOA_w_d_0_s_495_p_nh_prog_nnew_15) + _for_it_54)];
                            double p_nh_prog_nnew_out_w_0;
                            ...
                            v_p_nh_prog_nnew_w[(((((__f2dace_SA_w_d_0_s_495_p_nh_prog_nnew_15 * __f2dace_SA_w_d_1_s_496_p_nh_prog_nnew_15) * ((- __f2dace_SOA_w_d_2_s_497_p_nh_prog_nnew_15) + _for_it_51)) + (__f2dace_SA_w_d_0_s_495_p_nh_prog_nnew_15 * tmp_index_1130)) - __f2dace_SOA_w_d_0_s_495_p_nh_prog_nnew_15) + _for_it_54)] = p_nh_prog_nnew_out_w_0;
                        }
                        ...
                        for (_for_it_56 = i_startidx; (_for_it_56 <= i_endidx); _for_it_56 = (_for_it_56 + 1)) {
                            ...
                            }
                            {

                                {
                                    ...
                                    v_p_nh_prog_nnew_exner[(((((__f2dace_SA_exner_d_0_s_504_p_nh_prog_nnew_15 * __f2dace_SA_exner_d_1_s_505_p_nh_prog_nnew_15) * ((- __f2dace_SOA_exner_d_2_s_506_p_nh_prog_nnew_15) + _for_it_51)) + (__f2dace_SA_exner_d_0_s_504_p_nh_prog_nnew_15 * ((- __f2dace_SOA_exner_d_1_s_505_p_nh_prog_nnew_15) + _for_it_55))) - __f2dace_SOA_exner_d_0_s_504_p_nh_prog_nnew_15) + _for_it_56)] = p_nh_prog_nnew_out_exner_0;
                                }
                    ...
                    for (_for_it_57 = i_startidx; (_for_it_57 <= i_endidx); _for_it_57 = (_for_it_57 + 1)) {
                        ...
                        tmp_index_1172 = (nlevp1 - __f2dace_SOA_grf_tend_w_d_1_s_526_diag_p_nh_2);
                        {

                            {
                                ...
                                double p_nh_prog_nnow_0_in_w_0 = v_p_nh_prog_nnow_w[(((((__f2dace_SA_w_d_0_s_495_p_nh_prog_nnow_14 * __f2dace_SA_w_d_1_s_496_p_nh_prog_nnow_14) * ((- __f2dace_SOA_w_d_2_s_497_p_nh_prog_nnew_15) + _for_it_51)) + (__f2dace_SA_w_d_0_s_495_p_nh_prog_nnow_14 * tmp_index_1169)) - __f2dace_SOA_w_d_0_s_495_p_nh_prog_nnew_15) + _for_it_57)];
                                double p_nh_prog_nnew_out_w_0;
                                ...
                                v_p_nh_prog_nnew_w[(((((__f2dace_SA_w_d_0_s_495_p_nh_prog_nnew_15 * __f2dace_SA_w_d_1_s_496_p_nh_prog_nnew_15) * ((- __f2dace_SOA_w_d_2_s_497_p_nh_prog_nnew_15) + _for_it_51)) + (__f2dace_SA_w_d_0_s_495_p_nh_prog_nnew_15 * tmp_index_1166)) - __f2dace_SOA_w_d_0_s_495_p_nh_prog_nnew_15) + _for_it_57)] = p_nh_prog_nnew_out_w_0;
                            }
            ...
            if ((_if_cond_19 == 1)) {
                ...
                for (_for_it_58 = v_global_data_kstart_dd3d[tmp_index_1174]; (_for_it_58 <= nlev); _for_it_58 = (_for_it_58 + 1)) {
                    for (_for_it_59 = i_startidx; (_for_it_59 <= i_endidx); _for_it_59 = (_for_it_59 + 1)) {
                        {
...

                            {
                                int* global_data_0_in_kstart_dd3d = &v_global_data_kstart_dd3d[0];
                                int tmp_index_6_0_in = tmp_index_6;
                                int tmp_index_1176_out;

                                ///////////////////
                                // Tasklet code (T_l1503_c1503)
                                tmp_index_1176_out = (_for_it_58 - global_data_0_in_kstart_dd3d[tmp_index_6_0_in]);
                                ///////////////////

                                tmp_index_1176 = tmp_index_1176_out;
                            }
                            {
                                ...
                                double p_nh_1_in_diag_w_concorr_c_0 = v_v_p_nh_diag_w_concorr_c[(((((__f2dace_SA_w_concorr_c_d_0_s_594_diag_p_nh_2 * __f2dace_SA_w_concorr_c_d_1_s_595_diag_p_nh_2) * ((- __f2dace_SOA_w_concorr_c_d_2_s_596_diag_p_nh_2) + _for_it_51)) + (__f2dace_SA_w_concorr_c_d_0_s_594_diag_p_nh_2 * ((- __f2dace_SOA_w_concorr_c_d_1_s_595_diag_p_nh_2) + _for_it_58))) - __f2dace_SOA_w_concorr_c_d_0_s_594_diag_p_nh_2) + _for_it_59)];
                                double p_nh_2_in_diag_w_concorr_c_0 = v_v_p_nh_diag_w_concorr_c[(((((__f2dace_SA_w_concorr_c_d_0_s_594_diag_p_nh_2 * __f2dace_SA_w_concorr_c_d_1_s_595_diag_p_nh_2) * ((- __f2dace_SOA_w_concorr_c_d_2_s_596_diag_p_nh_2) + _for_it_51)) + (__f2dace_SA_w_concorr_c_d_0_s_594_diag_p_nh_2 * (((- __f2dace_SOA_w_concorr_c_d_1_s_595_diag_p_nh_2) + _for_it_58) + 1))) - __f2dace_SOA_w_concorr_c_d_0_s_594_diag_p_nh_2) + _for_it_59)];
                                ...
                                int tmp_index_1176_0_in = tmp_index_1176;
                                double* z_dwdz_dd_out = z_dwdz_dd;

                                ///////////////////
                                // Tasklet code (T_l1503_c1503)
                                z_dwdz_dd_out[(((_for_it_59 + (tmp_index_1176_0_in * tmp_struct_symbol_81)) + ((tmp_struct_symbol_81 * tmp_struct_symbol_82) * (_for_it_51 - 1))) - 1)] = (p_nh_0_in_metrics_inv_ddqz_z_full_0 * ((p_nh_prog_nnew_0_in_w_0 - p_nh_prog_nnew_1_in_w_0) - (p_nh_1_in_diag_w_concorr_c_0 - p_nh_2_in_diag_w_concorr_c_0)));
                                ///////////////////
