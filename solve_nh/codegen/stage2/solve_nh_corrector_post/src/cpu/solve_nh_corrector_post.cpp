...
inline void loop_body_48_0_8(solve_nh_corrector_post_state_t *__state, double* __restrict__ __CG_p_int__m_e_flx_avg, double* __restrict__ __CG_p_nh_prog_nnew__m_vn, int* __restrict__ __CG_p_patch__CG_edges__m_quad_blk, int* __restrict__ __CG_p_patch__CG_edges__m_quad_idx, double* __restrict__ z_vn_avg, int _for_it_0, int64_t _for_it_3, int64_t _for_it_4, int tmp_struct_symbol_47) {
    int tmp_index_133;
    int tmp_index_135;
    int tmp_index_145;
    int tmp_index_147;
...

            {
                for (auto _for_it_1 = 1; _for_it_1 < (nlev + 1); _for_it_1 += 1) {
                    for (auto _for_it_2 = i_startidx; _for_it_2 < (i_endidx + 1); _for_it_2 += 1) {
                        loop_body_46_0_10(__state, &__CG_p_int__m_e_flx_avg[0], &__CG_p_int__m_rbf_vec_coeff_e[0], &__CG_p_nh_prog_nnew__m_vn[0], &__CG_p_patch__CG_edges__m_quad_blk[0], &__CG_p_patch__CG_edges__m_quad_idx[0], &__CG_p_nh__CG_diag__m_vt[0], &z_vn_avg[0], _for_it_0, _for_it_1, _for_it_2, tmp_struct_symbol_47);
                    }
                }
            }
...

            {
                for (auto _for_it_3 = 1; _for_it_3 < (nlev + 1); _for_it_3 += 1) {
                    for (auto _for_it_4 = i_startidx; _for_it_4 < (i_endidx + 1); _for_it_4 += 1) {
                        loop_body_48_0_8(__state, &__CG_p_int__m_e_flx_avg[0], &__CG_p_nh_prog_nnew__m_vn[0], &__CG_p_patch__CG_edges__m_quad_blk[0], &__CG_p_patch__CG_edges__m_quad_idx[0], &z_vn_avg[0], _for_it_0, _for_it_3, _for_it_4, tmp_struct_symbol_47);
                    }
                }
            }
...

        {
            for (auto _for_it_20 = global_data__m_nflatlev_sym_0; _for_it_20 < (nlev + 1); _for_it_20 += 1) {
                for (auto _for_it_21 = i_startidx; _for_it_21 < (i_endidx + 1); _for_it_21 += 1) {
                    loop_body_13_2_8(__state, &__CG_p_int__m_e_bln_c_s[0], &__CG_p_patch__CG_cells__m_edge_blk[0], &__CG_p_patch__CG_cells__m_edge_idx[0], &z_w_concorr_me[0], &z_w_concorr_mc[0], _for_it_19, _for_it_20, _for_it_21, tmp_struct_symbol_39, tmp_struct_symbol_40, tmp_struct_symbol_69);
                }
            }
        }
...

            {
                for (auto _for_it_59 = global_data__m_kstart_moist_sym_0; _for_it_59 < (nlev + 1); _for_it_59 += 1) {
                    for (auto _for_it_60 = i_startidx; _for_it_60 < (i_endidx + 1); _for_it_60 += 1) {
                        loop_body_92_1_10(__state, &__CG_global_data__m_ndyn_substeps_var[0], &__CG_p_nh__CG_diag__m_ddt_exner_phy[0], &__CG_p_nh_prog_nnew__m_exner[0], dtime, jg, &__CG_p_nh__CG_diag__m_exner_dyn_incr[0], _for_it_25, _for_it_59, _for_it_60);
                    }
                }
            }
