...
inline void loop_body_16_0_0(solve_nh_corrector_post_state_t *__state, double* __restrict__ __CG_p_nh__CG_diag__m_mass_fl_e, int* __restrict__ __CG_p_patch__CG_edges__m_refin_ctrl, double* __restrict__ __CG_p_nh__CG_diag__m_mass_fl_e_sv, int _for_it_0, int _for_it_7, int64_t _for_it_8) {
    bool _if_cond_5;
...
inline void for_cfg_13_1_4_20(solve_nh_corrector_post_state_t *__state, double* __restrict__ __CG_p_nh__CG_diag__m_mass_fl_e, int* __restrict__ __CG_p_patch__CG_edges__m_refin_ctrl, double* __restrict__ __CG_p_nh__CG_diag__m_mass_fl_e_sv, int _for_it_0, int _for_it_7, int64_t _for_it_8, int _if_cond_4) {


    if ((_if_cond_4 == 1)) {
        {

            loop_body_16_0_0(__state, &__CG_p_nh__CG_diag__m_mass_fl_e[0], &__CG_p_patch__CG_edges__m_refin_ctrl[0], &__CG_p_nh__CG_diag__m_mass_fl_e_sv[0], _for_it_0, _for_it_7, _for_it_8);
...
inline void for_cfg_11_3_1_0(solve_nh_corrector_post_state_t *__state, double* __restrict__ __CG_prep_adv__m_mass_flx_me, double* __restrict__ __CG_prep_adv__m_vn_traj, int _for_it_0, int64_t _for_it_10, int64_t _for_it_9, int _if_cond_7) {
...
inline void for_cfg_9_61_1_0(solve_nh_corrector_post_state_t *__state, double* __restrict__ __CG_p_nh__CG_diag__m_mass_fl_e, double* __restrict__ __CG_p_nh__CG_metrics__m_ddqz_z_full_e, const int&  jb_local, const int&  je_local, const double&  r_nsubsteps, double* __restrict__ z_rho_e, double* __restrict__ __CG_prep_adv__m_mass_flx_me, double* __restrict__ __CG_prep_adv__m_vn_traj, int _for_it_16, int _if_cond_10, int tmp_struct_symbol_6, int tmp_struct_symbol_7) {


    if ((_if_cond_10 == 1)) {
        {

            loop_body_64_0_0(__state, &__CG_p_nh__CG_diag__m_mass_fl_e[0], &__CG_p_nh__CG_metrics__m_ddqz_z_full_e[0], jb_local, je_local, r_nsubsteps, &z_rho_e[0], &__CG_prep_adv__m_mass_flx_me[0], &__CG_prep_adv__m_vn_traj[0], _for_it_16, tmp_struct_symbol_6, tmp_struct_symbol_7);
...
inline void loop_body_61_1_13(solve_nh_corrector_post_state_t *__state, double* __restrict__ __CG_p_nh__CG_diag__m_grf_bdy_mflx, const double&  dtime, const int&  jb_local, const int&  je_local, const int&  jstep, double* __restrict__ z_theta_v_e, double* __restrict__ __CG_p_nh__CG_diag__m_mass_fl_e, double* __restrict__ z_theta_v_fl_e, int _for_it_15, int _for_it_17, int tmp_struct_symbol_0, int tmp_struct_symbol_1, int tmp_struct_symbol_3, int tmp_struct_symbol_4) {
    double tmp_call_1;
    int tmp_index_267;
    int tmp_index_269;
    int tmp_index_276;
...
inline void for_cfg_10_61_1_21(solve_nh_corrector_post_state_t *__state, double* __restrict__ __CG_p_nh__CG_diag__m_mass_fl_e, double* __restrict__ __CG_p_nh__CG_metrics__m_ddqz_z_full_e, const int&  jb_local, const int&  je_local, const double&  r_nsubsteps, double* __restrict__ z_rho_e, double* __restrict__ __CG_prep_adv__m_mass_flx_me, double* __restrict__ __CG_prep_adv__m_vn_traj, int _for_it_18, int _if_cond_11, int tmp_struct_symbol_6, int tmp_struct_symbol_7) {


    if ((_if_cond_11 == 1)) {
        {

            loop_body_69_0_0(__state, &__CG_p_nh__CG_diag__m_mass_fl_e[0], &__CG_p_nh__CG_metrics__m_ddqz_z_full_e[0], jb_local, je_local, r_nsubsteps, &z_rho_e[0], &__CG_prep_adv__m_mass_flx_me[0], &__CG_prep_adv__m_vn_traj[0], _for_it_18, tmp_struct_symbol_6, tmp_struct_symbol_7);
...

    {

        {
            for (auto _for_it_16 = 1; _for_it_16 < 91; _for_it_16 += 1) {
                for_cfg_9_61_1_0(__state, &__CG_p_nh__CG_diag__m_mass_fl_e[0], &__CG_p_nh__CG_metrics__m_ddqz_z_full_e[0], jb_local, je_local, r_nsubsteps, &z_rho_e[0], &__CG_prep_adv__m_mass_flx_me[0], &__CG_prep_adv__m_vn_traj[0], _for_it_16, _if_cond_10, tmp_struct_symbol_6, tmp_struct_symbol_7);
            }
        }
        {
            for (auto _for_it_17 = 1; _for_it_17 < 91; _for_it_17 += 1) {
                loop_body_61_1_13(__state, &__CG_p_nh__CG_diag__m_grf_bdy_mflx[0], dtime, jb_local, je_local, jstep, &z_theta_v_e[0], &__CG_p_nh__CG_diag__m_mass_fl_e[0], &z_theta_v_fl_e[0], _for_it_15, _for_it_17, tmp_struct_symbol_0, tmp_struct_symbol_1, tmp_struct_symbol_3, tmp_struct_symbol_4);
                for_cfg_10_61_1_21(__state, &__CG_p_nh__CG_diag__m_mass_fl_e[0], &__CG_p_nh__CG_metrics__m_ddqz_z_full_e[0], jb_local, je_local, r_nsubsteps, &z_rho_e[0], &__CG_prep_adv__m_mass_flx_me[0], &__CG_prep_adv__m_vn_traj[0], _for_it_17, _if_cond_11, tmp_struct_symbol_6, tmp_struct_symbol_7);
            }
        }
...
inline void for_cfg_3_23_6_0(solve_nh_corrector_post_state_t *__state, double* __restrict__ __CG_p_nh__CG_diag__m_theta_v_ic, double* __restrict__ __CG_p_nh__CG_metrics__m_ddqz_z_half, double* __restrict__ __CG_p_nh__CG_metrics__m_deepatmo_divzl_mc, double* __restrict__ __CG_p_nh__CG_metrics__m_deepatmo_divzu_mc, double* __restrict__ __CG_p_nh__CG_metrics__m_vwind_impl_wgt, const double&  dtime, double* __restrict__ z_alpha, double* __restrict__ z_beta, double* __restrict__ z_exner_expl, double* __restrict__ z_w_expl, double* __restrict__ __CG_p_nh_prog_nnew__m_w, double* __restrict__ z_q, int _for_it_23, int64_t _for_it_42, int tmp_struct_symbol_45, int tmp_struct_symbol_55, int tmp_struct_symbol_57, int tmp_struct_symbol_59, int tmp_struct_symbol_61) {
    int64_t _for_it_41;
...
inline void for_cfg_4_23_6_16(solve_nh_corrector_post_state_t *__state, double* __restrict__ z_q, double* __restrict__ __CG_p_nh_prog_nnew__m_w, int _for_it_23, int64_t _for_it_44, int tmp_struct_symbol_61) {
    int64_t _for_it_43;
    ...
    if ((_if_cond_20 == 1)) {
        {
...

            {
                ...
                single_state_body_map_inner_sdfg_6___CG_p_nh_prog_nnew__m_rho_transified_0 = p_nh_prog_nnew_out_rho_0;
            }
            {
                double inp = single_state_body_map_inner_sdfg_6___CG_p_nh_prog_nnew__m_rho_transified_0;
                double out;
            ...
            }
            {
                ...
                single_state_body_map_inner_sdfg_6___CG_p_nh_prog_nnew__m_exner_transified_0 = p_nh_prog_nnew_out_exner_0;
            }
            {
                double inp = single_state_body_map_inner_sdfg_6___CG_p_nh_prog_nnew__m_exner_transified_0;
                double out;
                ...
                __CG_p_nh_prog_nnew__m_exner[(((((__f2dace_SA_exner_d_0_s_504_p_nh_prog_nnew_15 * __f2dace_SA_exner_d_1_s_505_p_nh_prog_nnew_15) * ((- __f2dace_SOA_exner_d_2_s_506_p_nh_prog_nnew_15) + _for_it_23)) + (__f2dace_SA_exner_d_0_s_504_p_nh_prog_nnew_15 * (1 - __f2dace_SOA_exner_d_1_s_505_p_nh_prog_nnew_15))) - __f2dace_SOA_exner_d_0_s_504_p_nh_prog_nnew_15) + _for_it_51)] = out;
            }
            {
                double p_nh_prog_nnew_0_in_exner_0 = single_state_body_map_inner_sdfg_6___CG_p_nh_prog_nnew__m_exner_transified_0;
                double p_nh_prog_nnew_1_in_rho_0 = single_state_body_map_inner_sdfg_6___CG_p_nh_prog_nnew__m_rho_transified_0;
...
inline void for_cfg_16_28_1_17(solve_nh_corrector_post_state_t *__state, double* __restrict__ __CG_p_nh__CG_diag__m_rho_ic, const double&  r_nsubsteps, double* __restrict__ z_mflx_top, double* __restrict__ __CG_prep_adv__m_mass_flx_ic, double* __restrict__ __CG_prep_adv__m_vol_flx_ic, int _for_it_23, int64_t _for_it_56, int _if_cond_23, int tmp_struct_symbol_49) {
...
inline void for_cfg_17_23_8_0(solve_nh_corrector_post_state_t *__state, int* __restrict__ __CG_global_data__m_ndyn_substeps_var, double* __restrict__ __CG_p_nh__CG_diag__m_ddt_exner_phy, double* __restrict__ __CG_p_nh_prog_nnew__m_exner, const double&  dtime, double* __restrict__ __CG_p_nh__CG_diag__m_exner_dyn_incr, int _for_it_23, int64_t _for_it_57, int64_t _for_it_58, int _if_cond_24) {
...
inline void loop_body_56_0_0(solve_nh_corrector_post_state_t *__state, double* __restrict__ __CG_p_nh__CG_diag__m_rho_ic, double* __restrict__ __CG_p_nh__CG_diag__m_theta_v_ic, double* __restrict__ __CG_p_nh__CG_metrics__m_vwind_expl_wgt, double* __restrict__ __CG_p_nh__CG_metrics__m_vwind_impl_wgt, double* __restrict__ __CG_p_nh_prog_nnew__m_w, double* __restrict__ __CG_p_nh_prog_nnow__m_w, const int&  idyn_timestep, const int&  nshift, double* __restrict__ __CG_p_nh__CG_diag__m_mflx_ic_int, double* __restrict__ __CG_p_nh__CG_diag__m_rho_ic_int, double* __restrict__ __CG_p_nh__CG_diag__m_theta_v_ic_int, double* __restrict__ __CG_p_nh__CG_diag__m_w_int, int _for_it_23, int _for_it_59) {
    int tmp_index_1075;
    int tmp_index_1077;
    int tmp_index_1080;
    int tmp_index_1084;
...
inline void for_cfg_18_23_8_9(solve_nh_corrector_post_state_t *__state, double* __restrict__ __CG_p_nh__CG_diag__m_rho_ic, double* __restrict__ __CG_p_nh__CG_diag__m_theta_v_ic, double* __restrict__ __CG_p_nh__CG_metrics__m_vwind_expl_wgt, double* __restrict__ __CG_p_nh__CG_metrics__m_vwind_impl_wgt, double* __restrict__ __CG_p_nh_prog_nnew__m_w, double* __restrict__ __CG_p_nh_prog_nnow__m_w, const int&  idyn_timestep, const int&  nshift, double* __restrict__ __CG_p_nh__CG_diag__m_mflx_ic_int, double* __restrict__ __CG_p_nh__CG_diag__m_rho_ic_int, double* __restrict__ __CG_p_nh__CG_diag__m_theta_v_ic_int, double* __restrict__ __CG_p_nh__CG_diag__m_w_int, int _for_it_23, int _for_it_59, int _if_cond_25) {


    if ((_if_cond_25 == 1)) {
        {

            loop_body_56_0_0(__state, &__CG_p_nh__CG_diag__m_rho_ic[0], &__CG_p_nh__CG_diag__m_theta_v_ic[0], &__CG_p_nh__CG_metrics__m_vwind_expl_wgt[0], &__CG_p_nh__CG_metrics__m_vwind_impl_wgt[0], &__CG_p_nh_prog_nnew__m_w[0], &__CG_p_nh_prog_nnow__m_w[0], idyn_timestep, nshift, &__CG_p_nh__CG_diag__m_mflx_ic_int[0], &__CG_p_nh__CG_diag__m_rho_ic_int[0], &__CG_p_nh__CG_diag__m_theta_v_ic_int[0], &__CG_p_nh__CG_diag__m_w_int[0], _for_it_23, _for_it_59);
...

    {

        {
            for (auto _for_it_42 = i_startidx_local; _for_it_42 < (i_endidx_local + 1); _for_it_42 += 1) {
                for_cfg_3_23_6_0(__state, &__CG_p_nh__CG_diag__m_theta_v_ic[0], &__CG_p_nh__CG_metrics__m_ddqz_z_half[0], &__CG_p_nh__CG_metrics__m_deepatmo_divzl_mc[0], &__CG_p_nh__CG_metrics__m_deepatmo_divzu_mc[0], &__CG_p_nh__CG_metrics__m_vwind_impl_wgt[0], dtime, &z_alpha[0], &z_beta[0], &z_exner_expl[0], &z_w_expl[0], &__CG_p_nh_prog_nnew__m_w[0], &z_q[0], _for_it_23, _for_it_42, tmp_struct_symbol_45, tmp_struct_symbol_55, tmp_struct_symbol_57, tmp_struct_symbol_59, tmp_struct_symbol_61);
                for_cfg_4_23_6_16(__state, &z_q[0], &__CG_p_nh_prog_nnew__m_w[0], _for_it_23, _for_it_42, tmp_struct_symbol_61);
            }
        }
        {
            ...
            for (auto _for_it_49 = jk_start_transified; _for_it_49 < 91; _for_it_49 += 1) {
                for (auto _for_it_50 = i_startidx_local; _for_it_50 < (i_endidx_local + 1); _for_it_50 += 1) {
                    ...
                    }
                    {
                        ...
                        __CG_p_nh_prog_nnew__m_exner[(((((__f2dace_SA_exner_d_0_s_504_p_nh_prog_nnew_15 * __f2dace_SA_exner_d_1_s_505_p_nh_prog_nnew_15) * ((- __f2dace_SOA_exner_d_2_s_506_p_nh_prog_nnew_15) + _for_it_23)) + (__f2dace_SA_exner_d_0_s_504_p_nh_prog_nnew_15 * ((- __f2dace_SOA_exner_d_1_s_505_p_nh_prog_nnew_15) + _for_it_49))) - __f2dace_SOA_exner_d_0_s_504_p_nh_prog_nnew_15) + _for_it_50)] = out;
                    }
                    {
        ...
        }
        {
            ...
            }
            {
                for (auto _for_it_56 = i_startidx_local; _for_it_56 < (i_endidx_local + 1); _for_it_56 += 1) {
                    for_cfg_16_28_1_17(__state, &__CG_p_nh__CG_diag__m_rho_ic[0], r_nsubsteps, &z_mflx_top[0], &__CG_prep_adv__m_mass_flx_ic[0], &__CG_prep_adv__m_vol_flx_ic[0], _for_it_23, _for_it_56, _if_cond_23, tmp_struct_symbol_49);
                }
            }
...

        {
            for (auto _for_it_57 = global_data__m_kstart_moist_sym_2; _for_it_57 < 91; _for_it_57 += 1) {
                for (auto _for_it_58 = i_startidx_local; _for_it_58 < (i_endidx_local + 1); _for_it_58 += 1) {
                    for_cfg_17_23_8_0(__state, &__CG_global_data__m_ndyn_substeps_var[0], &__CG_p_nh__CG_diag__m_ddt_exner_phy[0], &__CG_p_nh_prog_nnew__m_exner[0], dtime, &__CG_p_nh__CG_diag__m_exner_dyn_incr[0], _for_it_23, _for_it_57, _for_it_58, _if_cond_24);
                }
            }
        }
        {
            for (auto _for_it_59 = i_startidx_local; _for_it_59 < (i_endidx_local + 1); _for_it_59 += 1) {
                for_cfg_18_23_8_9(__state, &__CG_p_nh__CG_diag__m_rho_ic[0], &__CG_p_nh__CG_diag__m_theta_v_ic[0], &__CG_p_nh__CG_metrics__m_vwind_expl_wgt[0], &__CG_p_nh__CG_metrics__m_vwind_impl_wgt[0], &__CG_p_nh_prog_nnew__m_w[0], &__CG_p_nh_prog_nnow__m_w[0], idyn_timestep, nshift, &__CG_p_nh__CG_diag__m_mflx_ic_int[0], &__CG_p_nh__CG_diag__m_rho_ic_int[0], &__CG_p_nh__CG_diag__m_theta_v_ic_int[0], &__CG_p_nh__CG_diag__m_w_int[0], _for_it_23, _for_it_59, _if_cond_25);
            }
        }
...

            {
                ...
                for (auto _for_it_3 = 1; _for_it_3 < 91; _for_it_3 += 1) {
                    for (auto _for_it_4 = i_startidx_local; _for_it_4 < (i_endidx_local + 1); _for_it_4 += 1) {
                        loop_body_1_4_7(__state, &__CG_p_int__m_e_flx_avg[0], &__CG_p_nh_prog_nnew__m_vn[0], &__CG_p_patch__CG_edges__m_quad_blk[0], &__CG_p_patch__CG_edges__m_quad_idx[0], &z_vn_avg[0], _for_it_0, _for_it_3, _for_it_4, tmp_struct_symbol_47);
                    }
                }
            }
            {
                ...
                for (auto _for_it_5 = 1; _for_it_5 < 91; _for_it_5 += 1) {
                    for (auto _for_it_6 = i_startidx_local; _for_it_6 < (i_endidx_local + 1); _for_it_6 += 1) {
                        ...
                        for_cfg_13_1_4_20(__state, &__CG_p_nh__CG_diag__m_mass_fl_e[0], &__CG_p_patch__CG_edges__m_refin_ctrl[0], &__CG_p_nh__CG_diag__m_mass_fl_e_sv[0], _for_it_0, _for_it_5, _for_it_6, _if_cond_4);
                        {
...

                {
                    ...
                    for (auto _for_it_9 = 1; _for_it_9 < 91; _for_it_9 += 1) {
                        for (auto _for_it_10 = i_startidx_local; _for_it_10 < (i_endidx_local + 1); _for_it_10 += 1) {
                            for_cfg_11_3_1_0(__state, &__CG_prep_adv__m_mass_flx_me[0], &__CG_prep_adv__m_vn_traj[0], _for_it_0, _for_it_10, _for_it_9, _if_cond_7);
                            {
                                ...
                                double r_nsubsteps_0_in = r_nsubsteps;
                                double p_nh_0_in_diag_mass_fl_e_0 = __CG_p_nh__CG_diag__m_mass_fl_e[(((((__f2dace_SA_mass_fl_e_d_0_s_513_diag_p_nh_2 * __f2dace_SA_mass_fl_e_d_1_s_514_diag_p_nh_2) * ((- __f2dace_SOA_mass_fl_e_d_2_s_515_diag_p_nh_2) + _for_it_0)) + (__f2dace_SA_mass_fl_e_d_0_s_513_diag_p_nh_2 * ((- __f2dace_SOA_mass_fl_e_d_1_s_514_diag_p_nh_2) + _for_it_9))) - __f2dace_SOA_mass_fl_e_d_0_s_513_diag_p_nh_2) + _for_it_10)];
                                double prep_adv_out_mass_flx_me_0;
                            ...
                            {
                                double prep_adv_0_in_vn_traj_0 = __CG_prep_adv__m_vn_traj[(((((__f2dace_SA_vn_traj_d_0_s_769_prep_adv_13 * __f2dace_SA_vn_traj_d_1_s_770_prep_adv_13) * ((- __f2dace_SOA_vn_traj_d_2_s_771_prep_adv_13) + _for_it_0)) + (__f2dace_SA_vn_traj_d_0_s_769_prep_adv_13 * ((- __f2dace_SOA_vn_traj_d_1_s_770_prep_adv_13) + _for_it_9))) - __f2dace_SOA_vn_traj_d_0_s_769_prep_adv_13) + _for_it_10)];
                                double r_nsubsteps_0_in = r_nsubsteps;
                                double z_vn_avg_0_in_0 = z_vn_avg[((_for_it_10 + (tmp_struct_symbol_47 * (_for_it_9 - 1))) - 1)];
                                double prep_adv_out_vn_traj_0;
...

    {

        {
            ...
            for (auto _for_it_15 = 1; _for_it_15 < (__CG_p_nh__CG_metrics__m_bdy_mflx_e_dim + 1); _for_it_15 += 1) {
                for_cfg_14_0_6_0(__state, &__CG_p_nh__CG_diag__m_grf_bdy_mflx[0], &__CG_p_nh__CG_metrics__m_bdy_mflx_e_blk[0], &__CG_p_nh__CG_metrics__m_bdy_mflx_e_idx[0], &__CG_p_nh__CG_metrics__m_ddqz_z_full_e[0], dtime, jstep, lprep_adv, r_nsubsteps, &z_rho_e[0], &z_theta_v_e[0], &__CG_p_nh__CG_diag__m_mass_fl_e[0], &__CG_prep_adv__m_mass_flx_me[0], &__CG_prep_adv__m_vn_traj[0], &z_theta_v_fl_e[0], _for_it_15, _if_cond_9, tmp_struct_symbol_0, tmp_struct_symbol_1, tmp_struct_symbol_3, tmp_struct_symbol_4, tmp_struct_symbol_6, tmp_struct_symbol_7);
            }
        }
        {
