...
inline void loop_body_42_0_15(solve_nh_corrector_pre_state_t *__state, const int&  __CG_p_nh__CG_diag__m_ddt_vn_dmp_is_associated, const int&  __CG_p_nh__CG_diag__m_ddt_vn_dyn_is_associated, const double&  r_dtimensubsteps, const double&  scal_divdamp_o2, double* __restrict__ z_graddiv_vn, double* __restrict__ __CG_p_nh__CG_diag__m_ddt_vn_dmp, double* __restrict__ __CG_p_nh__CG_diag__m_ddt_vn_dyn, double* __restrict__ __CG_p_nh_prog_nnew__m_vn, double&  z_d_vn_dmp, int _for_it_50, int64_t _for_it_57, int64_t _for_it_58, int tmp_struct_symbol_42, int tmp_struct_symbol_43) {
    int _if_cond_40;
    int _if_cond_41;
...
inline void loop_body_57_0_15(solve_nh_corrector_pre_state_t *__state, const int&  __CG_p_nh__CG_diag__m_ddt_vn_dmp_is_associated, const int&  __CG_p_nh__CG_diag__m_ddt_vn_dyn_is_associated, const double&  r_dtimensubsteps, double* __restrict__ scal_divdamp, double* __restrict__ z_graddiv2_vn, double* __restrict__ __CG_p_nh__CG_diag__m_ddt_vn_dmp, double* __restrict__ __CG_p_nh__CG_diag__m_ddt_vn_dyn, double* __restrict__ __CG_p_nh_prog_nnew__m_vn, double&  z_d_vn_dmp, int _for_it_50, int64_t _for_it_61, int64_t _for_it_62, int tmp_struct_symbol_63) {
    int _if_cond_46;
    int _if_cond_47;
...
inline void loop_body_64_0_15(solve_nh_corrector_pre_state_t *__state, const double&  __CG_global_data__m_iau_wgt_dyn, const int&  __CG_p_nh__CG_diag__m_ddt_vn_dyn_is_associated, const int&  __CG_p_nh__CG_diag__m_ddt_vn_iau_is_associated, double* __restrict__ __CG_p_nh__CG_diag__m_vn_incr, const double&  r_dtimensubsteps, double* __restrict__ __CG_p_nh__CG_diag__m_ddt_vn_dyn, double* __restrict__ __CG_p_nh__CG_diag__m_ddt_vn_iau, double* __restrict__ __CG_p_nh_prog_nnew__m_vn, double&  z_d_vn_iau, int _for_it_50, int64_t _for_it_63, int64_t _for_it_64) {
    int _if_cond_49;
    int _if_cond_50;
...
inline void loop_body_71_1_14(solve_nh_corrector_pre_state_t *__state, const int&  __CG_p_nh__CG_diag__m_ddt_vn_dyn_is_associated, const int&  __CG_p_nh__CG_diag__m_ddt_vn_ray_is_associated, double* __restrict__ __CG_p_nh__CG_metrics__m_rayleigh_vn, double* __restrict__ __CG_p_nh__CG_ref__m_vn_ref, const double&  dtime, const double&  r_nsubsteps, double* __restrict__ __CG_p_nh__CG_diag__m_ddt_vn_dyn, double* __restrict__ __CG_p_nh__CG_diag__m_ddt_vn_ray, double* __restrict__ __CG_p_nh_prog_nnew__m_vn, int _for_it_50, int64_t _for_it_65, int64_t _for_it_66) {
...

            {
                for (auto _for_it_55 = 1; _for_it_55 < (nlev + 1); _for_it_55 += 1) {
                    for (auto _for_it_56 = i_startidx; _for_it_56 < (i_endidx + 1); _for_it_56 += 1) {
                        loop_body_39_0_7(__state, &__CG_p_int__m_geofac_grdiv[0], &__CG_p_patch__CG_edges__m_quad_blk[0], &__CG_p_patch__CG_edges__m_quad_idx[0], &z_graddiv_vn[0], &z_graddiv2_vn[0], _for_it_50, _for_it_55, _for_it_56, tmp_struct_symbol_42, tmp_struct_symbol_43, tmp_struct_symbol_63);
                    }
                }
            }
...

            {
                for (auto _for_it_57 = 1; _for_it_57 < (nlev + 1); _for_it_57 += 1) {
                    for (auto _for_it_58 = i_startidx; _for_it_58 < (i_endidx + 1); _for_it_58 += 1) {
                        loop_body_42_0_15(__state, __CG_p_nh__CG_diag__m_ddt_vn_dmp_is_associated, __CG_p_nh__CG_diag__m_ddt_vn_dyn_is_associated, r_dtimensubsteps, scal_divdamp_o2, &z_graddiv_vn[0], &__CG_p_nh__CG_diag__m_ddt_vn_dmp[0], &__CG_p_nh__CG_diag__m_ddt_vn_dyn[0], &__CG_p_nh_prog_nnew__m_vn[0], z_d_vn_dmp, _for_it_50, _for_it_57, _for_it_58, tmp_struct_symbol_42, tmp_struct_symbol_43);
                    }
                }
            }
...

                {
                    for (auto _for_it_61 = 1; _for_it_61 < (nlev + 1); _for_it_61 += 1) {
                        for (auto _for_it_62 = i_startidx; _for_it_62 < (i_endidx + 1); _for_it_62 += 1) {
                            loop_body_57_0_15(__state, __CG_p_nh__CG_diag__m_ddt_vn_dmp_is_associated, __CG_p_nh__CG_diag__m_ddt_vn_dyn_is_associated, r_dtimensubsteps, &scal_divdamp[0], &z_graddiv2_vn[0], &__CG_p_nh__CG_diag__m_ddt_vn_dmp[0], &__CG_p_nh__CG_diag__m_ddt_vn_dyn[0], &__CG_p_nh_prog_nnew__m_vn[0], z_d_vn_dmp, _for_it_50, _for_it_61, _for_it_62, tmp_struct_symbol_63);
                        }
                    }
                }
