...
inline void loop_body_1_4_0(solve_nh_predictor_post_state_t *__state, double* __restrict__ __CG_p_nh__CG_diag__m_vt, double* __restrict__ __CG_p_nh__CG_metrics__m_wgtfacq_e, double* __restrict__ __CG_p_nh_prog_nnew__m_vn, double* __restrict__ __CG_p_nh__CG_diag__m_vn_ie, double* __restrict__ z_kin_hor_e, double* __restrict__ z_vt_ie, int _for_it_0, int _for_it_9, int tmp_struct_symbol_21, int tmp_struct_symbol_22, int tmp_struct_symbol_24, int tmp_struct_symbol_25) {
...

        {
            for (auto _for_it_1 = 1; _for_it_1 < 91; _for_it_1 += 1) {
                for (auto _for_it_2 = i_startidx_local; _for_it_2 < (i_endidx_local + 1); _for_it_2 += 1) {
                    ...
                    loop_body_1_3_11(__state, &__CG_p_int__m_e_flx_avg[0], &__CG_p_int__m_geofac_grdiv[0], &__CG_p_int__m_rbf_vec_coeff_e[0], &__CG_p_nh_prog_nnew__m_vn[0], &__CG_p_patch__CG_edges__m_quad_blk[0], &__CG_p_patch__CG_edges__m_quad_idx[0], &__CG_p_nh__CG_diag__m_vt[0], &z_graddiv_vn[0], &z_vn_avg[0], _for_it_0, _for_it_1, _for_it_2, tmp_struct_symbol_42, tmp_struct_symbol_43, tmp_struct_symbol_47);
                    {
...

    {

        {
            for (auto _for_it_9 = i_startidx_local; _for_it_9 < (i_endidx_local + 1); _for_it_9 += 1) {
                loop_body_1_4_0(__state, &__CG_p_nh__CG_diag__m_vt[0], &__CG_p_nh__CG_metrics__m_wgtfacq_e[0], &__CG_p_nh_prog_nnew__m_vn[0], &__CG_p_nh__CG_diag__m_vn_ie[0], &z_kin_hor_e[0], &z_vt_ie[0], _for_it_0, _for_it_9, tmp_struct_symbol_21, tmp_struct_symbol_22, tmp_struct_symbol_24, tmp_struct_symbol_25);
            }
        }
...
inline void loop_body_21_3_0(solve_nh_predictor_post_state_t *__state, double* __restrict__ z_alpha, double* __restrict__ z_q, int _for_it_25, int tmp_struct_symbol_57, int tmp_struct_symbol_61) {
...
inline void loop_body_21_4_0(solve_nh_predictor_post_state_t *__state, double* __restrict__ __CG_p_nh__CG_diag__m_w_concorr_c, double* __restrict__ __CG_p_nh_prog_nnew__m_w, double* __restrict__ z_contr_w_fl_l, int _for_it_17, int _for_it_28, int tmp_struct_symbol_51) {
...
inline void for_cfg_1_21_5_30(solve_nh_predictor_post_state_t *__state, double* __restrict__ z_q, double* __restrict__ __CG_p_nh_prog_nnew__m_w, int _for_it_17, int64_t _for_it_37, int tmp_struct_symbol_61) {
    int64_t _for_it_36;
...
inline void for_cfg_3_21_5_61(solve_nh_predictor_post_state_t *__state, double* __restrict__ __CG_p_nh_prog_nnow__m_exner, double* __restrict__ __CG_p_nh__CG_diag__m_exner_dyn_incr, int _for_it_17, int64_t _for_it_47, int64_t _for_it_48, int _if_cond_14) {
...

    {

        {
            for (auto _for_it_25 = i_startidx_local; _for_it_25 < (i_endidx_local + 1); _for_it_25 += 1) {
                loop_body_21_3_0(__state, &z_alpha[0], &z_q[0], _for_it_25, tmp_struct_symbol_57, tmp_struct_symbol_61);
            }
        }
        {
...

    {

        {
            for (auto _for_it_28 = i_startidx_local; _for_it_28 < (i_endidx_local + 1); _for_it_28 += 1) {
                loop_body_21_4_0(__state, &__CG_p_nh__CG_diag__m_w_concorr_c[0], &__CG_p_nh_prog_nnew__m_w[0], &z_contr_w_fl_l[0], _for_it_17, _for_it_28, tmp_struct_symbol_51);
            }
        }
        {
        ...
        }
        {
            for (auto _for_it_42 = jk_start_transified; _for_it_42 < 91; _for_it_42 += 1) {
                for (auto _for_it_43 = i_startidx_local; _for_it_43 < (i_endidx_local + 1); _for_it_43 += 1) {
                    double __CG_p_nh_prog_nnew__m_exner_transified_0;
                    double __CG_p_nh_prog_nnew__m_rho_transified_0;
                    {
                        ...
                        __CG_p_nh_prog_nnew__m_rho_transified_0 = p_nh_prog_nnew_out_rho_0;
                    }
                    {
                        double inp = __CG_p_nh_prog_nnew__m_rho_transified_0;
                        double out;
                    ...
                    }
                    {
                        ...
                        __CG_p_nh_prog_nnew__m_exner_transified_0 = p_nh_prog_nnew_out_exner_0;
                    }
                    {
                        double inp = __CG_p_nh_prog_nnew__m_exner_transified_0;
                        double out;
                    ...
                    {
                        double p_nh_prog_nnew_0_in_exner_0 = __CG_p_nh_prog_nnew__m_exner_transified_0;
                        double p_nh_prog_nnew_1_in_rho_0 = __CG_p_nh_prog_nnew__m_rho_transified_0;
                        double p_nh_prog_nnow_0_in_rho_0 = __CG_p_nh_prog_nnow__m_rho[(((((__f2dace_SA_rho_d_0_s_501_p_nh_prog_nnow_14 * __f2dace_SA_rho_d_1_s_502_p_nh_prog_nnow_14) * ((- __f2dace_SOA_rho_d_2_s_503_p_nh_prog_nnew_15) + _for_it_17)) + (__f2dace_SA_rho_d_0_s_501_p_nh_prog_nnow_14 * ((- __f2dace_SOA_rho_d_1_s_502_p_nh_prog_nnew_15) + _for_it_42))) - __f2dace_SOA_rho_d_0_s_501_p_nh_prog_nnew_15) + _for_it_43)];
        ...
        }
        {
            for (auto _for_it_45 = global_data__m_kstart_dd3d_sym_1; _for_it_45 < 91; _for_it_45 += 1) {
                for (auto _for_it_46 = i_startidx_local; _for_it_46 < (i_endidx_local + 1); _for_it_46 += 1) {
                    loop_body_21_5_58(__state, &__CG_global_data__m_kstart_dd3d[0], &__CG_p_nh__CG_diag__m_w_concorr_c[0], &__CG_p_nh__CG_metrics__m_inv_ddqz_z_full[0], &__CG_p_nh_prog_nnew__m_w[0], &z_dwdz_dd[0], _for_it_17, _for_it_45, _for_it_46, tmp_index_6, tmp_struct_symbol_81, tmp_struct_symbol_82);
                }
            }
        }
        {
            for (auto _for_it_47 = global_data__m_kstart_moist_sym_2; _for_it_47 < 91; _for_it_47 += 1) {
                for (auto _for_it_48 = i_startidx_local; _for_it_48 < (i_endidx_local + 1); _for_it_48 += 1) {
                    for_cfg_3_21_5_61(__state, &__CG_p_nh_prog_nnow__m_exner[0], &__CG_p_nh__CG_diag__m_exner_dyn_incr[0], _for_it_17, _for_it_47, _for_it_48, _if_cond_14);
                }
            }
        }
...

            {
                ...
                for (auto _for_it_14 = (global_data__m_nflatlev_sym_0 + 1); _for_it_14 < 91; _for_it_14 += 1) {
                    for (auto _for_it_15 = i_startidx_local; _for_it_15 < (i_endidx_local + 1); _for_it_15 += 1) {
                        loop_body_10_2_8(__state, &__CG_p_int__m_e_bln_c_s[0], &__CG_p_nh__CG_metrics__m_wgtfac_c[0], &__CG_p_patch__CG_cells__m_edge_blk[0], &__CG_p_patch__CG_cells__m_edge_idx[0], &z_w_concorr_me[0], &__CG_p_nh__CG_diag__m_w_concorr_c[0], _for_it_13, _for_it_14, _for_it_15, tmp_struct_symbol_39, tmp_struct_symbol_40);
                    }
                }
            }
        ...
        }
        {

            {
                ...
                for (auto _for_it_16 = i_startidx_local; _for_it_16 < (i_endidx_local + 1); _for_it_16 += 1) {
                    loop_body_10_3_0(__state, &__CG_p_int__m_e_bln_c_s[0], &__CG_p_nh__CG_metrics__m_wgtfacq_c[0], &__CG_p_patch__CG_cells__m_edge_blk[0], &__CG_p_patch__CG_cells__m_edge_idx[0], &z_w_concorr_me[0], &__CG_p_nh__CG_diag__m_w_concorr_c[0], _for_it_13, _for_it_16, tmp_struct_symbol_39, tmp_struct_symbol_40);
                }
            }
