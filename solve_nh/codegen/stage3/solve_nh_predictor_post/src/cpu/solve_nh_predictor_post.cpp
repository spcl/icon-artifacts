...
inline void loop_body_31_0_0(solve_nh_predictor_post_state_t *__state, double* __restrict__ __CG_p_nh__CG_diag__m_vt, double* __restrict__ __CG_p_nh__CG_metrics__m_wgtfacq_e, double* __restrict__ __CG_p_nh_prog_nnew__m_vn, const int&  nlev, const int&  nlevp1, double* __restrict__ __CG_p_nh__CG_diag__m_vn_ie, double* __restrict__ z_kin_hor_e, double* __restrict__ z_vt_ie, int _for_it_0, int _for_it_9, int tmp_struct_symbol_21, int tmp_struct_symbol_22, int tmp_struct_symbol_24, int tmp_struct_symbol_25) {
    int tmp_index_270;
    int tmp_index_276;
    int tmp_index_282;
    int tmp_index_288;
...
inline void loop_body_33_0_0(solve_nh_predictor_post_state_t *__state, double* __restrict__ __CG_p_nh__CG_diag__m_vn_ie_ubc, double* __restrict__ __CG_p_nh__CG_diag__m_vt, double* __restrict__ __CG_p_nh__CG_metrics__m_wgtfacq_e, double* __restrict__ __CG_p_nh_prog_nnew__m_vn, const double&  dt_linintp_ubc_nnew, const int&  nlev, const int&  nlevp1, double* __restrict__ __CG_p_nh__CG_diag__m_vn_ie, double* __restrict__ z_kin_hor_e, double* __restrict__ z_vt_ie, int _for_it_0, int _for_it_10, int tmp_struct_symbol_21, int tmp_struct_symbol_22, int tmp_struct_symbol_24, int tmp_struct_symbol_25) {
    int tmp_index_315;
    int tmp_index_321;
    int tmp_index_327;
    int tmp_index_333;
...

        {
            for (auto _for_it_1 = 1; _for_it_1 < (nlev + 1); _for_it_1 += 1) {
                for (auto _for_it_2 = i_startidx_local; _for_it_2 < (i_endidx_local + 1); _for_it_2 += 1) {
                    loop_body_29_5_10(__state, &__CG_p_int__m_e_flx_avg[0], &__CG_p_int__m_geofac_grdiv[0], &__CG_p_int__m_rbf_vec_coeff_e[0], &__CG_p_nh_prog_nnew__m_vn[0], &__CG_p_patch__CG_edges__m_quad_blk[0], &__CG_p_patch__CG_edges__m_quad_idx[0], &__CG_p_nh__CG_diag__m_vt[0], &z_graddiv_vn[0], &z_vn_avg[0], _for_it_0, _for_it_1, _for_it_2, tmp_struct_symbol_42, tmp_struct_symbol_43, tmp_struct_symbol_47);
                }
            }
        }
        {
    ...
    if ((_if_cond_3 == 1)) {
        {

            {
                for (auto _for_it_9 = i_startidx_local; _for_it_9 < (i_endidx_local + 1); _for_it_9 += 1) {
                    loop_body_31_0_0(__state, &__CG_p_nh__CG_diag__m_vt[0], &__CG_p_nh__CG_metrics__m_wgtfacq_e[0], &__CG_p_nh_prog_nnew__m_vn[0], nlev, nlevp1, &__CG_p_nh__CG_diag__m_vn_ie[0], &z_kin_hor_e[0], &z_vt_ie[0], _for_it_0, _for_it_9, tmp_struct_symbol_21, tmp_struct_symbol_22, tmp_struct_symbol_24, tmp_struct_symbol_25);
                }
            }
...
inline void loop_body_3_1_0(solve_nh_predictor_post_state_t *__state, double* __restrict__ __CG_p_nh__CG_diag__m_grf_bdy_mflx, const double&  dtime, const int&  jstep, double* __restrict__ z_theta_v_e, double* __restrict__ __CG_p_nh__CG_diag__m_mass_fl_e, double* __restrict__ z_theta_v_fl_e, int _for_it_11, int _for_it_12, int jb_local_1, int je_local_1, int tmp_struct_symbol_0, int tmp_struct_symbol_1, int tmp_struct_symbol_3, int tmp_struct_symbol_4) {
    ...
    tmp_index_337 = (je_local_1 - __f2dace_SOA_mass_fl_e_d_0_s_513_diag_p_nh_2);
    tmp_index_339 = (jb_local_1 - __f2dace_SOA_mass_fl_e_d_2_s_515_diag_p_nh_2);
    tmp_index_346 = (je_local_1 - 1);
    tmp_index_348 = (jb_local_1 - 1);
    tmp_index_349 = (je_local_1 - __f2dace_SOA_mass_fl_e_d_0_s_513_diag_p_nh_2);
    tmp_index_351 = (jb_local_1 - __f2dace_SOA_mass_fl_e_d_2_s_515_diag_p_nh_2);
    tmp_index_352 = (je_local_1 - 1);
    tmp_index_354 = (jb_local_1 - 1);
...
inline void loop_body_2_0_0(solve_nh_predictor_post_state_t *__state, double* __restrict__ __CG_p_nh__CG_diag__m_grf_bdy_mflx, int* __restrict__ __CG_p_nh__CG_metrics__m_bdy_mflx_e_blk, int* __restrict__ __CG_p_nh__CG_metrics__m_bdy_mflx_e_idx, const double&  dtime, const int&  jstep, const int&  nlev, double* __restrict__ z_theta_v_e, double* __restrict__ __CG_p_nh__CG_diag__m_mass_fl_e, double* __restrict__ z_theta_v_fl_e, int _for_it_11, int tmp_struct_symbol_0, int tmp_struct_symbol_1, int tmp_struct_symbol_3, int tmp_struct_symbol_4) {
    int je_local;
    int jb_local;



    je_local = __CG_p_nh__CG_metrics__m_bdy_mflx_e_idx[((- __f2dace_SOA_bdy_mflx_e_idx_d_0_s_739_metrics_p_nh_4) + _for_it_11)];


    jb_local = __CG_p_nh__CG_metrics__m_bdy_mflx_e_blk[((- __f2dace_SOA_bdy_mflx_e_blk_d_0_s_740_metrics_p_nh_4) + _for_it_11)];

    {

        {
            for (auto _for_it_12 = 1; _for_it_12 < (nlev + 1); _for_it_12 += 1) {
                loop_body_3_1_0(__state, &__CG_p_nh__CG_diag__m_grf_bdy_mflx[0], dtime, jstep, &z_theta_v_e[0], &__CG_p_nh__CG_diag__m_mass_fl_e[0], &z_theta_v_fl_e[0], _for_it_11, _for_it_12, jb_local, je_local, tmp_struct_symbol_0, tmp_struct_symbol_1, tmp_struct_symbol_3, tmp_struct_symbol_4);
            }
        }
...
inline void loop_body_42_5_0(solve_nh_predictor_post_state_t *__state, double* __restrict__ __CG_p_nh__CG_metrics__m_wgtfacq_c, const int&  nlev, const int&  nlevp1, double* __restrict__ z_w_concorr_mc, double* __restrict__ __CG_p_nh__CG_diag__m_w_concorr_c, int _for_it_13, int _for_it_18, int tmp_struct_symbol_69) {
    int tmp_index_411;
    int tmp_index_417;
    int tmp_index_422;
    int tmp_index_427;
...

        {
            for (auto _for_it_14 = global_data__m_nflatlev_sym_0; _for_it_14 < (nlev + 1); _for_it_14 += 1) {
                for (auto _for_it_15 = i_startidx_local; _for_it_15 < (i_endidx_local + 1); _for_it_15 += 1) {
                    loop_body_42_3_6(__state, &__CG_p_int__m_e_bln_c_s[0], &__CG_p_patch__CG_cells__m_edge_blk[0], &__CG_p_patch__CG_cells__m_edge_idx[0], &z_w_concorr_me[0], &z_w_concorr_mc[0], _for_it_13, _for_it_14, _for_it_15, tmp_struct_symbol_39, tmp_struct_symbol_40, tmp_struct_symbol_69);
                }
            }
        }
...

    {

        {
            for (auto _for_it_18 = i_startidx_local; _for_it_18 < (i_endidx_local + 1); _for_it_18 += 1) {
                loop_body_42_5_0(__state, &__CG_p_nh__CG_metrics__m_wgtfacq_c[0], nlev, nlevp1, &z_w_concorr_mc[0], &__CG_p_nh__CG_diag__m_w_concorr_c[0], _for_it_13, _for_it_18, tmp_struct_symbol_69);
            }
        }
...
inline void loop_body_53_9_9(solve_nh_predictor_post_state_t *__state, double* __restrict__ __CG_p_int__m_geofac_div, double* __restrict__ __CG_p_nh__CG_diag__m_mass_fl_e, double* __restrict__ __CG_p_nh__CG_metrics__m_deepatmo_divh_mc, int* __restrict__ __CG_p_patch__CG_cells__m_edge_blk, int* __restrict__ __CG_p_patch__CG_cells__m_edge_idx, double* __restrict__ z_theta_v_fl_e, double* __restrict__ z_flxdiv_mass, double* __restrict__ z_flxdiv_theta, int _for_it_19, int _for_it_20, int64_t _for_it_21, int tmp_struct_symbol_0, int tmp_struct_symbol_1, int tmp_struct_symbol_71, int tmp_struct_symbol_73) {
    int tmp_index_439;
    int tmp_index_441;
    int tmp_index_451;
    int tmp_index_453;
...
inline void loop_body_53_11_0(solve_nh_predictor_post_state_t *__state, const int&  nlevp1, double* __restrict__ z_alpha, double* __restrict__ z_q, int _for_it_27, int tmp_struct_symbol_57, int tmp_struct_symbol_61) {
    int tmp_index_584;
...
inline void loop_body_53_12_0(solve_nh_predictor_post_state_t *__state, double* __restrict__ __CG_p_nh__CG_diag__m_w_concorr_c, const int&  nlevp1, double* __restrict__ __CG_p_nh_prog_nnew__m_w, double* __restrict__ z_contr_w_fl_l, int _for_it_19, int _for_it_30, int tmp_struct_symbol_51) {
    int tmp_index_608;
    int tmp_index_611;
    int tmp_index_614;
...
inline void loop_body_53_15_0(solve_nh_predictor_post_state_t *__state, double* __restrict__ __CG_p_nh__CG_diag__m_theta_v_ic, double* __restrict__ __CG_p_nh__CG_metrics__m_ddqz_z_half, double* __restrict__ __CG_p_nh__CG_metrics__m_deepatmo_divzl_mc, double* __restrict__ __CG_p_nh__CG_metrics__m_deepatmo_divzu_mc, double* __restrict__ __CG_p_nh__CG_metrics__m_vwind_impl_wgt, const double&  dtime, double* __restrict__ z_alpha, double* __restrict__ z_beta, double* __restrict__ z_exner_expl, double* __restrict__ z_w_expl, double* __restrict__ __CG_p_nh_prog_nnew__m_w, double* __restrict__ z_q, int _for_it_19, int64_t _for_it_36, int64_t i_endidx_local, int64_t i_startidx_local, int tmp_struct_symbol_45, int tmp_struct_symbol_55, int tmp_struct_symbol_57, int tmp_struct_symbol_59, int tmp_struct_symbol_61) {
...

    {

        {
            for (auto _for_it_37 = i_startidx_local; _for_it_37 < (i_endidx_local + 1); _for_it_37 += 1) {
                ...
                double loop_body_z_c_local;
                double loop_body_z_gamma_local;
                double loop_body_z_g_local;
                double loop_body_z_b_local;
                {
                    ...
                    loop_body_z_gamma_local = z_gamma_out;
                }
                {
                    double z_gamma_0_in = loop_body_z_gamma_local;
                ...
                }
                {
                    ...
                    loop_body_z_b_local = z_b_out;
                }
                {
                    double z_a_0_in = loop_body_z_a_local;
                    double z_b_0_in = loop_body_z_b_local;
                    ...
                    loop_body_z_g_local = z_g_out;
                }
                {
                    double z_c_0_in = loop_body_z_c_local;
                    double z_g_0_in = loop_body_z_g_local;
                    double z_q_out_0;
...
inline void loop_body_53_16_0(solve_nh_predictor_post_state_t *__state, double* __restrict__ z_q, double* __restrict__ __CG_p_nh_prog_nnew__m_w, int _for_it_19, int64_t _for_it_38, int64_t i_endidx_local, int64_t i_startidx_local, int tmp_struct_symbol_61) {
...

    {

        {
            for (auto _for_it_27 = i_startidx_local; _for_it_27 < (i_endidx_local + 1); _for_it_27 += 1) {
                loop_body_53_11_0(__state, nlevp1, &z_alpha[0], &z_q[0], _for_it_27, tmp_struct_symbol_57, tmp_struct_symbol_61);
            }
        }
...

    {

        {
            for (auto _for_it_30 = i_startidx_local; _for_it_30 < (i_endidx_local + 1); _for_it_30 += 1) {
                loop_body_53_12_0(__state, &__CG_p_nh__CG_diag__m_w_concorr_c[0], nlevp1, &__CG_p_nh_prog_nnew__m_w[0], &z_contr_w_fl_l[0], _for_it_19, _for_it_30, tmp_struct_symbol_51);
            }
        }
        {
...

    {

        {
            for (auto _for_it_36 = 2; _for_it_36 < (nlev + 1); _for_it_36 += 1) {
                loop_body_53_15_0(__state, &__CG_p_nh__CG_diag__m_theta_v_ic[0], &__CG_p_nh__CG_metrics__m_ddqz_z_half[0], &__CG_p_nh__CG_metrics__m_deepatmo_divzl_mc[0], &__CG_p_nh__CG_metrics__m_deepatmo_divzu_mc[0], &__CG_p_nh__CG_metrics__m_vwind_impl_wgt[0], dtime, &z_alpha[0], &z_beta[0], &z_exner_expl[0], &z_w_expl[0], &__CG_p_nh_prog_nnew__m_w[0], &z_q[0], _for_it_19, _for_it_36, i_endidx_local, i_startidx_local, tmp_struct_symbol_45, tmp_struct_symbol_55, tmp_struct_symbol_57, tmp_struct_symbol_59, tmp_struct_symbol_61);
            }
        }
...

    {

        {
            for (auto _for_it_38 = 2; _for_it_38 < nlev; _for_it_38 += 1) {
                loop_body_53_16_0(__state, &z_q[0], &__CG_p_nh_prog_nnew__m_w[0], _for_it_19, _for_it_38, i_endidx_local, i_startidx_local, tmp_struct_symbol_61);
            }
        }
...

            {
                for (auto _for_it_47 = global_data__m_kstart_dd3d_sym_0; _for_it_47 < (nlev + 1); _for_it_47 += 1) {
                    for (auto _for_it_48 = i_startidx_local; _for_it_48 < (i_endidx_local + 1); _for_it_48 += 1) {
                        loop_body_69_2_6(__state, &__CG_global_data__m_kstart_dd3d[0], &__CG_p_nh__CG_diag__m_w_concorr_c[0], &__CG_p_nh__CG_metrics__m_inv_ddqz_z_full[0], &__CG_p_nh_prog_nnew__m_w[0], &z_dwdz_dd[0], _for_it_19, _for_it_47, _for_it_48, tmp_index_6, tmp_struct_symbol_81, tmp_struct_symbol_82);
                    }
                }
            }
...
inline void loop_body_12_1_0(solve_nh_predictor_post_state_t *__state, double* __restrict__ __CG_p_nh__CG_diag__m_grf_tend_w, double* __restrict__ __CG_p_nh_prog_nnow__m_w, const double&  dtime, const int&  nlevp1, double* __restrict__ __CG_p_nh_prog_nnew__m_w, int _for_it_53, int _for_it_56) {
    int tmp_index_999;
    int tmp_index_1002;
    int tmp_index_1005;
...
inline void loop_body_16_1_0(solve_nh_predictor_post_state_t *__state, double* __restrict__ __CG_p_nh__CG_diag__m_grf_tend_w, double* __restrict__ __CG_p_nh_prog_nnow__m_w, const double&  dtime, const int&  nlevp1, double* __restrict__ __CG_p_nh_prog_nnew__m_w, int _for_it_53, int _for_it_59) {
    int tmp_index_1035;
    int tmp_index_1038;
    int tmp_index_1041;
        ...
        }
        {

            {
                for (auto _for_it_56 = i_startidx_local; _for_it_56 < (i_endidx_local + 1); _for_it_56 += 1) {
                    loop_body_12_1_0(__state, &__CG_p_nh__CG_diag__m_grf_tend_w[0], &__CG_p_nh_prog_nnow__m_w[0], dtime, nlevp1, &__CG_p_nh_prog_nnew__m_w[0], _for_it_53, _for_it_56);
                }
            }
            ...
            }
            {

                {
                    for (auto _for_it_59 = i_startidx_local; _for_it_59 < (i_endidx_local + 1); _for_it_59 += 1) {
                        loop_body_16_1_0(__state, &__CG_p_nh__CG_diag__m_grf_tend_w[0], &__CG_p_nh_prog_nnow__m_w[0], dtime, nlevp1, &__CG_p_nh_prog_nnew__m_w[0], _for_it_53, _for_it_59);
                    }
                }
...

            {
                for (auto _for_it_60 = global_data__m_kstart_dd3d_sym_0; _for_it_60 < (nlev + 1); _for_it_60 += 1) {
                    for (auto _for_it_61 = i_startidx_local; _for_it_61 < (i_endidx_local + 1); _for_it_61 += 1) {
                        loop_body_19_2_6(__state, &__CG_global_data__m_kstart_dd3d[0], &__CG_p_nh__CG_diag__m_w_concorr_c[0], &__CG_p_nh__CG_metrics__m_inv_ddqz_z_full[0], &__CG_p_nh_prog_nnew__m_w[0], &z_dwdz_dd[0], _for_it_53, _for_it_60, _for_it_61, tmp_index_6, tmp_struct_symbol_81, tmp_struct_symbol_82);
                    }
                }
            }
    ...
    if ((_if_cond_4 == 1)) {
        {

            {
                for (auto _for_it_11 = 1; _for_it_11 < (__CG_p_nh__CG_metrics__m_bdy_mflx_e_dim + 1); _for_it_11 += 1) {
                    loop_body_2_0_0(__state, &__CG_p_nh__CG_diag__m_grf_bdy_mflx[0], &__CG_p_nh__CG_metrics__m_bdy_mflx_e_blk[0], &__CG_p_nh__CG_metrics__m_bdy_mflx_e_idx[0], dtime, jstep, nlev, &z_theta_v_e[0], &__CG_p_nh__CG_diag__m_mass_fl_e[0], &z_theta_v_fl_e[0], _for_it_11, tmp_struct_symbol_0, tmp_struct_symbol_1, tmp_struct_symbol_3, tmp_struct_symbol_4);
                }
            }
...

    {

        {
            for (auto _for_it_13 = i_startblk; _for_it_13 < (i_endblk + 1); _for_it_13 += 1) {
                loop_body_0_9_0(__state, &__CG_global_data__m_nflatlev[0], __CG_global_data__m_nproma, &__CG_p_int__m_e_bln_c_s[0], &__CG_p_nh__CG_metrics__m_wgtfac_c[0], &__CG_p_nh__CG_metrics__m_wgtfacq_c[0], &__CG_p_patch__CG_cells__m_edge_blk[0], &__CG_p_patch__CG_cells__m_edge_idx[0], &__CG_p_patch__CG_cells__m_end_index[0], &__CG_p_patch__CG_cells__m_start_index[0], i_endblk, i_startblk, jg, nlev, nlevp1, &z_w_concorr_me[0], &__CG_p_nh__CG_diag__m_w_concorr_c[0], &z_w_concorr_mc[0], _for_it_13, tmp_struct_symbol_39, tmp_struct_symbol_40, tmp_struct_symbol_69);
            }
        }
