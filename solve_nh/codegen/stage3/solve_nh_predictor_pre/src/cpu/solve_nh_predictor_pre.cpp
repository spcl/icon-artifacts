...
inline void loop_body_71_5_0(solve_nh_predictor_pre_state_t *__state, const int&  nlevp1, double* __restrict__ z_exner_ex_pr, int _for_it_66, int tmp_parfor_0, int tmp_struct_symbol_27, int tmp_struct_symbol_28) {
    int tmp_index_1418;
...
inline void loop_body_73_2_0(solve_nh_predictor_pre_state_t *__state, double* __restrict__ __CG_p_nh__CG_metrics__m_wgtfacq_c, const int&  nlev, const int&  nlevp1, double* __restrict__ z_exner_ex_pr, double* __restrict__ z_exner_ic, int _for_it_66, int _for_it_69, int tmp_struct_symbol_27, int tmp_struct_symbol_28, int tmp_struct_symbol_67) {
    int tmp_index_1421;
    int tmp_index_1426;
    int tmp_index_1432;
    int tmp_index_1438;
...
inline void loop_body_71_8_0(solve_nh_predictor_pre_state_t *__state, double* __restrict__ __CG_p_nh__CG_diag__m_exner_pr, double* __restrict__ __CG_p_nh__CG_metrics__m_d_exner_dz_ref_ic, double* __restrict__ __CG_p_nh__CG_metrics__m_ddqz_z_half, double* __restrict__ __CG_p_nh__CG_metrics__m_rho_ref_mc, double* __restrict__ __CG_p_nh__CG_metrics__m_theta_ref_mc, double* __restrict__ __CG_p_nh__CG_metrics__m_vwind_expl_wgt, double* __restrict__ __CG_p_nh__CG_metrics__m_wgtfac_c, double* __restrict__ __CG_p_nh_prog_nnow__m_rho, double* __restrict__ __CG_p_nh_prog_nnow__m_theta_v, double* __restrict__ __CG_p_nh__CG_diag__m_rho_ic, double* __restrict__ __CG_p_nh__CG_diag__m_theta_v_ic, double* __restrict__ z_rth_pr, double* __restrict__ z_th_ddz_exner_c, double* __restrict__ z_theta_v_pr_ic, int _for_it_66, int64_t _for_it_76, int64_t i_endidx_local, int64_t i_startidx_local, int tmp_struct_symbol_15, int tmp_struct_symbol_16, int tmp_struct_symbol_33, int tmp_struct_symbol_34, int tmp_struct_symbol_65) {
...
inline void loop_body_71_7_0(solve_nh_predictor_pre_state_t *__state, double* __restrict__ __CG_p_nh__CG_metrics__m_theta_ref_ic, double* __restrict__ __CG_p_nh__CG_metrics__m_wgtfacq_c, const int&  nlev, const int&  nlevp1, double* __restrict__ z_rth_pr, double* __restrict__ __CG_p_nh__CG_diag__m_theta_v_ic, double* __restrict__ z_theta_v_pr_ic, int _for_it_66, int _for_it_78, int tmp_struct_symbol_33, int tmp_struct_symbol_34, int tmp_struct_symbol_65) {
    int tmp_index_1610;
    int tmp_index_1616;
    int tmp_index_1623;
    int tmp_index_1630;
...

        {
            for (auto _for_it_67 = 1; _for_it_67 < (nlev + 1); _for_it_67 += 1) {
                for (auto _for_it_68 = i_startidx_local; _for_it_68 < (i_endidx_local + 1); _for_it_68 += 1) {
                    loop_body_71_4_7(__state, &__CG_p_nh__CG_metrics__m_exner_exfac[0], &__CG_p_nh__CG_metrics__m_exner_ref_mc[0], &__CG_p_nh_prog_nnow__m_exner[0], &__CG_p_nh__CG_diag__m_exner_pr[0], &z_exner_ex_pr[0], _for_it_66, _for_it_67, _for_it_68, tmp_struct_symbol_27, tmp_struct_symbol_28);
                }
            }
        }
...
inline void loop_body_138_0_0(solve_nh_predictor_pre_state_t *__state, double* __restrict__ __CG_p_nh__CG_diag__m_vn_ie, const int&  nshift, double* __restrict__ __CG_p_nh__CG_diag__m_vn_ie_int, int _for_it_89, int _for_it_90) {
    int tmp_index_1952;
...
inline void loop_body_47_0_11(solve_nh_predictor_pre_state_t *__state, int* __restrict__ __CG_p_nh__CG_metrics__m_pg_edgeblk, int* __restrict__ __CG_p_nh__CG_metrics__m_pg_edgeidx, double* __restrict__ __CG_p_nh__CG_metrics__m_pg_exdist, int* __restrict__ __CG_p_nh__CG_metrics__m_pg_vertidx, const int&  nblks_gradp, const int&  nproma_gradp, const int&  npromz_gradp, double* __restrict__ z_hydro_corr, double* __restrict__ z_gradh_exner, int _for_it_101, int64_t _for_it_102, int tmp_struct_symbol_30, int tmp_struct_symbol_31, int tmp_struct_symbol_75) {
    int ishift_local;
    ...
    if ((_for_it_102 < nlen_gradp_local)) {
                ...
                for (auto _for_it_106 = 1; _for_it_106 < (nlev + 1); _for_it_106 += 1) {
                    for (auto _for_it_107 = i_startidx_local; _for_it_107 < (i_endidx_local + 1); _for_it_107 += 1) {
                        double loop_body_z_d_vn_iau_local;
                        {
                            ...
                            loop_body_z_d_vn_iau_local = z_d_vn_iau_out;
                        }
                        {
                            double z_d_vn_iau_0_in = loop_body_z_d_vn_iau_local;
...
inline void loop_body_69_0_15(solve_nh_predictor_pre_state_t *__state, double* __restrict__ __CG_p_nh__CG_diag__m_grf_tend_mflx, double* __restrict__ __CG_prep_adv__m_mass_flx_me, const double&  dt_shift, const int&  jb_local, const int&  je_local, double* __restrict__ __CG_p_nh__CG_diag__m_grf_bdy_mflx, int _for_it_113, int64_t _for_it_114) {
    int tmp_index_2631;
    int tmp_index_2633;
    int tmp_index_2637;
    int tmp_index_2639;
        ...
        max_map_range = max(npromz_gradp, nproma_gradp);
        {

            {
                ...
                for (auto _for_it_101 = 1; _for_it_101 < (nblks_gradp + 1); _for_it_101 += 1) {
                    for (auto _for_it_102 = 1; _for_it_102 < (max_map_range + 1); _for_it_102 += 1) {
                        loop_body_47_0_11(__state, &__CG_p_nh__CG_metrics__m_pg_edgeblk[0], &__CG_p_nh__CG_metrics__m_pg_edgeidx[0], &__CG_p_nh__CG_metrics__m_pg_exdist[0], &__CG_p_nh__CG_metrics__m_pg_vertidx[0], nblks_gradp, nproma_gradp, npromz_gradp, &z_hydro_corr[0], &z_gradh_exner[0], _for_it_101, _for_it_102, tmp_struct_symbol_30, tmp_struct_symbol_31, tmp_struct_symbol_75);
                    }
                }
            }
        ...
        }
        {

            {
                for (auto _for_it_110 = i_startblk; _for_it_110 < (i_endblk + 1); _for_it_110 += 1) {
                    loop_body_55_1_0(__state, __CG_global_data__m_nproma, __CG_p_nh__CG_diag__m_ddt_vn_dyn_is_associated, __CG_p_nh__CG_diag__m_ddt_vn_grf_is_associated, &__CG_p_nh__CG_diag__m_grf_tend_vn[0], &__CG_p_nh_prog_nnow__m_vn[0], &__CG_p_patch__CG_edges__m_end_index[0], &__CG_p_patch__CG_edges__m_start_index[0], dtime, i_endblk, i_startblk, nlev, r_nsubsteps, &__CG_p_nh__CG_diag__m_ddt_vn_dyn[0], &__CG_p_nh__CG_diag__m_ddt_vn_grf[0], &__CG_p_nh_prog_nnew__m_vn[0], _for_it_110);
                }
            }
                ...
                for (auto _for_it_113 = 1; _for_it_113 < (__CG_p_nh__CG_metrics__m_bdy_mflx_e_dim + 1); _for_it_113 += 1) {
                    ...
                    }
                    {
                        for (auto _for_it_114 = 1; _for_it_114 < (nlev + 1); _for_it_114 += 1) {
                            loop_body_69_0_15(__state, &__CG_p_nh__CG_diag__m_grf_tend_mflx[0], &__CG_prep_adv__m_mass_flx_me[0], dt_shift, loop_body_jb_local, loop_body_je_local, &__CG_p_nh__CG_diag__m_grf_bdy_mflx[0], _for_it_113, _for_it_114);
                        }
                    }
                }
            }
