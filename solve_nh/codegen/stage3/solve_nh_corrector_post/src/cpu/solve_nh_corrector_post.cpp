...
inline void loop_body_48_0_6(solve_nh_corrector_post_state_t *__state, double* __restrict__ __CG_p_int__m_e_flx_avg, double* __restrict__ __CG_p_nh_prog_nnew__m_vn, int* __restrict__ __CG_p_patch__CG_edges__m_quad_blk, int* __restrict__ __CG_p_patch__CG_edges__m_quad_idx, double* __restrict__ z_vn_avg, int _for_it_0, int _for_it_3, int64_t _for_it_4, int tmp_struct_symbol_47) {
    int tmp_index_133;
    int tmp_index_135;
    int tmp_index_145;
    int tmp_index_147;
...
inline void loop_body_51_0_0(solve_nh_corrector_post_state_t *__state, double* __restrict__ __CG_p_nh__CG_diag__m_mass_fl_e, int* __restrict__ __CG_p_patch__CG_edges__m_refin_ctrl, double* __restrict__ __CG_p_nh__CG_diag__m_mass_fl_e_sv, int _for_it_0, int _for_it_7, int64_t nlev) {
    int _if_cond_5;
...

            {
                for (auto _for_it_1 = 1; _for_it_1 < (nlev + 1); _for_it_1 += 1) {
                    for (auto _for_it_2 = i_startidx_local; _for_it_2 < (i_endidx_local + 1); _for_it_2 += 1) {
                        loop_body_46_0_8(__state, &__CG_p_int__m_e_flx_avg[0], &__CG_p_int__m_rbf_vec_coeff_e[0], &__CG_p_nh_prog_nnew__m_vn[0], &__CG_p_patch__CG_edges__m_quad_blk[0], &__CG_p_patch__CG_edges__m_quad_idx[0], &__CG_p_nh__CG_diag__m_vt[0], &z_vn_avg[0], _for_it_0, _for_it_1, _for_it_2, tmp_struct_symbol_47);
                    }
                }
            }
...

            {
                for (auto _for_it_3 = 1; _for_it_3 < (nlev + 1); _for_it_3 += 1) {
                    for (auto _for_it_4 = i_startidx_local; _for_it_4 < (i_endidx_local + 1); _for_it_4 += 1) {
                        loop_body_48_0_6(__state, &__CG_p_int__m_e_flx_avg[0], &__CG_p_nh_prog_nnew__m_vn[0], &__CG_p_patch__CG_edges__m_quad_blk[0], &__CG_p_patch__CG_edges__m_quad_idx[0], &z_vn_avg[0], _for_it_0, _for_it_3, _for_it_4, tmp_struct_symbol_47);
                    }
                }
            }
    ...
    if ((_if_cond_10 == 1)) {
        {

            {
                for (auto _for_it_16 = 1; _for_it_16 < (nlev + 1); _for_it_16 += 1) {
                    loop_body_5_0_0(__state, &__CG_p_nh__CG_diag__m_mass_fl_e[0], &__CG_p_nh__CG_metrics__m_ddqz_z_full_e[0], jb_local, je_local, r_nsubsteps, &z_rho_e[0], &__CG_prep_adv__m_mass_flx_me[0], &__CG_prep_adv__m_vn_traj[0], _for_it_16, tmp_struct_symbol_6, tmp_struct_symbol_7);
                }
            }
...

    {

        {
            for (auto _for_it_17 = 1; _for_it_17 < (nlev + 1); _for_it_17 += 1) {
                loop_body_3_3_0(__state, &__CG_p_nh__CG_diag__m_grf_bdy_mflx[0], dtime, jb_local, je_local, jstep, &z_theta_v_e[0], &__CG_p_nh__CG_diag__m_mass_fl_e[0], &z_theta_v_fl_e[0], _for_it_15, _for_it_17, tmp_struct_symbol_0, tmp_struct_symbol_1, tmp_struct_symbol_3, tmp_struct_symbol_4);
            }
        }
    ...
    if ((_if_cond_11 == 1)) {
        {

            {
                for (auto _for_it_18 = 1; _for_it_18 < (nlev + 1); _for_it_18 += 1) {
                    loop_body_8_0_0(__state, &__CG_p_nh__CG_diag__m_mass_fl_e[0], &__CG_p_nh__CG_metrics__m_ddqz_z_full_e[0], jb_local, je_local, r_nsubsteps, &z_rho_e[0], &__CG_prep_adv__m_mass_flx_me[0], &__CG_prep_adv__m_vn_traj[0], _for_it_18, tmp_struct_symbol_6, tmp_struct_symbol_7);
                }
            }
...
inline void loop_body_13_5_0(solve_nh_corrector_post_state_t *__state, double* __restrict__ __CG_p_nh__CG_metrics__m_wgtfacq_c, const int&  nlev, const int&  nlevp1, double* __restrict__ z_w_concorr_mc, double* __restrict__ __CG_p_nh__CG_diag__m_w_concorr_c, int _for_it_19, int _for_it_24, int tmp_struct_symbol_69) {
    int tmp_index_365;
    int tmp_index_371;
    int tmp_index_376;
    int tmp_index_381;
...

        {
            for (auto _for_it_20 = global_data__m_nflatlev_sym_0; _for_it_20 < (nlev + 1); _for_it_20 += 1) {
                for (auto _for_it_21 = i_startidx_local; _for_it_21 < (i_endidx_local + 1); _for_it_21 += 1) {
                    loop_body_13_3_6(__state, &__CG_p_int__m_e_bln_c_s[0], &__CG_p_patch__CG_cells__m_edge_blk[0], &__CG_p_patch__CG_cells__m_edge_idx[0], &z_w_concorr_me[0], &z_w_concorr_mc[0], _for_it_19, _for_it_20, _for_it_21, tmp_struct_symbol_39, tmp_struct_symbol_40, tmp_struct_symbol_69);
                }
            }
        }
...

    {

        {
            for (auto _for_it_24 = i_startidx_local; _for_it_24 < (i_endidx_local + 1); _for_it_24 += 1) {
                loop_body_13_5_0(__state, &__CG_p_nh__CG_metrics__m_wgtfacq_c[0], nlev, nlevp1, &z_w_concorr_mc[0], &__CG_p_nh__CG_diag__m_w_concorr_c[0], _for_it_19, _for_it_24, tmp_struct_symbol_69);
            }
        }
...
inline void loop_body_67_11_9(solve_nh_corrector_post_state_t *__state, double* __restrict__ __CG_p_int__m_geofac_div, double* __restrict__ __CG_p_nh__CG_diag__m_mass_fl_e, double* __restrict__ __CG_p_nh__CG_metrics__m_deepatmo_divh_mc, int* __restrict__ __CG_p_patch__CG_cells__m_edge_blk, int* __restrict__ __CG_p_patch__CG_cells__m_edge_idx, double* __restrict__ z_theta_v_fl_e, double* __restrict__ z_flxdiv_mass, double* __restrict__ z_flxdiv_theta, int _for_it_25, int _for_it_26, int64_t _for_it_27, int tmp_struct_symbol_0, int tmp_struct_symbol_1, int tmp_struct_symbol_71, int tmp_struct_symbol_73) {
    int tmp_index_393;
    int tmp_index_395;
    int tmp_index_405;
    int tmp_index_407;
...
inline void loop_body_67_13_0(solve_nh_corrector_post_state_t *__state, const int&  nlevp1, double* __restrict__ z_alpha, double* __restrict__ z_q, int _for_it_34, int tmp_struct_symbol_57, int tmp_struct_symbol_61) {
    int tmp_index_541;
...
inline void loop_body_67_14_0(solve_nh_corrector_post_state_t *__state, double* __restrict__ __CG_p_nh__CG_diag__m_w_concorr_c, const int&  nlevp1, double* __restrict__ __CG_p_nh_prog_nnew__m_w, double* __restrict__ z_contr_w_fl_l, int _for_it_25, int _for_it_37, int tmp_struct_symbol_51) {
    int tmp_index_565;
    int tmp_index_568;
    int tmp_index_571;
...
inline void loop_body_67_18_0(solve_nh_corrector_post_state_t *__state, double* __restrict__ z_q, double* __restrict__ __CG_p_nh_prog_nnew__m_w, int _for_it_25, int64_t _for_it_45, int64_t i_endidx_local, int64_t i_startidx_local, int tmp_struct_symbol_61) {
...

    {

        {
            for (auto _for_it_45 = 2; _for_it_45 < nlev; _for_it_45 += 1) {
                loop_body_67_18_0(__state, &z_q[0], &__CG_p_nh_prog_nnew__m_w[0], _for_it_25, _for_it_45, i_endidx_local, i_startidx_local, tmp_struct_symbol_61);
            }
        }
...

            {
                for (auto _for_it_59 = global_data__m_kstart_moist_sym_0; _for_it_59 < (nlev + 1); _for_it_59 += 1) {
                    for (auto _for_it_60 = i_startidx_local; _for_it_60 < (i_endidx_local + 1); _for_it_60 += 1) {
                        loop_body_92_2_8(__state, &__CG_global_data__m_ndyn_substeps_var[0], &__CG_p_nh__CG_diag__m_ddt_exner_phy[0], &__CG_p_nh_prog_nnew__m_exner[0], dtime, jg, &__CG_p_nh__CG_diag__m_exner_dyn_incr[0], _for_it_25, _for_it_59, _for_it_60);
                    }
                }
            }
