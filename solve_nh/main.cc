...
int main(int argc, char *argv[]) {
  ...
  for (int n : ns) {
    ...
    auto *h = __dace_init_solve_nh_predictor_post(
        ...
        dt_linintp_ubc_nnew_in, dt_linintp_ubc_nnow_in, dt_shift_in, dthalf_in,
        dtime_in, dz32_in, dz42_in, dzlin_in, dzqdr_in, i_endblk_in,
        i_endidx_in, i_startblk_in, i_startidx_in, idyn_timestep_in, ishift_in,
        istep_in, jb_in, jc_in, je_in, jg_in, jk_in, jk_start_in, jks_in,
        jstep_in, l_child_vertnest_in, l_init_in, l_recompute_in,
        l_vert_nested_in, lacc_in, lclean_mflx_in, lprep_adv_in, lsave_mflx_in,
        lvn_only_in, lvn_pos_in, nblks_gradp_in, nlen_gradp_in, nlev_in,
        nlevp1_in, nnew_in, nnow_in, nproma_gradp_in, npromz_gradp_in,
        nshift_in, nshift_total_in, ntl1_in, ntl2_in, nvar_in,
        r_dtimensubsteps_in, r_nsubsteps_in, rl_end_in, rl_start_in,
